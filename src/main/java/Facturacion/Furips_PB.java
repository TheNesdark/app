...
/* JADX INFO: loaded from: GenomaP.jar:Facturacion/Furips_PB.class */
public class Furips_PB {
    ...
    public Furips_PB(String xidPersonaEvento, String xidEvento, String xidIngreso, String xNRadicacionG, String xnValorG, String xTraslado) {
    ...
    public JasperReportBuilder build() {
        ...
        try {
            ...
            ResultSet xrsAtencionE = AtencionEgreso.executeQuery(xsql);
            xrsAtencionE.first();
            ...
            } else if (xrsAtencionI.getString("Id_TipoAtencion").equals("3") || xrsAtencionI.getString("Id_TipoAtencion").equals("2") || xrsAtencionI.getString("Id_TipoAtencion").equals("4")) {
                this.xApellido1 = xrsAtencionE.getString("Apellido1");
                this.xApellido2 = xrsAtencionE.getString("Apellido2");
                this.xNombre1 = xrsAtencionE.getString("Nombre1");
                this.xNombre2 = xrsAtencionE.getString("Nombre2");
