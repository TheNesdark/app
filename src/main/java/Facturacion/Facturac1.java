...
/* JADX INFO: loaded from: GenomaP.jar:Facturacion/Facturac1.class */
public class Facturac1 extends JInternalFrame {
    ...
    public Facturac1 frmFacturac = null;

    public Facturac1(claseFacturacion xclasefacturacion, int cajaabierta, claseCaja claseC) {
        ...
        if (Principal.informacionIps.getNombreIps().equals("LABORATORIO CLINICO VIVIAN RAMIREZ I.P.S. S.A.") || Principal.informacionIps.getNombreIps().equals("BIOMED VIDA IPS S.A.S") || Principal.informacionIps.getNombreIps().equals("E.S.E. HOSPITAL SAN VICENTE DE PAUL") || Principal.informacionIps.getIdentificacion().equals("812001579")) {
    ...
    public Facturac1(claseFacturacion xclasefacturacion, int cajaabierta, claseCaja claseC, String idOrdenSimedis, String t) {
        this.clasefacturacion = null;
        this.clasecaja = null;
        initComponents();
        this.cargaInicial = 0;
    ...
    public Facturac1(claseFacturacion xclasefacturacion, int cajaabierta, claseCaja claseC, String xnhc) {
        this.clasefacturacion = null;
        this.clasecaja = null;
        idModulo = 0;
        this.cargaInicial = 0;
    ...
    private void initComponents() {
        ...
        setName("Facturac");
        setPreferredSize(new Dimension(1216, 937));
        addInternalFrameListener(new InternalFrameListener() { // from class: Facturacion.Facturac1.1
            public void internalFrameActivated(InternalFrameEvent evt) {
                Facturac1.this.formInternalFrameActivated(evt);
            }
            ...
            public void internalFrameClosing(InternalFrameEvent evt) {
                Facturac1.this.formInternalFrameClosing(evt);
            }
            ...
            public void internalFrameOpened(InternalFrameEvent evt) {
                Facturac1.this.formInternalFrameOpened(evt);
            }
        });
        ...
        this.jtpUsuario.addMouseListener(new MouseAdapter() { // from class: Facturacion.Facturac1.2
            public void mouseClicked(MouseEvent evt) {
                Facturac1.this.jtpUsuarioMouseClicked(evt);
            }
        });
        ...
        panelPersonaLayout.setHorizontalGroup(panelPersonaLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGap(0, 1009, 32767));
        panelPersonaLayout.setVerticalGroup(panelPersonaLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGap(0, 159, 32767));
        ...
        this.JBTRegistroHora.addActionListener(new ActionListener() { // from class: Facturacion.Facturac1.3
            public void actionPerformed(ActionEvent evt) {
                Facturac1.this.JBTRegistroHoraActionPerformed(evt);
            }
        });
        this.btnConsolidado.setFont(new Font("Arial", 1, 12));
        this.btnConsolidado.setIcon(new ImageIcon(getClass().getResource("/Imagenes/consolida2.jpg")));
        this.btnConsolidado.setText("<html><P ALIGN=center>Consolidado Servicios");
        this.btnConsolidado.setEnabled(false);
        this.btnConsolidado.setIconTextGap(0);
        this.btnConsolidado.addActionListener(new ActionListener() { // from class: Facturacion.Facturac1.4
            public void actionPerformed(ActionEvent evt) {
                Facturac1.this.btnConsolidadoActionPerformed(evt);
            }
        });
        ...
        this.JBTRegistroHora1.addActionListener(new ActionListener() { // from class: Facturacion.Facturac1.5
            public void actionPerformed(ActionEvent evt) {
                Facturac1.this.JBTRegistroHora1ActionPerformed(evt);
            }
        });
        this.btnWanglabUser.setFont(new Font("Arial", 1, 12));
        this.btnWanglabUser.setText("<html><P ALIGN=center> Registro Wanglab");
        this.btnWanglabUser.addActionListener(new ActionListener() { // from class: Facturacion.Facturac1.6
            public void actionPerformed(ActionEvent evt) {
                Facturac1.this.btnWanglabUserActionPerformed(evt);
            }
        });
        ...
        this.btnWanglabUser1.addActionListener(new ActionListener() { // from class: Facturacion.Facturac1.7
            public void actionPerformed(ActionEvent evt) {
                Facturac1.this.btnWanglabUser1ActionPerformed(evt);
            }
        });
        ...
        this.JBTHuella.addActionListener(new ActionListener() { // from class: Facturacion.Facturac1.8
            public void actionPerformed(ActionEvent evt) {
                Facturac1.this.JBTHuellaActionPerformed(evt);
            }
        });
        ...
        jtpUsuarioLayout.setHorizontalGroup(jtpUsuarioLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(jtpUsuarioLayout.createSequentialGroup().addGroup(jtpUsuarioLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(jtpUsuarioLayout.createSequentialGroup().addComponent(this.panelPersona, -2, 1009, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.btnConsolidado, -2, 167, 32767)).addGroup(jtpUsuarioLayout.createSequentialGroup().addComponent(this.JBTRegistroHora, -2, 140, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JBTRegistroHora1, -2, 140, -2).addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED).addComponent(this.btnWanglabUser, -2, 140, -2).addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED).addComponent(this.btnWanglabUser1, -2, 140, -2).addGap(18, 18, 18).addComponent(this.JBTHuella, -2, 140, -2).addGap(0, 0, 32767))).addContainerGap()));
        jtpUsuarioLayout.setVerticalGroup(jtpUsuarioLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(jtpUsuarioLayout.createSequentialGroup().addContainerGap().addGroup(jtpUsuarioLayout.createParallelGroup(GroupLayout.Alignment.TRAILING).addComponent(this.panelPersona, -2, 159, -2).addComponent(this.btnConsolidado, -2, 92, -2)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(jtpUsuarioLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.JBTHuella).addGroup(GroupLayout.Alignment.TRAILING, jtpUsuarioLayout.createSequentialGroup().addGap(0, 0, 32767).addGroup(jtpUsuarioLayout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(this.JBTRegistroHora1, -2, -1, -2).addComponent(this.JBTRegistroHora, -2, -1, -2))).addComponent(this.btnWanglabUser, GroupLayout.Alignment.TRAILING).addComponent(this.btnWanglabUser1, -1, -1, 32767))));
        ...
        this.jtpIngreso.addMouseListener(new MouseAdapter() { // from class: Facturacion.Facturac1.9
            public void mouseClicked(MouseEvent evt) {
                Facturac1.this.jtpIngresoMouseClicked(evt);
            }
        });
        ...
        panelIngresoLayout.setHorizontalGroup(panelIngresoLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGap(0, 1188, 32767));
        ...
        panelMvtoLayout.setVerticalGroup(panelMvtoLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGap(0, 500, 32767));
        this.jtpOrdenes.getContentPane().add(this.panelMvto);
        GroupLayout jTaskPane1Layout = new GroupLayout(this.jTaskPane1);
        this.jTaskPane1.setLayout(jTaskPane1Layout);
        jTaskPane1Layout.setHorizontalGroup(jTaskPane1Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(jTaskPane1Layout.createSequentialGroup().addGroup(jTaskPane1Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.jtpUsuario, -2, -1, -2).addComponent(this.jtpIngreso, -2, 1210, -2).addComponent(this.jtpOrdenes, -2, 1210, -2)).addGap(56, 56, 56)));
        jTaskPane1Layout.setVerticalGroup(jTaskPane1Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(jTaskPane1Layout.createSequentialGroup().addContainerGap().addComponent(this.jtpUsuario, -2, -1, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.jtpIngreso, -2, -1, -2).addGap(0, 0, 0).addComponent(this.jtpOrdenes, -2, -1, -2)));
        GroupLayout layout = new GroupLayout(getContentPane());
        getContentPane().setLayout(layout);
        layout.setHorizontalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(layout.createSequentialGroup().addContainerGap().addComponent(this.jTaskPane1, -2, -1, -2).addContainerGap(-1, 32767)));
        layout.setVerticalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(layout.createSequentialGroup().addContainerGap().addComponent(this.jTaskPane1, -2, -1, -2).addContainerGap(-1, 32767)));
        pack();
    }
    ...
    private void grabado() {
        ...
        if (n == 0 && !this.xhorallegado) {
            try {
                ...
                Logger.getLogger(Facturac1.class.getName()).log(Level.SEVERE, (String) null, (Throwable) ex);
            }
        }
    }
