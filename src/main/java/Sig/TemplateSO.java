...
/* JADX INFO: loaded from: GenomaP.jar:Sig/TemplateSO.class */
public class TemplateSO {
    ...
    public static final StyleBuilder encabezado = DynamicReports.stl.style(boldStyle).setBackgroundColor(new Color(192, 192, 192)).setFontSize(8).setBorder(DynamicReports.stl.pen1Point()).setAlignment(HorizontalAlignment.CENTER, VerticalAlignment.TOP);
    ...
    static {
        ...
        dynamicReportsComponent = DynamicReports.cmp.horizontalList(new ComponentBuilder[]{DynamicReports.cmp.verticalList(new ComponentBuilder[]{DynamicReports.cmp.text("").setStyle(bold22CenteredStyle).setHorizontalAlignment(HorizontalAlignment.LEFT)})});
    ...
    public static ComponentBuilder<?, ?> createTitleComponent(String label) {
        return DynamicReports.cmp.horizontalList().add(new ComponentBuilder[]{dynamicReportsComponent, DynamicReports.cmp.text(label).setStyle(bold18CenteredStyle).setHorizontalAlignment(HorizontalAlignment.RIGHT)}).newRow().add(new ComponentBuilder[]{DynamicReports.cmp.line()}).newRow().add(new ComponentBuilder[]{DynamicReports.cmp.verticalGap(10)});
    }
    ...
    /* JADX INFO: loaded from: GenomaP.jar:Sig/TemplateSO$CurrencyType.class */
    ...
    /* JADX INFO: loaded from: GenomaP.jar:Sig/TemplateSO$CurrencyValueFormatter.class */
    private static class CurrencyValueFormatter extends AbstractValueFormatter<String, Number> {
        ...
        public String format(Number value, ReportParameters reportParameters) {
            return this.label + TemplateSO.currencyType.valueToString(value, reportParameters.getLocale());
        }
    }
}
