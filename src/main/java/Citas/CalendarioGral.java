...
/* JADX INFO: loaded from: GenomaP.jar:Citas/CalendarioGral.class */
public class CalendarioGral extends JPanel {
    ...
    public String[][] listaDiasConCita = new String[1000][8];
    private CitasGral frmCita = null;
    private CitaTerapia frmCitaT = null;
    private CitaInterconsulta frmCitaIC = null;
    private JIF_Programacion_Cx xJif_PCx = null;

    public CalendarioGral(JInternalFrame frm) {
        initComponents();
        casting(frm);
        cargarDiasFestivos();
        iniciar();
    ...
    public int getTieneCita(String xfecha) {
        int tiene = 0;
        for (String[] listaDiasConCita1 : this.listaDiasConCita) {
            if (listaDiasConCita1[0] == null) {
                break;
            }
            if (listaDiasConCita1[0].equals(xfecha)) {
                tiene = 1;
            }
        }
        return tiene;
    ...
    private void buscarCita(JButton xBoton) {
        if (xBoton.getIcon() == null || xBoton.getForeground().toString().equals("java.awt.Color[r=204,g=0,b=0]")) {
        ...
        if (this.frmCita != null) {
            ...
            if (!this.frmCita.xCambioFecha && !this.metodos.formatoAMD1.format(getFecha().getTime()).equals(this.metodos.formatoAMD1.format(this.frmCita.JDFFechaSolictud.getDate()))) {
                int x = JOptionPane.showInternalConfirmDialog(this.frmCita, "Fecha de solicitud diferente a la asignada;\nDesea modificarla?", "CONFIRMACIÓN", 0, 1, new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/Imagenes/Question.png"))));
                if (x == 0) {
                    this.frmCita.JDFFechaSolictud.setDate(getFecha().getTime());
                    return;
                }
                return;
            }
    ...
    private void casting(JInternalFrame frm) {
        ...
        switch (frm.getName()) {
            ...
            case "CitaTerapia":
                ...
                break;
            case "CitaInterconsulta":
                this.frmCitaIC = (CitaInterconsulta) frm;
                break;
    ...
    private String mTraerMes() {
        ...
        try {
            ...
            Logger.getLogger(CalendarioGral.class.getName()).log(Level.SEVERE, (String) null, (Throwable) ex);
        }
        return mes;
    }
    ...
    public void limpiarListaDiasConCita() {
        for (int i = 0; i < 1000; i++) {
            ...
            this.listaDiasConCita[i][7] = null;
        }
    }

    public void montarAgendaGeneral(String idProfesional, String idEspecial, String idSede) {
        String ymes = String.valueOf(Integer.parseInt(getMes()) + 1);
        if (ymes.length() == 1) {
            ymes = "0" + ymes;
        }
        if (this.xNombre.equals("xjig_programacion_cx") || this.xNombre.equals("Programación Cirugia")) {
            this.sql = "SELECT `q_confsalacirugias`.`Fecha_Conf` , `q_confsalacirugias`.`DiaSemana`  , `q_confsalacirugias`.`HoraInicial` , `q_confsalacirugias`.`HoraFinal` , `q_salacirugias`.`Nbre` , 0 AS `Cupo`, 1 idConsultorio FROM `q_confsalacirugias` INNER JOIN  `q_salacirugias`  ON (`q_confsalacirugias`.`Id_SalaCirugia` = `q_salacirugias`.`Id`) WHERE (`q_salacirugias`.`Nbre` ='" + idProfesional + "' and `q_confsalacirugias`.`Fecha_Conf` <='" + getAno() + "/" + ymes + "/" + getUltimoDiaMes() + "' AND TipoAgenda = 1 ) ";
        } else {
            this.sql = "SELECT c_confcitas.Fecha_ConfCitas, c_confcitas.DiaSemana, c_confcitas.Id_Consultorio, c_confcitas.HoraInicial, c_confcitas.HoraFinal, c_consultorio.Nbre, c_confcitas.Cupo, c_consultorio.Id idConsultorio FROM c_confcitas INNER JOIN c_consultorio ON (c_confcitas.Id_Consultorio = c_consultorio.Id) WHERE (c_confcitas.Id_Profesional ='" + idProfesional + "' AND c_confcitas.Id_Especialidad ='" + idEspecial + "' AND c_confcitas.IdSede ='" + idSede + "' AND c_confcitas.Fecha_ConfCitas <='" + getAno() + "/" + ymes + "/" + getUltimoDiaMes() + "' AND TipoAgenda = 1 AND c_confcitas.Estado = 0 ) ORDER BY c_confcitas.Fecha_ConfCitas ASC, c_confcitas.DiaSemana ASC, c_confcitas.HoraInicial ASC";
        }
                        ...
                        if (f >= Integer.parseInt(this.rs.getString(1).substring(8, 10)) || (f <= Integer.parseInt(this.rs.getString(1).substring(8, 10)) && Integer.parseInt(ymes) >= Integer.parseInt(this.rs.getString(1).substring(5, 7)) && Integer.parseInt(getAno()) >= Integer.parseInt(this.rs.getString(1).substring(0, 4)))) {
                            ...
                            if (this.panelDias.getComponent(f).isEnabled() && !this.boton.getForeground().equals(new Color(204, 0, 0))) {
                                ...
                                if (this.xNombre.equals("xjig_programacion_cx") || this.xNombre.equals("Programación Cirugia")) {
                                    ...
                                    this.listaDiasConCita[this.filaListaDiasConCita][7] = this.rs.getString("idConsultorio");
                                } else {
    ...
    public void montarAgendaEspecial(String idProfesional, String idEspecial, String idSede) {
        String ymes = String.valueOf(Integer.parseInt(getMes()) + 1);
        if (ymes.length() == 1) {
            String str = "0" + ymes;
        }
        if (this.xNombre.equals("xjig_programacion_cx") || this.xNombre.equals("Programación Cirugia")) {
            this.sql = "SELECT `q_confsalacirugias`.`Fecha_Conf` , `q_confsalacirugias`.`DiaSemana`  , `q_confsalacirugias`.`HoraInicial` , `q_confsalacirugias`.`HoraFinal` , `q_salacirugias`.`Nbre` , 0 AS `Cupo`, 0 idConsultorio FROM `q_confsalacirugias` INNER JOIN  `q_salacirugias`  ON (`q_confsalacirugias`.`Id_SalaCirugia` = `q_salacirugias`.`Id`) WHERE (`q_salacirugias`.`Nbre` ='" + idProfesional + "' and MONTH(`q_confsalacirugias`.`Fecha_Conf`) ='" + (Integer.parseInt(getMes()) + 1) + "' and YEAR(`q_confsalacirugias`.`Fecha_Conf`) ='" + getAno() + "' AND TipoAgenda = 2 ) ";
        } else {
            this.sql = "SELECT c_confcitas.Fecha_ConfCitas, c_confcitas.Id_Consultorio, c_confcitas.HoraInicial, c_confcitas.HoraFinal, c_consultorio.Nbre, c_confcitas.Id_Profesional, c_confcitas.Cupo, c_consultorio.Id idConsultorio FROM  c_consultorio INNER JOIN  c_confcitas ON (c_consultorio.Id = c_confcitas.Id_Consultorio) WHERE (MONTH(c_confcitas.Fecha_ConfCitas) ='" + (Integer.parseInt(getMes()) + 1) + "' AND YEAR(c_confcitas.Fecha_ConfCitas) ='" + getAno() + "' AND c_confcitas.TipoAgenda =2 AND c_confcitas.Id_Profesional ='" + idProfesional + "' AND c_confcitas.Id_Especialidad ='" + idEspecial + "' AND c_confcitas.IdSede ='" + idSede + "' AND c_confcitas.Estado = 0) ORDER BY c_confcitas.Fecha_ConfCitas ASC, c_confcitas.HoraInicial ASC";
        }
        this.rs = this.consultas.traerRs(this.sql);
        while (this.rs.next()) {
            try {
                ...
                if (this.xNombre.equals("xjig_programacion_cx") || this.xNombre.equals("Programación Cirugia")) {
                    ...
                    this.listaDiasConCita[this.filaListaDiasConCita][6] = this.rs.getString(6);
                    this.listaDiasConCita[this.filaListaDiasConCita][7] = this.rs.getString("idConsultorio");
                    setMarcarBoton(this.rs.getString(1).substring(8, 10), "/Imagenes/Quirofano.png");
                } else {
    ...
    public void montarAgendaExcepcion(String idProfesional, String idEspecial, String idSede) {
        if (this.xNombre.equals("xjig_programacion_cx") || this.xNombre.equals("Programación Cirugia")) {
            ...
            this.sql = "SELECT c_confcitas.Fecha_ConfCitas, c_confcitas.Id_Consultorio, c_confcitas.HoraInicial, c_confcitas.HoraFinal, c_consultorio.Nbre, c_confcitas.Id_Profesional, c_confcitas.Cupo, c_consultorio.Id idConsultorio FROM  c_consultorio INNER JOIN  c_confcitas ON (c_consultorio.Id = c_confcitas.Id_Consultorio) WHERE (MONTH(c_confcitas.Fecha_ConfCitas) ='" + (Integer.parseInt(getMes()) + 1) + "' AND YEAR(c_confcitas.Fecha_ConfCitas) ='" + getAno() + "' AND c_confcitas.TipoAgenda =3 AND c_confcitas.Id_Profesional ='" + idProfesional + "' AND c_confcitas.Id_Especialidad ='" + idEspecial + "' AND c_confcitas.IdSede ='" + idSede + "' AND c_confcitas.Estado = 0) ORDER BY c_confcitas.Fecha_ConfCitas ASC, c_confcitas.HoraInicial ASC";
        }
        this.rs = this.consultas.traerRs(this.sql);
        try {
            this.rs.last();
                    ...
                    while (true) {
                        if (u < 42) {
                            ...
                            if (this.boton.getText() == null || Integer.parseInt(this.boton.getText()) != Integer.parseInt(this.rs.getString(1).substring(8, 10)) || !this.boton.isEnabled()) {
                                ...
                                setMarcarBoton(this.rs.getString(1).substring(8, 10), "/Imagenes/Cita.png");
                                this.listaDiasConCita[this.filaListaDiasConCita][0] = this.boton.getText();
                                if (this.xNombre.equals("xjig_programacion_cx") || this.xNombre.equals("Programación Cirugia")) {
                                    this.listaDiasConCita[this.filaListaDiasConCita][1] = "";
                                    this.listaDiasConCita[this.filaListaDiasConCita][2] = this.rs.getString(3);
        ...
        for (int i2 = xColumna; i2 < this.panelDias.getComponentCount(); i2++) {
            ...
            for (int df = 0; df < this.lisDiasFestivos.length; df++) {
                if (this.lisDiasFestivos[df].equals(fecBoton)) {
                    ...
                    this.boton.setIcon(new ImageIcon(getClass().getResource("/Imagenes/Festivo.png")));
                }
            }
    ...
    private void initComponents() {
        ...
        this.cboMes.addItemListener(new ItemListener() { // from class: Citas.CalendarioGral.1
            public void itemStateChanged(ItemEvent evt) {
                CalendarioGral.this.cboMesItemStateChanged(evt);
            }
        });
        this.txtAno.setFont(new Font("Arial", 1, 12));
        this.txtAno.setValue(2010);
        this.txtAno.addChangeListener(new ChangeListener() { // from class: Citas.CalendarioGral.2
            public void stateChanged(ChangeEvent evt) {
                CalendarioGral.this.txtAnoStateChanged(evt);
            }
        });
        ...
        this.btn1.addActionListener(new ActionListener() { // from class: Citas.CalendarioGral.3
            public void actionPerformed(ActionEvent evt) {
                CalendarioGral.this.btn1ActionPerformed(evt);
            }
        });
        ...
        this.btn2.addActionListener(new ActionListener() { // from class: Citas.CalendarioGral.4
            public void actionPerformed(ActionEvent evt) {
                CalendarioGral.this.btn2ActionPerformed(evt);
            }
        });
        ...
        this.btn3.addActionListener(new ActionListener() { // from class: Citas.CalendarioGral.5
            public void actionPerformed(ActionEvent evt) {
                CalendarioGral.this.btn3ActionPerformed(evt);
            }
        });
        ...
        this.btn4.addActionListener(new ActionListener() { // from class: Citas.CalendarioGral.6
            public void actionPerformed(ActionEvent evt) {
                CalendarioGral.this.btn4ActionPerformed(evt);
            }
        });
        ...
        this.btn5.addActionListener(new ActionListener() { // from class: Citas.CalendarioGral.7
            public void actionPerformed(ActionEvent evt) {
                CalendarioGral.this.btn5ActionPerformed(evt);
            }
        });
        ...
        this.btn6.addActionListener(new ActionListener() { // from class: Citas.CalendarioGral.8
            public void actionPerformed(ActionEvent evt) {
                CalendarioGral.this.btn6ActionPerformed(evt);
            }
        });
        ...
        this.btn7.addActionListener(new ActionListener() { // from class: Citas.CalendarioGral.9
            public void actionPerformed(ActionEvent evt) {
                CalendarioGral.this.btn7ActionPerformed(evt);
            }
        });
        ...
        this.btn8.addActionListener(new ActionListener() { // from class: Citas.CalendarioGral.10
            public void actionPerformed(ActionEvent evt) {
                CalendarioGral.this.btn8ActionPerformed(evt);
            }
        });
        ...
        this.btn9.addActionListener(new ActionListener() { // from class: Citas.CalendarioGral.11
            public void actionPerformed(ActionEvent evt) {
                CalendarioGral.this.btn9ActionPerformed(evt);
            }
        });
        ...
        this.btn10.addActionListener(new ActionListener() { // from class: Citas.CalendarioGral.12
            public void actionPerformed(ActionEvent evt) {
                CalendarioGral.this.btn10ActionPerformed(evt);
            }
        });
        ...
        this.btn11.addActionListener(new ActionListener() { // from class: Citas.CalendarioGral.13
            public void actionPerformed(ActionEvent evt) {
                CalendarioGral.this.btn11ActionPerformed(evt);
            }
        });
        ...
        this.btn12.addActionListener(new ActionListener() { // from class: Citas.CalendarioGral.14
            public void actionPerformed(ActionEvent evt) {
                CalendarioGral.this.btn12ActionPerformed(evt);
            }
        });
        ...
        this.btn13.addActionListener(new ActionListener() { // from class: Citas.CalendarioGral.15
            public void actionPerformed(ActionEvent evt) {
                CalendarioGral.this.btn13ActionPerformed(evt);
            }
        });
        ...
        this.btn14.addActionListener(new ActionListener() { // from class: Citas.CalendarioGral.16
            public void actionPerformed(ActionEvent evt) {
                CalendarioGral.this.btn14ActionPerformed(evt);
            }
        });
        ...
        this.btn15.addActionListener(new ActionListener() { // from class: Citas.CalendarioGral.17
            public void actionPerformed(ActionEvent evt) {
                CalendarioGral.this.btn15ActionPerformed(evt);
            }
        });
        ...
        this.btn16.addActionListener(new ActionListener() { // from class: Citas.CalendarioGral.18
            public void actionPerformed(ActionEvent evt) {
                CalendarioGral.this.btn16ActionPerformed(evt);
            }
        });
        ...
        this.btn17.addActionListener(new ActionListener() { // from class: Citas.CalendarioGral.19
            public void actionPerformed(ActionEvent evt) {
                CalendarioGral.this.btn17ActionPerformed(evt);
            }
        });
        ...
        this.btn18.addItemListener(new ItemListener() { // from class: Citas.CalendarioGral.20
            public void itemStateChanged(ItemEvent evt) {
                CalendarioGral.this.btn18ItemStateChanged(evt);
            }
        });
        this.btn18.addActionListener(new ActionListener() { // from class: Citas.CalendarioGral.21
            public void actionPerformed(ActionEvent evt) {
                CalendarioGral.this.btn18ActionPerformed(evt);
            }
        });
        ...
        this.btn19.addActionListener(new ActionListener() { // from class: Citas.CalendarioGral.22
            public void actionPerformed(ActionEvent evt) {
                CalendarioGral.this.btn19ActionPerformed(evt);
            }
        });
        ...
        this.btn20.addActionListener(new ActionListener() { // from class: Citas.CalendarioGral.23
            public void actionPerformed(ActionEvent evt) {
                CalendarioGral.this.btn20ActionPerformed(evt);
            }
        });
        ...
        this.btn21.addActionListener(new ActionListener() { // from class: Citas.CalendarioGral.24
            public void actionPerformed(ActionEvent evt) {
                CalendarioGral.this.btn21ActionPerformed(evt);
            }
        });
        ...
        this.btn22.addActionListener(new ActionListener() { // from class: Citas.CalendarioGral.25
            public void actionPerformed(ActionEvent evt) {
                CalendarioGral.this.btn22ActionPerformed(evt);
            }
        });
        ...
        this.btn23.addActionListener(new ActionListener() { // from class: Citas.CalendarioGral.26
            public void actionPerformed(ActionEvent evt) {
                CalendarioGral.this.btn23ActionPerformed(evt);
            }
        });
        ...
        this.btn24.addActionListener(new ActionListener() { // from class: Citas.CalendarioGral.27
            public void actionPerformed(ActionEvent evt) {
                CalendarioGral.this.btn24ActionPerformed(evt);
            }
        });
        ...
        this.btn25.addActionListener(new ActionListener() { // from class: Citas.CalendarioGral.28
            public void actionPerformed(ActionEvent evt) {
                CalendarioGral.this.btn25ActionPerformed(evt);
            }
        });
        ...
        this.btn26.addActionListener(new ActionListener() { // from class: Citas.CalendarioGral.29
            public void actionPerformed(ActionEvent evt) {
                CalendarioGral.this.btn26ActionPerformed(evt);
            }
        });
        ...
        this.btn27.addActionListener(new ActionListener() { // from class: Citas.CalendarioGral.30
            public void actionPerformed(ActionEvent evt) {
                CalendarioGral.this.btn27ActionPerformed(evt);
            }
        });
        ...
        this.btn28.addActionListener(new ActionListener() { // from class: Citas.CalendarioGral.31
            public void actionPerformed(ActionEvent evt) {
                CalendarioGral.this.btn28ActionPerformed(evt);
            }
        });
        ...
        this.btn29.addActionListener(new ActionListener() { // from class: Citas.CalendarioGral.32
            public void actionPerformed(ActionEvent evt) {
                CalendarioGral.this.btn29ActionPerformed(evt);
            }
        });
        ...
        this.btn30.addActionListener(new ActionListener() { // from class: Citas.CalendarioGral.33
            public void actionPerformed(ActionEvent evt) {
                CalendarioGral.this.btn30ActionPerformed(evt);
            }
        });
        ...
        this.btn31.addActionListener(new ActionListener() { // from class: Citas.CalendarioGral.34
            public void actionPerformed(ActionEvent evt) {
                CalendarioGral.this.btn31ActionPerformed(evt);
            }
        });
        ...
        this.btn32.addActionListener(new ActionListener() { // from class: Citas.CalendarioGral.35
            public void actionPerformed(ActionEvent evt) {
                CalendarioGral.this.btn32ActionPerformed(evt);
            }
        });
        ...
        this.btn33.addActionListener(new ActionListener() { // from class: Citas.CalendarioGral.36
            public void actionPerformed(ActionEvent evt) {
                CalendarioGral.this.btn33ActionPerformed(evt);
            }
        });
        ...
        this.btn34.addActionListener(new ActionListener() { // from class: Citas.CalendarioGral.37
            public void actionPerformed(ActionEvent evt) {
                CalendarioGral.this.btn34ActionPerformed(evt);
            }
        });
        ...
        this.btn35.addActionListener(new ActionListener() { // from class: Citas.CalendarioGral.38
            public void actionPerformed(ActionEvent evt) {
                CalendarioGral.this.btn35ActionPerformed(evt);
            }
        });
        ...
        this.btn36.addActionListener(new ActionListener() { // from class: Citas.CalendarioGral.39
            public void actionPerformed(ActionEvent evt) {
                CalendarioGral.this.btn36ActionPerformed(evt);
            }
        });
        ...
        this.btn37.addActionListener(new ActionListener() { // from class: Citas.CalendarioGral.40
            public void actionPerformed(ActionEvent evt) {
                CalendarioGral.this.btn37ActionPerformed(evt);
            }
        });
        ...
        this.btn38.addActionListener(new ActionListener() { // from class: Citas.CalendarioGral.41
            public void actionPerformed(ActionEvent evt) {
                CalendarioGral.this.btn38ActionPerformed(evt);
            }
        });
        ...
        this.btn39.addActionListener(new ActionListener() { // from class: Citas.CalendarioGral.42
            public void actionPerformed(ActionEvent evt) {
                CalendarioGral.this.btn39ActionPerformed(evt);
            }
        });
        ...
        this.btn40.addActionListener(new ActionListener() { // from class: Citas.CalendarioGral.43
            public void actionPerformed(ActionEvent evt) {
                CalendarioGral.this.btn40ActionPerformed(evt);
            }
        });
        ...
        this.btn41.addActionListener(new ActionListener() { // from class: Citas.CalendarioGral.44
            public void actionPerformed(ActionEvent evt) {
                CalendarioGral.this.btn41ActionPerformed(evt);
            }
        });
        ...
        this.btn42.addActionListener(new ActionListener() { // from class: Citas.CalendarioGral.45
            public void actionPerformed(ActionEvent evt) {
                CalendarioGral.this.btn42ActionPerformed(evt);
            }
        });
