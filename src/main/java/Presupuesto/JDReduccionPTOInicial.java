...
/* JADX INFO: loaded from: GenomaP.jar:Presupuesto/JDReduccionPTOInicial.class */
public class JDReduccionPTOInicial extends JDialog {
    ...
    public JDReduccionPTOInicial(Frame parent, boolean modal, JIFFCarguePTOInicial xJIFFCarguePTOInicial) {
        super(parent, modal);
        ...
        this.xConsecutivo = 0;
        this.xIdAdicion = "";
        setTitle("REDUCCIÓN AL PRESUPUESTO INICIAL");
    ...
    private void initComponents() {
        ...
        this.JCBTipoDocumento.addItemListener(new ItemListener() { // from class: Presupuesto.JDReduccionPTOInicial.1
            public void itemStateChanged(ItemEvent evt) {
                JDReduccionPTOInicial.this.JCBTipoDocumentoItemStateChanged(evt);
            }
        });
        ...
        jPanel1Layout.setHorizontalGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(jPanel1Layout.createSequentialGroup().addComponent(this.JDFFechaR, -2, 109, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED, -1, 32767).addComponent(this.JCBTipoDocumento, -2, 323, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JTFDatosRes, -2, 145, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JDFFechaAD, -2, 121, -2).addContainerGap()));
        jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(jPanel1Layout.createSequentialGroup().addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.TRAILING).addComponent(this.JDFFechaR, -1, -1, 32767).addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING, false).addComponent(this.JCBTipoDocumento, -2, 50, -2).addComponent(this.JDFFechaAD, -1, -1, 32767).addComponent(this.JTFDatosRes, GroupLayout.Alignment.TRAILING))).addGap(5, 10, 32767)));
        ...
        this.JFTFValorTotal_Ing.setBackground(new Color(255, 255, 255));
        ...
        this.JFTFValorTotal_Ing.setFormatterFactory(new DefaultFormatterFactory(new NumberFormatter(new DecimalFormat("#,##0"))));
        this.JFTFValorTotal_Ing.setHorizontalAlignment(0);
        this.JFTFValorTotal_Ing.setText("0");
        ...
        this.JBGrabar.addActionListener(new ActionListener() { // from class: Presupuesto.JDReduccionPTOInicial.2
            public void actionPerformed(ActionEvent evt) {
                JDReduccionPTOInicial.this.JBGrabarActionPerformed(evt);
            }
        });
        ...
        this.JTDetalleIngresos.addPropertyChangeListener(new PropertyChangeListener() { // from class: Presupuesto.JDReduccionPTOInicial.3
            @Override // java.beans.PropertyChangeListener
            public void propertyChange(PropertyChangeEvent evt) {
                JDReduccionPTOInicial.this.JTDetalleIngresosPropertyChange(evt);
            }
        });
        this.JTDetalleIngresos.addKeyListener(new KeyAdapter() { // from class: Presupuesto.JDReduccionPTOInicial.4
            public void keyPressed(KeyEvent evt) {
                JDReduccionPTOInicial.this.JTDetalleIngresosKeyPressed(evt);
            }
        });
        ...
        this.jScrollPane2.addPropertyChangeListener(new PropertyChangeListener() { // from class: Presupuesto.JDReduccionPTOInicial.5
            @Override // java.beans.PropertyChangeListener
            public void propertyChange(PropertyChangeEvent evt) {
                JDReduccionPTOInicial.this.jScrollPane2PropertyChange(evt);
            }
        });
        ...
        this.JTDetalleGastos.addPropertyChangeListener(new PropertyChangeListener() { // from class: Presupuesto.JDReduccionPTOInicial.6
            @Override // java.beans.PropertyChangeListener
            public void propertyChange(PropertyChangeEvent evt) {
                JDReduccionPTOInicial.this.JTDetalleGastosPropertyChange(evt);
            }
        });
        this.JTDetalleGastos.addKeyListener(new KeyAdapter() { // from class: Presupuesto.JDReduccionPTOInicial.7
            public void keyPressed(KeyEvent evt) {
                JDReduccionPTOInicial.this.JTDetalleGastosKeyPressed(evt);
            }
        });
        ...
        this.jScrollPane3.addPropertyChangeListener(new PropertyChangeListener() { // from class: Presupuesto.JDReduccionPTOInicial.8
            @Override // java.beans.PropertyChangeListener
            public void propertyChange(PropertyChangeEvent evt) {
                JDReduccionPTOInicial.this.jScrollPane3PropertyChange(evt);
            }
        });
        ...
        this.JTHistAdicion.addMouseListener(new MouseAdapter() { // from class: Presupuesto.JDReduccionPTOInicial.9
            public void mouseClicked(MouseEvent evt) {
                JDReduccionPTOInicial.this.JTHistAdicionMouseClicked(evt);
            }
        });
        this.JTHistAdicion.addPropertyChangeListener(new PropertyChangeListener() { // from class: Presupuesto.JDReduccionPTOInicial.10
            @Override // java.beans.PropertyChangeListener
            public void propertyChange(PropertyChangeEvent evt) {
                JDReduccionPTOInicial.this.JTHistAdicionPropertyChange(evt);
            }
        });
        ...
        this.JFTFValorTotal_Gast.setBackground(new Color(255, 255, 255));
        ...
        this.JFTFValorTotal_Gast.setFormatterFactory(new DefaultFormatterFactory(new NumberFormatter(new DecimalFormat("#,##0"))));
        this.JFTFValorTotal_Gast.setHorizontalAlignment(0);
        this.JFTFValorTotal_Gast.setText("0");
        ...
        this.JBImprimir1.addActionListener(new ActionListener() { // from class: Presupuesto.JDReduccionPTOInicial.11
            public void actionPerformed(ActionEvent evt) {
                JDReduccionPTOInicial.this.JBImprimir1ActionPerformed(evt);
            }
        });
        ...
        this.JLNoAdicion.setBorder(BorderFactory.createTitledBorder((Border) null, "No. Reducción", 0, 0, new Font("Arial", 1, 12), Color.blue));
        ...
        this.JBImprimir.addActionListener(new ActionListener() { // from class: Presupuesto.JDReduccionPTOInicial.12
            public void actionPerformed(ActionEvent evt) {
                JDReduccionPTOInicial.this.JBImprimirActionPerformed(evt);
            }
        });
        this.JTFRuta.setFont(new Font("Arial", 1, 12));
        this.JTFRuta.setText("C:\\Genoma\\plantilla");
        this.JTFRuta.setBorder(BorderFactory.createTitledBorder((Border) null, "Ubicación de archivo a exportar", 0, 0, new Font("Arial", 1, 12), Color.blue));
        this.JTFRuta.addMouseListener(new MouseAdapter() { // from class: Presupuesto.JDReduccionPTOInicial.13
            public void mouseClicked(MouseEvent evt) {
                JDReduccionPTOInicial.this.JTFRutaMouseClicked(evt);
            }
        });
        ...
        this.JBImprimir2.addActionListener(new ActionListener() { // from class: Presupuesto.JDReduccionPTOInicial.14
            public void actionPerformed(ActionEvent evt) {
                JDReduccionPTOInicial.this.JBImprimir2ActionPerformed(evt);
            }
        });
        GroupLayout layout = new GroupLayout(getContentPane());
        getContentPane().setLayout(layout);
        layout.setHorizontalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(layout.createSequentialGroup().addContainerGap().addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.jPanel1, -1, -1, 32767).addComponent(this.jTabbedPane1).addComponent(this.JTFObservacion).addGroup(layout.createSequentialGroup().addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(layout.createSequentialGroup().addComponent(this.JFTFValorTotal_Ing, -2, 169, -2).addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED).addComponent(this.JFTFValorTotal_Gast, -2, 169, -2).addGap(64, 64, 64).addComponent(this.JLNoAdicion, -2, 120, -2)).addGroup(layout.createSequentialGroup().addComponent(this.JBGrabar, -2, 154, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JBImprimir1, -2, 136, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JBImprimir2))).addGap(0, 0, 32767)).addGroup(layout.createSequentialGroup().addComponent(this.JTFRuta).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JBImprimir, -2, 147, -2))).addContainerGap()));
        layout.setVerticalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(layout.createSequentialGroup().addContainerGap().addComponent(this.jPanel1, -2, -1, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.jTabbedPane1, -2, 268, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING, false).addGroup(layout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(this.JFTFValorTotal_Ing, -2, 52, -2).addComponent(this.JFTFValorTotal_Gast, -2, 52, -2)).addComponent(this.JLNoAdicion, -1, -1, 32767)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JTFObservacion, -2, -1, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(layout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(this.JBGrabar, -2, 36, -2).addComponent(this.JBImprimir1, -2, 36, -2).addComponent(this.JBImprimir2, -2, 36, -2)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED, -1, 32767).addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.JTFRuta, -2, 53, -2).addComponent(this.JBImprimir, -2, 50, -2))));
        pack();
    }
    ...
    public void JTHistAdicionMouseClicked(MouseEvent evt) {
        if (this.JTHistAdicion.getSelectedRow() > -1 && evt.getClickCount() == 2) {
            ...
            this.JDFFechaAD.setDate(Date.valueOf(this.xModeloHist.getValueAt(this.JTHistAdicion.getSelectedRow(), 7).toString()));
            this.JDFFechaR.setDate(Date.valueOf(this.xModeloHist.getValueAt(this.JTHistAdicion.getSelectedRow(), 2).toString()));
    ...
    private void mBuscaSaldoAdicionRubro() {
        String sql = "SELECT `Valor` , `Id_Rubro`, Estado FROM `pp_detalle_movimiento` WHERE (`Id_Movimiento` ='" + this.xIdAdicion + "' AND pp_detalle_movimiento.idEncabezado='" + Principal.informacionGeneralPrincipalDTO.getIdMaestroRubro() + "');";
        ...
        try {
            ...
            Logger.getLogger(JDReduccionPTOInicial.class.getName()).log(Level.SEVERE, (String) null, (Throwable) ex);
        }
    }
        ...
        if (this.JTDetalleIngresos.getRowCount() > 0) {
            ...
            if (n == 0) {
                try {
                    ...
                    Logger.getLogger(JDReduccionPTOInicial.class.getName()).log(Level.SEVERE, (String) null, e);
    ...
    private void mIniciaComponentes() {
        this.xIdTipDocumento = this.xct.llenarCombo("SELECT `Id`,`Nbre` FROM  `pp_tipo_documentos` WHERE (`Id_ClaseDoc`=8 AND `Estado`=1 AND EsReduccion=1)", this.xIdTipDocumento, this.JCBTipoDocumento);
        this.xct.cerrarConexionBd();
        this.JCBTipoDocumento.setSelectedIndex(-1);
        this.JDFFechaR.setDate(this.xmt.getFechaActual());
        this.JDFFechaAD.setDate(this.xmt.getFechaActual());
    ...
    private void mCrearModeloDatosGastos() {
        this.xModelogasto = new DefaultTableModel(new Object[0], new String[]{"Cod.Rubro", "Nombre Rubro", "Valor", "Reducción", ""}) { // from class: Presupuesto.JDReduccionPTOInicial.15
    ...
    private void mCrearModeloDatosHist() {
        this.xModeloHist = new DefaultTableModel(new Object[0], new String[]{"Id", "Cod. Doc", "Fecha", "Nombre Doc", "Valor", "Observacion", "Acto Admin.", "FechaActo.Admin"}) { // from class: Presupuesto.JDReduccionPTOInicial.16
    ...
    private void mCrearModeloDatosIngreso() {
        this.xmodelo = new DefaultTableModel(new Object[0], new String[]{"Cod.Rubro", "Nombre Rubro", "Valor", "Reducción", ""}) { // from class: Presupuesto.JDReduccionPTOInicial.17
            Class[] types = {String.class, String.class, Double.class, Double.class, String.class};
            boolean[] canEdit = {false, false, false, true, false};
        ...
        if (this.xmt.mVerificaFecha_PeriodoPresupuesto(this.xmt.formatoAMD.format(this.JDFFechaR.getDate()))) {
            if (this.JCBTipoDocumento.getSelectedIndex() > -1) {
                if (mVerificaSaldoAdicion()) {
                            ...
                            if (n == 0) {
                                ...
                                for (int i = 0; i < this.JTDetalleIngresos.getRowCount(); i++) {
                                    if (Double.valueOf(this.xmodelo.getValueAt(i, 3).toString()).doubleValue() != 0.0d) {
                                        String sql2 = "INSERT INTO  `pp_detalle_movimiento` (`Id_Movimiento`, `Id_Rubro`, `Id_Tercero`, `Valor`, Tipo, `Observacion`,idEncabezado)\n VALUES ('" + xidAdicion + "', '" + this.xmodelo.getValueAt(i, 0) + "', '" + Principal.informacionIps.getIdEmpresa() + "', '" + this.xmodelo.getValueAt(i, 3) + "', '0','" + this.JTFObservacion.getText() + "', '" + Principal.informacionGeneralPrincipalDTO.getIdMaestroRubro() + "' );";
                                ...
                                for (int i2 = 0; i2 < this.JTDetalleGastos.getRowCount(); i2++) {
                                    if (Double.valueOf(this.xModelogasto.getValueAt(i2, 3).toString()).doubleValue() != 0.0d) {
                                        String sql22 = "INSERT INTO  `pp_detalle_movimiento` (`Id_Movimiento`, `Id_Rubro`, `Id_Tercero`, `Valor`, Tipo, `Observacion`,idEncabezado)\n VALUES ('" + xidAdicion + "', '" + this.xModelogasto.getValueAt(i2, 0) + "', '" + Principal.informacionIps.getIdEmpresa() + "', '" + this.xModelogasto.getValueAt(i2, 3) + "', '0','" + this.JTFObservacion.getText() + "','" + Principal.informacionGeneralPrincipalDTO.getIdMaestroRubro() + "');";
                        ...
                        if (n2 == 0) {
                            ...
                            for (int i3 = 0; i3 < this.JTDetalleIngresos.getRowCount(); i3++) {
                                ...
                                if (Double.valueOf(this.xmodelo.getValueAt(i3, 3).toString()).doubleValue() != 0.0d && this.xmodelo.getValueAt(i3, 4).toString().equals("0")) {
                                    String sql23 = "INSERT INTO  `pp_detalle_movimiento` (`Id_Movimiento`, `Id_Rubro`, `Id_Tercero`, `Valor`,Tipo,  `Observacion`,idEncabezado)\n VALUES ('" + this.xIdAdicion + "', '" + this.xmodelo.getValueAt(i3, 0) + "', '" + Principal.informacionIps.getIdEmpresa() + "', '" + this.xmodelo.getValueAt(i3, 3) + "', '0','" + this.JTFObservacion.getText() + "','" + Principal.informacionGeneralPrincipalDTO.getIdMaestroRubro() + "' );";
                                    ...
                                    String sql24 = "UPDATE `pp_detalle_movimiento` SET  `Valor`='" + this.xmodelo.getValueAt(i3, 3) + "',  Observacion='" + this.JTFObservacion.getText() + "' where (Id_Movimiento='" + this.xIdAdicion + "' AND Id_Rubro='" + this.xmodelo.getValueAt(i3, 0) + "' AND pp_detalle_movimiento.idEncabezado='" + Principal.informacionGeneralPrincipalDTO.getIdMaestroRubro() + "')";
                            ...
                            for (int i4 = 0; i4 < this.JTDetalleGastos.getRowCount(); i4++) {
                                if (Double.valueOf(this.xModelogasto.getValueAt(i4, 3).toString()).doubleValue() != 0.0d && this.xModelogasto.getValueAt(i4, 4).toString().equals("0")) {
                                    String sql25 = "INSERT INTO  `pp_detalle_movimiento` (`Id_Movimiento`, `Id_Rubro`, `Id_Tercero`, `Valor`, Tipo `Observacion`,idEncabezado)\n VALUES ('" + this.xIdAdicion + "', '" + this.xModelogasto.getValueAt(i4, 0) + "', '" + Principal.informacionIps.getIdEmpresa() + "', '" + this.xModelogasto.getValueAt(i4, 3) + "', '0','" + this.JTFObservacion.getText() + "','" + Principal.informacionGeneralPrincipalDTO.getIdMaestroRubro() + "' );";
                                    ...
                                    String sql26 = "UPDATE `pp_detalle_movimiento` SET  `Valor`='" + this.xModelogasto.getValueAt(i4, 3) + "',  Observacion='" + this.JTFObservacion.getText() + "' where (Id_Movimiento='" + this.xIdAdicion + "' AND Id_Rubro='" + this.xModelogasto.getValueAt(i4, 0) + "' AND pp_detalle_movimiento.idEncabezado='" + Principal.informacionGeneralPrincipalDTO.getIdMaestroRubro() + "')";
                    ...
                    JOptionPane.showMessageDialog(this, "La reducción del gasto debe ser igual a la del ingreso", "VERIFICAR", 1, new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/Imagenes/Information.png"))));
                    return;
                }
    ...
    private void mConcecutivo() {
        int Con = 0;
        String sql = "SELECT `pp_tipo_documentos`.`Id_ClaseDoc` , IFNULL (MAX(`pp_movimiento`.`NoConcecutivo`),0) AS MaximoCons\nFROM `pp_movimiento`\nINNER JOIN  `pp_tipo_documentos`  ON (`pp_movimiento`.`Id_TipoDoc` = `pp_tipo_documentos`.`Id`)\nWHERE (date_format(pp_movimiento.FechaD,'%Y')='" + this.xmt.formatoANO.format(this.JDFFechaR.getDate()) + "' and `pp_tipo_documentos`.`Id_ClaseDoc` ='8'  and DATE_FORMAT(pp_movimiento.`FechaD`, '%Y') ='" + this.xmt.formatoANO.format(this.JDFFechaR.getDate()) + "' AND  pp_tipo_documentos.`Id`='" + this.xIdTipDocumento[this.JCBTipoDocumento.getSelectedIndex()] + "');";
