...
/* JADX INFO: loaded from: GenomaP.jar:Inventarios/InformeAuditoria.class */
public class InformeAuditoria extends JInternalFrame {
    ...
    public InformeAuditoria() {
        ...
        crearGrid();
        this.grid.addMouseListener(new MouseAdapter() { // from class: Inventarios.InformeAuditoria.1
            public void mouseClicked(MouseEvent e) {
                InformeAuditoria.this.filaGrid = InformeAuditoria.this.grid.rowAtPoint(e.getPoint());
                InformeAuditoria.this.cargarDatos();
            }
        });
    }
    ...
    public void crearGrid() {
        this.modelo = new DefaultTableModel((Object[][]) null, new String[]{"Id", "Producto", "Rotación", "Cant. Inventario", "Cant. Física", "Cant. Diferencia", "Vr. Unidad", "Costo Diferencia", "Explicación Diferencia", "Acción", "Responsable"}) { // from class: Inventarios.InformeAuditoria.2
        ...
        try {
            switch (this.opcion) {
                case 1:
                    ...
                    this.sql = "INSERT INTO i_auditoria(FechaAuditoria, IdBodega, VrMinimo, VrMaximo, Cantidad) VALUES ('" + this.metodos.formatoAMD.format(this.metodos.getFechaActual()) + "','" + this.listaBodega[this.cboBodega.getSelectedIndex()] + "','" + this.txtValorMinimo.getValue() + "','" + this.txtValorMaximo.getValue() + "','" + this.txtCantidad.getValue() + "')";
                    this.IdAuditoria = Integer.parseInt(this.consultas.ejecutarSQLId(this.sql));
                    this.consultas.cerrarConexionBd();
                    ...
                    break;
                case 2:
                    this.sql = "SELECT MAX(Id) FROM i_auditoria WHERE (Fecha = '" + this.metodos.formatoAMD.format(this.txtFecha.getDate()) + "') AND (IdBodega = '" + this.listaBodega[this.cboBodega.getSelectedIndex()] + "')";
    ...
    private void initComponents() {
        ...
        setMaximumSize(new Dimension(1183, 686));
        setMinimumSize(new Dimension(1183, 686));
        setName("InformeAuditoria");
        setNormalBounds(new Rectangle(0, 0, 604, 460));
        setPreferredSize(new Dimension(1183, 686));
        try {
            setSelected(true);
        ...
        this.jScrollPane1.setBounds(10, 10, 1130, 180);
        getContentPane().add(this.jPanel1);
        this.jPanel1.setBounds(0, 400, 1160, 200);
        ...
        this.btnAceptar.addActionListener(new ActionListener() { // from class: Inventarios.InformeAuditoria.3
            public void actionPerformed(ActionEvent evt) {
                InformeAuditoria.this.btnAceptarActionPerformed(evt);
            }
        });
        getContentPane().add(this.btnAceptar);
        this.btnAceptar.setBounds(930, 100, 210, 33);
        ...
        this.jLabel5.setBounds(930, 30, 210, 20);
        this.cboBodega.setFont(new Font("Arial", 1, 12));
        this.cboBodega.addActionListener(new ActionListener() { // from class: Inventarios.InformeAuditoria.4
            public void actionPerformed(ActionEvent evt) {
                InformeAuditoria.this.cboBodegaActionPerformed(evt);
            }
        });
        getContentPane().add(this.cboBodega);
        this.cboBodega.setBounds(930, 60, 210, 30);
        ...
        this.btnConsultarFecha.addActionListener(new ActionListener() { // from class: Inventarios.InformeAuditoria.5
            public void actionPerformed(ActionEvent evt) {
                InformeAuditoria.this.btnConsultarFechaActionPerformed(evt);
            }
        });
        ...
        this.txtFecha.setBounds(200, 20, 100, 30);
        ...
        this.btnConsultarNumero.addActionListener(new ActionListener() { // from class: Inventarios.InformeAuditoria.6
            public void actionPerformed(ActionEvent evt) {
                InformeAuditoria.this.btnConsultarNumeroActionPerformed(evt);
            }
        });
        ...
        this.txtNumero.setEnabled(false);
        this.txtNumero.addChangeListener(new ChangeListener() { // from class: Inventarios.InformeAuditoria.7
            public void stateChanged(ChangeEvent evt) {
                InformeAuditoria.this.txtNumeroStateChanged(evt);
            }
        });
        this.txtNumero.addPropertyChangeListener(new PropertyChangeListener() { // from class: Inventarios.InformeAuditoria.8
            @Override // java.beans.PropertyChangeListener
            public void propertyChange(PropertyChangeEvent evt) {
                InformeAuditoria.this.txtNumeroPropertyChange(evt);
            }
        });
        this.jPanel2.add(this.txtNumero);
        this.txtNumero.setBounds(190, 80, 100, 30);
        getContentPane().add(this.jPanel2);
        this.jPanel2.setBounds(420, 20, 310, 130);
        ...
        this.btnGenerar.addActionListener(new ActionListener() { // from class: Inventarios.InformeAuditoria.9
            public void actionPerformed(ActionEvent evt) {
                InformeAuditoria.this.btnGenerarActionPerformed(evt);
            }
        });
        ...
        this.jPanel3.setBounds(0, 20, 420, 130);
        ...
        this.lblNumero.setBounds(740, 30, 180, 120);
        this.jPanel4.setBorder(BorderFactory.createTitledBorder((Border) null, "DATOS DEL PRODUCTO A ANULAR", 0, 0, new Font("Arial", 1, 14), new Color(0, 102, 0)));
        ...
        this.txtResponsable.setBounds(900, 119, 250, 41);
        this.btnModificar.setFont(new Font("Arial", 1, 12));
        this.btnModificar.setText("Modificar");
        this.btnModificar.addActionListener(new ActionListener() { // from class: Inventarios.InformeAuditoria.10
            public void actionPerformed(ActionEvent evt) {
                InformeAuditoria.this.btnModificarActionPerformed(evt);
            }
        });
        ...
        this.txtCantFisica.addActionListener(new ActionListener() { // from class: Inventarios.InformeAuditoria.11
            public void actionPerformed(ActionEvent evt) {
                InformeAuditoria.this.txtCantFisicaActionPerformed(evt);
            }
        });
        ...
        this.jPanel4.setBounds(0, 180, 1160, 210);
        ...
        this.btnImprimir.addActionListener(new ActionListener() { // from class: Inventarios.InformeAuditoria.12
            public void actionPerformed(ActionEvent evt) {
                InformeAuditoria.this.btnImprimirActionPerformed(evt);
            }
        });
        getContentPane().add(this.btnImprimir);
        this.btnImprimir.setBounds(610, 610, 530, 40);
        ...
        this.btnGrabar.addActionListener(new ActionListener() { // from class: Inventarios.InformeAuditoria.13
            public void actionPerformed(ActionEvent evt) {
                InformeAuditoria.this.btnGrabarActionPerformed(evt);
            }
        });
        getContentPane().add(this.btnGrabar);
        this.btnGrabar.setBounds(10, 610, 590, 40);
        pack();
    }
