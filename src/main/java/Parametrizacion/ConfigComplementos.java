...
/* JADX INFO: loaded from: GenomaP.jar:Parametrizacion/ConfigComplementos.class */
public class ConfigComplementos extends JInternalFrame {
    ...
    private void crearGridregistrotecnico1() {
        this.xmodeloregistrotecnico1 = new DefaultTableModel(new Object[0], new String[]{"Id", "Registro", "Fecha"}) { // from class: Parametrizacion.ConfigComplementos.1
    ...
    private void crearGridrepuesto1() {
        this.xmodelorepuesto1 = new DefaultTableModel(new Object[0], new String[]{"Id", "Repuesto", "Laboratorio", "Valor"}) { // from class: Parametrizacion.ConfigComplementos.2
    ...
    private void crearGridnormalidad1() {
        this.xmodelonormalidad1 = new DefaultTableModel(new Object[0], new String[]{"Id", "Nombre", "Valor Normal", "Valor Maximo", "Valor minimo", "U. Medida"}) { // from class: Parametrizacion.ConfigComplementos.3
    ...
    private void crearGridproce1() {
        this.xmodeloproce1 = new DefaultTableModel(new Object[0], new String[]{"Id", "Procedimeinto", "Frecuencia"}) { // from class: Parametrizacion.ConfigComplementos.4
            Class[] types = {String.class, String.class, String.class};
            boolean[] canEdit = {false, false, false};
    ...
    private void crearGridpcomponente1() {
        this.xmodelocomponente1 = new DefaultTableModel(new Object[0], new String[]{"Id", "Componente", "Laboratorio", "# Serie"}) { // from class: Parametrizacion.ConfigComplementos.5
            Class[] types = {String.class, String.class, String.class, String.class};
            boolean[] canEdit = {false, false, false, false};
    ...
    private void crearGridblafrecuencia() {
        this.xmodelofrecuencia = new DefaultTableModel(new Object[0], new String[]{"Id", "Frecuencia"}) { // from class: Parametrizacion.ConfigComplementos.6
    ...
    private void crearGridpmanual() {
        this.xmodelomanual1 = new DefaultTableModel(new Object[0], new String[]{"Id", "Nombre Manual", "Fecha"}) { // from class: Parametrizacion.ConfigComplementos.7
            Class[] types = {String.class, String.class, String.class};
            boolean[] canEdit = {false, false, false};
    ...
    private void initComponents() {
        ...
        this.jTabbedPane2.setForeground(new Color(255, 0, 0));
        ...
        this.jTextField3.setBorder(BorderFactory.createTitledBorder((Border) null, "Id", 0, 0, new Font("Arial", 1, 12), new Color(0, 0, 255)));
        ...
        this.jButton3.addActionListener(new ActionListener() { // from class: Parametrizacion.ConfigComplementos.8
        ...
        this.jButton4.addActionListener(new ActionListener() { // from class: Parametrizacion.ConfigComplementos.9
            public void actionPerformed(ActionEvent evt) {
        ...
        this.tablaregistrotecnico.addMouseListener(new MouseAdapter() { // from class: Parametrizacion.ConfigComplementos.10
        ...
        jPanel12Layout.setHorizontalGroup(jPanel12Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(jPanel12Layout.createSequentialGroup().addContainerGap().addComponent(this.jScrollPane2, -1, 456, 32767).addContainerGap()));
        jPanel12Layout.setVerticalGroup(jPanel12Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(jPanel12Layout.createSequentialGroup().addContainerGap().addComponent(this.jScrollPane2, -1, 236, 32767).addContainerGap()));
        ...
        this.txtregistro.addActionListener(new ActionListener() { // from class: Parametrizacion.ConfigComplementos.11
            public void actionPerformed(ActionEvent evt) {
        ...
        this.jTextField9.setBorder(BorderFactory.createTitledBorder((Border) null, "Id", 0, 0, new Font("Arial", 1, 12), new Color(0, 0, 255)));
        ...
        this.jButton7.addActionListener(new ActionListener() { // from class: Parametrizacion.ConfigComplementos.12
            public void actionPerformed(ActionEvent evt) {
        ...
        this.jButton8.addActionListener(new ActionListener() { // from class: Parametrizacion.ConfigComplementos.13
            public void actionPerformed(ActionEvent evt) {
        ...
        this.tablarepuesto1.addMouseListener(new MouseAdapter() { // from class: Parametrizacion.ConfigComplementos.14
            public void mouseClicked(MouseEvent evt) {
        ...
        this.txtrepuesto.addActionListener(new ActionListener() { // from class: Parametrizacion.ConfigComplementos.15
            public void actionPerformed(ActionEvent evt) {
        ...
        this.txtvalor.setBorder(BorderFactory.createTitledBorder((Border) null, "Valor Repuesto", 0, 0, new Font("Arial", 1, 12), new Color(0, 0, 255)));
        this.txtvalor.addActionListener(new ActionListener() { // from class: Parametrizacion.ConfigComplementos.16
            public void actionPerformed(ActionEvent evt) {
        ...
        this.jTextField4.setBorder(BorderFactory.createTitledBorder((Border) null, "Id", 0, 0, new Font("Arial", 1, 12), new Color(0, 0, 255)));
        ...
        this.jButton6.addActionListener(new ActionListener() { // from class: Parametrizacion.ConfigComplementos.17
            public void actionPerformed(ActionEvent evt) {
        ...
        this.jButton5.addActionListener(new ActionListener() { // from class: Parametrizacion.ConfigComplementos.18
            public void actionPerformed(ActionEvent evt) {
        ...
        this.txtserie.setBorder(BorderFactory.createTitledBorder((Border) null, "Nombre Componente", 0, 0, new Font("Arial", 1, 12), new Color(0, 0, 255)));
        this.txtserie.addActionListener(new ActionListener() { // from class: Parametrizacion.ConfigComplementos.19
            public void actionPerformed(ActionEvent evt) {
                ConfigComplementos.this.txtserieActionPerformed(evt);
            }
        });
        this.jPanel4.add(this.txtserie);
        this.txtserie.setBounds(160, 120, 150, 41);
        ...
        this.txtnomcomponente.addActionListener(new ActionListener() { // from class: Parametrizacion.ConfigComplementos.20
            public void actionPerformed(ActionEvent evt) {
        ...
        this.combomarca.setBounds(10, 120, 140, 43);
        ...
        this.tablacomponente.addMouseListener(new MouseAdapter() { // from class: Parametrizacion.ConfigComplementos.21
            public void mouseClicked(MouseEvent evt) {
        ...
        this.jTable7.addMouseListener(new MouseAdapter() { // from class: Parametrizacion.ConfigComplementos.22
            public void mouseClicked(MouseEvent evt) {
        ...
        this.txtfrecuencia.addActionListener(new ActionListener() { // from class: Parametrizacion.ConfigComplementos.23
            public void actionPerformed(ActionEvent evt) {
        ...
        this.jButton15.addActionListener(new ActionListener() { // from class: Parametrizacion.ConfigComplementos.24
            public void actionPerformed(ActionEvent evt) {
        ...
        this.jButton16.addActionListener(new ActionListener() { // from class: Parametrizacion.ConfigComplementos.25
            public void actionPerformed(ActionEvent evt) {
        ...
        this.tablafecuencia.addMouseListener(new MouseAdapter() { // from class: Parametrizacion.ConfigComplementos.26
            public void mouseClicked(MouseEvent evt) {
        ...
        this.txtnombre.addActionListener(new ActionListener() { // from class: Parametrizacion.ConfigComplementos.27
            public void actionPerformed(ActionEvent evt) {
        ...
        this.txtmax.addActionListener(new ActionListener() { // from class: Parametrizacion.ConfigComplementos.28
            public void actionPerformed(ActionEvent evt) {
        ...
        this.txtmin.addActionListener(new ActionListener() { // from class: Parametrizacion.ConfigComplementos.29
            public void actionPerformed(ActionEvent evt) {
        ...
        this.tablanormalidad.addMouseListener(new MouseAdapter() { // from class: Parametrizacion.ConfigComplementos.30
            public void mouseClicked(MouseEvent evt) {
        ...
        this.txtnor.addActionListener(new ActionListener() { // from class: Parametrizacion.ConfigComplementos.31
            public void actionPerformed(ActionEvent evt) {
                ConfigComplementos.this.txtnorActionPerformed(evt);
            }
        });
        this.jPanel7.add(this.txtnor);
        this.txtnor.setBounds(10, 160, 170, 41);
        ...
        this.jButton12.addActionListener(new ActionListener() { // from class: Parametrizacion.ConfigComplementos.32
            public void actionPerformed(ActionEvent evt) {
        ...
        this.jButton11.addActionListener(new ActionListener() { // from class: Parametrizacion.ConfigComplementos.33
            public void actionPerformed(ActionEvent evt) {
        ...
        this.txtprocedimiento.addActionListener(new ActionListener() { // from class: Parametrizacion.ConfigComplementos.34
            public void actionPerformed(ActionEvent evt) {
        ...
        this.jButton9.addActionListener(new ActionListener() { // from class: Parametrizacion.ConfigComplementos.35
            public void actionPerformed(ActionEvent evt) {
        ...
        this.jButton10.addActionListener(new ActionListener() { // from class: Parametrizacion.ConfigComplementos.36
            public void actionPerformed(ActionEvent evt) {
        ...
        this.tablaproce.addMouseListener(new MouseAdapter() { // from class: Parametrizacion.ConfigComplementos.37
            public void mouseClicked(MouseEvent evt) {
        ...
        this.jTabbedPane2.addTab("PROCEDIMIENTOS", this.jPanel6);
        ...
        this.txtmanual.addActionListener(new ActionListener() { // from class: Parametrizacion.ConfigComplementos.38
            public void actionPerformed(ActionEvent evt) {
        ...
        this.jButton1.addActionListener(new ActionListener() { // from class: Parametrizacion.ConfigComplementos.39
            public void actionPerformed(ActionEvent evt) {
        ...
        this.jButton2.addActionListener(new ActionListener() { // from class: Parametrizacion.ConfigComplementos.40
            public void actionPerformed(ActionEvent evt) {
                ConfigComplementos.this.jButton2ActionPerformed(evt);
            }
        });
        this.jPanel9.add(this.jButton2);
        this.jButton2.setBounds(110, 10, 90, 29);
        ...
        this.tablamanual.addMouseListener(new MouseAdapter() { // from class: Parametrizacion.ConfigComplementos.41
            public void mouseClicked(MouseEvent evt) {
        ...
        layout.setHorizontalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(layout.createSequentialGroup().addGap(20, 20, 20).addComponent(this.jTabbedPane2, -2, 852, -2).addContainerGap(25, 32767)));
        layout.setVerticalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(layout.createSequentialGroup().addGap(22, 22, 22).addComponent(this.jTabbedPane2, -2, 341, -2).addContainerGap(37, 32767)));
        pack();
    }
