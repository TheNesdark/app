...
/* JADX INFO: loaded from: GenomaP.jar:Sgc/JIFConfiguracionDosT.class */
public class JIFConfiguracionDosT extends JInternalFrame {
    ...
    public JIFConfiguracionDosT(String xtitulo) {
        initComponents();
    ...
    private void initComponents() {
        ...
        this.JTBDetalle.addMouseListener(new MouseAdapter() { // from class: Sgc.JIFConfiguracionDosT.1
            public void mouseClicked(MouseEvent evt) {
                JIFConfiguracionDosT.this.JTBDetalleMouseClicked(evt);
            }
        });
        ...
        this.JCBActivo.addActionListener(new ActionListener() { // from class: Sgc.JIFConfiguracionDosT.2
            public void actionPerformed(ActionEvent evt) {
                JIFConfiguracionDosT.this.JCBActivoActionPerformed(evt);
            }
        });
        this.jFormattedTextField1.setBorder(BorderFactory.createTitledBorder((Border) null, "Código", 0, 0, new Font("Arial", 1, 12), Color.blue));
        this.jFormattedTextField1.setFont(new Font("Arial", 1, 12));
        GroupLayout layout = new GroupLayout(getContentPane());
        getContentPane().setLayout(layout);
        layout.setHorizontalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(layout.createSequentialGroup().addContainerGap().addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(GroupLayout.Alignment.TRAILING, layout.createSequentialGroup().addComponent(this.JTFNombre, -2, 436, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.jFormattedTextField1, -2, 81, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JCBActivo).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED, 4, 32767).addComponent(this.JLBTitulo, -1, -1, 32767)).addComponent(this.JSPDetalle)).addContainerGap()));
        layout.setVerticalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(layout.createSequentialGroup().addContainerGap().addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING, false).addComponent(this.jFormattedTextField1).addComponent(this.JTFNombre, -2, 50, -2).addComponent(this.JCBActivo, GroupLayout.Alignment.TRAILING)).addComponent(this.JLBTitulo, -2, 31, -2)).addGap(18, 18, 18).addComponent(this.JSPDetalle, -2, 220, -2).addContainerGap(-1, 32767)));
        pack();
    }
    ...
    private void mCrearTabla() {
        this.xmodelo = new DefaultTableModel(new Object[0], new String[]{"Id", "Nombre", "Estado"}) { // from class: Sgc.JIFConfiguracionDosT.3
    ...
    private void mCargarDatosTabla() {
        try {
            ...
            Logger.getLogger(JIFConfiguracionDosT.class.getName()).log(Level.SEVERE, (String) null, (Throwable) ex);
        }
    }
