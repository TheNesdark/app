...
/* JADX INFO: loaded from: GenomaP.jar:General/JIFBuscarPatologia_OLD.class */
public class JIFBuscarPatologia_OLD extends JInternalFrame {
    ...
    public JIFBuscarPatologia_OLD(Object jppatologias, String nombre, JTextField codigo, JTextField nombrep, Object jifhistoria, String idcofides) {
    ...
    public JIFBuscarPatologia_OLD(Object jppatologias, String nombre, JTextField codigo, JTextField nombrep, Object jifhistoria, int nidcofides) {
        this.modelo = new DefaultTableModel();
        this.metodos = new Metodos();
        this.consultas = new ConsultasMySQL();
        this.nfila = 0;
    ...
    public JIFBuscarPatologia_OLD(Object jppatologias, String xnombrellamador) {
        this.modelo = new DefaultTableModel();
        this.metodos = new Metodos();
        this.consultas = new ConsultasMySQL();
        this.nfila = 0;
    ...
    public JIFBuscarPatologia_OLD(JTextField codigo, JTextField nombrep, String xnombrellamador, int xValidacion) {
        this.modelo = new DefaultTableModel();
        this.metodos = new Metodos();
        this.consultas = new ConsultasMySQL();
        this.nfila = 0;
    ...
    public JIFBuscarPatologia_OLD(JTextField codigo, String xnombrellamador) {
        this.modelo = new DefaultTableModel();
        this.metodos = new Metodos();
        this.consultas = new ConsultasMySQL();
        this.nfila = 0;
    ...
    public JIFBuscarPatologia_OLD(JPSo_Osteomuscular xclase, String xnombrellamador) {
        this.modelo = new DefaultTableModel();
        this.metodos = new Metodos();
        this.consultas = new ConsultasMySQL();
        this.nfila = 0;
    ...
    public JIFBuscarPatologia_OLD(JPOdontograma xJPOdontograma, String xnombrellamador) {
        this.modelo = new DefaultTableModel();
        this.metodos = new Metodos();
        this.consultas = new ConsultasMySQL();
        this.nfila = 0;
    ...
    private void initComponents() {
        ...
        this.JTResultado.addMouseListener(new MouseAdapter() { // from class: General.JIFBuscarPatologia_OLD.1
            public void mouseClicked(MouseEvent evt) {
                JIFBuscarPatologia_OLD.this.JTResultadoMouseClicked(evt);
            }
        });
        ...
        this.JFTFNombrePatologia.addKeyListener(new KeyAdapter() { // from class: General.JIFBuscarPatologia_OLD.2
            public void keyPressed(KeyEvent evt) {
                JIFBuscarPatologia_OLD.this.JFTFNombrePatologiaKeyPressed(evt);
            }

            public void keyReleased(KeyEvent evt) {
                JIFBuscarPatologia_OLD.this.JFTFNombrePatologiaKeyReleased(evt);
            }
        });
        ...
        this.JCHEmpieza.addActionListener(new ActionListener() { // from class: General.JIFBuscarPatologia_OLD.3
            public void actionPerformed(ActionEvent evt) {
                JIFBuscarPatologia_OLD.this.JCHEmpiezaActionPerformed(evt);
            }
        });
        ...
        this.JCHContiene.addActionListener(new ActionListener() { // from class: General.JIFBuscarPatologia_OLD.4
            public void actionPerformed(ActionEvent evt) {
                JIFBuscarPatologia_OLD.this.JCHContieneActionPerformed(evt);
            }
        });
        ...
        this.JCHFiltroPrograma.addActionListener(new ActionListener() { // from class: General.JIFBuscarPatologia_OLD.5
            public void actionPerformed(ActionEvent evt) {
                JIFBuscarPatologia_OLD.this.JCHFiltroProgramaActionPerformed(evt);
            }
        });
    ...
    private void mCrearTabla() {
        this.modelo = new DefaultTableModel(new Object[0], new String[]{"Código", "Nombre"}) { // from class: General.JIFBuscarPatologia_OLD.6
