...
/* JADX INFO: loaded from: GenomaP.jar:Utilidades/corrector/jorthodictionaries/BookGenerator_es.class */
public class BookGenerator_es extends BookGenerator {
    @Override // Utilidades.corrector.jorthodictionaries.BookGenerator
    boolean isValidLanguage(String word, String wikiText) {
        ...
        findRuleAndAddWords(word, wikiText, "es.v.conj.ar", null, new String[]{"ar", "ado", "ando", "o", "as", "ás", "a", "amos", "áis", "an", "aba", "abas", "ábamos", "abais", "aban", "é", "aste", "ó", "asteis", "aron", "aré", "arás", "ará", "aremos", "aréis", "arán", "aría", "arías", "aríamos", "aríais", "arían", "e", "es", "és", "emos", "éis", "en", "ara", "aras", "áramos", "arais", "aran", "ase", "ases", "ásemos", "aseis", "asen", "are", "ares", "áremos", "areis", "aren", "á", "emos", "ad"});
        findRuleAndAddWords(word, wikiText, "es.v.conj.2.ar", null, new String[]{"ar", "ado", "ando", "ás", "amos", "áis", "aba", "abas", "ábamos", "abais", "aban", "é", "aste", "ó", "asteis", "aron", "aré", "arás", "ará", "aremos", "aréis", "arán", "aría", "arías", "aríamos", "aríais", "arían", "és", "emos", "éis", "ara", "aras", "áramos", "arais", "aran", "ase", "ases", "ásemos", "aseis", "asen", "are", "ares", "áremos", "areis", "aren", "á", "emos", "ad"}, new String[]{"o", "as", "a", "an", "e", "es", "en"});
        findRuleAndAddWords(word, wikiText, "es.v.conj.car", null, new String[]{"car", "cado", "cando", "co", "cas", "cás", "ca", "camos", "cáis", "can", "caba", "cabas", "cábamos", "cabais", "caban", "qué", "caste", "có", "casteis", "caron", "caré", "carás", "cará", "caremos", "caréis", "carán", "caría", "carías", "caríamos", "caríais", "carían", "que", "ques", "qués", "quemos", "quéis", "quen", "cara", "caras", "cáramos", "carais", "caran", "case", "acses", "cásemos", "caseis", "casen", "care", "cares", "cáremos", "careis", "caren", "cá", "quemos", "cad"});
        findRuleAndAddWords(word, wikiText, "es.v.conj.cuar", null, new String[]{"cuar", "cuado", "cuando", "cuo", "cúo", "cuas", "cúas", "cua", "cúa", "cuamos", "cuáis", "cuan", "cúan", "cuaba", "cuabas", "cuábamos", "cuabais", "cuaban", "cué", "cuaste", "cuó", "cuasteis", "cuaron", "cuaré", "cuarás", "cuará", "cuaremos", "cuaréis", "cuarán", "cuaría", "cuarías", "cuaríamos", "cuaríais", "cuarían", "cue", "cúe", "cues", "cúes", "cuemos", "cuéis", "cuen", "cúen", "cuara", "cuaras", "cuáramos", "cuarais", "cuaran", "cuase", "cuases", "cuásemos", "cuaseis", "cuasen", "cuare", "cuares", "cuáremos", "cuareis", "cuaren", "cua", "cúa", "cuemos", "cuad"});
        findRuleAndAddWords(word, wikiText, "es.v.conj.gar", null, new String[]{"gar", "gado", "gando", "go", "gas", "gás", "ga", "gamos", "gáis", "gan", "gaba", "gabas", "gábamos", "gabais", "gaban", "gué", "gaste", "gó", "gasteis", "garon", "garé", "garás", "gará", "garemos", "garéis", "garán", "garía", "garías", "garíamos", "garíais", "garían", "gue", "gues", "gués", "guemos", "guéis", "guen", "gara", "garas", "gáramos", "garais", "garan", "gase", "gases", "gásemos", "gaseis", "gasen", "gare", "gares", "gáremos", "gareis", "garen", "gá", "guemos", "gad"});
        findRuleAndAddWords(word, wikiText, "es.v.conj.-ie-ue-.ar", null, new String[]{"ar", "ado", "ando", "ás", "amos", "áis", "aba", "abas", "ábamos", "abais", "aban", "é", "aste", "ó", "asteis", "aron", "aré", "arás", "ará", "aremos", "aréis", "arán", "aría", "arías", "aríamos", "aríais", "arían", "és", "emos", "éis", "ara", "aras", "áramos", "arais", "aran", "ase", "ases", "ásemos", "aseis", "asen", "are", "ares", "áremos", "areis", "aren", "á", "emos", "ad"}, new String[]{"o", "as", "a", "an", "e", "es", "en"});
        findRuleAndAddWords(word, wikiText, "es.v.conj.zar", null, new String[]{"zar", "zado", "zando", "zo", "zas", "zás", "za", "zamos", "záis", "zan", "zaba", "zabas", "zábamos", "zabais", "zaban", "cé", "zaste", "zó", "zasteis", "zaron", "zaré", "zarás", "zará", "azremos", "zaréis", "zarán", "zaría", "zarías", "zaríamos", "zaríais", "zarían", "ce", "ces", "cés", "cemos", "céis", "cen", "zara", "zaras", "záramos", "zarais", "zaran", "zase", "zases", "zásemos", "zaseis", "zasen", "zare", "zares", "záremos", "zareis", "zaren", "zá", "cemos", "zad"});
    ...
    private void es_v_conj_er(Properties props) {
        ...
        addWord(w1 + nexo + "ido");
        addWord(w1 + nexo + (pronominal ? "iéndose" : "iendo"));
        if (part != null) {
            addWord(part);
        }
        if (part2 != null) {
    ...
    private void findRuleAndAddWords(String word, String wikiText, String rule, String[] endingName, String[] ending1, String[] ending2, String[] ending3, String[] ending4) {
        ...
        int idx2 = idx + rule.length() + 3;
        int idx22 = wikiText.indexOf("}}", idx2);
        String params = wikiText.substring(idx2, idx22);
        StringTokenizer tok = new StringTokenizer(params, "|");
        if (tok.hasMoreElements()) {
            String first = tok.nextToken().trim();
            if (ending1 != null) {
                for (String ending5 : ending1) {
                    addWord(first + ending5);
                }
            }
            if (tok.hasMoreElements()) {
                String second = tok.nextToken().trim();
                if (ending2 != null) {
                    for (String ending6 : ending2) {
                        addWord(second + ending6);
                    }
                }
                if (tok.hasMoreElements()) {
                    String third = tok.nextToken().trim();
                    if (ending3 != null) {
                        for (String ending7 : ending3) {
                            addWord(third + ending7);
                        }
                    }
                    if (tok.hasMoreElements()) {
                        String four = tok.nextToken().trim();
                        if (ending4 != null) {
                            for (String ending8 : ending4) {
                                addWord(four + ending8);
                            }
                        }
                    }
                }
