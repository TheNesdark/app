...
/* JADX INFO: loaded from: GenomaP.jar:Utilidades/BoundsPopupMenuListener.class */
public class BoundsPopupMenuListener implements PopupMenuListener {
    ...
    public void popupMenuWillBecomeVisible(PopupMenuEvent e) {
        ...
        if (child instanceof BasicComboPopup) {
            SwingUtilities.invokeLater(new Runnable() { // from class: Utilidades.BoundsPopupMenuListener.1
