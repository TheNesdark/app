...
/* JADX INFO: loaded from: GenomaP.jar:Historia/JP_PyP_Diabetes.class */
public class JP_PyP_Diabetes extends JPanel {
    private String xsql;
    ...
    private JCheckBox JCHHta_Hipertenso;
    ...
    public JP_PyP_Diabetes(String xnombre, long tipo) {
        initComponents();
        setName(xnombre);
    ...
    private void initComponents() {
        ...
        this.JCHHta_Hipertenso = new JCheckBox();
        ...
        this.JCHHta_Hipertenso.setFont(new Font("Arial", 1, 12));
        this.JCHHta_Hipertenso.setText("Aplica?");
        this.JCHHta_Hipertenso.addActionListener(new ActionListener() { // from class: Historia.JP_PyP_Diabetes.1
            public void actionPerformed(ActionEvent evt) {
                JP_PyP_Diabetes.this.JCHHta_HipertensoActionPerformed(evt);
            }
        });
        ...
        this.JDHta_FechaDx.addPropertyChangeListener(new PropertyChangeListener() { // from class: Historia.JP_PyP_Diabetes.2
            @Override // java.beans.PropertyChangeListener
            public void propertyChange(PropertyChangeEvent evt) {
                JP_PyP_Diabetes.this.JDHta_FechaDxPropertyChange(evt);
            }
        });
        ...
        this.JRBHta_NoAplica.setForeground(new Color(51, 51, 51));
        this.JRBHta_NoAplica.setSelected(true);
        this.JRBHta_NoAplica.setText("No Aplica");
        this.JRBHta_NoAplica.addActionListener(new ActionListener() { // from class: Historia.JP_PyP_Diabetes.3
            public void actionPerformed(ActionEvent evt) {
                JP_PyP_Diabetes.this.JRBHta_NoAplicaActionPerformed(evt);
            }
        });
        this.JBGHta_TipoDx.add(this.JRBHta_Nuevo);
        this.JRBHta_Nuevo.setFont(new Font("Arial", 1, 12));
        this.JRBHta_Nuevo.setForeground(new Color(51, 51, 51));
        this.JRBHta_Nuevo.setText("Nuevo");
        this.JRBHta_Nuevo.addActionListener(new ActionListener() { // from class: Historia.JP_PyP_Diabetes.4
            public void actionPerformed(ActionEvent evt) {
                JP_PyP_Diabetes.this.JRBHta_NuevoActionPerformed(evt);
            }
        });
        this.JBGHta_TipoDx.add(this.JRBHta_Conocido);
        this.JRBHta_Conocido.setFont(new Font("Arial", 1, 12));
        this.JRBHta_Conocido.setForeground(new Color(51, 51, 51));
        this.JRBHta_Conocido.setText("Conocido");
        this.JRBHta_Conocido.addActionListener(new ActionListener() { // from class: Historia.JP_PyP_Diabetes.5
            public void actionPerformed(ActionEvent evt) {
                JP_PyP_Diabetes.this.JRBHta_ConocidoActionPerformed(evt);
            }
        });
        ...
        this.JCBHta_ClasificacionR.addItemListener(new ItemListener() { // from class: Historia.JP_PyP_Diabetes.6
            public void itemStateChanged(ItemEvent evt) {
                JP_PyP_Diabetes.this.JCBHta_ClasificacionRItemStateChanged(evt);
            }
        });
        this.JCBHta_Estadio.setFont(new Font("Arial", 1, 12));
        this.JCBHta_Estadio.setModel(new DefaultComboBoxModel(new String[]{" ", "Estadio 1", "Estadio 2"}));
        this.JCBHta_Estadio.setBorder(BorderFactory.createTitledBorder((Border) null, "Estadio", 0, 0, new Font("Arial", 1, 12), Color.blue));
        this.JCBHta_Estadio.addItemListener(new ItemListener() { // from class: Historia.JP_PyP_Diabetes.7
            public void itemStateChanged(ItemEvent evt) {
                JP_PyP_Diabetes.this.JCBHta_EstadioItemStateChanged(evt);
            }
        });
        GroupLayout JPIDHtaLayout = new GroupLayout(this.JPIDHta);
        this.JPIDHta.setLayout(JPIDHtaLayout);
        JPIDHtaLayout.setHorizontalGroup(JPIDHtaLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPIDHtaLayout.createSequentialGroup().addGap(5, 5, 5).addGroup(JPIDHtaLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPIDHtaLayout.createSequentialGroup().addComponent(this.JCHHta_Hipertenso).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JDHta_FechaDx, -2, 113, -2)).addComponent(this.JCBHta_ClasificacionR, GroupLayout.Alignment.TRAILING, -2, 188, -2).addComponent(this.JCBHta_Estadio, -2, 187, -2)).addGap(5, 5, 5).addComponent(this.JPIHta_TipoDx, -2, 93, -2)));
        JPIDHtaLayout.setVerticalGroup(JPIDHtaLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPIDHtaLayout.createSequentialGroup().addGroup(JPIDHtaLayout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(this.JDHta_FechaDx, -2, 51, -2).addComponent(this.JCHHta_Hipertenso)).addGap(3, 3, 3).addComponent(this.JCBHta_ClasificacionR, -2, 51, -2).addGap(5, 5, 5).addComponent(this.JCBHta_Estadio, -2, 51, -2)).addGroup(JPIDHtaLayout.createSequentialGroup().addContainerGap().addComponent(this.JPIHta_TipoDx, -2, -1, -2).addContainerGap(-1, 32767)));
        this.JPIDIngreso.setBorder(BorderFactory.createTitledBorder((Border) null, "DATOS DIABETES", 2, 0, new Font("Arial", 1, 12), Color.red));
        this.JDIFecha.setBorder(BorderFactory.createTitledBorder((Border) null, "Fecha", 0, 0, new Font("Arial", 1, 12), new Color(0, 0, 255)));
        this.JDIFecha.setDateFormatString("dd/MM/yyyy");
        this.JDIFecha.setFont(new Font("Arial", 1, 12));
        this.JDIFechaDx.setBorder(BorderFactory.createTitledBorder((Border) null, "Fecha Dx", 0, 0, new Font("Arial", 1, 12), new Color(0, 0, 255)));
        ...
        this.JDIFechaDx.addPropertyChangeListener(new PropertyChangeListener() { // from class: Historia.JP_PyP_Diabetes.8
            @Override // java.beans.PropertyChangeListener
            public void propertyChange(PropertyChangeEvent evt) {
                JP_PyP_Diabetes.this.JDIFechaDxPropertyChange(evt);
            }
        });
        ...
        this.JRBI_TDx_Nuevo.addActionListener(new ActionListener() { // from class: Historia.JP_PyP_Diabetes.9
            public void actionPerformed(ActionEvent evt) {
                JP_PyP_Diabetes.this.JRBI_TDx_NuevoActionPerformed(evt);
            }
        });
        ...
        this.JRBI_TDx_Conocido.addActionListener(new ActionListener() { // from class: Historia.JP_PyP_Diabetes.10
            public void actionPerformed(ActionEvent evt) {
                JP_PyP_Diabetes.this.JRBI_TDx_ConocidoActionPerformed(evt);
            }
        });
        ...
        this.JRBSiesNuevoP.addActionListener(new ActionListener() { // from class: Historia.JP_PyP_Diabetes.11
            public void actionPerformed(ActionEvent evt) {
                JP_PyP_Diabetes.this.JRBSiesNuevoPActionPerformed(evt);
            }
        });
        this.JBGNuevo.add(this.JRBNoesNuevoP);
        this.JRBNoesNuevoP.setFont(new Font("Arial", 1, 12));
        this.JRBNoesNuevoP.setText("No");
        this.JRBNoesNuevoP.addActionListener(new ActionListener() { // from class: Historia.JP_PyP_Diabetes.12
            public void actionPerformed(ActionEvent evt) {
                JP_PyP_Diabetes.this.JRBNoesNuevoPActionPerformed(evt);
            }
        });
        ...
        this.JCBClasfCardiovascular.addItemListener(new ItemListener() { // from class: Historia.JP_PyP_Diabetes.13
            public void itemStateChanged(ItemEvent evt) {
                JP_PyP_Diabetes.this.JCBClasfCardiovascularItemStateChanged(evt);
            }
        });
        GroupLayout JPIDIngresoLayout = new GroupLayout(this.JPIDIngreso);
        this.JPIDIngreso.setLayout(JPIDIngresoLayout);
        JPIDIngresoLayout.setHorizontalGroup(JPIDIngresoLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPIDIngresoLayout.createSequentialGroup().addGroup(JPIDIngresoLayout.createParallelGroup(GroupLayout.Alignment.LEADING, false).addComponent(this.JDIFecha, -1, -1, 32767).addComponent(this.JDIFechaDx, -1, -1, 32767)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(JPIDIngresoLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPIDIngresoLayout.createSequentialGroup().addComponent(this.JPIITipo_Dx1, -2, -1, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JPIITipo_Dx, -2, -1, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED, -1, 32767).addComponent(this.JCBI_Tipo_Diabetes, -2, 120, -2)).addGroup(JPIDIngresoLayout.createSequentialGroup().addComponent(this.JCBI_ClasificacionR, -2, 215, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JCBI_Tipo_Insulina, 0, -1, 32767))).addGap(25, 25, 25)).addGroup(JPIDIngresoLayout.createSequentialGroup().addComponent(this.JCBClasfCardiovascular, -2, 302, -2).addContainerGap(-1, 32767)));
        JPIDIngresoLayout.setVerticalGroup(JPIDIngresoLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPIDIngresoLayout.createSequentialGroup().addGroup(JPIDIngresoLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPIDIngresoLayout.createParallelGroup(GroupLayout.Alignment.TRAILING).addComponent(this.JPIITipo_Dx, -2, 51, -2).addComponent(this.JDIFecha, -2, 50, -2).addComponent(this.JCBI_Tipo_Diabetes, -2, 51, -2)).addGroup(JPIDIngresoLayout.createSequentialGroup().addGap(1, 1, 1).addComponent(this.JPIITipo_Dx1, -2, 51, -2))).addGap(3, 3, 3).addGroup(JPIDIngresoLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.JDIFechaDx, -2, 51, -2).addGroup(JPIDIngresoLayout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(this.JCBI_Tipo_Insulina, -2, 51, -2).addComponent(this.JCBI_ClasificacionR, -2, 51, -2))).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED, 9, 32767).addComponent(this.JCBClasfCardiovascular, -2, 51, -2)));
        ...
        this.JTFFE_PSistolica.addActionListener(new ActionListener() { // from class: Historia.JP_PyP_Diabetes.14
            public void actionPerformed(ActionEvent evt) {
                JP_PyP_Diabetes.this.JTFFE_PSistolicaActionPerformed(evt);
            }
        });
        this.JTFFE_PSistolica.addFocusListener(new FocusAdapter() { // from class: Historia.JP_PyP_Diabetes.15
            public void focusGained(FocusEvent evt) {
                JP_PyP_Diabetes.this.JTFFE_PSistolicaFocusGained(evt);
            }

            public void focusLost(FocusEvent evt) {
                JP_PyP_Diabetes.this.JTFFE_PSistolicaFocusLost(evt);
            }
        });
        ...
        this.JTFFE_PDiastolica.addFocusListener(new FocusAdapter() { // from class: Historia.JP_PyP_Diabetes.16
            public void focusGained(FocusEvent evt) {
                JP_PyP_Diabetes.this.JTFFE_PDiastolicaFocusGained(evt);
            }
        });
        ...
        this.JTFFE_PAbdominal.addActionListener(new ActionListener() { // from class: Historia.JP_PyP_Diabetes.17
            public void actionPerformed(ActionEvent evt) {
                JP_PyP_Diabetes.this.JTFFE_PAbdominalActionPerformed(evt);
            }
        });
        this.JTFFE_PAbdominal.addFocusListener(new FocusAdapter() { // from class: Historia.JP_PyP_Diabetes.18
            public void focusGained(FocusEvent evt) {
                JP_PyP_Diabetes.this.JTFFE_PAbdominalFocusGained(evt);
            }
        });
        ...
        this.JTFFE_Talla.addActionListener(new ActionListener() { // from class: Historia.JP_PyP_Diabetes.19
            public void actionPerformed(ActionEvent evt) {
                JP_PyP_Diabetes.this.JTFFE_TallaActionPerformed(evt);
            }
        });
        this.JTFFE_Talla.addFocusListener(new FocusAdapter() { // from class: Historia.JP_PyP_Diabetes.20
            public void focusGained(FocusEvent evt) {
                JP_PyP_Diabetes.this.JTFFE_TallaFocusGained(evt);
            }

            public void focusLost(FocusEvent evt) {
                JP_PyP_Diabetes.this.JTFFE_TallaFocusLost(evt);
            }
        });
        ...
        this.JTFFE_Peso.addActionListener(new ActionListener() { // from class: Historia.JP_PyP_Diabetes.21
            public void actionPerformed(ActionEvent evt) {
                JP_PyP_Diabetes.this.JTFFE_PesoActionPerformed(evt);
            }
        });
        this.JTFFE_Peso.addFocusListener(new FocusAdapter() { // from class: Historia.JP_PyP_Diabetes.22
            public void focusGained(FocusEvent evt) {
                JP_PyP_Diabetes.this.JTFFE_PesoFocusGained(evt);
            }

            public void focusLost(FocusEvent evt) {
                JP_PyP_Diabetes.this.JTFFE_PesoFocusLost(evt);
            }
        });
        ...
        this.JCHR_Aplica.addActionListener(new ActionListener() { // from class: Historia.JP_PyP_Diabetes.23
            public void actionPerformed(ActionEvent evt) {
                JP_PyP_Diabetes.this.JCHR_AplicaActionPerformed(evt);
            }
        });
        ...
        this.JDR_FechaDx.addPropertyChangeListener(new PropertyChangeListener() { // from class: Historia.JP_PyP_Diabetes.24
            @Override // java.beans.PropertyChangeListener
            public void propertyChange(PropertyChangeEvent evt) {
                JP_PyP_Diabetes.this.JDR_FechaDxPropertyChange(evt);
            }
        });
        ...
        this.JCBR_ClasificacionEstadio.addItemListener(new ItemListener() { // from class: Historia.JP_PyP_Diabetes.25
            public void itemStateChanged(ItemEvent evt) {
                JP_PyP_Diabetes.this.JCBR_ClasificacionEstadioItemStateChanged(evt);
            }
        });
        ...
        this.JRBR_NoAplica.addActionListener(new ActionListener() { // from class: Historia.JP_PyP_Diabetes.26
            public void actionPerformed(ActionEvent evt) {
                JP_PyP_Diabetes.this.JRBR_NoAplicaActionPerformed(evt);
            }
        });
        this.JBGTipoDxRenal.add(this.JRBR_Nuevo);
        this.JRBR_Nuevo.setFont(new Font("Arial", 1, 12));
        this.JRBR_Nuevo.setText("Nuevo");
        this.JRBR_Nuevo.addActionListener(new ActionListener() { // from class: Historia.JP_PyP_Diabetes.27
            public void actionPerformed(ActionEvent evt) {
                JP_PyP_Diabetes.this.JRBR_NuevoActionPerformed(evt);
            }
        });
        ...
        this.JRBR_Conocido.addActionListener(new ActionListener() { // from class: Historia.JP_PyP_Diabetes.28
            public void actionPerformed(ActionEvent evt) {
                JP_PyP_Diabetes.this.JRBR_ConocidoActionPerformed(evt);
            }
        });
        ...
        this.JDR_FProteinas.addPropertyChangeListener(new PropertyChangeListener() { // from class: Historia.JP_PyP_Diabetes.29
            @Override // java.beans.PropertyChangeListener
            public void propertyChange(PropertyChangeEvent evt) {
                JP_PyP_Diabetes.this.JDR_FProteinasPropertyChange(evt);
            }
        });
        ...
        this.JDR_FPOrina.addPropertyChangeListener(new PropertyChangeListener() { // from class: Historia.JP_PyP_Diabetes.30
            @Override // java.beans.PropertyChangeListener
            public void propertyChange(PropertyChangeEvent evt) {
                JP_PyP_Diabetes.this.JDR_FPOrinaPropertyChange(evt);
            }
        });
        ...
        this.JDR_FMicroAlbumina.addPropertyChangeListener(new PropertyChangeListener() { // from class: Historia.JP_PyP_Diabetes.31
            @Override // java.beans.PropertyChangeListener
            public void propertyChange(PropertyChangeEvent evt) {
                JP_PyP_Diabetes.this.JDR_FMicroAlbuminaPropertyChange(evt);
            }
        });
        ...
        this.JDR_FEcografia.addPropertyChangeListener(new PropertyChangeListener() { // from class: Historia.JP_PyP_Diabetes.32
            @Override // java.beans.PropertyChangeListener
            public void propertyChange(PropertyChangeEvent evt) {
                JP_PyP_Diabetes.this.JDR_FEcografiaPropertyChange(evt);
            }
        });
        ...
        this.JDR_FREnfermedad.addPropertyChangeListener(new PropertyChangeListener() { // from class: Historia.JP_PyP_Diabetes.33
            @Override // java.beans.PropertyChangeListener
            public void propertyChange(PropertyChangeEvent evt) {
                JP_PyP_Diabetes.this.JDR_FREnfermedadPropertyChange(evt);
            }
        });
        ...
        this.JTFFO_CDia.addActionListener(new ActionListener() { // from class: Historia.JP_PyP_Diabetes.34
            public void actionPerformed(ActionEvent evt) {
                JP_PyP_Diabetes.this.JTFFO_CDiaActionPerformed(evt);
            }
        });
        this.JTFFO_CDia.addFocusListener(new FocusAdapter() { // from class: Historia.JP_PyP_Diabetes.35
            public void focusGained(FocusEvent evt) {
                JP_PyP_Diabetes.this.JTFFO_CDiaFocusGained(evt);
            }
        });
        ...
        this.JTFFO_NAnosF.addActionListener(new ActionListener() { // from class: Historia.JP_PyP_Diabetes.36
            public void actionPerformed(ActionEvent evt) {
                JP_PyP_Diabetes.this.JTFFO_NAnosFActionPerformed(evt);
            }
        });
        this.JTFFO_NAnosF.addFocusListener(new FocusAdapter() { // from class: Historia.JP_PyP_Diabetes.37
            public void focusGained(FocusEvent evt) {
                JP_PyP_Diabetes.this.JTFFO_NAnosFFocusGained(evt);
            }

            public void focusLost(FocusEvent evt) {
                JP_PyP_Diabetes.this.JTFFO_NAnosFFocusLost(evt);
            }
        });
        ...
        this.JCHO_EnfCoronaria.addActionListener(new ActionListener() { // from class: Historia.JP_PyP_Diabetes.38
            public void actionPerformed(ActionEvent evt) {
                JP_PyP_Diabetes.this.JCHO_EnfCoronariaActionPerformed(evt);
            }
        });
        ...
        this.JRBO_SiM.addActionListener(new ActionListener() { // from class: Historia.JP_PyP_Diabetes.39
            public void actionPerformed(ActionEvent evt) {
                JP_PyP_Diabetes.this.JRBO_SiMActionPerformed(evt);
            }
        });
        this.JRBO_NoM.setFont(new Font("Arial", 1, 12));
        this.JRBO_NoM.setText("No");
        this.JRBO_NoM.addActionListener(new ActionListener() { // from class: Historia.JP_PyP_Diabetes.40
            public void actionPerformed(ActionEvent evt) {
                JP_PyP_Diabetes.this.JRBO_NoMActionPerformed(evt);
            }
        });
        ...
        JPIngresoLayout.setHorizontalGroup(JPIngresoLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPIngresoLayout.createSequentialGroup().addGroup(JPIngresoLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPIngresoLayout.createSequentialGroup().addGap(14, 14, 14).addComponent(this.JPIDIngreso, -2, 502, 32767).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JPIDHta, -2, -1, -2)).addGroup(JPIngresoLayout.createSequentialGroup().addContainerGap().addComponent(this.JTPDatosE))).addContainerGap()));
        ...
        this.JBTGuardar.addActionListener(new ActionListener() { // from class: Historia.JP_PyP_Diabetes.41
            public void actionPerformed(ActionEvent evt) {
                JP_PyP_Diabetes.this.JBTGuardarActionPerformed(evt);
            }
        });
        GroupLayout layout = new GroupLayout(this);
        setLayout(layout);
        layout.setHorizontalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(layout.createSequentialGroup().addContainerGap().addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.JBTGuardar, -1, -1, 32767).addGroup(layout.createSequentialGroup().addComponent(this.JTPDatos, -2, 840, -2).addGap(0, 0, 32767))).addContainerGap()));
        layout.setVerticalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(GroupLayout.Alignment.TRAILING, layout.createSequentialGroup().addComponent(this.JTPDatos, -2, 465, -2).addGap(5, 5, 5).addComponent(this.JBTGuardar, -2, 41, -2).addContainerGap()));
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void JCHHta_HipertensoActionPerformed(ActionEvent evt) {
        if (this.JCHHta_Hipertenso.isSelected()) {
            this.xhipertenso = 1L;
            this.JDHta_FechaDx.setEnabled(true);
            this.JCBHta_ClasificacionR.setEnabled(true);
            this.JPIHta_TipoDx.setEnabled(true);
            this.JRBHta_NoAplica.setEnabled(true);
            this.JRBHta_Nuevo.setEnabled(true);
            this.JRBHta_Conocido.setEnabled(true);
            return;
        }
        this.xhipertenso = 0L;
        ...
        this.JDHta_FechaDx.setEnabled(false);
        this.JCBHta_ClasificacionR.setEnabled(false);
        this.JPIHta_TipoDx.setEnabled(false);
        this.JRBHta_NoAplica.setEnabled(false);
        this.JRBHta_Nuevo.setEnabled(false);
        this.JRBHta_Conocido.setEnabled(false);
        this.JRBHta_NoAplica.setSelected(true);
    }
    ...
    public void mNuevo() {
        ...
        this.JCBI_ClasificacionR.setSelectedIndex(-1);
        this.JDHta_FechaDx.setDate((Date) null);
        this.JCHHta_Hipertenso.setSelected(false);
        this.xhta_tipodx = -1;
        this.xhipertenso = 0L;
        this.xhta_clasificacionr = "";
        this.xhta_fecha = "NULL";
    ...
    public void mGrabarBd() {
        ...
        if (this.xnombre.equals("xjifDiabetes_HC") && Principal.informacionIps.getNombreIps().equals("E.S.E. HOSPITAL SAN JUAN DE DIOS - Segovia")) {
    ...
    public void mBuscarDatosUserProgram() {
        ...
        try {
            if (rs.next()) {
                ...
                if (rs.getLong("EsDM_HTA") == 1) {
                    this.xhipertenso = 1L;
                    this.JCHHta_Hipertenso.setSelected(true);
                } else {
                    this.xhipertenso = 0L;
                    this.JCHHta_Hipertenso.setSelected(false);
                }
