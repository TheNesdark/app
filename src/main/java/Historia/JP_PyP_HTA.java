...
/* JADX INFO: loaded from: GenomaP.jar:Historia/JP_PyP_HTA.class */
public class JP_PyP_HTA extends JPanel {
    private String xsql;
    private DefaultTableModel xmodelo;
    private Object[] xdato;
    private String[] xclasificacionR;
    private String[] xclasificacionE;
    ...
    private ButtonGroup JBGEsNuevo;
    private ButtonGroup JBGIngreso;
    private ButtonGroup JBGMedica;
    private ButtonGroup JBGTipoDX;
    private ButtonGroup JBGTipoDXNefro;
    ...
    public JP_PyP_HTA(String xnombre, long tipo) {
        initComponents();
        setName(xnombre);
    ...
    public JP_PyP_HTA(String xnombre) {
        initComponents();
        setName(xnombre);
        this.xnombre = xnombre;
        mNuevo();
    ...
    private void initComponents() {
        this.JBGIngreso = new ButtonGroup();
        this.JBGEsNuevo = new ButtonGroup();
        this.JBGMedica = new ButtonGroup();
        this.JBGTipoDX = new ButtonGroup();
        this.JBGTipoDXNefro = new ButtonGroup();
        ...
        this.JDHta_FechaDx.setBorder(BorderFactory.createTitledBorder((Border) null, "Fecha Dx", 0, 0, new Font("Arial", 1, 12), new Color(0, 0, 255)));
        ...
        this.JDHta_FechaDx.addPropertyChangeListener(new PropertyChangeListener() { // from class: Historia.JP_PyP_HTA.1
            @Override // java.beans.PropertyChangeListener
            public void propertyChange(PropertyChangeEvent evt) {
                JP_PyP_HTA.this.JDHta_FechaDxPropertyChange(evt);
            }
        });
        ...
        this.JBGTipoDX.add(this.JRBHta_NoAplica);
        ...
        this.JRBHta_NoAplica.addActionListener(new ActionListener() { // from class: Historia.JP_PyP_HTA.2
            public void actionPerformed(ActionEvent evt) {
                JP_PyP_HTA.this.JRBHta_NoAplicaActionPerformed(evt);
            }
        });
        this.JBGTipoDX.add(this.JRBHta_Nuevo);
        this.JRBHta_Nuevo.setFont(new Font("Arial", 1, 12));
        this.JRBHta_Nuevo.setText("Nuevo");
        this.JRBHta_Nuevo.addActionListener(new ActionListener() { // from class: Historia.JP_PyP_HTA.3
            public void actionPerformed(ActionEvent evt) {
                JP_PyP_HTA.this.JRBHta_NuevoActionPerformed(evt);
            }
        });
        this.JBGTipoDX.add(this.JRBHta_Conocido);
        this.JRBHta_Conocido.setFont(new Font("Arial", 1, 12));
        this.JRBHta_Conocido.setText("Conocido");
        this.JRBHta_Conocido.addActionListener(new ActionListener() { // from class: Historia.JP_PyP_HTA.4
            public void actionPerformed(ActionEvent evt) {
                JP_PyP_HTA.this.JRBHta_ConocidoActionPerformed(evt);
            }
        });
        GroupLayout JPIHta_TipoDxLayout = new GroupLayout(this.JPIHta_TipoDx);
        this.JPIHta_TipoDx.setLayout(JPIHta_TipoDxLayout);
        JPIHta_TipoDxLayout.setHorizontalGroup(JPIHta_TipoDxLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPIHta_TipoDxLayout.createSequentialGroup().addGap(3, 3, 3).addComponent(this.JRBHta_NoAplica, -2, 81, -2).addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED).addComponent(this.JRBHta_Nuevo).addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED).addComponent(this.JRBHta_Conocido).addGap(3, 3, 3)));
        JPIHta_TipoDxLayout.setVerticalGroup(JPIHta_TipoDxLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPIHta_TipoDxLayout.createSequentialGroup().addGap(0, 0, 0).addGroup(JPIHta_TipoDxLayout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(this.JRBHta_NoAplica).addComponent(this.JRBHta_Nuevo).addComponent(this.JRBHta_Conocido)).addContainerGap(-1, 32767)));
        this.JCBHta_ClasificacionR.setFont(new Font("Arial", 1, 12));
        this.JCBHta_ClasificacionR.setModel(new DefaultComboBoxModel(new String[]{" ", "Bajo", "Moderado", "Alto", "Muy Alto"}));
        ...
        this.JCBHta_ClasificacionR.addItemListener(new ItemListener() { // from class: Historia.JP_PyP_HTA.5
            public void itemStateChanged(ItemEvent evt) {
                JP_PyP_HTA.this.JCBHta_ClasificacionRItemStateChanged(evt);
            }
        });
        ...
        this.JBGEsNuevo.add(this.JRBSiesNuevoP);
        this.JRBSiesNuevoP.setFont(new Font("Arial", 1, 12));
        this.JRBSiesNuevoP.setText("Si");
        this.JRBSiesNuevoP.addActionListener(new ActionListener() { // from class: Historia.JP_PyP_HTA.6
            public void actionPerformed(ActionEvent evt) {
                JP_PyP_HTA.this.JRBSiesNuevoPActionPerformed(evt);
            }
        });
        this.JBGEsNuevo.add(this.JRBNoesNuevoP);
        this.JRBNoesNuevoP.setFont(new Font("Arial", 1, 12));
        this.JRBNoesNuevoP.setSelected(true);
        this.JRBNoesNuevoP.setText("No");
        this.JRBNoesNuevoP.addActionListener(new ActionListener() { // from class: Historia.JP_PyP_HTA.7
            public void actionPerformed(ActionEvent evt) {
                JP_PyP_HTA.this.JRBNoesNuevoPActionPerformed(evt);
            }
        });
        GroupLayout JPIITipo_Dx1Layout = new GroupLayout(this.JPIITipo_Dx1);
        this.JPIITipo_Dx1.setLayout(JPIITipo_Dx1Layout);
        JPIITipo_Dx1Layout.setHorizontalGroup(JPIITipo_Dx1Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(GroupLayout.Alignment.TRAILING, JPIITipo_Dx1Layout.createSequentialGroup().addContainerGap(-1, 32767).addComponent(this.JRBSiesNuevoP).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JRBNoesNuevoP)));
        JPIITipo_Dx1Layout.setVerticalGroup(JPIITipo_Dx1Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPIITipo_Dx1Layout.createSequentialGroup().addGroup(JPIITipo_Dx1Layout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(this.JRBNoesNuevoP).addComponent(this.JRBSiesNuevoP)).addContainerGap(-1, 32767)));
        ...
        this.JCBHta_Estadio.addItemListener(new ItemListener() { // from class: Historia.JP_PyP_HTA.8
            public void itemStateChanged(ItemEvent evt) {
                JP_PyP_HTA.this.JCBHta_EstadioItemStateChanged(evt);
            }
        });
        this.JDHta_FechaIngreso.setBorder(BorderFactory.createTitledBorder((Border) null, "Fecha Ingreso", 0, 0, new Font("Arial", 1, 12), new Color(0, 0, 255)));
        ...
        this.JDHta_FechaIngreso.addPropertyChangeListener(new PropertyChangeListener() { // from class: Historia.JP_PyP_HTA.9
            @Override // java.beans.PropertyChangeListener
            public void propertyChange(PropertyChangeEvent evt) {
                JP_PyP_HTA.this.JDHta_FechaIngresoPropertyChange(evt);
            }
        });
        GroupLayout JPIDHtaLayout = new GroupLayout(this.JPIDHta);
        this.JPIDHta.setLayout(JPIDHtaLayout);
        JPIDHtaLayout.setHorizontalGroup(JPIDHtaLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(GroupLayout.Alignment.TRAILING, JPIDHtaLayout.createSequentialGroup().addGap(3, 3, 3).addComponent(this.JDHta_FechaIngreso, -2, 102, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JPIITipo_Dx1, -2, -1, -2).addGap(3, 3, 3).addComponent(this.JDHta_FechaDx, -2, 102, -2).addGap(3, 3, 3).addComponent(this.JPIHta_TipoDx, -2, -1, -2).addGap(3, 3, 3).addComponent(this.JCBHta_ClasificacionR, -2, 151, -2).addGap(3, 3, 3).addComponent(this.JCBHta_Estadio, -2, 100, -2).addGap(3, 3, 3)));
        JPIDHtaLayout.setVerticalGroup(JPIDHtaLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPIDHtaLayout.createSequentialGroup().addGroup(JPIDHtaLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPIDHtaLayout.createParallelGroup(GroupLayout.Alignment.TRAILING).addComponent(this.JPIHta_TipoDx, -2, -1, -2).addGroup(JPIDHtaLayout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(this.JCBHta_ClasificacionR, -2, 51, -2).addComponent(this.JCBHta_Estadio, -2, 51, -2)).addGroup(JPIDHtaLayout.createSequentialGroup().addGroup(JPIDHtaLayout.createParallelGroup(GroupLayout.Alignment.TRAILING).addComponent(this.JDHta_FechaIngreso, -2, 51, -2).addComponent(this.JPIITipo_Dx1, -2, -1, -2)).addGap(1, 1, 1))).addComponent(this.JDHta_FechaDx, -2, 51, -2)).addContainerGap(-1, 32767)));
        ...
        this.JTFFE_PSistolica.addActionListener(new ActionListener() { // from class: Historia.JP_PyP_HTA.10
            public void actionPerformed(ActionEvent evt) {
                JP_PyP_HTA.this.JTFFE_PSistolicaActionPerformed(evt);
            }
        });
        this.JTFFE_PSistolica.addFocusListener(new FocusAdapter() { // from class: Historia.JP_PyP_HTA.11
            public void focusGained(FocusEvent evt) {
                JP_PyP_HTA.this.JTFFE_PSistolicaFocusGained(evt);
            }

            public void focusLost(FocusEvent evt) {
                JP_PyP_HTA.this.JTFFE_PSistolicaFocusLost(evt);
            }
        });
        ...
        this.JTFFE_PDiastolica.addFocusListener(new FocusAdapter() { // from class: Historia.JP_PyP_HTA.12
            public void focusGained(FocusEvent evt) {
                JP_PyP_HTA.this.JTFFE_PDiastolicaFocusGained(evt);
            }
        });
        ...
        this.JTFFE_PAbdominal.setBorder(BorderFactory.createTitledBorder((Border) null, "P.Abdominal", 0, 0, new Font("Arial", 1, 12), new Color(0, 0, 255)));
        ...
        this.JTFFE_PAbdominal.setExprecionRegular("^[0-9]*$");
        this.JTFFE_PAbdominal.setFocusAccelerator('C');
        this.JTFFE_PAbdominal.setFont(new Font("Arial", 1, 12));
        this.JTFFE_PAbdominal.addActionListener(new ActionListener() { // from class: Historia.JP_PyP_HTA.13
            public void actionPerformed(ActionEvent evt) {
                JP_PyP_HTA.this.JTFFE_PAbdominalActionPerformed(evt);
            }
        });
        this.JTFFE_PAbdominal.addFocusListener(new FocusAdapter() { // from class: Historia.JP_PyP_HTA.14
            public void focusGained(FocusEvent evt) {
                JP_PyP_HTA.this.JTFFE_PAbdominalFocusGained(evt);
            }
        });
        ...
        this.JTFFE_Talla.addActionListener(new ActionListener() { // from class: Historia.JP_PyP_HTA.15
            public void actionPerformed(ActionEvent evt) {
                JP_PyP_HTA.this.JTFFE_TallaActionPerformed(evt);
            }
        });
        this.JTFFE_Talla.addFocusListener(new FocusAdapter() { // from class: Historia.JP_PyP_HTA.16
            public void focusGained(FocusEvent evt) {
                JP_PyP_HTA.this.JTFFE_TallaFocusGained(evt);
            }

            public void focusLost(FocusEvent evt) {
                JP_PyP_HTA.this.JTFFE_TallaFocusLost(evt);
            }
        });
        ...
        this.JTFFE_Peso.addActionListener(new ActionListener() { // from class: Historia.JP_PyP_HTA.17
            public void actionPerformed(ActionEvent evt) {
                JP_PyP_HTA.this.JTFFE_PesoActionPerformed(evt);
            }
        });
        this.JTFFE_Peso.addFocusListener(new FocusAdapter() { // from class: Historia.JP_PyP_HTA.18
            public void focusGained(FocusEvent evt) {
                JP_PyP_HTA.this.JTFFE_PesoFocusGained(evt);
            }

            public void focusLost(FocusEvent evt) {
                JP_PyP_HTA.this.JTFFE_PesoFocusLost(evt);
            }
        });
        ...
        JPIExamenFLayout.setHorizontalGroup(JPIExamenFLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPIExamenFLayout.createSequentialGroup().addContainerGap().addGroup(JPIExamenFLayout.createParallelGroup(GroupLayout.Alignment.TRAILING, false).addComponent(this.JSPEObservacion).addGroup(JPIExamenFLayout.createSequentialGroup().addComponent(this.JPIPresion, -2, -1, -2).addGap(32, 32, 32).addComponent(this.JPESignosVitales, -2, -1, -2))).addContainerGap(122, 32767)));
        JPIExamenFLayout.setVerticalGroup(JPIExamenFLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(GroupLayout.Alignment.TRAILING, JPIExamenFLayout.createSequentialGroup().addContainerGap().addGroup(JPIExamenFLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.JPIPresion, -2, -1, -2).addComponent(this.JPESignosVitales, -2, -1, -2)).addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED).addComponent(this.JSPEObservacion, -2, 73, -2).addContainerGap(-1, 32767)));
        ...
        this.JDR_FechaDx.addPropertyChangeListener(new PropertyChangeListener() { // from class: Historia.JP_PyP_HTA.19
            @Override // java.beans.PropertyChangeListener
            public void propertyChange(PropertyChangeEvent evt) {
                JP_PyP_HTA.this.JDR_FechaDxPropertyChange(evt);
            }
        });
        ...
        this.JCBR_ClasificacionEstadio.addItemListener(new ItemListener() { // from class: Historia.JP_PyP_HTA.20
            public void itemStateChanged(ItemEvent evt) {
                JP_PyP_HTA.this.JCBR_ClasificacionEstadioItemStateChanged(evt);
            }
        });
        ...
        this.JBGTipoDXNefro.add(this.JRBR_NoAplica);
        this.JRBR_NoAplica.setFont(new Font("Arial", 1, 12));
        this.JRBR_NoAplica.setSelected(true);
        this.JRBR_NoAplica.setText("No Aplica");
        this.JRBR_NoAplica.addActionListener(new ActionListener() { // from class: Historia.JP_PyP_HTA.21
            public void actionPerformed(ActionEvent evt) {
                JP_PyP_HTA.this.JRBR_NoAplicaActionPerformed(evt);
            }
        });
        this.JBGTipoDXNefro.add(this.JRBR_Nuevo);
        this.JRBR_Nuevo.setFont(new Font("Arial", 1, 12));
        this.JRBR_Nuevo.setText("Nuevo");
        this.JRBR_Nuevo.addActionListener(new ActionListener() { // from class: Historia.JP_PyP_HTA.22
            public void actionPerformed(ActionEvent evt) {
                JP_PyP_HTA.this.JRBR_NuevoActionPerformed(evt);
            }
        });
        this.JBGTipoDXNefro.add(this.JRBR_Conocido);
        this.JRBR_Conocido.setFont(new Font("Arial", 1, 12));
        this.JRBR_Conocido.setText("Conocido");
        this.JRBR_Conocido.addActionListener(new ActionListener() { // from class: Historia.JP_PyP_HTA.23
            public void actionPerformed(ActionEvent evt) {
                JP_PyP_HTA.this.JRBR_ConocidoActionPerformed(evt);
            }
        });
        ...
        this.JDR_FProteinas.addPropertyChangeListener(new PropertyChangeListener() { // from class: Historia.JP_PyP_HTA.24
            @Override // java.beans.PropertyChangeListener
            public void propertyChange(PropertyChangeEvent evt) {
                JP_PyP_HTA.this.JDR_FProteinasPropertyChange(evt);
            }
        });
        ...
        this.JDR_FPOrina.addPropertyChangeListener(new PropertyChangeListener() { // from class: Historia.JP_PyP_HTA.25
            @Override // java.beans.PropertyChangeListener
            public void propertyChange(PropertyChangeEvent evt) {
                JP_PyP_HTA.this.JDR_FPOrinaPropertyChange(evt);
            }
        });
        ...
        this.JDR_FMicroAlbumina.addPropertyChangeListener(new PropertyChangeListener() { // from class: Historia.JP_PyP_HTA.26
            @Override // java.beans.PropertyChangeListener
            public void propertyChange(PropertyChangeEvent evt) {
                JP_PyP_HTA.this.JDR_FMicroAlbuminaPropertyChange(evt);
            }
        });
        ...
        this.JDR_FEcografia.addPropertyChangeListener(new PropertyChangeListener() { // from class: Historia.JP_PyP_HTA.27
            @Override // java.beans.PropertyChangeListener
            public void propertyChange(PropertyChangeEvent evt) {
                JP_PyP_HTA.this.JDR_FEcografiaPropertyChange(evt);
            }
        });
        ...
        this.JTFFO_CDia.addActionListener(new ActionListener() { // from class: Historia.JP_PyP_HTA.29
            public void actionPerformed(ActionEvent evt) {
                JP_PyP_HTA.this.JTFFO_CDiaActionPerformed(evt);
            }
        });
        this.JTFFO_CDia.addFocusListener(new FocusAdapter() { // from class: Historia.JP_PyP_HTA.30
            public void focusGained(FocusEvent evt) {
                JP_PyP_HTA.this.JTFFO_CDiaFocusGained(evt);
            }
        });
        ...
        this.JTFFO_NAnosF.addActionListener(new ActionListener() { // from class: Historia.JP_PyP_HTA.31
            public void actionPerformed(ActionEvent evt) {
                JP_PyP_HTA.this.JTFFO_NAnosFActionPerformed(evt);
            }
        });
        this.JTFFO_NAnosF.addFocusListener(new FocusAdapter() { // from class: Historia.JP_PyP_HTA.32
            public void focusGained(FocusEvent evt) {
                JP_PyP_HTA.this.JTFFO_NAnosFFocusGained(evt);
            }

            public void focusLost(FocusEvent evt) {
                JP_PyP_HTA.this.JTFFO_NAnosFFocusLost(evt);
            }
        });
        ...
        this.JBGMedica.add(this.JRBO_SiM);
        this.JRBO_SiM.setFont(new Font("Arial", 1, 12));
        this.JRBO_SiM.setText("Si");
        this.JRBO_SiM.addActionListener(new ActionListener() { // from class: Historia.JP_PyP_HTA.34
            public void actionPerformed(ActionEvent evt) {
                JP_PyP_HTA.this.JRBO_SiMActionPerformed(evt);
            }
        });
        this.JBGMedica.add(this.JRBO_NoM);
        this.JRBO_NoM.setFont(new Font("Arial", 1, 12));
        this.JRBO_NoM.setSelected(true);
        this.JRBO_NoM.setText("No");
        this.JRBO_NoM.addActionListener(new ActionListener() { // from class: Historia.JP_PyP_HTA.35
            public void actionPerformed(ActionEvent evt) {
                JP_PyP_HTA.this.JRBO_NoMActionPerformed(evt);
            }
        });
        ...
        JPIngresoLayout.setHorizontalGroup(JPIngresoLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPIngresoLayout.createSequentialGroup().addContainerGap().addGroup(JPIngresoLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.JPIDHta, -1, -1, 32767).addComponent(this.JTPDatosE)).addContainerGap()));
        JPIngresoLayout.setVerticalGroup(JPIngresoLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPIngresoLayout.createSequentialGroup().addContainerGap().addComponent(this.JPIDHta, -2, -1, -2).addGap(8, 8, 8).addComponent(this.JTPDatosE, -2, 217, -2).addContainerGap(-1, 32767)));
        ...
        JPIEgresoLayout.setHorizontalGroup(JPIEgresoLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPIEgresoLayout.createSequentialGroup().addContainerGap().addGroup(JPIEgresoLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPIEgresoLayout.createSequentialGroup().addComponent(this.JDFechaEgreso, -2, 120, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JCBMotEgreso, -2, 464, -2).addGap(0, 0, 32767)).addComponent(this.jScrollPane2, -1, 833, 32767)).addContainerGap()));
        JPIEgresoLayout.setVerticalGroup(JPIEgresoLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPIEgresoLayout.createSequentialGroup().addContainerGap().addGroup(JPIEgresoLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.JCBMotEgreso, -2, 51, -2).addComponent(this.JDFechaEgreso, -2, 50, -2)).addGap(18, 18, 18).addComponent(this.jScrollPane2, -1, 206, 32767).addGap(48, 48, 48)));
        ...
        this.JBTGuardar.addActionListener(new ActionListener() { // from class: Historia.JP_PyP_HTA.36
            public void actionPerformed(ActionEvent evt) {
                JP_PyP_HTA.this.JBTGuardarActionPerformed(evt);
            }
        });
        GroupLayout layout = new GroupLayout(this);
        setLayout(layout);
        layout.setHorizontalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(layout.createSequentialGroup().addContainerGap().addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.JTPDatos).addGroup(layout.createSequentialGroup().addComponent(this.JBTGuardar, -2, 850, -2).addGap(0, 0, 32767))).addContainerGap()));
        layout.setVerticalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(GroupLayout.Alignment.TRAILING, layout.createSequentialGroup().addGap(3, 3, 3).addComponent(this.JTPDatos, -2, 365, -2).addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED).addComponent(this.JBTGuardar, -2, 41, -2).addContainerGap(-1, 32767)));
    }
    ...
    public void mNuevo() {
        ...
        this.JDFechaEgreso.setDate(this.xmt.getFechaActual());
        this.JCBR_ClasificacionEstadio.setSelectedIndex(-1);
        ...
        this.JCBO_Nutricion.setSelectedItem("NO SATISFACTORIA");
        this.JTFFO_CDia.setText("0");
        this.JTFFO_NAnosF.setText("0");
        this.JLBO_Clasificacion.setText("NO APLICA");
    ...
    public void mGrabarBd() {
        ...
        String xusuarioA = "";
        String xprograma = "";
        String xidatencion = "0";
        if (this.xnombre.equals("xjifhta_HC") && Principal.informacionIps.getNombreIps().equals("E.S.E. HOSPITAL SAN JUAN DE DIOS - Segovia")) {
            xusuarioA = String.valueOf(clasesHistoriaCE.informacionAgendaMedicaDTO.getIdUsuarioAtendido()).toString();
            xprograma = "2";
            xidatencion = clasesHistoriaCE.informacionAgendaMedicaDTO.getIdAtencion();
        } else if (this.xnombre.equals("xjifhta_HC")) {
            xusuarioA = String.valueOf(clasesHistoriaCE.informacionAgendaMedicaDTO.getIdUsuarioAtendido()).toString();
            xprograma = String.valueOf(clasesHistoriaCE.informacionAgendaMedicaDTO.getIdPrograma()).toString();
            xidatencion = clasesHistoriaCE.informacionAgendaMedicaDTO.getIdAtencion();
        } else if (this.xnombre.equals("xjifHTA_PyP")) {
            xusuarioA = getXidUsuarioPersona();
            xprograma = "2";
        }
        String sql2 = null;
        if (this.JTPDatos.getComponentAt(0).isVisible()) {
            ...
            if (n == 0) {
                if (!mConsultarUserProgram()) {
                    sql = " INSERT INTO g_usuarioxprograma (`Id_Usuario` , `Id_Programa` , `Cardinal` , `EsIngreso` ,  FechaDxhta,Hta_FechaDx,`FechaIngreso` , `Id_Atencion_Ingreso` , `ObservacionIngreso` , `Talla` , `Peso`,  `IMC`,`PAbdominal`, `TASistolica`,`TADiastolica`, EsDM_HTA,  Hta_TipoDx, ClasifRiesgoHTA, `I_NF_Fecha`, `I_NF_TipoDx`, `I_NF_Estadio`, `I_NF_FProteinas24H`, `I_NF_FOrina`,`I_NF_FMicroAlbumina`, `I_NF_VMicroAlbumina`, `I_NF_FEcografiaR`, `I_NF_FRegresionE`, `I_CActividadFisica`, `I_CAlcohol`, `I_CNutricional`, `I_CTabaco_CDia`, `I_CTabaco_CAno`, `I_CTabaco_Clasificacion`, `I_CAntecedenteFC`, `I_CPanifica` , `O_PRealizado`, `O_Fecha_PR`, `O_RMedicamentos`, `O_Cual_Medicamento`, HTA_esNuevo,Fecha,HtaEstadio, UsuarioS)  VALUES ('" + xusuarioA + "','" + xprograma + "','0','" + this.xesingreso + "'," + mDatoFecha_Nulo(this.JDHta_FechaDx) + "," + mDatoFecha_Nulo(this.JDHta_FechaDx) + ",'" + this.xmt.formatoAMD1.format(this.JDHta_FechaIngreso.getDate()) + "','" + xidatencion + "','" + this.JTPEFObservaciones.getText() + "','" + this.JTFFE_Talla.getText() + "','" + this.JTFFE_Peso.getText() + "','" + this.JTFFE_IMC.getText() + "','" + this.JTFFE_PAbdominal.getText() + "','" + this.JTFFE_PSistolica.getValue() + "','" + this.JTFFE_PDiastolica.getValue() + "','1','" + this.xhta_tipodx + "','" + this.xhta_clasificacionr + "'," + mDatoFecha_Nulo(this.JDR_FechaDx) + ",'" + this.xr_tipodx + "','" + this.JCBR_ClasificacionEstadio.getSelectedItem() + "'," + mDatoFecha_Nulo(this.JDR_FProteinas) + "," + mDatoFecha_Nulo(this.JDR_FPOrina) + "," + mDatoFecha_Nulo(this.JDR_FMicroAlbumina) + ",'" + this.JTFFR_VMicroalbumina.getValue() + "'," + mDatoFecha_Nulo(this.JDR_FEcografia) + "," + mDatoFecha_Nulo(this.JDR_FREnfermedad) + ",'" + this.JCBO_CActividadF.getSelectedItem() + "','" + this.JCBO_Alcohol.getSelectedItem() + "','" + this.JCBO_Nutricion.getSelectedItem() + "','" + this.JTFFO_CDia.getText() + "','" + this.JTFFO_NAnosF.getText() + "','" + this.JLBO_Clasificacion.getText() + "','" + this.xemfcoronaria + "','" + this.JCBO_Planificacion.getSelectedItem() + "','" + this.JCBO_PRealizado.getSelectedItem() + "'," + mDatoFecha_Nulo(this.JDO_Fecha) + ",'" + this.xrmedicamento + "','" + this.JTPO_Medicamentos.getText() + "','" + this.xesnuevo + "','" + this.xmt.formatoAMD.format(this.xmt.getFechaActual()) + "','" + this.JCBHta_Estadio.getSelectedItem() + "','" + Principal.usuarioSistemaDTO.getLogin() + "')";
                } else {
                    sql = " UPDATE g_usuarioxprograma SET EsIngreso='" + this.xesingreso + "' , FechaIngreso='" + this.xmt.formatoAMD.format(this.JDHta_FechaIngreso.getDate()) + "' ,ObservacionIngreso='" + this.JTPEFObservaciones.getText() + "', EsDM_HTA=1  ,ClasifRiesgoHTA='" + this.JCBHta_ClasificacionR.getSelectedItem() + "' ," + mDatoFecha_Nulo(this.JDR_FechaDx, "I_NF_Fecha") + " ,I_NF_TipoDx='" + this.xr_tipodx + "' ,I_NF_CRiesgo='" + this.JCBR_ClasificacionEstadio.getSelectedItem() + "' ,I_NF_Estadio='" + this.JCBR_ClasificacionEstadio.getSelectedItem() + "' ," + mDatoFecha_Nulo(this.JDR_FProteinas, "I_NF_FProteinas24H") + " ," + mDatoFecha_Nulo(this.JDR_FPOrina, "I_NF_FOrina") + " ," + mDatoFecha_Nulo(this.JDR_FMicroAlbumina, "I_NF_FMicroAlbumina") + " ,I_NF_VMicroAlbumina='" + this.JTFFR_VMicroalbumina.getValue() + "' ," + mDatoFecha_Nulo(this.JDR_FEcografia, "I_NF_FEcografiaR") + " ," + mDatoFecha_Nulo(this.JDR_FREnfermedad, "I_NF_FRegresionE") + " ,Talla='" + this.JTFFE_Talla.getText() + "' ,Peso='" + this.JTFFE_Peso.getText() + "' ,IMC='" + this.JTFFE_IMC.getText() + "' ,PAbdominal='" + this.JTFFE_PAbdominal.getText() + "' ,TASistolica='" + this.JTFFE_PSistolica.getValue() + "' ,TADiastolica='" + this.JTFFE_PDiastolica.getValue() + "' ,I_CActividadFisica='" + this.JCBO_CActividadF.getSelectedItem() + "' ,I_CAlcohol='" + this.JCBO_Alcohol.getSelectedItem() + "' ,I_CNutricional='" + this.JCBO_Nutricion.getSelectedItem() + "' ,I_CTabaco_CDia='" + this.JTFFO_CDia.getText() + "' ,I_CTabaco_CAno='" + this.JTFFO_NAnosF.getText() + "' ,I_CTabaco_Clasificacion='" + this.JLBO_Clasificacion.getText() + "' ,I_CAntecedenteFC='" + this.xemfcoronaria + "' ,I_CPanifica='" + this.JCBO_Planificacion.getSelectedItem() + "' ,O_PRealizado='" + this.JCBO_PRealizado.getSelectedItem() + "' ," + mDatoFecha_Nulo(this.JDO_Fecha, "O_Fecha_PR") + " ,O_RMedicamentos='" + this.xrmedicamento + "' ,O_Cual_Medicamento='" + this.JTPO_Medicamentos.getText() + "' ,HTA_esNuevo='" + this.xesnuevo + "' ,HtaEstadio='" + this.JCBHta_Estadio.getSelectedItem() + "' ," + mDatoFecha_Nulo(this.JDHta_FechaDx, "Hta_FechaDx") + " , Hta_TipoDx='" + this.xhta_tipodx + "' ,Fecha='" + this.xmt.formatoAMD.format(this.xmt.getFechaActual()) + "' ,UsuarioS='" + Principal.usuarioSistemaDTO.getLogin() + "' WHERE Id_Usuario= '" + xusuarioA + "' AND Id_Programa='" + xprograma + "'";
                }
        ...
        if (this.JCBMotEgreso.getSelectedIndex() != -1) {
            ...
            if (n2 == 0) {
                if (mConsultarUserProgram()) {
                    sql2 = " UPDATE g_usuarioxprograma SET `FechaEgreso`='" + this.xmt.formatoAMD.format(this.JDFechaEgreso.getDate()) + "' , `MotivoEgreso`='" + this.listaMotivoEgreso[this.JCBMotEgreso.getSelectedIndex()] + "' , `Observacion_Egreso` = '" + this.JTPEFObsEgresos.getText() + "', `Id_Atencion_Egreso`='" + clasesHistoriaCE.informacionAgendaMedicaDTO.getIdAtencion() + "' ,Fecha='" + this.xmt.formatoAMD.format(this.xmt.getFechaActual()) + "', UsuarioS='" + Principal.usuarioSistemaDTO.getLogin() + "' WHERE Id_Usuario= '" + clasesHistoriaCE.informacionAgendaMedicaDTO.getIdUsuarioAtendido() + "' AND Id_Programa='" + xprograma + "'";
                }
    ...
    private String mDatoFecha_Nulo(JDateChooser xcomp) {
        String xv;
        if (xcomp.getDate() != null) {
            xv = "'" + this.xmt.formatoAMD.format(xcomp.getDate()) + "'";
        } else {
    ...
    public boolean mConsultarUserProgram() {
        ...
        String sql = "SELECT  `Id`,  `Id_Usuario` , `Id_Programa`,`EsIngreso` , `FechaIngreso` , `ObservacionIngreso` , `FechaDxhta` , `ClasifRiesgoHTA` , `ClasifEstHTA` , `Talla` , `Peso` , `IMC` FROM `g_usuarioxprograma` WHERE (`Id_Usuario` = '" + xusuarioA + "' AND `Id_Programa` ='" + xprograma + "')";
    ...
    public void mBuscarDatosUserProgram() {
        ...
        try {
            if (rs.next()) {
                ...
                this.JTFFE_Talla.setText("" + rs.getDouble("Talla"));
                this.JTFFE_Peso.setText("" + rs.getDouble("Peso"));
                this.JTFFE_IMC.setText("" + rs.getDouble("IMC"));
                this.JTFFE_PAbdominal.setText("" + rs.getDouble("PAbdominal"));
                ...
                this.JDHta_FechaIngreso.setDate(rs.getDate("FechaIngreso"));
                ...
                this.JTPO_Medicamentos.setText(rs.getString("O_Cual_Medicamento"));
                ...
                this.JDR_FMicroAlbumina.setDate(rs.getDate("I_NF_FMicroAlbumina"));
    ...
    public void mBuscarDatosUserProgramEgreso() {
        ...
        String sql = "SELECT  `g_usuarioxprograma`.`FechaEgreso` , `p_motivoegreso`.`Nbre` AS MotivoEgreso, `g_usuarioxprograma`.`Observacion_Egreso`  FROM `g_usuarioxprograma`  INNER JOIN `p_motivoegreso`  ON (`g_usuarioxprograma`.`MotivoEgreso` = `p_motivoegreso`.`Id`) WHERE (`Id_Usuario` = '" + xusuarioA + "' AND `Id_Programa` ='" + xprograma + "')";
        ResultSet rs = this.xct.traerRs(sql);
        try {
            if (rs.next()) {
                rs.first();
                this.JDFechaEgreso.setDate(rs.getDate("FechaEgreso"));
                this.JCBMotEgreso.setSelectedItem(rs.getString("MotivoEgreso"));
                this.JTPEFObsEgresos.setText(rs.getString("Observacion_Egreso"));
            }
            rs.close();
            this.xct.cerrarConexionBd();
        } catch (SQLException ex) {
    ...
    private void mIniciarComponentes() {
        ...
        this.xidnutricion = this.xct.llenarCombo("SELECT `Id` , `Nbre` FROM `h_tipo_riesgo` WHERE (`Tipo` =8  AND `Estado` =1 AND Id<>29) ORDER BY Id", this.xidnutricion, this.JCBO_Nutricion);
        this.JCBO_Nutricion.setSelectedItem("NO SATISFACTORIA");
