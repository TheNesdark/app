...
/* JADX INFO: loaded from: GenomaP.jar:Historia/ReporteAnexo3_Interconsulta.class */
public class ReporteAnexo3_Interconsulta {
    ...
    public ReporteAnexo3_Interconsulta(String xidAtencion, String xid_orden, int xForma) {
        this.xidAtencion = "";
        this.xid_orden = "";
        this.xForma = 0;
    ...
    public JasperReportBuilder build() {
        JasperPdfExporterBuilder pdfExporter = DynamicReports.export.pdfExporter(this.xmt.getRutaRep() + "H_Anexo3_Orden" + this.xidAtencion + ".pdf");
            ...
            try {
                ...
                if (this.xrsRemision.next()) {
                    ...
                    while (this.xrsRemision.next()) {
                        componentBuilderNewRow3.add(new ComponentBuilder[]{label(n + " ", 1), textCell(this.xrsRemision.getString("Cups"), 7), emptyCell(1), textCell("1", 3), emptyCell(1), label(this.xrsRemision.getString("Procedimiento"), 45, this.labelStyleFontSmall)}).newRow(0);
                        n++;
                    }
                }
                this.xrsRemision.close();
            } catch (SQLException ex) {
                Logger.getLogger(ReporteAnexo3_Interconsulta.class.getName()).log(Level.SEVERE, (String) null, (Throwable) ex);
            }
            report.setTemplate(Templates_1.reportTemplate).setPageFormat(612, 950, PageOrientation.PORTRAIT).setTextStyle(this.textStyle).title(new ComponentBuilder[]{DynamicReports.cmp.image(this.xmt.getRutaRep() + "Anexo3.png").setFixedDimension(592, 60), componentBuilderNewRow, DynamicReports.cmp.verticalGap(0), componentBuilderNewRow2, DynamicReports.cmp.verticalGap(0), componentBuilderAdd, DynamicReports.cmp.verticalGap(2), componentBuilderNewRow3, DynamicReports.cmp.verticalGap(2), componentBuilderAdd2, DynamicReports.cmp.verticalGap(2)});
            try {
                report.toPdf(pdfExporter);
            } catch (DRException e) {
                Logger.getLogger(ReporteAnexo3_Interconsulta.class.getName()).log(Level.SEVERE, (String) null, e);
            }
        } catch (SQLException ex2) {
            Logger.getLogger(ReporteAnexo3_Interconsulta.class.getName()).log(Level.SEVERE, (String) null, (Throwable) ex2);
        }
        return report;
    }
