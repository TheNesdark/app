...
/* JADX INFO: loaded from: GenomaP.jar:Historia/JPANotas_v2.class */
public class JPANotas_v2 extends JPanel {
    ...
    private JCheckBox JCHNotasCheck;
    ...
    public String prueba = "Nota2";

    public JPANotas_v2(JInternalFrame xjif, Long xId_Atencion, String xTipoAtencion, String xId_AtencionEsp, Long xIdIngreso, String xFiltro, String Nombre) {
    ...
    private void initComponents() {
        ...
        this.JCHNotasCheck = new JCheckBox();
        ...
        this.JDCFecha.addFocusListener(new FocusAdapter() { // from class: Historia.JPANotas_v2.1
            public void focusLost(FocusEvent evt) {
                JPANotas_v2.this.JDCFechaFocusLost(evt);
            }
        });
        this.JDCFecha.addPropertyChangeListener(new PropertyChangeListener() { // from class: Historia.JPANotas_v2.2
            @Override // java.beans.PropertyChangeListener
            public void propertyChange(PropertyChangeEvent evt) {
                JPANotas_v2.this.JDCFechaPropertyChange(evt);
            }
        });
        ...
        this.JTFFHora.addFocusListener(new FocusAdapter() { // from class: Historia.JPANotas_v2.3
            public void focusLost(FocusEvent evt) {
                JPANotas_v2.this.JTFFHoraFocusLost(evt);
            }
        });
        this.JTFFHora.addActionListener(new ActionListener() { // from class: Historia.JPANotas_v2.4
            public void actionPerformed(ActionEvent evt) {
                JPANotas_v2.this.JTFFHoraActionPerformed(evt);
            }
        });
        this.JTFFHora.addPropertyChangeListener(new PropertyChangeListener() { // from class: Historia.JPANotas_v2.5
            @Override // java.beans.PropertyChangeListener
            public void propertyChange(PropertyChangeEvent evt) {
                JPANotas_v2.this.JTFFHoraPropertyChange(evt);
            }
        });
        ...
        this.JCBTipoNota.addItemListener(new ItemListener() { // from class: Historia.JPANotas_v2.6
            public void itemStateChanged(ItemEvent evt) {
                JPANotas_v2.this.JCBTipoNotaItemStateChanged(evt);
            }
        });
        this.JCBTipoNota.addActionListener(new ActionListener() { // from class: Historia.JPANotas_v2.7
            public void actionPerformed(ActionEvent evt) {
                JPANotas_v2.this.JCBTipoNotaActionPerformed(evt);
            }
        });
        ...
        this.JCH_NCierreHC.setText("Cerrar para facturar?");
        this.JCH_NCierreHC.addActionListener(new ActionListener() { // from class: Historia.JPANotas_v2.8
            public void actionPerformed(ActionEvent evt) {
                JPANotas_v2.this.JCH_NCierreHCActionPerformed(evt);
            }
        });
        this.JCHNotasCheck.setFont(new Font("Arial", 1, 12));
        this.JCHNotasCheck.setText("Filtrar ");
        this.JCHNotasCheck.addActionListener(new ActionListener() { // from class: Historia.JPANotas_v2.9
            public void actionPerformed(ActionEvent evt) {
                JPANotas_v2.this.JCHNotasCheckActionPerformed(evt);
            }
        });
        GroupLayout jPanel1Layout = new GroupLayout(this.jPanel1);
        this.jPanel1.setLayout(jPanel1Layout);
        jPanel1Layout.setHorizontalGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(jPanel1Layout.createSequentialGroup().addGap(12, 12, 12).addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING, false).addGroup(jPanel1Layout.createSequentialGroup().addComponent(this.JCBEspecialidad, -2, 532, -2).addGap(12, 12, 12).addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.JCH_NCierreHC).addComponent(this.JCHNotasCheck))).addGroup(jPanel1Layout.createSequentialGroup().addComponent(this.JDCFecha, -2, 111, -2).addGap(18, 18, 18).addComponent(this.JTFFHora, -2, 119, -2).addGap(18, 18, 18).addComponent(this.JCBTipoNota, 0, -1, 32767))).addGap(28, 28, 28)));
        jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(jPanel1Layout.createSequentialGroup().addContainerGap().addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.TRAILING).addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(this.JTFFHora, -2, 50, -2).addComponent(this.JCBTipoNota, -2, 50, -2)).addComponent(this.JDCFecha, -2, 50, -2)).addGap(10, 10, 10).addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.TRAILING).addComponent(this.JCBEspecialidad, -2, 50, -2).addGroup(jPanel1Layout.createSequentialGroup().addComponent(this.JCHNotasCheck).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JCH_NCierreHC))).addGap(10, 10, 10)));
        ...
        this.JTPNota.addKeyListener(new KeyAdapter() { // from class: Historia.JPANotas_v2.10
            public void keyPressed(KeyEvent evt) {
                JPANotas_v2.this.JTPNotaKeyPressed(evt);
            }
        });
        this.JSPNotas.setViewportView(this.JTPNota);
        this.JTPNota.getAccessibleContext().setAccessibleName("");
        ...
        this.JTFCDxP.addFocusListener(new FocusAdapter() { // from class: Historia.JPANotas_v2.11
            public void focusLost(FocusEvent evt) {
                JPANotas_v2.this.JTFCDxPFocusLost(evt);
            }
        });
        this.JTFCDxP.addKeyListener(new KeyAdapter() { // from class: Historia.JPANotas_v2.12
            public void keyPressed(KeyEvent evt) {
                JPANotas_v2.this.JTFCDxPKeyPressed(evt);
            }
        });
        ...
        this.JTFNCodigoDxP.addMouseListener(new MouseAdapter() { // from class: Historia.JPANotas_v2.13
            public void mouseClicked(MouseEvent evt) {
                JPANotas_v2.this.JTFNCodigoDxPMouseClicked(evt);
            }
        });
        this.JTFNCodigoDxP.addKeyListener(new KeyAdapter() { // from class: Historia.JPANotas_v2.14
            public void keyPressed(KeyEvent evt) {
                JPANotas_v2.this.JTFNCodigoDxPKeyPressed(evt);
            }
        });
        ...
        this.JTDetalle.addMouseListener(new MouseAdapter() { // from class: Historia.JPANotas_v2.15
            public void mouseClicked(MouseEvent evt) {
                JPANotas_v2.this.JTDetalleMouseClicked(evt);
            }
        });
        this.JTDetalle.addKeyListener(new KeyAdapter() { // from class: Historia.JPANotas_v2.16
            public void keyPressed(KeyEvent evt) {
                JPANotas_v2.this.JTDetalleKeyPressed(evt);
            }
        });
        ...
        this.JBTGuardarTemp1.addActionListener(new ActionListener() { // from class: Historia.JPANotas_v2.17
            public void actionPerformed(ActionEvent evt) {
                JPANotas_v2.this.JBTGuardarTemp1ActionPerformed(evt);
            }
        });
        this.JBTGuardarTemp1.addKeyListener(new KeyAdapter() { // from class: Historia.JPANotas_v2.18
            public void keyPressed(KeyEvent evt) {
                JPANotas_v2.this.JBTGuardarTemp1KeyPressed(evt);
            }
        });
        ...
        JPDiagnosticoLayout.setHorizontalGroup(JPDiagnosticoLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPDiagnosticoLayout.createSequentialGroup().addContainerGap().addGroup(JPDiagnosticoLayout.createParallelGroup(GroupLayout.Alignment.LEADING, false).addComponent(this.JSPDiagnostico, -2, 703, -2).addGroup(JPDiagnosticoLayout.createSequentialGroup().addComponent(this.JTFCDxP, -2, 63, -2).addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED).addComponent(this.JTFNCodigoDxP, -2, 466, -2).addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED).addComponent(this.JSOrden, -2, 78, -2).addGap(18, 18, 18).addComponent(this.JBTGuardarTemp1, -1, -1, 32767))).addContainerGap(-1, 32767)));
        JPDiagnosticoLayout.setVerticalGroup(JPDiagnosticoLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPDiagnosticoLayout.createSequentialGroup().addGap(13, 13, 13).addGroup(JPDiagnosticoLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPDiagnosticoLayout.createParallelGroup(GroupLayout.Alignment.TRAILING, false).addComponent(this.JSOrden, GroupLayout.Alignment.LEADING).addGroup(JPDiagnosticoLayout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(this.JTFCDxP, -2, -1, -2).addComponent(this.JTFNCodigoDxP, -2, -1, -2))).addComponent(this.JBTGuardarTemp1, -2, 43, -2)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED, -1, 32767).addComponent(this.JSPDiagnostico, -1, 165, 32767)));
        ...
        this.JTBDetalle.addMouseListener(new MouseAdapter() { // from class: Historia.JPANotas_v2.19
            public void mouseClicked(MouseEvent evt) {
                JPANotas_v2.this.JTBDetalleMouseClicked(evt);
            }
        });
        this.JTBDetalle.addKeyListener(new KeyAdapter() { // from class: Historia.JPANotas_v2.20
            public void keyPressed(KeyEvent evt) {
                JPANotas_v2.this.JTBDetalleKeyPressed(evt);
            }
        });
        ...
        this.JBTGuardarTemp.addActionListener(new ActionListener() { // from class: Historia.JPANotas_v2.21
            public void actionPerformed(ActionEvent evt) {
                JPANotas_v2.this.JBTGuardarTempActionPerformed(evt);
            }
        });
        this.JBTGuardarTemp.addKeyListener(new KeyAdapter() { // from class: Historia.JPANotas_v2.22
            public void keyPressed(KeyEvent evt) {
                JPANotas_v2.this.JBTGuardarTempKeyPressed(evt);
            }
        });
        ...
        this.JBT_NotaP.addActionListener(new ActionListener() { // from class: Historia.JPANotas_v2.23
            public void actionPerformed(ActionEvent evt) {
                JPANotas_v2.this.JBT_NotaPActionPerformed(evt);
            }
        });
        this.JBT_NotaP.addKeyListener(new KeyAdapter() { // from class: Historia.JPANotas_v2.24
            public void keyPressed(KeyEvent evt) {
                JPANotas_v2.this.JBT_NotaPKeyPressed(evt);
            }
        });
        ...
        this.jchMostrarNotas.addActionListener(new ActionListener() { // from class: Historia.JPANotas_v2.25
            public void actionPerformed(ActionEvent evt) {
                JPANotas_v2.this.jchMostrarNotasActionPerformed(evt);
            }
        });
        ...
        JPI_NotaLayout.setVerticalGroup(JPI_NotaLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPI_NotaLayout.createSequentialGroup().addContainerGap().addComponent(this.jPanel1, -2, -1, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JTPMenus, -2, 269, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(JPI_NotaLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.JBT_NotaP, -2, 48, -2).addComponent(this.JBTGuardarTemp, -2, 50, -2).addGroup(JPI_NotaLayout.createSequentialGroup().addGap(1, 1, 1).addGroup(JPI_NotaLayout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(this.JTFNNota, -2, 50, -2).addComponent(this.jchMostrarNotas)))).addContainerGap(26, 32767)));
        this.JTPDatos.addTab("NOTA", this.JPI_Nota);
        this.JPI_Historico.setAutoscrolls(true);
        this.JPI_Historico.setName("xjphistoricoa");
        this.JSPHistoricoA.setBorder(BorderFactory.createTitledBorder((Border) null, "DETALLE", 2, 0, new Font("Arial", 1, 14), new Color(0, 103, 0)));
        ...
        this.JCBH_Nota.addItemListener(new ItemListener() { // from class: Historia.JPANotas_v2.26
            public void itemStateChanged(ItemEvent evt) {
                JPANotas_v2.this.JCBH_NotaItemStateChanged(evt);
            }
        });
        this.JCBH_Nota.addKeyListener(new KeyAdapter() { // from class: Historia.JPANotas_v2.27
            public void keyPressed(KeyEvent evt) {
                JPANotas_v2.this.JCBH_NotaKeyPressed(evt);
            }
        });
        this.JCHFiltro.setFont(new Font("Arial", 1, 12));
        this.JCHFiltro.setText("Aplicar filtro?");
        this.JCHFiltro.addActionListener(new ActionListener() { // from class: Historia.JPANotas_v2.28
            public void actionPerformed(ActionEvent evt) {
                JPANotas_v2.this.JCHFiltroActionPerformed(evt);
            }
        });
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void JCHNotasCheckActionPerformed(ActionEvent evt) {
        if (this.JCHNotasCheck.isSelected()) {
            mBuscar();
            mCargarDatosTabla();
        }
    }
    ...
    private void mCrearTabla() {
        this.xmodelonota = new DefaultTableModel(new Object[0], new String[]{"Id", "Fecha y Hora", "Descripción", "Especialidad", "Profesional", "Tipo Nota", "EstadoHC", "Fecha", "Hora", "Especilidad", "idClasificacionTipoNota"}) { // from class: Historia.JPANotas_v2.29
    ...
    private void mCargarDatosTabla() {
        ...
        try {
            ...
            } else if (this.JCBTipoNota.getSelectedIndex() > -1 && this.JCHNotasCheck.isSelected()) {
                System.out.println("3");
                sql = "SELECT h_notasclinicas.Id, \nDATE_FORMAT(h_notasclinicas.FechaNota, '%d-%m-%Y') AS fecha, \nh_notasclinicas.HoraNota, \nh_notasclinicas.Descripcion, \nge.Nbre Especialidad, \nconcat(gp.Apellido1,' ', gp.Apellido2,' ', gp.Nombre1 ,' ', gp.Nombre2)NProfesional,\nh_tiponota.`Nbre`, \n`h_atencion`.`TipoGuardado`, \nIF(g_especialidad.`Nbre` IS NULL, '', g_especialidad.`Nbre`) NEspecialidad,\nh_tiponota.NReporte \nFROM h_notasclinicas \ninner join g_profesional gp2 on (gp2.Id_Persona=h_notasclinicas.Id_Profesional)\nINNER JOIN  g_persona gp  ON (gp.Id  = gp2.Id_Persona)\ninner join g_especialidad ge on (h_notasclinicas.Id_Especialidad = ge.Id) \nINNER JOIN `h_tiponota`  ON (`h_notasclinicas`.`Id_TipoNota` = `h_tiponota`.`Id`) \nINNER JOIN `h_atencion`   ON (`h_notasclinicas`.`Id_Atencion` = `h_atencion`.`Id`) \nLEFT JOIN `h_ordenes_interconsultas`  ON (h_ordenes_interconsultas.`Id_Nota` = h_notasclinicas.`Id`) \nLEFT JOIN `g_especialidad`ON (h_ordenes_interconsultas.`Id_Especialidad` = g_especialidad.`Id`)\nWHERE (h_notasclinicas.Id_Atencion =" + this.xId_Atencion + " AND h_tiponota.Id = " + this.xidtiponota[this.JCBTipoNota.getSelectedIndex()][0] + " and h_notasclinicas.Estado=1) \nORDER BY h_notasclinicas.FechaNota DESC, h_notasclinicas.HoraNota DESC ";
            ...
            Logger.getLogger(JPANotas_v2.class.getName()).log(Level.SEVERE, (String) null, (Throwable) ex);
        }
    }
    ...
    private void mGrabarInterconsulta() {
        if (this.xidtiponota[this.JCBTipoNota.getSelectedIndex()][4].equals("1")) {
    ...
    private void mCrearModeloDatos() {
        this.xmodelo = new DefaultTableModel(new Object[0], new String[]{"Cie10", "Diagnóstico", "Nº Orden"}) { // from class: Historia.JPANotas_v2.30
