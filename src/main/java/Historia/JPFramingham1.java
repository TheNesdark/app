...
/* JADX INFO: loaded from: GenomaP.jar:Historia/JPFramingham1.class */
public class JPFramingham1 extends JPanel {
    ...
    private void mIniciaComponentes() {
        try {
            this.JLPaso1.setIcon(new ImageIcon(getClass().getResource("/Imagenes/Framinghan/Paso_1" + clasesHistoriaCE.informacionAgendaMedicaDTO.getNombreSexo() + ".PNG")));
            this.JLPaso2.setIcon(new ImageIcon(getClass().getResource("/Imagenes/Framinghan/Paso_2" + clasesHistoriaCE.informacionAgendaMedicaDTO.getNombreSexo() + ".PNG")));
            this.JLPaso3.setIcon(new ImageIcon(getClass().getResource("/Imagenes/Framinghan/Paso_3" + clasesHistoriaCE.informacionAgendaMedicaDTO.getNombreSexo() + ".PNG")));
            this.JLPaso4.setIcon(new ImageIcon(getClass().getResource("/Imagenes/Framinghan/Paso_4" + clasesHistoriaCE.informacionAgendaMedicaDTO.getNombreSexo() + ".PNG")));
            this.JLPaso5.setIcon(new ImageIcon(getClass().getResource("/Imagenes/Framinghan/Paso_5" + clasesHistoriaCE.informacionAgendaMedicaDTO.getNombreSexo() + ".PNG")));
            this.JLPaso6.setIcon(new ImageIcon(getClass().getResource("/Imagenes/Framinghan/Paso_6" + clasesHistoriaCE.informacionAgendaMedicaDTO.getNombreSexo() + ".PNG")));
        } catch (Exception e) {
    ...
    public void mCalcularEdadColesterol() {
        ...
        if (this.xPaso4 != null) {
            ...
            if (Integer.valueOf(this.valorEdad).intValue() >= 40 && Integer.valueOf(this.valorEdad).intValue() <= 49) {
                ...
                switch (this.xCalculoEdadCoresterol) {
                    case 0:
                        this.JLBEdadCoresterol1.setBounds(248, 52, 90, 20);
                        this.xResultadoColesterol = "0";
                        this.xRangoColesterol = "<160";
                        this.xPuntajeColesterol = "3";
                        break;
                    case 1:
                        this.JLBEdadCoresterol1.setBounds(248, 70, 90, 20);
                        this.xResultadoColesterol = "1";
                        this.xRangoColesterol = "160-199";
                        this.xPuntajeColesterol = "3";
                        break;
                    case 2:
                        this.JLBEdadCoresterol1.setBounds(248, 88, 90, 20);
                        this.xResultadoColesterol = "2";
                        this.xRangoColesterol = "200-239";
                        this.xPuntajeColesterol = "5";
                        break;
                    case 3:
                        this.JLBEdadCoresterol1.setBounds(248, 107, 90, 20);
                        this.xResultadoColesterol = "3";
                        this.xRangoColesterol = "240-279";
                        this.xPuntajeColesterol = "8";
                        break;
                    case 4:
                        this.JLBEdadCoresterol1.setBounds(248, 124, 90, 20);
                        this.xResultadoColesterol = "4";
                        this.xRangoColesterol = ">280";
                        this.xPuntajeColesterol = "8";
                        break;
            ...
            if (Integer.valueOf(this.valorEdad).intValue() >= 50 && Integer.valueOf(this.valorEdad).intValue() <= 59) {
                ...
                switch (this.xCalculoEdadCoresterol) {
                    case 0:
                        this.JLBEdadCoresterol2.setBounds(337, 52, 90, 20);
                        this.xResultadoColesterol = "0";
                        this.xRangoColesterol = "<160";
                        this.xPuntajeColesterol = "0";
                        break;
                    case 1:
                        this.JLBEdadCoresterol2.setBounds(337, 70, 90, 20);
                        this.xResultadoColesterol = "1";
                        this.xRangoColesterol = "160-199";
                        this.xPuntajeColesterol = "2";
                        break;
                    case 2:
                        this.JLBEdadCoresterol2.setBounds(337, 88, 90, 20);
                        this.xResultadoColesterol = "2";
                        this.xRangoColesterol = "200-239";
                        this.xPuntajeColesterol = "3";
                        break;
                    case 3:
                        this.JLBEdadCoresterol2.setBounds(337, 107, 90, 20);
                        this.xResultadoColesterol = "3";
                        this.xRangoColesterol = "240-279";
                        this.xPuntajeColesterol = "4";
                        break;
                    case 4:
                        this.JLBEdadCoresterol2.setBounds(337, 124, 90, 20);
                        this.xResultadoColesterol = "4";
                        this.xRangoColesterol = ">280";
                        this.xPuntajeColesterol = "5";
                        break;
            ...
            if (Integer.valueOf(this.valorEdad).intValue() >= 60 && Integer.valueOf(this.valorEdad).intValue() <= 69) {
                ...
                switch (this.xCalculoEdadCoresterol) {
                    case 0:
                        this.JLBEdadCoresterol3.setBounds(426, 52, 90, 20);
                        this.xResultadoColesterol = "0";
                        this.xRangoColesterol = "<160";
                        this.xPuntajeColesterol = "0";
                        break;
                    case 1:
                        this.JLBEdadCoresterol3.setBounds(426, 70, 90, 20);
                        this.xResultadoColesterol = "1";
                        this.xRangoColesterol = "160-199";
                        this.xPuntajeColesterol = "1";
                        break;
                    case 2:
                        this.JLBEdadCoresterol3.setBounds(426, 88, 90, 20);
                        this.xResultadoColesterol = "2";
                        this.xRangoColesterol = "200-239";
                        this.xPuntajeColesterol = "1";
                        break;
                    case 3:
                        this.JLBEdadCoresterol3.setBounds(426, 107, 90, 20);
                        this.xResultadoColesterol = "3";
                        this.xRangoColesterol = "240-279";
                        this.xPuntajeColesterol = "2";
                        break;
                    case 4:
                        this.JLBEdadCoresterol3.setBounds(426, 124, 90, 20);
                        this.xResultadoColesterol = "4";
                        this.xRangoColesterol = ">280";
                        this.xPuntajeColesterol = "3";
                        break;
            ...
            if (Integer.valueOf(this.valorEdad).intValue() >= 70 && Integer.valueOf(this.valorEdad).intValue() <= 79) {
                ...
                switch (this.xCalculoEdadCoresterol) {
                    case 0:
                        this.JLBEdadCoresterol4.setBounds(314, 52, 90, 20);
                        this.xResultadoColesterol = "0";
                        this.xRangoColesterol = "<160";
                        this.xPuntajeColesterol = "0";
                        break;
                    case 1:
                        this.JLBEdadCoresterol4.setBounds(314, 70, 90, 20);
                        this.xResultadoColesterol = "1";
                        this.xRangoColesterol = "160-199";
                        this.xPuntajeColesterol = "0";
                        break;
                    case 2:
                        this.JLBEdadCoresterol4.setBounds(314, 88, 90, 20);
                        this.xResultadoColesterol = "2";
                        this.xRangoColesterol = "200-239";
                        this.xPuntajeColesterol = "0";
                        break;
                    case 3:
                        this.JLBEdadCoresterol4.setBounds(314, 107, 90, 20);
                        this.xResultadoColesterol = "3";
                        this.xRangoColesterol = "240-279";
                        this.xPuntajeColesterol = "1";
                        break;
                    case 4:
                        this.JLBEdadCoresterol4.setBounds(314, 124, 90, 20);
                        this.xResultadoColesterol = "4";
                        this.xRangoColesterol = ">280";
                        this.xPuntajeColesterol = "1";
                        break;
    ...
    public void mCalcularHdl() {
        if (this.xPaso5 != null) {
            ...
            switch (this.xCalculoHDL) {
                case 0:
                    this.JLBPuntajeHdl.setBounds(95, 35, 77, 18);
                    this.xRangoHdl = "60";
                    this.xValorHdl = "0";
                    this.xPuntajeHdl = "1";
                    break;
                case 1:
                    this.JLBPuntajeHdl.setBounds(95, 53, 77, 18);
                    this.xRangoHdl = "50-59";
                    this.xValorHdl = "1";
                    this.xPuntajeHdl = "0";
                    break;
                case 2:
                    this.JLBPuntajeHdl.setBounds(95, 71, 77, 18);
                    this.xRangoHdl = "40-49";
                    this.xValorHdl = "2";
                    this.xPuntajeHdl = "1";
                    break;
                case 3:
                    this.JLBPuntajeHdl.setBounds(95, 90, 77, 18);
                    this.xRangoHdl = "<40";
                    this.xValorHdl = "3";
                    this.xPuntajeHdl = "2";
                    break;
    ...
    public void mCalcularEdad() {
        if (this.xPaso1 != null) {
            ...
            switch (this.xResultado2) {
                case 0:
                    this.JLBEdad.setBounds(20, 50, 67, 20);
                    ...
                    break;
                case 1:
                    this.JLBEdad.setBounds(20, 70, 67, 20);
                    ...
                    break;
                case 2:
                    this.JLBEdad.setBounds(20, 90, 67, 20);
                    ...
                    break;
                case 3:
                    this.JLBEdad.setBounds(20, 110, 67, 20);
                    ...
                    break;
                case 4:
                    this.JLBEdad.setBounds(20, 130, 67, 20);
                    ...
                    break;
                case 5:
                    this.JLBEdad.setBounds(20, 150, 67, 20);
                    ...
                    break;
                case 6:
                    this.JLBEdad.setBounds(20, 170, 67, 20);
                    ...
                    break;
                case 7:
                    this.JLBEdad.setBounds(20, 190, 67, 20);
                    ...
                    break;
                case 8:
                    this.JLBEdad.setBounds(20, 210, 67, 20);
                    ...
                    break;
                case 9:
                    this.JLBEdad.setBounds(20, 230, 67, 20);
    ...
    public void mPresionSistolica() {
        if (this.xPaso6 != null) {
            ...
            switch (this.xCalculoPresion) {
                case 0:
                    this.JLBPresionSistolica.setBounds(10, 35, 160, 20);
                    ...
                    break;
                case 1:
                    this.JLBPresionSistolica.setBounds(10, 52, 160, 20);
                    ...
                    break;
                case 2:
                    this.JLBPresionSistolica.setBounds(10, 70, 160, 20);
                    ...
                    break;
                case 3:
                    this.JLBPresionSistolica.setBounds(10, 86, 160, 20);
                    ...
                    break;
                case 4:
                    this.JLBPresionSistolica.setBounds(10, 103, 160, 20);
    ...
    private void mResultado() {
        if (this.xPaso1 != null && this.xPaso3 != null && this.xPaso4 != null && this.xPaso5 != null && this.xPaso6 != null) {
            System.out.println("xedad-> " + this.xedad);
            System.out.println("xPuntajeColesterol-> " + this.xPuntajeColesterol);
            System.out.println("xResultadoFumador-> " + this.xResultadoFumador);
            System.out.println("xPuntajeHdl-> " + this.xPuntajeHdl);
            System.out.println("xPuntajePresion-> " + this.xPuntajePresion);
            ...
            if (this.xResultado < 0) {
                this.xResultado = 0;
            } else if (this.xResultado > 18) {
                this.xResultado = 18;
            }
            switch (this.xResultado) {
                case 0:
                    this.JLPuntaje.setBounds(10, 33, 212, 20);
                    this.totalPuntaje = "<0";
                    this.xPorcentaje = "<1";
                    break;
                case 1:
                    this.JLPuntaje.setBounds(10, 21, 212, 20);
                    this.totalPuntaje = "0";
                    this.xPorcentaje = "1%";
                    break;
                case 2:
                    this.JLPuntaje.setBounds(10, 67, 212, 20);
                    this.totalPuntaje = "1";
                    this.xPorcentaje = "1%";
                    break;
                case 3:
                    this.JLPuntaje.setBounds(10, 84, 212, 20);
                    this.totalPuntaje = "2";
                    this.xPorcentaje = "1%";
                    break;
                case 4:
                    this.JLPuntaje.setBounds(10, 101, 212, 20);
                    this.totalPuntaje = "3";
                    this.xPorcentaje = "1%";
                    break;
                case 5:
                    this.JLPuntaje.setBounds(10, 117, 212, 20);
                    this.totalPuntaje = "4";
                    this.xPorcentaje = "1%";
                    break;
                case 6:
                    this.JLPuntaje.setBounds(10, 133, 212, 20);
                    this.totalPuntaje = "5";
                    this.xPorcentaje = "2%";
                    break;
                case 7:
                    this.JLPuntaje.setBounds(10, 148, 212, 20);
                    this.totalPuntaje = "6";
                    this.xPorcentaje = "2%";
                    break;
                case 8:
                    this.JLPuntaje.setBounds(10, 164, 212, 20);
                    this.totalPuntaje = "7";
                    this.xPorcentaje = "3%";
                    break;
                case 9:
                    this.JLPuntaje.setBounds(10, 182, 212, 20);
                    this.totalPuntaje = "8";
                    this.xPorcentaje = "4%";
                    break;
                case 10:
                    this.JLPuntaje.setBounds(220, 33, 222, 20);
                    this.totalPuntaje = "9";
                    this.xPorcentaje = "5&";
                    break;
                case 11:
                    this.JLPuntaje.setBounds(220, 51, 222, 20);
                    this.totalPuntaje = "10";
                    this.xPorcentaje = "6%";
                    break;
                case 12:
                    this.JLPuntaje.setBounds(220, 67, 222, 20);
                    this.totalPuntaje = "11";
                    this.xPorcentaje = "8%";
                    break;
                case 13:
                    this.JLPuntaje.setBounds(220, 84, 222, 20);
                    this.totalPuntaje = "12";
                    this.xPorcentaje = "10%";
                    break;
                case 14:
                    this.JLPuntaje.setBounds(220, 101, 222, 20);
                    this.totalPuntaje = "13";
                    this.xPorcentaje = "12%";
                    break;
                case 15:
                    this.JLPuntaje.setBounds(220, 117, 222, 20);
                    this.totalPuntaje = "14";
                    this.xPorcentaje = "16%";
                    break;
                case 16:
                    this.JLPuntaje.setBounds(220, 133, 222, 20);
                    this.totalPuntaje = "15";
                    this.xPorcentaje = "20%";
                    break;
                case 17:
                    this.JLPuntaje.setBounds(220, 150, 222, 20);
                    this.totalPuntaje = "17";
                    this.xPorcentaje = "25%";
                    break;
                case 18:
                    this.JLPuntaje.setBounds(220, 164, 222, 20);
                    this.totalPuntaje = ">17";
                    this.xPorcentaje = ">30%";
                    break;
            }
    ...
    private void mVerifica() {
        ...
        try {
            ...
            Logger.getLogger(JPFramingham1.class.getName()).log(Level.SEVERE, (String) null, (Throwable) ex);
        }
    }

    /* JADX WARN: Type inference failed for: r4v1, types: [java.lang.Object[], java.lang.Object[][]] */
    private void mCrearModelo() {
        this.xmodelo = new DefaultTableModel(new Object[0], new String[]{"Id", "Fecha", "Punt. Edad", "Riesgo Cardiovascular", "Punt. Fumador", "Punt. Colesterol total", "Punt. HDL", "Punt. Presión Art.", "Total Puntos", "Porcentaje"}) { // from class: Historia.JPFramingham1.1
    ...
    private void initComponents() {
        ...
        this.P_1.addActionListener(new ActionListener() { // from class: Historia.JPFramingham1.2
            public void actionPerformed(ActionEvent evt) {
                JPFramingham1.this.P_1ActionPerformed(evt);
            }
        });
        ...
        this.P_2.addActionListener(new ActionListener() { // from class: Historia.JPFramingham1.3
            public void actionPerformed(ActionEvent evt) {
                JPFramingham1.this.P_2ActionPerformed(evt);
            }
        });
        ...
        this.P_3.addActionListener(new ActionListener() { // from class: Historia.JPFramingham1.4
            public void actionPerformed(ActionEvent evt) {
                JPFramingham1.this.P_3ActionPerformed(evt);
            }
        });
        ...
        this.P_4.addActionListener(new ActionListener() { // from class: Historia.JPFramingham1.5
            public void actionPerformed(ActionEvent evt) {
                JPFramingham1.this.P_4ActionPerformed(evt);
            }
        });
        ...
        this.P_5.addActionListener(new ActionListener() { // from class: Historia.JPFramingham1.6
            public void actionPerformed(ActionEvent evt) {
                JPFramingham1.this.P_5ActionPerformed(evt);
            }
        });
        ...
        this.P_6.addActionListener(new ActionListener() { // from class: Historia.JPFramingham1.7
            public void actionPerformed(ActionEvent evt) {
                JPFramingham1.this.P_6ActionPerformed(evt);
            }
        });
        ...
        this.P_7.addActionListener(new ActionListener() { // from class: Historia.JPFramingham1.8
            public void actionPerformed(ActionEvent evt) {
                JPFramingham1.this.P_7ActionPerformed(evt);
            }
        });
        ...
        this.P_8.addActionListener(new ActionListener() { // from class: Historia.JPFramingham1.9
            public void actionPerformed(ActionEvent evt) {
                JPFramingham1.this.P_8ActionPerformed(evt);
            }
        });
        ...
        this.P_9.addActionListener(new ActionListener() { // from class: Historia.JPFramingham1.10
            public void actionPerformed(ActionEvent evt) {
                JPFramingham1.this.P_9ActionPerformed(evt);
            }
        });
        ...
        this.P_10.addActionListener(new ActionListener() { // from class: Historia.JPFramingham1.11
            public void actionPerformed(ActionEvent evt) {
                JPFramingham1.this.P_10ActionPerformed(evt);
            }
        });
        ...
        this.JLPaso1.setIcon(new ImageIcon(getClass().getResource("/Imagenes/Framinghan/paso_1.png")));
        ...
        this.P2_1.addActionListener(new ActionListener() { // from class: Historia.JPFramingham1.12
            public void actionPerformed(ActionEvent evt) {
                JPFramingham1.this.P2_1ActionPerformed(evt);
            }
        });
        ...
        this.P2_2.addActionListener(new ActionListener() { // from class: Historia.JPFramingham1.13
            public void actionPerformed(ActionEvent evt) {
                JPFramingham1.this.P2_2ActionPerformed(evt);
            }
        });
        ...
        this.P2_3.addActionListener(new ActionListener() { // from class: Historia.JPFramingham1.14
            public void actionPerformed(ActionEvent evt) {
                JPFramingham1.this.P2_3ActionPerformed(evt);
            }
        });
        ...
        this.JLPaso2.setIcon(new ImageIcon(getClass().getResource("/Imagenes/Framinghan/paso_2.png")));
        ...
        this.P3_1.addActionListener(new ActionListener() { // from class: Historia.JPFramingham1.15
            public void actionPerformed(ActionEvent evt) {
                JPFramingham1.this.P3_1ActionPerformed(evt);
            }
        });
        ...
        this.P3_2.addActionListener(new ActionListener() { // from class: Historia.JPFramingham1.16
            public void actionPerformed(ActionEvent evt) {
                JPFramingham1.this.P3_2ActionPerformed(evt);
            }
        });
        ...
        this.JLPaso3.setIcon(new ImageIcon(getClass().getResource("/Imagenes/Framinghan/paso_3.png")));
        ...
        this.P4_1.addActionListener(new ActionListener() { // from class: Historia.JPFramingham1.17
            public void actionPerformed(ActionEvent evt) {
                JPFramingham1.this.P4_1ActionPerformed(evt);
            }
        });
        this.JPPaso4.add(this.P4_1);
        this.P4_1.setBounds(130, 50, 20, 30);
        this.Paso4.add(this.P4_2);
        this.P4_2.setName("1");
        this.P4_2.setOpaque(false);
        this.P4_2.addActionListener(new ActionListener() { // from class: Historia.JPFramingham1.18
            public void actionPerformed(ActionEvent evt) {
                JPFramingham1.this.P4_2ActionPerformed(evt);
            }
        });
        this.JPPaso4.add(this.P4_2);
        this.P4_2.setBounds(130, 70, 25, 25);
        this.Paso4.add(this.P4_3);
        this.P4_3.setName("2");
        this.P4_3.setOpaque(false);
        this.P4_3.addActionListener(new ActionListener() { // from class: Historia.JPFramingham1.19
            public void actionPerformed(ActionEvent evt) {
                JPFramingham1.this.P4_3ActionPerformed(evt);
            }
        });
        this.JPPaso4.add(this.P4_3);
        this.P4_3.setBounds(130, 90, 20, 25);
        this.Paso4.add(this.P4_4);
        this.P4_4.setName("3");
        this.P4_4.setOpaque(false);
        this.P4_4.addActionListener(new ActionListener() { // from class: Historia.JPFramingham1.20
            public void actionPerformed(ActionEvent evt) {
                JPFramingham1.this.P4_4ActionPerformed(evt);
            }
        });
        this.JPPaso4.add(this.P4_4);
        this.P4_4.setBounds(130, 110, 20, 20);
        this.Paso4.add(this.P4_5);
        this.P4_5.setName("4");
        this.P4_5.setOpaque(false);
        this.P4_5.addActionListener(new ActionListener() { // from class: Historia.JPFramingham1.21
            public void actionPerformed(ActionEvent evt) {
                JPFramingham1.this.P4_5ActionPerformed(evt);
            }
        });
        this.JPPaso4.add(this.P4_5);
        this.P4_5.setBounds(130, 130, 20, 20);
        ...
        this.JLPaso4.setIcon(new ImageIcon(getClass().getResource("/Imagenes/Framinghan/paso_4.png")));
        ...
        this.P5_1.addActionListener(new ActionListener() { // from class: Historia.JPFramingham1.22
            public void actionPerformed(ActionEvent evt) {
                JPFramingham1.this.P5_1ActionPerformed(evt);
            }
        });
        ...
        this.P5_2.addActionListener(new ActionListener() { // from class: Historia.JPFramingham1.23
            public void actionPerformed(ActionEvent evt) {
                JPFramingham1.this.P5_2ActionPerformed(evt);
            }
        });
        ...
        this.P5_3.addActionListener(new ActionListener() { // from class: Historia.JPFramingham1.24
            public void actionPerformed(ActionEvent evt) {
                JPFramingham1.this.P5_3ActionPerformed(evt);
            }
        });
        ...
        this.P5_4.addActionListener(new ActionListener() { // from class: Historia.JPFramingham1.25
            public void actionPerformed(ActionEvent evt) {
                JPFramingham1.this.P5_4ActionPerformed(evt);
            }
        });
        ...
        this.JLPaso5.setIcon(new ImageIcon(getClass().getResource("/Imagenes/Framinghan/paso_5.png")));
        ...
        this.P6_1.addActionListener(new ActionListener() { // from class: Historia.JPFramingham1.26
            public void actionPerformed(ActionEvent evt) {
                JPFramingham1.this.P6_1ActionPerformed(evt);
            }
        });
        this.JPPaso6.add(this.P6_1);
        this.P6_1.setBounds(170, 35, 20, 20);
        this.Paso6Presion1.add(this.P6_2);
        this.P6_2.setName("0");
        this.P6_2.setOpaque(false);
        this.P6_2.addActionListener(new ActionListener() { // from class: Historia.JPFramingham1.27
            public void actionPerformed(ActionEvent evt) {
                JPFramingham1.this.P6_2ActionPerformed(evt);
            }
        });
        this.JPPaso6.add(this.P6_2);
        this.P6_2.setBounds(240, 30, 20, 30);
        this.Paso6Presion1.add(this.P6_3);
        this.P6_3.setName("1");
        this.P6_3.setOpaque(false);
        this.P6_3.addActionListener(new ActionListener() { // from class: Historia.JPFramingham1.28
            public void actionPerformed(ActionEvent evt) {
                JPFramingham1.this.P6_3ActionPerformed(evt);
            }
        });
        this.JPPaso6.add(this.P6_3);
        this.P6_3.setBounds(170, 50, 20, 25);
        this.Paso6Presion1.add(this.P6_4);
        this.P6_4.setName("1");
        this.P6_4.setOpaque(false);
        this.P6_4.addActionListener(new ActionListener() { // from class: Historia.JPFramingham1.29
            public void actionPerformed(ActionEvent evt) {
                JPFramingham1.this.P6_4ActionPerformed(evt);
            }
        });
        this.JPPaso6.add(this.P6_4);
        this.P6_4.setBounds(240, 50, 25, 20);
        this.Paso6Presion1.add(this.P6_5);
        this.P6_5.setName("2");
        this.P6_5.setOpaque(false);
        this.P6_5.addActionListener(new ActionListener() { // from class: Historia.JPFramingham1.30
            public void actionPerformed(ActionEvent evt) {
                JPFramingham1.this.P6_5ActionPerformed(evt);
            }
        });
        this.JPPaso6.add(this.P6_5);
        this.P6_5.setBounds(170, 70, 20, 20);
        this.Paso6Presion1.add(this.P6_6);
        this.P6_6.setName("2");
        this.P6_6.setOpaque(false);
        this.P6_6.addActionListener(new ActionListener() { // from class: Historia.JPFramingham1.31
            public void actionPerformed(ActionEvent evt) {
                JPFramingham1.this.P6_6ActionPerformed(evt);
            }
        });
        this.JPPaso6.add(this.P6_6);
        this.P6_6.setBounds(240, 70, 20, 20);
        this.Paso6Presion1.add(this.P6_7);
        this.P6_7.setName("3");
        this.P6_7.setOpaque(false);
        this.P6_7.addActionListener(new ActionListener() { // from class: Historia.JPFramingham1.32
            public void actionPerformed(ActionEvent evt) {
                JPFramingham1.this.P6_7ActionPerformed(evt);
            }
        });
        this.JPPaso6.add(this.P6_7);
        this.P6_7.setBounds(170, 90, 20, 10);
        this.Paso6Presion1.add(this.P6_8);
        this.P6_8.setName("3");
        this.P6_8.setOpaque(false);
        this.P6_8.addActionListener(new ActionListener() { // from class: Historia.JPFramingham1.33
            public void actionPerformed(ActionEvent evt) {
                JPFramingham1.this.P6_8ActionPerformed(evt);
            }
        });
        this.JPPaso6.add(this.P6_8);
        this.P6_8.setBounds(240, 90, 20, 10);
        this.Paso6Presion1.add(this.P6_9);
        this.P6_9.setName("4");
        this.P6_9.setOpaque(false);
        this.P6_9.addActionListener(new ActionListener() { // from class: Historia.JPFramingham1.34
            public void actionPerformed(ActionEvent evt) {
                JPFramingham1.this.P6_9ActionPerformed(evt);
            }
        });
        this.JPPaso6.add(this.P6_9);
        this.P6_9.setBounds(170, 100, 20, 20);
        this.Paso6Presion1.add(this.P6_10);
        this.P6_10.setName("4");
        this.P6_10.setOpaque(false);
        this.P6_10.addActionListener(new ActionListener() { // from class: Historia.JPFramingham1.35
            public void actionPerformed(ActionEvent evt) {
                JPFramingham1.this.P6_10ActionPerformed(evt);
            }
        });
        this.JPPaso6.add(this.P6_10);
        this.P6_10.setBounds(240, 100, 20, 20);
        this.JPPaso6.add(this.JLBPresionSistolica);
        this.JLBPresionSistolica.setBounds(10, 20, 160, 20);
        this.JLPaso6.setIcon(new ImageIcon(getClass().getResource("/Imagenes/Framinghan/paso_6.png")));
        ...
        this.jLabel2.setIcon(new ImageIcon(getClass().getResource("/Imagenes/Framinghan/Resultado.png")));
        ...
        JPFormLayout.setHorizontalGroup(JPFormLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPFormLayout.createSequentialGroup().addContainerGap().addGroup(JPFormLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPFormLayout.createSequentialGroup().addGroup(JPFormLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPFormLayout.createSequentialGroup().addComponent(this.JPPaso1, -2, 177, -2).addGap(18, 18, 18).addGroup(JPFormLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPFormLayout.createSequentialGroup().addComponent(this.JPPaso3, -2, 440, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JPPaso5, -2, 177, -2)).addComponent(this.JPPaso4, -2, 622, -2))).addGroup(JPFormLayout.createSequentialGroup().addComponent(this.JPPaso6, -2, 306, -2).addGap(18, 18, 18).addComponent(this.JPPaso2, -2, 310, -2))).addContainerGap(83, 32767)).addGroup(JPFormLayout.createSequentialGroup().addComponent(this.JPResultado, -2, 456, -2).addGap(172, 446, 32767)))));
        ...
        this.JTBDetalle.addMouseListener(new MouseAdapter() { // from class: Historia.JPFramingham1.36
            public void mouseClicked(MouseEvent evt) {
                JPFramingham1.this.JTBDetalleMouseClicked(evt);
            }
        });
        this.JTBDetalle.addKeyListener(new KeyAdapter() { // from class: Historia.JPFramingham1.37
            public void keyPressed(KeyEvent evt) {
                JPFramingham1.this.JTBDetalleKeyPressed(evt);
            }
        });
