...
/* JADX INFO: loaded from: GenomaP.jar:Historia/JIFValidarProcedimientos.class */
public class JIFValidarProcedimientos extends JInternalFrame {
    ...
    public JIFValidarProcedimientos(String rsc, String xnombre) throws SQLException {
        initComponents();
    ...
    private void initComponents() {
        ...
        this.JBTCerrar.addActionListener(new ActionListener() { // from class: Historia.JIFValidarProcedimientos.1
            public void actionPerformed(ActionEvent evt) {
                JIFValidarProcedimientos.this.JBTCerrarActionPerformed(evt);
            }
        });
        GroupLayout layout = new GroupLayout(getContentPane());
        getContentPane().setLayout(layout);
        layout.setHorizontalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(layout.createSequentialGroup().addContainerGap().addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.JSPDatos, -1, 974, 32767).addComponent(this.JBTCerrar, -1, -1, 32767)).addContainerGap()));
        layout.setVerticalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(layout.createSequentialGroup().addGap(19, 19, 19).addComponent(this.JSPDatos, -2, 207, -2).addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED).addComponent(this.JBTCerrar, -2, 55, -2).addContainerGap(27, 32767)));
        pack();
    }
