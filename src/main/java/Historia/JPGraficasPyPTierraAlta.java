...
/* JADX INFO: loaded from: GenomaP.jar:Historia/JPGraficasPyPTierraAlta.class */
public class JPGraficasPyPTierraAlta extends JPanel {
    private DefaultTableModel xmodelo;
    private DefaultTableModel xmodeloSeg;
    private DefaultTableModel modeloRevisionDelCuerpo;
    ...
    private String encabezadoExamenFisico;
    ...
    private JCheckBox JCHBValorDefecto;
    ...
    public JPGraficasPyPTierraAlta() {
        this.xedad = "";
        this.xEdadActual = 0;
        this.G1 = null;
        this.G2 = null;
        ...
        try {
            ...
            Logger.getLogger(JPGraficasPyPTierraAlta.class.getName()).log(Level.SEVERE, (String) null, (Throwable) ex);
        }
        ...
        xVerifica();
        cargarDatosRevisionDelcuerpo();
    }

    private void springStart() {
        this.detalleExamenFisicoDAO = (DetalleExamenFisicoDAOImpl) new ClassPathXmlApplicationContext(new String[]{"/recursos/applicationContext.xml"}).getBean("detalleExamenFisicoDAOImpl");
    }
    ...
    private void mCrearModeloDatos() {
        this.xmodelo = new DefaultTableModel(new Object[0], new String[]{"Fecha", "FC(r/m)", "T(°C)", "Presión", "Edad(Mes)", "Talla(cm)", "Peso(Kg)", "IMC", "Per.Cefálico", "Observación", "FR(r/m)", "Per.Brazo", "PS2"}) { // from class: Historia.JPGraficasPyPTierraAlta.1
    ...
    /* JADX WARN: Type inference failed for: r4v1, types: [java.lang.Object[], java.lang.Object[][]] */
    private void crearModeloDatosRevisionDelCuerpo() {
        this.modeloRevisionDelCuerpo = new DefaultTableModel(new Object[0], new String[]{"Id", "idExamen", "Parte del cuerpo", "Respuesta"}) { // from class: Historia.JPGraficasPyPTierraAlta.2
        ...
        this.JTDetalle.setModel(this.modeloRevisionDelCuerpo);
        ...
        this.JTDetalle.getColumnModel().getColumn(3).setPreferredWidth(240);
    }

    private void guardarEvaluacionDelCuerpo() {
        if (this.JTDetalle.isEditing()) {
            this.JTDetalle.getCellEditor().stopCellEditing();
        }
        for (int j = 0; j < this.modeloRevisionDelCuerpo.getRowCount(); j++) {
            DetalleExamenFisicoNDTO detalleExamenFisico = new DetalleExamenFisicoNDTO();
            detalleExamenFisico.setIdExamenFisico(Long.valueOf(Long.parseLong(this.encabezadoExamenFisico)));
            detalleExamenFisico.setIdGrupoExamen(Long.valueOf(Long.parseLong(this.modeloRevisionDelCuerpo.getValueAt(j, 0).toString())));
            detalleExamenFisico.setObservacion(this.modeloRevisionDelCuerpo.getValueAt(j, 3).toString());
            detalleExamenFisico.setEstado(true);
            this.detalleExamenFisicoDAO.mCrear(detalleExamenFisico);
        }
    }

    private void cargarDatosRevisionDelcuerpo() {
        crearModeloDatosRevisionDelCuerpo();
        String sql = "SELECT\n    `h_grupoexamenfisico`.`Id`\n    , `h_grupoexamenfisico`.`Nbre`\n    , `h_grupoexamenfisico`.`DatosPredefinidos`\n    , `h_grupoexamenfisico`.`FiltroSexo`\n    , `h_grupoexamenfisico_tipohc`.`Id_TipoHc`\nFROM\n    `baseserver`.`h_grupoexamenfisico_tipohc`\n    INNER JOIN `baseserver`.`h_grupoexamenfisico` \n        ON (`h_grupoexamenfisico_tipohc`.`Id_GrupoExamenFisico` = `h_grupoexamenfisico`.`Id`)\n        WHERE(`h_grupoexamenfisico_tipohc`.`Id_TipoHc` = " + clasesHistoriaCE.informacionAgendaMedicaDTO.getIdTipohc() + ");";
        try {
            ResultSet xrs = this.xct.traerRs(sql);
            if (xrs.next()) {
                xrs.beforeFirst();
                int n = 0;
                while (xrs.next()) {
                    this.modeloRevisionDelCuerpo.addRow(this.xdato);
                    this.modeloRevisionDelCuerpo.setValueAt(xrs.getString(1), n, 0);
                    this.modeloRevisionDelCuerpo.setValueAt(0, n, 1);
                    this.modeloRevisionDelCuerpo.setValueAt(xrs.getString(2), n, 2);
                    this.modeloRevisionDelCuerpo.setValueAt("", n, 3);
                    n++;
                }
            }
        } catch (Exception e) {
    ...
    private void mCrear_ExamenFisico() {
        try {
            ...
            if (!xrsm.next()) {
                ...
                String sql2 = " UPDATE  `h_examenfisico` SET  `Id_Usuario_Programa`='" + clasesHistoriaCE.informacionAgendaMedicaDTO.getIdUsuarioPrograma() + "' , `FCardiaca`='" + this.JTFFSFc.getText() + "' , `FRespiratoria`='" + this.JTFFSFr.getText() + "' , `Temperatura`='" + this.JTFFTemperatura.getText() + "' , TArtSentadoD='" + this.JTFFPSentadoD.getValue() + "', TArtSentadoS='" + this.JTFFPSentadoS.getValue() + "', `Talla`='" + this.JTFFSTalla.getText() + "' , `Peso`='" + this.JTFFSPeso.getText() + "' , `IMC`='" + this.JTFFSIMC.getText().replaceAll(",", ".") + "'  , `PerimetroCefalico`='" + this.JTFFSPCefalico.getText() + "', PerimetroBrazo='" + this.JTFFSPBrazo.getText() + "',  `Fecha`='" + this.xmt.formatoAMD.format(this.xmt.getFechaActual()) + "' , `UsuarioS`='" + Principal.usuarioSistemaDTO.getLogin() + "', `Ps2` = '" + this.JTFFPS2.getText() + "' WHERE Id_Atencion='" + clasesHistoriaCE.informacionAgendaMedicaDTO.getIdAtencion() + "'";
    ...
    /* JADX INFO: loaded from: GenomaP.jar:Historia/JPGraficasPyPTierraAlta$Imagen.class */
    public class Imagen extends JPanel {
        private int[][] xCoordenada;
        private ConsultasMySQL xct = new ConsultasMySQL();
        private JPGraficasPyPTierraAlta xJPGraficasPyP;
        ...
        public Imagen(JPGraficasPyPTierraAlta xJPGraficasPyP, String xTitulo, String xImagen, int x, int y, int xTipoGrafica, JPanel xPanel, long xRangoX, long xRangoY, String sexo) {
            this.x = 0;
            this.y = 0;
            this.xTipoGrafica = 0;
            this.xRangoX = 0L;
                ...
                for (int j = 0; j < this.xJPGraficasPyP.JTBHistorico.getRowCount(); j++) {
                    ...
                    if (xData == 1) {
                        ...
                        try {
                            ...
                            Logger.getLogger(JPGraficasPyPTierraAlta.class.getName()).log(Level.SEVERE, (String) null, (Throwable) ex2);
                        }
                    }
                }
            }
    ...
    private void initComponents() {
        ...
        this.JPAOtrosDatos = new JPanel();
        this.jPanel7 = new JPanel();
        this.jScrollPane2 = new JScrollPane();
        this.JTDetalle = new JTable();
        this.JCHBValorDefecto = new JCheckBox();
        setName("JPGraficasPyP");
        this.JTPCDDatos.setForeground(new Color(0, 107, 0));
        this.JTPCDDatos.setFont(new Font("Arial", 1, 14));
        this.JTPCDDatos.addChangeListener(new ChangeListener() { // from class: Historia.JPGraficasPyPTierraAlta.4
            public void stateChanged(ChangeEvent evt) {
                JPGraficasPyPTierraAlta.this.JTPCDDatosStateChanged(evt);
            }
        });
        ...
        this.JTFFSFc.addActionListener(new ActionListener() { // from class: Historia.JPGraficasPyPTierraAlta.5
            public void actionPerformed(ActionEvent evt) {
                JPGraficasPyPTierraAlta.this.JTFFSFcActionPerformed(evt);
            }
        });
        this.JTFFSFc.addFocusListener(new FocusAdapter() { // from class: Historia.JPGraficasPyPTierraAlta.6
            public void focusGained(FocusEvent evt) {
                JPGraficasPyPTierraAlta.this.JTFFSFcFocusGained(evt);
            }

            public void focusLost(FocusEvent evt) {
                JPGraficasPyPTierraAlta.this.JTFFSFcFocusLost(evt);
            }
        });
        ...
        this.JTFFSFr.addFocusListener(new FocusAdapter() { // from class: Historia.JPGraficasPyPTierraAlta.7
            public void focusGained(FocusEvent evt) {
                JPGraficasPyPTierraAlta.this.JTFFSFrFocusGained(evt);
            }
        });
        ...
        this.JTFFTemperatura.addFocusListener(new FocusAdapter() { // from class: Historia.JPGraficasPyPTierraAlta.8
            public void focusGained(FocusEvent evt) {
                JPGraficasPyPTierraAlta.this.JTFFTemperaturaFocusGained(evt);
            }
        });
        this.JTFFTemperatura.addActionListener(new ActionListener() { // from class: Historia.JPGraficasPyPTierraAlta.9
            public void actionPerformed(ActionEvent evt) {
                JPGraficasPyPTierraAlta.this.JTFFTemperaturaActionPerformed(evt);
            }
        });
        ...
        this.JTFFSTalla.addActionListener(new ActionListener() { // from class: Historia.JPGraficasPyPTierraAlta.10
            public void actionPerformed(ActionEvent evt) {
                JPGraficasPyPTierraAlta.this.JTFFSTallaActionPerformed(evt);
            }
        });
        this.JTFFSTalla.addFocusListener(new FocusAdapter() { // from class: Historia.JPGraficasPyPTierraAlta.11
            public void focusGained(FocusEvent evt) {
                JPGraficasPyPTierraAlta.this.JTFFSTallaFocusGained(evt);
            }

            public void focusLost(FocusEvent evt) {
                JPGraficasPyPTierraAlta.this.JTFFSTallaFocusLost(evt);
            }
        });
        ...
        this.JTFFSPeso.addFocusListener(new FocusAdapter() { // from class: Historia.JPGraficasPyPTierraAlta.12
            public void focusGained(FocusEvent evt) {
                JPGraficasPyPTierraAlta.this.JTFFSPesoFocusGained(evt);
            }

            public void focusLost(FocusEvent evt) {
                JPGraficasPyPTierraAlta.this.JTFFSPesoFocusLost(evt);
            }
        });
        this.JTFFSPeso.addActionListener(new ActionListener() { // from class: Historia.JPGraficasPyPTierraAlta.13
            public void actionPerformed(ActionEvent evt) {
                JPGraficasPyPTierraAlta.this.JTFFSPesoActionPerformed(evt);
            }
        });
        ...
        this.JBTGuardar.addActionListener(new ActionListener() { // from class: Historia.JPGraficasPyPTierraAlta.14
            public void actionPerformed(ActionEvent evt) {
                JPGraficasPyPTierraAlta.this.JBTGuardarActionPerformed(evt);
            }
        });
        ...
        this.JTFFSPCefalico.addFocusListener(new FocusAdapter() { // from class: Historia.JPGraficasPyPTierraAlta.15
            public void focusGained(FocusEvent evt) {
                JPGraficasPyPTierraAlta.this.JTFFSPCefalicoFocusGained(evt);
            }

            public void focusLost(FocusEvent evt) {
                JPGraficasPyPTierraAlta.this.JTFFSPCefalicoFocusLost(evt);
            }
        });
        this.JTFFSPCefalico.addActionListener(new ActionListener() { // from class: Historia.JPGraficasPyPTierraAlta.16
            public void actionPerformed(ActionEvent evt) {
                JPGraficasPyPTierraAlta.this.JTFFSPCefalicoActionPerformed(evt);
            }
        });
        ...
        this.JTFFPSentadoS.addActionListener(new ActionListener() { // from class: Historia.JPGraficasPyPTierraAlta.17
            public void actionPerformed(ActionEvent evt) {
                JPGraficasPyPTierraAlta.this.JTFFPSentadoSActionPerformed(evt);
            }
        });
        this.JTFFPSentadoS.addFocusListener(new FocusAdapter() { // from class: Historia.JPGraficasPyPTierraAlta.18
            public void focusLost(FocusEvent evt) {
                JPGraficasPyPTierraAlta.this.JTFFPSentadoSFocusLost(evt);
            }
        });
        ...
        this.JTFFPSentadoD.addActionListener(new ActionListener() { // from class: Historia.JPGraficasPyPTierraAlta.19
            public void actionPerformed(ActionEvent evt) {
                JPGraficasPyPTierraAlta.this.JTFFPSentadoDActionPerformed(evt);
            }
        });
        this.JTFFPSentadoD.addFocusListener(new FocusAdapter() { // from class: Historia.JPGraficasPyPTierraAlta.20
            public void focusLost(FocusEvent evt) {
                JPGraficasPyPTierraAlta.this.JTFFPSentadoDFocusLost(evt);
            }
        });
        ...
        this.JTFFSPBrazo.addActionListener(new ActionListener() { // from class: Historia.JPGraficasPyPTierraAlta.21
            public void actionPerformed(ActionEvent evt) {
                JPGraficasPyPTierraAlta.this.JTFFSPBrazoActionPerformed(evt);
            }
        });
        this.JTFFSPBrazo.addFocusListener(new FocusAdapter() { // from class: Historia.JPGraficasPyPTierraAlta.22
            public void focusGained(FocusEvent evt) {
                JPGraficasPyPTierraAlta.this.JTFFSPBrazoFocusGained(evt);
            }

            public void focusLost(FocusEvent evt) {
                JPGraficasPyPTierraAlta.this.JTFFSPBrazoFocusLost(evt);
            }
        });
        ...
        this.JTFFPS2.addFocusListener(new FocusAdapter() { // from class: Historia.JPGraficasPyPTierraAlta.23
            public void focusGained(FocusEvent evt) {
                JPGraficasPyPTierraAlta.this.JTFFPS2FocusGained(evt);
            }
        });
        this.JTFFPS2.addActionListener(new ActionListener() { // from class: Historia.JPGraficasPyPTierraAlta.24
            public void actionPerformed(ActionEvent evt) {
                JPGraficasPyPTierraAlta.this.JTFFPS2ActionPerformed(evt);
            }
        });
        GroupLayout JPDatosLayout = new GroupLayout(this.JPDatos);
        this.JPDatos.setLayout(JPDatosLayout);
        JPDatosLayout.setHorizontalGroup(JPDatosLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPDatosLayout.createSequentialGroup().addContainerGap().addGroup(JPDatosLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPDatosLayout.createParallelGroup(GroupLayout.Alignment.TRAILING, false).addComponent(this.JSPHistorico).addComponent(this.JBTGuardar, -1, -1, 32767).addGroup(JPDatosLayout.createSequentialGroup().addGap(0, 0, 32767).addGroup(JPDatosLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPDatosLayout.createSequentialGroup().addGap(2, 2, 2).addComponent(this.JLBPSentado, -2, 103, -2)).addGroup(JPDatosLayout.createSequentialGroup().addComponent(this.JTFFPSentadoS, -2, 45, -2).addGap(4, 4, 4).addComponent(this.JLBPBSentado).addGap(4, 4, 4).addComponent(this.JTFFPSentadoD, -2, 45, -2))).addGap(715, 715, 715))).addGroup(JPDatosLayout.createSequentialGroup().addGroup(JPDatosLayout.createParallelGroup(GroupLayout.Alignment.TRAILING).addComponent(this.JLEdadMeses, -2, 120, -2).addGroup(JPDatosLayout.createSequentialGroup().addComponent(this.JTFFSFc, -2, 80, -2).addGap(5, 5, 5).addComponent(this.JTFFSFr, -2, 76, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JTFFTemperatura, -2, 67, -2).addGap(4, 4, 4).addComponent(this.JTFFSTalla, -2, 90, -2).addGap(5, 5, 5).addComponent(this.JTFFSPeso, -2, 90, -2).addGap(5, 5, 5).addComponent(this.JTFFSIMC, -2, 83, -2).addGap(5, 5, 5).addComponent(this.JTFFSPCefalico, -2, 105, -2).addGap(5, 5, 5).addComponent(this.JTFFSPBrazo, -2, 91, -2))).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JTFFPS2, -2, 67, -2))).addContainerGap(-1, 32767)));
        JPDatosLayout.setVerticalGroup(JPDatosLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(GroupLayout.Alignment.TRAILING, JPDatosLayout.createSequentialGroup().addGap(7, 7, 7).addGroup(JPDatosLayout.createParallelGroup(GroupLayout.Alignment.TRAILING).addGroup(JPDatosLayout.createSequentialGroup().addComponent(this.JLBPSentado).addGap(5, 5, 5).addGroup(JPDatosLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.JTFFPSentadoS, -2, 25, -2).addComponent(this.JLBPBSentado, -2, 23, -2).addComponent(this.JTFFPSentadoD, -2, 25, -2))).addComponent(this.JLEdadMeses, -2, 48, -2)).addGap(2, 2, 2).addGroup(JPDatosLayout.createParallelGroup(GroupLayout.Alignment.LEADING, false).addComponent(this.JTFFSPCefalico, -1, -1, 32767).addComponent(this.JTFFSIMC, -2, 0, 32767).addComponent(this.JTFFSPeso, -1, -1, 32767).addGroup(JPDatosLayout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(this.JTFFSPBrazo, -2, -1, -2).addComponent(this.JTFFPS2, -2, 50, -2)).addGroup(JPDatosLayout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(this.JTFFSFr, -2, 50, -2).addComponent(this.JTFFSFc, -2, 50, -2).addComponent(this.JTFFSTalla, -2, 50, -2).addComponent(this.JTFFTemperatura, -2, 50, -2))).addGap(10, 10, 10).addComponent(this.JBTGuardar).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JSPHistorico, -2, 362, -2).addGap(208, 208, 208)));
        ...
        JPGraficaLayout.setVerticalGroup(JPGraficaLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPGraficaLayout.createSequentialGroup().addComponent(this.JTPGraficasCyD, -2, 637, -2).addGap(0, 6, 32767)));
        ...
        this.JBTGuardarObs.addActionListener(new ActionListener() { // from class: Historia.JPGraficasPyPTierraAlta.25
            public void actionPerformed(ActionEvent evt) {
                JPGraficasPyPTierraAlta.this.JBTGuardarObsActionPerformed(evt);
            }
        });
        GroupLayout jPanel1Layout = new GroupLayout(this.jPanel1);
        this.jPanel1.setLayout(jPanel1Layout);
        jPanel1Layout.setHorizontalGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(jPanel1Layout.createSequentialGroup().addContainerGap().addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(jPanel1Layout.createSequentialGroup().addComponent(this.jScrollPane1, -2, 801, -2).addGap(0, 0, 32767)).addComponent(this.JBTGuardarObs, -1, 829, 32767)).addContainerGap()));
        jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(jPanel1Layout.createSequentialGroup().addContainerGap().addComponent(this.jScrollPane1, -2, 196, -2).addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED).addComponent(this.JBTGuardarObs).addContainerGap(393, 32767)));
        ...
        this.JDC_FechaEvento.addPropertyChangeListener(new PropertyChangeListener() { // from class: Historia.JPGraficasPyPTierraAlta.26
            @Override // java.beans.PropertyChangeListener
            public void propertyChange(PropertyChangeEvent evt) {
                JPGraficasPyPTierraAlta.this.JDC_FechaEventoPropertyChange(evt);
            }
        });
        ...
        this.JDC_FechaVitA.addPropertyChangeListener(new PropertyChangeListener() { // from class: Historia.JPGraficasPyPTierraAlta.27
            @Override // java.beans.PropertyChangeListener
            public void propertyChange(PropertyChangeEvent evt) {
                JPGraficasPyPTierraAlta.this.JDC_FechaVitAPropertyChange(evt);
            }
        });
        ...
        this.JDC_FechaHierro.addPropertyChangeListener(new PropertyChangeListener() { // from class: Historia.JPGraficasPyPTierraAlta.28
            @Override // java.beans.PropertyChangeListener
            public void propertyChange(PropertyChangeEvent evt) {
                JPGraficasPyPTierraAlta.this.JDC_FechaHierroPropertyChange(evt);
            }
        });
        ...
        this.JDC_FechaAntParasitario.addPropertyChangeListener(new PropertyChangeListener() { // from class: Historia.JPGraficasPyPTierraAlta.29
            @Override // java.beans.PropertyChangeListener
            public void propertyChange(PropertyChangeEvent evt) {
                JPGraficasPyPTierraAlta.this.JDC_FechaAntParasitarioPropertyChange(evt);
            }
        });
        ...
        this.JDC_FechaAtnOdont.addPropertyChangeListener(new PropertyChangeListener() { // from class: Historia.JPGraficasPyPTierraAlta.30
            @Override // java.beans.PropertyChangeListener
            public void propertyChange(PropertyChangeEvent evt) {
                JPGraficasPyPTierraAlta.this.JDC_FechaAtnOdontPropertyChange(evt);
            }
        });
        ...
        this.JDC_FechaPCita.addPropertyChangeListener(new PropertyChangeListener() { // from class: Historia.JPGraficasPyPTierraAlta.31
            @Override // java.beans.PropertyChangeListener
            public void propertyChange(PropertyChangeEvent evt) {
                JPGraficasPyPTierraAlta.this.JDC_FechaPCitaPropertyChange(evt);
            }
        });
        this.jCheckBox1.setFont(new Font("Arial", 1, 12));
        this.jCheckBox1.setText("Aplica?");
        this.jCheckBox1.addActionListener(new ActionListener() { // from class: Historia.JPGraficasPyPTierraAlta.32
            public void actionPerformed(ActionEvent evt) {
                JPGraficasPyPTierraAlta.this.jCheckBox1ActionPerformed(evt);
            }
        });
        this.jCheckBox2.setFont(new Font("Arial", 1, 12));
        this.jCheckBox2.setText("Aplica?");
        this.jCheckBox2.addActionListener(new ActionListener() { // from class: Historia.JPGraficasPyPTierraAlta.33
            public void actionPerformed(ActionEvent evt) {
                JPGraficasPyPTierraAlta.this.jCheckBox2ActionPerformed(evt);
            }
        });
        this.jCheckBox3.setFont(new Font("Arial", 1, 12));
        this.jCheckBox3.setText("Aplica?");
        this.jCheckBox3.addActionListener(new ActionListener() { // from class: Historia.JPGraficasPyPTierraAlta.34
            public void actionPerformed(ActionEvent evt) {
                JPGraficasPyPTierraAlta.this.jCheckBox3ActionPerformed(evt);
            }
        });
        this.jCheckBox4.setFont(new Font("Arial", 1, 12));
        this.jCheckBox4.setText("Aplica?");
        this.jCheckBox4.addActionListener(new ActionListener() { // from class: Historia.JPGraficasPyPTierraAlta.35
            public void actionPerformed(ActionEvent evt) {
                JPGraficasPyPTierraAlta.this.jCheckBox4ActionPerformed(evt);
            }
        });
        ...
        this.JDC_FechaSulfatoDeZinc.addPropertyChangeListener(new PropertyChangeListener() { // from class: Historia.JPGraficasPyPTierraAlta.36
            @Override // java.beans.PropertyChangeListener
            public void propertyChange(PropertyChangeEvent evt) {
                JPGraficasPyPTierraAlta.this.JDC_FechaSulfatoDeZincPropertyChange(evt);
            }
        });
        this.JCHAplicaSulfatoDeZinc.setFont(new Font("Arial", 1, 12));
        this.JCHAplicaSulfatoDeZinc.setText("Aplica?");
        this.JCHAplicaSulfatoDeZinc.addActionListener(new ActionListener() { // from class: Historia.JPGraficasPyPTierraAlta.37
            public void actionPerformed(ActionEvent evt) {
                JPGraficasPyPTierraAlta.this.JCHAplicaSulfatoDeZincActionPerformed(evt);
            }
        });
        ...
        this.JDC_FechaVih.addPropertyChangeListener(new PropertyChangeListener() { // from class: Historia.JPGraficasPyPTierraAlta.38
            @Override // java.beans.PropertyChangeListener
            public void propertyChange(PropertyChangeEvent evt) {
                JPGraficasPyPTierraAlta.this.JDC_FechaVihPropertyChange(evt);
            }
        });
        this.JCHAplicaVih.setFont(new Font("Arial", 1, 12));
        this.JCHAplicaVih.setText("Aplica?");
        this.JCHAplicaVih.addActionListener(new ActionListener() { // from class: Historia.JPGraficasPyPTierraAlta.39
            public void actionPerformed(ActionEvent evt) {
                JPGraficasPyPTierraAlta.this.JCHAplicaVihActionPerformed(evt);
            }
        });
        ...
        this.JDC_FechaHemoglobina.addPropertyChangeListener(new PropertyChangeListener() { // from class: Historia.JPGraficasPyPTierraAlta.40
            @Override // java.beans.PropertyChangeListener
            public void propertyChange(PropertyChangeEvent evt) {
                JPGraficasPyPTierraAlta.this.JDC_FechaHemoglobinaPropertyChange(evt);
            }
        });
        this.JCHAplicaHemoglobina.setFont(new Font("Arial", 1, 12));
        this.JCHAplicaHemoglobina.setText("Aplica?");
        this.JCHAplicaHemoglobina.addActionListener(new ActionListener() { // from class: Historia.JPGraficasPyPTierraAlta.41
            public void actionPerformed(ActionEvent evt) {
                JPGraficasPyPTierraAlta.this.JCHAplicaHemoglobinaActionPerformed(evt);
            }
        });
        ...
        this.JTHistorico.addMouseListener(new MouseAdapter() { // from class: Historia.JPGraficasPyPTierraAlta.42
            public void mouseClicked(MouseEvent evt) {
                JPGraficasPyPTierraAlta.this.JTHistoricoMouseClicked(evt);
            }
        });
        ...
        this.JBGuardar.addActionListener(new ActionListener() { // from class: Historia.JPGraficasPyPTierraAlta.43
            public void actionPerformed(ActionEvent evt) {
                JPGraficasPyPTierraAlta.this.JBGuardarActionPerformed(evt);
            }
        });
        ...
        jPanel2Layout.setVerticalGroup(jPanel2Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(jPanel2Layout.createSequentialGroup().addGap(3, 3, 3).addGroup(jPanel2Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.JBGuardar, -2, 144, -2).addComponent(this.jPanel3, -2, 136, -2)).addGap(1, 1, 1).addComponent(this.jPanel4, -2, -1, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.jPanel5, -2, -1, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.jPanel6, -2, -1, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JSPHistoricoSeg, -2, 88, -2).addContainerGap(-1, 32767)));
        this.JTPCDDatos.addTab("SEGUIMIENTO", this.jPanel2);
        this.JPAOtrosDatos.setFont(new Font("Arial", 1, 12));
        this.jPanel7.setBorder(BorderFactory.createTitledBorder((Border) null, "HALLAZGO", 2, 0, new Font("Arial", 1, 12), new Color(0, 103, 0)));
        this.JTDetalle.setFont(new Font("Arial", 1, 12));
        this.JTDetalle.setModel(new DefaultTableModel((Object[][]) new Object[]{new Object[0], new Object[0], new Object[0], new Object[0]}, new String[0]));
        this.jScrollPane2.setViewportView(this.JTDetalle);
        GroupLayout jPanel7Layout = new GroupLayout(this.jPanel7);
        this.jPanel7.setLayout(jPanel7Layout);
        jPanel7Layout.setHorizontalGroup(jPanel7Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.jScrollPane2, -1, 827, 32767));
        jPanel7Layout.setVerticalGroup(jPanel7Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.jScrollPane2, -1, 566, 32767));
        this.JCHBValorDefecto.setFont(new Font("Arial", 1, 12));
        this.JCHBValorDefecto.setText("VALOR POR DEFECTO");
        this.JCHBValorDefecto.addMouseListener(new MouseAdapter() { // from class: Historia.JPGraficasPyPTierraAlta.44
            public void mouseClicked(MouseEvent evt) {
                JPGraficasPyPTierraAlta.this.JCHBValorDefectoMouseClicked(evt);
            }
        });
        GroupLayout JPAOtrosDatosLayout = new GroupLayout(this.JPAOtrosDatos);
        this.JPAOtrosDatos.setLayout(JPAOtrosDatosLayout);
        JPAOtrosDatosLayout.setHorizontalGroup(JPAOtrosDatosLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(GroupLayout.Alignment.TRAILING, JPAOtrosDatosLayout.createSequentialGroup().addGroup(JPAOtrosDatosLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.jPanel7, -1, -1, 32767).addGroup(JPAOtrosDatosLayout.createSequentialGroup().addGap(0, 0, 32767).addComponent(this.JCHBValorDefecto, -2, 198, -2))).addContainerGap()));
        JPAOtrosDatosLayout.setVerticalGroup(JPAOtrosDatosLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPAOtrosDatosLayout.createSequentialGroup().addContainerGap().addComponent(this.jPanel7, -2, -1, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JCHBValorDefecto).addContainerGap(20, 32767)));
        this.JTPCDDatos.addTab("OTROS DATOS", this.JPAOtrosDatos);
        ...
        layout.setVerticalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(layout.createSequentialGroup().addContainerGap(-1, 32767).addComponent(this.JTPCDDatos, -2, 689, -2)));
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void JCHBValorDefectoMouseClicked(MouseEvent evt) {
        if (this.JCHBValorDefecto.isSelected()) {
            for (int i = 0; i < this.JTDetalle.getRowCount(); i++) {
                if (this.modeloRevisionDelCuerpo.getValueAt(i, 3).toString().isEmpty()) {
                    this.modeloRevisionDelCuerpo.setValueAt("NORMAL", i, 3);
                }
            }
            return;
        }
        for (int i2 = 0; i2 < this.JTDetalle.getRowCount(); i2++) {
            if (this.modeloRevisionDelCuerpo.getValueAt(i2, 3).toString().equals("NORMAL")) {
                this.modeloRevisionDelCuerpo.setValueAt("", i2, 3);
            }
        }
    }
