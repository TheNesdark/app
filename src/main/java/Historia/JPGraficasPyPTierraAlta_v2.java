...
/* JADX INFO: loaded from: GenomaP.jar:Historia/JPGraficasPyPTierraAlta_v2.class */
public class JPGraficasPyPTierraAlta_v2 extends JPanel {
    ...
    public JPGraficasPyPTierraAlta_v2() {
        this.xedad = "";
        this.xEdadActual = 0;
        this.G1 = null;
        this.G2 = null;
        ...
        ResultSet xrs2Campos = this.xct.traerRs(sqLfecha_nacimientoYatencion);
        System.out.println("CONSULTA FECHA DE NACIMIENTO Y FECHA DE ATENCION : -----------------------------------------" + sqLfecha_nacimientoYatencion);
        System.out.println("---------------------------------------------------------------------------------------");
        System.out.println("CONSULTA FECHA DE NACIMIENTO Y FECHA DE ATENCION : -----------------------------------------" + xrs2Campos);
        try {
            if (xrs.next()) {
                this.xedad = xrs.getString(1);
                this.xEdadActual = Integer.parseInt(this.xmt.entregarEdadEnMeses(xrs.getString(2)));
            }
            if (xrs2Campos.next()) {
                this.xEdadActual = Integer.parseInt(this.xmt.edadEnMeses(xrs2Campos.getString(2), xrs2Campos.getString(3)));
            }
            xrs2Campos.close();
            xrs.close();
            this.xct.cerrarConexionBd();
        } catch (SQLException ex) {
            Logger.getLogger(JPGraficasPyPTierraAlta_v2.class.getName()).log(Level.SEVERE, (String) null, (Throwable) ex);
        }
    ...
    private void mCargarDatosTabla() {
        ...
        mModelo();
        this.xmt.mEstablecerTextEditor(this.JTB_Hallazgo, 1);
        this.xmt.mEstablecerTextEditor(this.JTB_Hallazgo, 2);
        if (!list.isEmpty()) {
    ...
    private void mModelo() {
        this.xmodelo1 = new DefaultTableModel(new Object[0], new String[]{"Id", "Sistema", "Descripcion", "IdDetalle", "VDefecto"}) { // from class: Historia.JPGraficasPyPTierraAlta_v2.1
    ...
    private void mCrearModeloDatos() {
        this.xmodelo = new DefaultTableModel(new Object[0], new String[]{"Fecha", "FC(r/m)", "T(°C)", "Presión", "Edad(Mes)", "Talla(cm)", "Peso(Kg)", "IMC", "Per.Cefálico", "Observación", "FR(r/m)", "Per.Brazo", "PS2"}) { // from class: Historia.JPGraficasPyPTierraAlta_v2.2
    ...
    private void guardarEvaluacionDelCuerpo() {
        ...
        for (int i = 0; i < this.JTB_Hallazgo.getRowCount(); i++) {
            ...
            d.setIdExamenFisico(Long.valueOf(Long.parseLong(this.encabezadoExamenFisico)));
    ...
    private void mCrear_ExamenFisico() {
        try {
            ...
            if (!xrsm.next()) {
                ...
                String sql2 = " UPDATE  `h_examenfisico` SET  `Id_Usuario_Programa`='" + clasesHistoriaCE.informacionAgendaMedicaDTO.getIdUsuarioPrograma() + "' , `FCardiaca`='" + this.JTFFSFc.getText() + "' , `FRespiratoria`='" + this.JTFFSFr.getText() + "' , `Temperatura`='" + this.JTFFTemperatura.getText() + "' , TArtSentadoD='" + this.JTFFPSentadoD.getValue() + "', TArtSentadoS='" + this.JTFFPSentadoS.getValue() + "', `Talla`='" + this.JTFFSTalla.getText() + "' , `Peso`='" + this.JTFFSPeso.getText() + "' , `IMC`='" + this.JTFFSIMC.getText() + "'  , `PerimetroCefalico`='" + this.JTFFSPCefalico.getText() + "', PerimetroBrazo='" + this.JTFFSPBrazo.getText() + "',  `Fecha`='" + this.xmt.formatoAMD.format(this.xmt.getFechaActual()) + "' , `UsuarioS`='" + Principal.usuarioSistemaDTO.getLogin() + "', `Ps2` = '" + this.JTFFPS2.getText() + "' WHERE Id_Atencion='" + clasesHistoriaCE.informacionAgendaMedicaDTO.getIdAtencion() + "'";
    ...
    /* JADX INFO: loaded from: GenomaP.jar:Historia/JPGraficasPyPTierraAlta_v2$Imagen.class */
    public class Imagen extends JPanel {
        private int[][] xCoordenada;
        private ConsultasMySQL xct = new ConsultasMySQL();
        private JPGraficasPyPTierraAlta_v2 xJPGraficasPyP;
        ...
        public Imagen(JPGraficasPyPTierraAlta_v2 xJPGraficasPyP, String xTitulo, String xImagen, int x, int y, int xTipoGrafica, JPanel xPanel, long xRangoX, long xRangoY, String sexo) {
            this.x = 0;
            this.y = 0;
            this.xTipoGrafica = 0;
            this.xRangoX = 0L;
                ...
                for (int j = 0; j < this.xJPGraficasPyP.JTBHistorico.getRowCount(); j++) {
                    ...
                    if (xData == 1) {
                        ...
                        try {
                            ...
                            Logger.getLogger(JPGraficasPyPTierraAlta_v2.class.getName()).log(Level.SEVERE, (String) null, (Throwable) ex2);
                        }
                    }
                }
            }
    ...
    private void initComponents() {
        ...
        this.JTPCDDatos.addChangeListener(new ChangeListener() { // from class: Historia.JPGraficasPyPTierraAlta_v2.4
            public void stateChanged(ChangeEvent evt) {
                JPGraficasPyPTierraAlta_v2.this.JTPCDDatosStateChanged(evt);
            }
        });
        ...
        this.JTFFSFc.addActionListener(new ActionListener() { // from class: Historia.JPGraficasPyPTierraAlta_v2.5
            public void actionPerformed(ActionEvent evt) {
                JPGraficasPyPTierraAlta_v2.this.JTFFSFcActionPerformed(evt);
            }
        });
        this.JTFFSFc.addFocusListener(new FocusAdapter() { // from class: Historia.JPGraficasPyPTierraAlta_v2.6
            public void focusGained(FocusEvent evt) {
                JPGraficasPyPTierraAlta_v2.this.JTFFSFcFocusGained(evt);
            }

            public void focusLost(FocusEvent evt) {
                JPGraficasPyPTierraAlta_v2.this.JTFFSFcFocusLost(evt);
            }
        });
        ...
        this.JTFFSFr.addFocusListener(new FocusAdapter() { // from class: Historia.JPGraficasPyPTierraAlta_v2.7
            public void focusGained(FocusEvent evt) {
                JPGraficasPyPTierraAlta_v2.this.JTFFSFrFocusGained(evt);
            }
        });
        ...
        this.JTFFTemperatura.addFocusListener(new FocusAdapter() { // from class: Historia.JPGraficasPyPTierraAlta_v2.8
            public void focusGained(FocusEvent evt) {
                JPGraficasPyPTierraAlta_v2.this.JTFFTemperaturaFocusGained(evt);
            }
        });
        this.JTFFTemperatura.addActionListener(new ActionListener() { // from class: Historia.JPGraficasPyPTierraAlta_v2.9
            public void actionPerformed(ActionEvent evt) {
                JPGraficasPyPTierraAlta_v2.this.JTFFTemperaturaActionPerformed(evt);
            }
        });
        ...
        this.JTFFSTalla.addActionListener(new ActionListener() { // from class: Historia.JPGraficasPyPTierraAlta_v2.10
            public void actionPerformed(ActionEvent evt) {
                JPGraficasPyPTierraAlta_v2.this.JTFFSTallaActionPerformed(evt);
            }
        });
        this.JTFFSTalla.addFocusListener(new FocusAdapter() { // from class: Historia.JPGraficasPyPTierraAlta_v2.11
            public void focusGained(FocusEvent evt) {
                JPGraficasPyPTierraAlta_v2.this.JTFFSTallaFocusGained(evt);
            }

            public void focusLost(FocusEvent evt) {
                JPGraficasPyPTierraAlta_v2.this.JTFFSTallaFocusLost(evt);
            }
        });
        ...
        this.JTFFSPeso.addFocusListener(new FocusAdapter() { // from class: Historia.JPGraficasPyPTierraAlta_v2.12
            public void focusGained(FocusEvent evt) {
                JPGraficasPyPTierraAlta_v2.this.JTFFSPesoFocusGained(evt);
            }

            public void focusLost(FocusEvent evt) {
                JPGraficasPyPTierraAlta_v2.this.JTFFSPesoFocusLost(evt);
            }
        });
        this.JTFFSPeso.addActionListener(new ActionListener() { // from class: Historia.JPGraficasPyPTierraAlta_v2.13
            public void actionPerformed(ActionEvent evt) {
                JPGraficasPyPTierraAlta_v2.this.JTFFSPesoActionPerformed(evt);
            }
        });
        ...
        this.JBTGuardar.addActionListener(new ActionListener() { // from class: Historia.JPGraficasPyPTierraAlta_v2.14
            public void actionPerformed(ActionEvent evt) {
                JPGraficasPyPTierraAlta_v2.this.JBTGuardarActionPerformed(evt);
            }
        });
        ...
        this.JTFFSPCefalico.addFocusListener(new FocusAdapter() { // from class: Historia.JPGraficasPyPTierraAlta_v2.15
            public void focusGained(FocusEvent evt) {
                JPGraficasPyPTierraAlta_v2.this.JTFFSPCefalicoFocusGained(evt);
            }

            public void focusLost(FocusEvent evt) {
                JPGraficasPyPTierraAlta_v2.this.JTFFSPCefalicoFocusLost(evt);
            }
        });
        this.JTFFSPCefalico.addActionListener(new ActionListener() { // from class: Historia.JPGraficasPyPTierraAlta_v2.16
            public void actionPerformed(ActionEvent evt) {
                JPGraficasPyPTierraAlta_v2.this.JTFFSPCefalicoActionPerformed(evt);
            }
        });
        ...
        this.JTFFPSentadoS.addActionListener(new ActionListener() { // from class: Historia.JPGraficasPyPTierraAlta_v2.17
            public void actionPerformed(ActionEvent evt) {
                JPGraficasPyPTierraAlta_v2.this.JTFFPSentadoSActionPerformed(evt);
            }
        });
        this.JTFFPSentadoS.addFocusListener(new FocusAdapter() { // from class: Historia.JPGraficasPyPTierraAlta_v2.18
            public void focusLost(FocusEvent evt) {
                JPGraficasPyPTierraAlta_v2.this.JTFFPSentadoSFocusLost(evt);
            }
        });
        ...
        this.JTFFPSentadoD.addActionListener(new ActionListener() { // from class: Historia.JPGraficasPyPTierraAlta_v2.19
            public void actionPerformed(ActionEvent evt) {
                JPGraficasPyPTierraAlta_v2.this.JTFFPSentadoDActionPerformed(evt);
            }
        });
        this.JTFFPSentadoD.addFocusListener(new FocusAdapter() { // from class: Historia.JPGraficasPyPTierraAlta_v2.20
            public void focusLost(FocusEvent evt) {
                JPGraficasPyPTierraAlta_v2.this.JTFFPSentadoDFocusLost(evt);
            }
        });
        ...
        this.JTFFSPBrazo.addActionListener(new ActionListener() { // from class: Historia.JPGraficasPyPTierraAlta_v2.21
            public void actionPerformed(ActionEvent evt) {
                JPGraficasPyPTierraAlta_v2.this.JTFFSPBrazoActionPerformed(evt);
            }
        });
        this.JTFFSPBrazo.addFocusListener(new FocusAdapter() { // from class: Historia.JPGraficasPyPTierraAlta_v2.22
            public void focusGained(FocusEvent evt) {
                JPGraficasPyPTierraAlta_v2.this.JTFFSPBrazoFocusGained(evt);
            }

            public void focusLost(FocusEvent evt) {
                JPGraficasPyPTierraAlta_v2.this.JTFFSPBrazoFocusLost(evt);
            }
        });
        ...
        this.JTFFPS2.addFocusListener(new FocusAdapter() { // from class: Historia.JPGraficasPyPTierraAlta_v2.23
            public void focusGained(FocusEvent evt) {
                JPGraficasPyPTierraAlta_v2.this.JTFFPS2FocusGained(evt);
            }
        });
        this.JTFFPS2.addActionListener(new ActionListener() { // from class: Historia.JPGraficasPyPTierraAlta_v2.24
            public void actionPerformed(ActionEvent evt) {
                JPGraficasPyPTierraAlta_v2.this.JTFFPS2ActionPerformed(evt);
            }
        });
        ...
        this.JCH_ValorporDefecto.addActionListener(new ActionListener() { // from class: Historia.JPGraficasPyPTierraAlta_v2.25
            public void actionPerformed(ActionEvent evt) {
                JPGraficasPyPTierraAlta_v2.this.JCH_ValorporDefectoActionPerformed(evt);
            }
        });
        ...
        this.JCH_EstadoInicial.addActionListener(new ActionListener() { // from class: Historia.JPGraficasPyPTierraAlta_v2.26
            public void actionPerformed(ActionEvent evt) {
                JPGraficasPyPTierraAlta_v2.this.JCH_EstadoInicialActionPerformed(evt);
            }
        });
        ...
        JPGraficaLayout.setHorizontalGroup(JPGraficaLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPGraficaLayout.createSequentialGroup().addContainerGap().addComponent(this.JTPGraficasCyD).addContainerGap()));
        JPGraficaLayout.setVerticalGroup(JPGraficaLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPGraficaLayout.createSequentialGroup().addComponent(this.JTPGraficasCyD, -1, 638, 32767).addContainerGap()));
        ...
        this.JBTGuardarObs.addActionListener(new ActionListener() { // from class: Historia.JPGraficasPyPTierraAlta_v2.27
            public void actionPerformed(ActionEvent evt) {
                JPGraficasPyPTierraAlta_v2.this.JBTGuardarObsActionPerformed(evt);
            }
        });
        ...
        jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(jPanel1Layout.createSequentialGroup().addContainerGap().addComponent(this.jScrollPane1, -2, 196, -2).addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED).addComponent(this.JBTGuardarObs).addContainerGap(394, 32767)));
        ...
        this.JDC_FechaEvento.addPropertyChangeListener(new PropertyChangeListener() { // from class: Historia.JPGraficasPyPTierraAlta_v2.28
            @Override // java.beans.PropertyChangeListener
            public void propertyChange(PropertyChangeEvent evt) {
                JPGraficasPyPTierraAlta_v2.this.JDC_FechaEventoPropertyChange(evt);
            }
        });
        ...
        this.JDC_FechaVitA.addPropertyChangeListener(new PropertyChangeListener() { // from class: Historia.JPGraficasPyPTierraAlta_v2.29
            @Override // java.beans.PropertyChangeListener
            public void propertyChange(PropertyChangeEvent evt) {
                JPGraficasPyPTierraAlta_v2.this.JDC_FechaVitAPropertyChange(evt);
            }
        });
        ...
        this.JDC_FechaHierro.addPropertyChangeListener(new PropertyChangeListener() { // from class: Historia.JPGraficasPyPTierraAlta_v2.30
            @Override // java.beans.PropertyChangeListener
            public void propertyChange(PropertyChangeEvent evt) {
                JPGraficasPyPTierraAlta_v2.this.JDC_FechaHierroPropertyChange(evt);
            }
        });
        ...
        this.JDC_FechaAntParasitario.addPropertyChangeListener(new PropertyChangeListener() { // from class: Historia.JPGraficasPyPTierraAlta_v2.31
            @Override // java.beans.PropertyChangeListener
            public void propertyChange(PropertyChangeEvent evt) {
                JPGraficasPyPTierraAlta_v2.this.JDC_FechaAntParasitarioPropertyChange(evt);
            }
        });
        ...
        this.JDC_FechaAtnOdont.addPropertyChangeListener(new PropertyChangeListener() { // from class: Historia.JPGraficasPyPTierraAlta_v2.32
            @Override // java.beans.PropertyChangeListener
            public void propertyChange(PropertyChangeEvent evt) {
                JPGraficasPyPTierraAlta_v2.this.JDC_FechaAtnOdontPropertyChange(evt);
            }
        });
        ...
        this.JDC_FechaPCita.addPropertyChangeListener(new PropertyChangeListener() { // from class: Historia.JPGraficasPyPTierraAlta_v2.33
            @Override // java.beans.PropertyChangeListener
            public void propertyChange(PropertyChangeEvent evt) {
                JPGraficasPyPTierraAlta_v2.this.JDC_FechaPCitaPropertyChange(evt);
            }
        });
        this.jCheckBox1.setFont(new Font("Arial", 1, 12));
        this.jCheckBox1.setText("Aplica?");
        this.jCheckBox1.addActionListener(new ActionListener() { // from class: Historia.JPGraficasPyPTierraAlta_v2.34
            public void actionPerformed(ActionEvent evt) {
                JPGraficasPyPTierraAlta_v2.this.jCheckBox1ActionPerformed(evt);
            }
        });
        this.jCheckBox2.setFont(new Font("Arial", 1, 12));
        this.jCheckBox2.setText("Aplica?");
        this.jCheckBox2.addActionListener(new ActionListener() { // from class: Historia.JPGraficasPyPTierraAlta_v2.35
            public void actionPerformed(ActionEvent evt) {
                JPGraficasPyPTierraAlta_v2.this.jCheckBox2ActionPerformed(evt);
            }
        });
        this.jCheckBox3.setFont(new Font("Arial", 1, 12));
        this.jCheckBox3.setText("Aplica?");
        this.jCheckBox3.addActionListener(new ActionListener() { // from class: Historia.JPGraficasPyPTierraAlta_v2.36
            public void actionPerformed(ActionEvent evt) {
                JPGraficasPyPTierraAlta_v2.this.jCheckBox3ActionPerformed(evt);
            }
        });
        this.jCheckBox4.setFont(new Font("Arial", 1, 12));
        this.jCheckBox4.setText("Aplica?");
        this.jCheckBox4.addActionListener(new ActionListener() { // from class: Historia.JPGraficasPyPTierraAlta_v2.37
            public void actionPerformed(ActionEvent evt) {
                JPGraficasPyPTierraAlta_v2.this.jCheckBox4ActionPerformed(evt);
            }
        });
        ...
        this.JDC_FechaSulfatoDeZinc.addPropertyChangeListener(new PropertyChangeListener() { // from class: Historia.JPGraficasPyPTierraAlta_v2.38
            @Override // java.beans.PropertyChangeListener
            public void propertyChange(PropertyChangeEvent evt) {
                JPGraficasPyPTierraAlta_v2.this.JDC_FechaSulfatoDeZincPropertyChange(evt);
            }
        });
        this.JCHAplicaSulfatoDeZinc.setFont(new Font("Arial", 1, 12));
        this.JCHAplicaSulfatoDeZinc.setText("Aplica?");
        this.JCHAplicaSulfatoDeZinc.addActionListener(new ActionListener() { // from class: Historia.JPGraficasPyPTierraAlta_v2.39
            public void actionPerformed(ActionEvent evt) {
                JPGraficasPyPTierraAlta_v2.this.JCHAplicaSulfatoDeZincActionPerformed(evt);
            }
        });
        ...
        this.JDC_FechaVih.addPropertyChangeListener(new PropertyChangeListener() { // from class: Historia.JPGraficasPyPTierraAlta_v2.40
            @Override // java.beans.PropertyChangeListener
            public void propertyChange(PropertyChangeEvent evt) {
                JPGraficasPyPTierraAlta_v2.this.JDC_FechaVihPropertyChange(evt);
            }
        });
        this.JCHAplicaVih.setFont(new Font("Arial", 1, 12));
        this.JCHAplicaVih.setText("Aplica?");
        this.JCHAplicaVih.addActionListener(new ActionListener() { // from class: Historia.JPGraficasPyPTierraAlta_v2.41
            public void actionPerformed(ActionEvent evt) {
                JPGraficasPyPTierraAlta_v2.this.JCHAplicaVihActionPerformed(evt);
            }
        });
        ...
        this.JDC_FechaHemoglobina.addPropertyChangeListener(new PropertyChangeListener() { // from class: Historia.JPGraficasPyPTierraAlta_v2.42
            @Override // java.beans.PropertyChangeListener
            public void propertyChange(PropertyChangeEvent evt) {
                JPGraficasPyPTierraAlta_v2.this.JDC_FechaHemoglobinaPropertyChange(evt);
            }
        });
        this.JCHAplicaHemoglobina.setFont(new Font("Arial", 1, 12));
        this.JCHAplicaHemoglobina.setText("Aplica?");
        this.JCHAplicaHemoglobina.addActionListener(new ActionListener() { // from class: Historia.JPGraficasPyPTierraAlta_v2.43
            public void actionPerformed(ActionEvent evt) {
                JPGraficasPyPTierraAlta_v2.this.JCHAplicaHemoglobinaActionPerformed(evt);
            }
        });
        ...
        this.JTHistorico.addMouseListener(new MouseAdapter() { // from class: Historia.JPGraficasPyPTierraAlta_v2.44
            public void mouseClicked(MouseEvent evt) {
                JPGraficasPyPTierraAlta_v2.this.JTHistoricoMouseClicked(evt);
            }
        });
        ...
        this.JBGuardar.addActionListener(new ActionListener() { // from class: Historia.JPGraficasPyPTierraAlta_v2.45
            public void actionPerformed(ActionEvent evt) {
                JPGraficasPyPTierraAlta_v2.this.JBGuardarActionPerformed(evt);
            }
        });
        ...
        layout.setVerticalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(layout.createSequentialGroup().addContainerGap().addComponent(this.JTPCDDatos, -2, 690, 32767).addContainerGap()));
    }
