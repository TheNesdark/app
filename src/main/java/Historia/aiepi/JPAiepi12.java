...
/* JADX INFO: loaded from: GenomaP.jar:Historia/aiepi/JPAiepi12.class */
public class JPAiepi12 extends JPanel {
    ...
    private void mCreaModelodx() {
        this.xmodeloDx = new DefaultTableModel(new Object[0], new String[]{"Id", "Nombre", "Aplica?"}) { // from class: Historia.aiepi.JPAiepi12.1
