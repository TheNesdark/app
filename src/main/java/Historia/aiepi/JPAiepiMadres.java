...
/* JADX INFO: loaded from: GenomaP.jar:Historia/aiepi/JPAiepiMadres.class */
public class JPAiepiMadres extends JPanel {
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.JSPDx1, -2, 0, 32767).addGroup(jPanel1Layout.createSequentialGroup().addComponent(this.JSPane, -2, 378, -2).addGap(0, 0, 32767)));
    ...
    private void mCreaModelo() {
        this.xmodelo = new DefaultTableModel(new Object[0], new String[]{"Id", "Pregunta", "tipo", "Respuesta"}) { // from class: Historia.aiepi.JPAiepiMadres.1
    ...
    private void mllenaModelo() {
        ...
        try {
            ...
            Logger.getLogger(JPAiepiMadres.class.getName()).log(Level.SEVERE, (String) null, (Throwable) ex);
        }
    }

    /* JADX WARN: Type inference failed for: r4v1, types: [java.lang.Object[], java.lang.Object[][]] */
    private void mCreaModeloBloque2() {
        this.xmodelo2 = new DefaultTableModel(new Object[0], new String[]{"Id", "Pregunta", "tipo", "Respuesta"}) { // from class: Historia.aiepi.JPAiepiMadres.2
            public boolean isCellEditable(int row, int column) {
                if (column == 3) {
                    return true;
                }
    ...
    private void mCreaModeloDx1() {
        this.xmodeloDx1 = new DefaultTableModel(new Object[0], new String[]{"Id", "Dx", "Aplica?"}) { // from class: Historia.aiepi.JPAiepiMadres.3
    ...
    private void mCreaModeloDx2() {
        this.xmodeloDx2 = new DefaultTableModel(new Object[0], new String[]{"Id", "Dx", "Aplica?"}) { // from class: Historia.aiepi.JPAiepiMadres.4
            Class[] types = {Integer.class, String.class, Boolean.class};
            boolean[] canEdit = {false, false, true};
