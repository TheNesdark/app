...
/* JADX INFO: loaded from: GenomaP.jar:Historia/RadioButtonEditor2.class */
class RadioButtonEditor2 extends DefaultCellEditor implements ItemListener {
    public JRadioButton btn;

    public RadioButtonEditor2(JCheckBox checkBox, String xNombre) {
        super(checkBox);
        ...
        this.btn.addActionListener(new ActionListener() { // from class: Historia.RadioButtonEditor2.1
            public void actionPerformed(ActionEvent e) {
                if (RadioButtonEditor2.this.btn.getName().equals("0")) {
                }
            }
        });
    }
