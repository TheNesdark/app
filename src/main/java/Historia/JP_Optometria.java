...
/* JADX INFO: loaded from: GenomaP.jar:Historia/JP_Optometria.class */
public class JP_Optometria extends JPanel {
    ...
    private JComboBox JCBEsteropsis;
    ...
    public JP_Optometria(clasesHistoriaCE xclase) {
        this.xoptometria = "";
        this.id = "";
        initComponents();
        mCrearTabla();
    ...
    private void initComponents() {
        ...
        this.JCBEsteropsis = new JComboBox();
        ...
        this.jRadioButton1.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.1
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.jRadioButton1ActionPerformed(evt);
            }
        });
        this.jRadioButton2.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.2
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.jRadioButton2ActionPerformed(evt);
            }
        });
        this.jRadioButton3.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.3
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.jRadioButton3ActionPerformed(evt);
            }
        });
        this.jRadioButton4.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.4
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.jRadioButton4ActionPerformed(evt);
            }
        });
        ...
        this.jRadioButton9.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.5
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.jRadioButton9ActionPerformed(evt);
            }
        });
        this.jRadioButton10.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.6
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.jRadioButton10ActionPerformed(evt);
            }
        });
        this.jRadioButton11.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.7
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.jRadioButton11ActionPerformed(evt);
            }
        });
        this.jRadioButton12.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.8
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.jRadioButton12ActionPerformed(evt);
            }
        });
        ...
        this.JCBEsteropsis.setFont(new Font("Arial", 1, 12));
        this.JCBEsteropsis.setModel(new DefaultComboBoxModel(new String[]{"40°", "60°", "80°", "100°", "150°", "200°", "400°", "Sin Estereopsis"}));
        this.JCBEsteropsis.setToolTipText("APTO: Sin enfermedad aparente o hallazgos relevantes \nAPTO CON RESTRICCIÓN:Se identifica un hallazgo  o condición que requiere restricion para una tarea o actividad especifica \nAPLAZADO: Se requiere nueva valoración o ayuda diagnostica, antes de emitir concepto ocupacional.\nRECOMENDADO:Posee algún hallazgo o condición que limita su capacidad laboral y por lo tanto no se recomienda en esa labor, para proteger su salud");
        this.JCBEsteropsis.setBorder(BorderFactory.createTitledBorder((Border) null, "Estereopsis", 0, 0, new Font("Arial", 1, 12), Color.blue));
        this.JSPCEspecifico.setBorder(BorderFactory.createTitledBorder((Border) null, "Vision Cromatica", 2, 0, new Font("Arial", 1, 14), new Color(255, 0, 0)));
        this.JTDetalle.setFont(new Font("Arial", 1, 12));
        this.JTDetalle.setModel(new DefaultTableModel((Object[][]) new Object[0], new String[0]));
        this.JTDetalle.setCursor(new Cursor(0));
        this.JTDetalle.setRowHeight(25);
        this.JTDetalle.setSelectionBackground(new Color(255, 255, 255));
        this.JTDetalle.setSelectionForeground(new Color(255, 0, 0));
        this.JTDetalle.setSelectionMode(0);
        this.JTDetalle.addMouseListener(new MouseAdapter() { // from class: Historia.JP_Optometria.9
            public void mouseClicked(MouseEvent evt) {
                JP_Optometria.this.JTDetalleMouseClicked(evt);
            }
        });
        this.JSPCEspecifico.setViewportView(this.JTDetalle);
        GroupLayout JPSintomas2Layout = new GroupLayout(this.JPSintomas2);
        this.JPSintomas2.setLayout(JPSintomas2Layout);
        JPSintomas2Layout.setHorizontalGroup(JPSintomas2Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPSintomas2Layout.createSequentialGroup().addContainerGap().addGroup(JPSintomas2Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.JPVisionProxima4, -2, -1, -2).addComponent(this.JCBEsteropsis, -2, 152, -2)).addGap(8, 8, 8).addGroup(JPSintomas2Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPSintomas2Layout.createSequentialGroup().addComponent(this.JPVisionProxima3, -2, -1, -2).addGap(18, 18, 18).addComponent(this.JPVisionProxima6, -2, -1, -2).addGap(18, 18, 18).addComponent(this.jScrollPane3)).addComponent(this.JSPCEspecifico)).addContainerGap()));
        JPSintomas2Layout.setVerticalGroup(JPSintomas2Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPSintomas2Layout.createSequentialGroup().addGap(11, 11, 11).addGroup(JPSintomas2Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPSintomas2Layout.createSequentialGroup().addComponent(this.JPVisionProxima4, -2, -1, -2).addGap(31, 31, 31).addComponent(this.JCBEsteropsis, -2, -1, -2)).addGroup(JPSintomas2Layout.createSequentialGroup().addGroup(JPSintomas2Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.jScrollPane3, -2, 86, -2).addComponent(this.JPVisionProxima3, -2, -1, -2).addComponent(this.JPVisionProxima6, -2, -1, -2)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JSPCEspecifico, -2, 98, -2))).addContainerGap(11, 32767)));
        ...
        this.JCPterigio.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.24
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.JCPterigioActionPerformed(evt);
            }
        });
        this.JCNistagmus.setFont(new Font("Arial", 1, 11));
        this.JCNistagmus.setText("Nistagmus");
        this.JCNistagmus.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.25
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.JCNistagmusActionPerformed(evt);
            }
        });
        this.JhIPEREMIA.setFont(new Font("Arial", 1, 11));
        this.JhIPEREMIA.setText("Hiperemia");
        this.JhIPEREMIA.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.26
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.JhIPEREMIAActionPerformed(evt);
            }
        });
        this.JCPinguecula.setFont(new Font("Arial", 1, 11));
        this.JCPinguecula.setText("Pinguecula");
        this.JCPinguecula.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.27
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.JCPingueculaActionPerformed(evt);
            }
        });
        this.JCPtosis.setFont(new Font("Arial", 1, 11));
        this.JCPtosis.setText("Ptosis");
        this.JCPtosis.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.28
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.JCPtosisActionPerformed(evt);
            }
        });
        this.JSecrecion.setFont(new Font("Arial", 1, 11));
        this.JSecrecion.setText("Secreción ");
        this.JSecrecion.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.29
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.JSecrecionActionPerformed(evt);
            }
        });
        this.JOtros.setFont(new Font("Arial", 1, 11));
        this.JOtros.setText("Otros");
        this.JOtros.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.30
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.JOtrosActionPerformed(evt);
            }
        });
        ...
        this.JRBSiPrescipcion.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.31
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.JRBSiPrescipcionActionPerformed(evt);
            }
        });
        ...
        this.JRBNoPrescipcion.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.32
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.JRBNoPrescipcionActionPerformed(evt);
            }
        });
        ...
        this.JCHLO.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.33
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.JCHLOActionPerformed(evt);
            }
        });
        this.JCHLC.setFont(new Font("Arial", 1, 11));
        this.JCHLC.setText("LC");
        this.JCHLC.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.34
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.JCHLCActionPerformed(evt);
            }
        });
        ...
        this.JRBPermanente.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.35
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.JRBPermanenteActionPerformed(evt);
            }
        });
        ...
        this.JRBEsporadico.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.36
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.JRBEsporadicoActionPerformed(evt);
            }
        });
        this.JBGTipoVision.add(this.JCHVL);
        this.JCHVL.setFont(new Font("Arial", 1, 11));
        this.JCHVL.setText("VL");
        this.JCHVL.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.37
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.JCHVLActionPerformed(evt);
            }
        });
        this.JBGTipoVision.add(this.JCHVP);
        this.JCHVP.setFont(new Font("Arial", 1, 11));
        this.JCHVP.setText("VP");
        this.JCHVP.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.38
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.JCHVPActionPerformed(evt);
            }
        });
        ...
        this.JRBDGTLNinguno.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.39
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.JRBDGTLNingunoActionPerformed(evt);
            }
        });
        ...
        this.JRBDGTLProgresivo.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.40
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.JRBDGTLProgresivoActionPerformed(evt);
            }
        });
        ...
        this.JRBDGTLBifocales.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.41
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.JRBDGTLBifocalesActionPerformed(evt);
            }
        });
        ...
        this.JRBDGTLMonofocales.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.42
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.JRBDGTLMonofocalesActionPerformed(evt);
            }
        });
        ...
        this.JRBSiRxSeguridad.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.43
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.JRBSiRxSeguridadActionPerformed(evt);
            }
        });
        ...
        this.JRBNoRxSeguridad.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.44
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.JRBNoRxSeguridadActionPerformed(evt);
            }
        });
        ...
        this.JRBDGTLNingunoRx.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.45
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.JRBDGTLNingunoRxActionPerformed(evt);
            }
        });
        ...
        this.JRBDGTLProgresivoRx.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.46
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.JRBDGTLProgresivoRxActionPerformed(evt);
            }
        });
        ...
        this.JRBDGTLBifocalesRx.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.47
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.JRBDGTLBifocalesRxActionPerformed(evt);
            }
        });
        ...
        this.JRBDGTLMonofocalesRx.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.48
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.JRBDGTLMonofocalesRxActionPerformed(evt);
            }
        });
        ...
        this.JTFOICilindro.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.49
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.JTFOICilindroActionPerformed(evt);
            }
        });
        ...
        this.JRBUV.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.50
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.JRBUVActionPerformed(evt);
            }
        });
        this.JBGTipoFiltro.add(this.JRBGrado);
        this.JRBGrado.setFont(new Font("Arial", 1, 11));
        this.JRBGrado.setText("Grado Sol");
        this.JRBGrado.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.51
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.JRBGradoActionPerformed(evt);
            }
        });
        ...
        this.JRBTransicion.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.52
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.JRBTransicionActionPerformed(evt);
            }
        });
        ...
        this.JRBNinguno.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.53
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.JRBNingunoActionPerformed(evt);
            }
        });
        ...
        this.JRBUVRx.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.54
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.JRBUVRxActionPerformed(evt);
            }
        });
        this.JBGTipoFiltroRx.add(this.JRBGradoRx);
        this.JRBGradoRx.setFont(new Font("Arial", 1, 11));
        this.JRBGradoRx.setText("Grado Sol");
        this.JRBGradoRx.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.55
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.JRBGradoRxActionPerformed(evt);
            }
        });
        ...
        this.JRBSTransicionRx.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.56
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.JRBSTransicionRxActionPerformed(evt);
            }
        });
        ...
        this.JRBNingunoRx.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.57
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.JRBNingunoRxActionPerformed(evt);
            }
        });
        ...
        this.JTFODSCVL.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.58
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.JTFODSCVLActionPerformed(evt);
            }
        });
        ...
        this.JTFOIPersonalVL.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.59
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.JTFOIPersonalVLActionPerformed(evt);
            }
        });
        ...
        this.JTFOAPersonalVL.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.60
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.JTFOAPersonalVLActionPerformed(evt);
            }
        });
        GroupLayout JPVisionlejanaLayout = new GroupLayout(this.JPVisionlejana);
        this.JPVisionlejana.setLayout(JPVisionlejanaLayout);
        JPVisionlejanaLayout.setHorizontalGroup(JPVisionlejanaLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPVisionlejanaLayout.createSequentialGroup().addGap(5, 5, 5).addGroup(JPVisionlejanaLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPVisionlejanaLayout.createSequentialGroup().addComponent(this.jLabel25, -2, 33, -2).addGap(6, 6, 6).addComponent(this.JTFOASCVL, -2, 84, -2).addGap(5, 5, 5).addComponent(this.JTFOAPersonalVL, -2, 84, -2)).addGroup(JPVisionlejanaLayout.createSequentialGroup().addGroup(JPVisionlejanaLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.jLabel23, -2, 33, -2).addComponent(this.jLabel24, GroupLayout.Alignment.TRAILING, -2, 33, -2)).addGap(6, 6, 6).addGroup(JPVisionlejanaLayout.createParallelGroup(GroupLayout.Alignment.LEADING, false).addComponent(this.JTFODSCVL, -2, 84, -2).addComponent(this.JTFOISCVL, -2, 84, -2).addComponent(this.jLabel19, -1, -1, 32767)).addGap(5, 5, 5).addGroup(JPVisionlejanaLayout.createParallelGroup(GroupLayout.Alignment.LEADING, false).addComponent(this.JTFODPersonalVL, -2, 84, -2).addComponent(this.jLabel20, -1, -1, 32767).addComponent(this.JTFOIPersonalVL, -2, 84, -2)))).addContainerGap(-1, 32767)));
        JPVisionlejanaLayout.setVerticalGroup(JPVisionlejanaLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPVisionlejanaLayout.createSequentialGroup().addGroup(JPVisionlejanaLayout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(this.jLabel19).addComponent(this.jLabel20)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(JPVisionlejanaLayout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(this.JTFODSCVL, -2, -1, -2).addComponent(this.JTFODPersonalVL, -2, -1, -2).addComponent(this.jLabel23)).addGap(5, 5, 5).addGroup(JPVisionlejanaLayout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(this.JTFOISCVL, -2, -1, -2).addComponent(this.JTFOIPersonalVL, -2, -1, -2).addComponent(this.jLabel24)).addGap(5, 5, 5).addGroup(JPVisionlejanaLayout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(this.JTFOASCVL, -2, -1, -2).addComponent(this.JTFOAPersonalVL, -2, -1, -2).addComponent(this.jLabel25))));
        ...
        this.JTFOIPersonalVP.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.61
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.JTFOIPersonalVPActionPerformed(evt);
            }
        });
        ...
        this.JTFOAPersonalVP.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.62
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.JTFOAPersonalVPActionPerformed(evt);
            }
        });
        ...
        JPVisionProximaLayout.setHorizontalGroup(JPVisionProximaLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPVisionProximaLayout.createSequentialGroup().addGap(5, 5, 5).addGroup(JPVisionProximaLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPVisionProximaLayout.createSequentialGroup().addGroup(JPVisionProximaLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.jLabel28, -2, 33, -2).addComponent(this.jLabel29, GroupLayout.Alignment.TRAILING, -2, 33, -2)).addGap(6, 6, 6).addGroup(JPVisionProximaLayout.createParallelGroup(GroupLayout.Alignment.LEADING, false).addComponent(this.JTFODSCVP, -2, 84, -2).addComponent(this.JTFOISCVP, -2, 84, -2).addComponent(this.jLabel22, -1, -1, 32767)).addGap(5, 5, 5).addGroup(JPVisionProximaLayout.createParallelGroup(GroupLayout.Alignment.LEADING, false).addComponent(this.JTFOIPersonalVP, -2, 84, -2).addComponent(this.JTFODPersonalVP, -2, 84, -2).addComponent(this.jLabel26, -1, -1, 32767))).addGroup(JPVisionProximaLayout.createSequentialGroup().addComponent(this.jLabel30, -2, 33, -2).addGap(6, 6, 6).addComponent(this.JTFOASCVP, -2, 84, -2).addGap(5, 5, 5).addComponent(this.JTFOAPersonalVP, -2, 84, -2))).addContainerGap(-1, 32767)));
        JPVisionProximaLayout.setVerticalGroup(JPVisionProximaLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPVisionProximaLayout.createSequentialGroup().addGroup(JPVisionProximaLayout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(this.jLabel22).addComponent(this.jLabel26)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(JPVisionProximaLayout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(this.JTFODSCVP, -2, -1, -2).addComponent(this.JTFODPersonalVP, -2, -1, -2).addComponent(this.jLabel28)).addGap(5, 5, 5).addGroup(JPVisionProximaLayout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(this.JTFOISCVP, -2, -1, -2).addComponent(this.JTFOIPersonalVP, -2, -1, -2).addComponent(this.jLabel29)).addGap(5, 5, 5).addGroup(JPVisionProximaLayout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(this.JTFOASCVP, -2, -1, -2).addComponent(this.JTFOAPersonalVP, -2, -1, -2).addComponent(this.jLabel30))));
        ...
        JPAgudezaVisualLayout.setHorizontalGroup(JPAgudezaVisualLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPAgudezaVisualLayout.createSequentialGroup().addComponent(this.JPVisionlejana, -2, -1, -2).addGap(30, 30, 30).addComponent(this.JPVisionProxima, -2, -1, -2).addGap(0, 313, 32767)));
        ...
        JPDatosLayout.setVerticalGroup(JPDatosLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPDatosLayout.createSequentialGroup().addContainerGap().addComponent(this.jPanel1, -2, 484, -2).addGap(10, 10, 10)));
        ...
        this.JTFOIEsferaRet.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.63
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.JTFOIEsferaRetActionPerformed(evt);
            }
        });
        ...
        this.JTFOICilindroRet.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.64
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.JTFOICilindroRetActionPerformed(evt);
            }
        });
        ...
        this.JTFOIEjeRet.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.65
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.JTFOIEjeRetActionPerformed(evt);
            }
        });
        ...
        this.JTFOICilindroRxFinal.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.66
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.JTFOICilindroRxFinalActionPerformed(evt);
            }
        });
        ...
        this.JTFOICilindroRxFinalVP.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.67
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.JTFOICilindroRxFinalVPActionPerformed(evt);
            }
        });
        ...
        this.JTFOIEsferaSub.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.68
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.JTFOIEsferaSubActionPerformed(evt);
            }
        });
        ...
        this.JTFOICilindroSub.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.69
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.JTFOICilindroSubActionPerformed(evt);
            }
        });
        ...
        this.JTFOIEjeSub.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.70
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.JTFOIEjeSubActionPerformed(evt);
            }
        });
        ...
        this.JRBSiCorrecionOpt.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.71
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.JRBSiCorrecionOptActionPerformed(evt);
            }
        });
        ...
        this.JRBNoCorrecionOpt.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.72
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.JRBNoCorrecionOptActionPerformed(evt);
            }
        });
        this.JCHLOftalmico.setFont(new Font("Arial", 1, 11));
        this.JCHLOftalmico.setText("Lente oftálmico");
        this.JCHLOftalmico.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.73
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.JCHLOftalmicoActionPerformed(evt);
            }
        });
        this.JCHLCotacto.setFont(new Font("Arial", 1, 11));
        this.JCHLCotacto.setText("Lente de contacto");
        this.JCHLCotacto.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.74
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.JCHLCotactoActionPerformed(evt);
            }
        });
        ...
        this.JRBSiElementos.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.75
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.JRBSiElementosActionPerformed(evt);
            }
        });
        ...
        this.JRBNoElementos.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.76
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.JRBNoElementosActionPerformed(evt);
            }
        });
        ...
        this.JRBDGTLNingunoConducta.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.77
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.JRBDGTLNingunoConductaActionPerformed(evt);
            }
        });
        ...
        this.JRBDGTLProgresivoConducta.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.78
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.JRBDGTLProgresivoConductaActionPerformed(evt);
            }
        });
        ...
        this.JRBDGTLBifocalesConducta.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.79
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.JRBDGTLBifocalesConductaActionPerformed(evt);
            }
        });
        ...
        this.JRBDGTLMonofocalesConducta.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.80
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.JRBDGTLMonofocalesConductaActionPerformed(evt);
            }
        });
        ...
        this.JRBUVConducta.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.81
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.JRBUVConductaActionPerformed(evt);
            }
        });
        ...
        this.JRBGradoConducta.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.82
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.JRBGradoConductaActionPerformed(evt);
            }
        });
        ...
        this.JRBSTransicionConducta.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.83
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.JRBSTransicionConductaActionPerformed(evt);
            }
        });
        ...
        this.JRBNingunoConducta.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.84
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.JRBNingunoConductaActionPerformed(evt);
            }
        });
        ...
        this.JBGuardar.addActionListener(new ActionListener() { // from class: Historia.JP_Optometria.85
            public void actionPerformed(ActionEvent evt) {
                JP_Optometria.this.JBGuardarActionPerformed(evt);
            }
        });
    ...
    public void mGrababarPdfOptometria() {
        if (Principal.informacionIps.getNombreIps().equals("BIEN ESTAR SALUD BS S.A.S.")) {
            ...
            this.xmetodo.GenerarPdfOptometriaBienestar(this.xmetodo.getRutaRep() + "SO2_HistoriaClinica_Optometria_Bienestar12", mparametros, String.valueOf(clasesHistoriaCE.informacionAgendaMedicaDTO.getIdIngreso()), true);
        }
    }
    ...
    public void mImprimir(String idAtencion) {
        ...
        if (Principal.informacionIps.getNombreIps().equals("IPS SU SALUD INTEGRAL S.A.S")) {
            ...
            this.xmetodo.GenerarPDF(this.xmetodo.getRutaRep() + "SO2_HistoriaClinica_Optometria_Bienestar12", mparametros);
        } else {
            if (Principal.informacionIps.getNombreIps().equals("BIEN ESTAR SALUD BS S.A.S.")) {
                mparametros[0][0] = "idatencion1";
                mparametros[0][1] = idAtencion;
                System.out.println(":::::: GENERANDO PDF BIENESTAR SALUD (SOLO VISTA)");
                this.xmetodo.GenerarPdfOptometriaBienestar(this.xmetodo.getRutaRep() + "SO2_HistoriaClinica_Optometria_Bienestar12", mparametros, String.valueOf(clasesHistoriaCE.informacionAgendaMedicaDTO.getIdIngreso()), false);
                return;
            }
            this.xmetodo.GenerarPDF(this.xmetodo.getRutaRep() + "SO2_HistoriaClinica_Optometria_Bienestar11", mparametros);
        }
    }
    ...
    private void mCrearTabla() {
        this.xmodelo = new DefaultTableModel(new Object[0], new String[]{"visión", "Accion ", "Observacion"}) { // from class: Historia.JP_Optometria.86
        ...
        this.xmodelo.addRow(new Object[]{"1"});
        this.xmodelo.addRow(new Object[]{"2"});
        this.xmodelo.addRow(new Object[]{"3"});
        this.xmodelo.addRow(new Object[]{"4"});
        this.xmodelo.addRow(new Object[]{"5"});
        this.xmodelo.addRow(new Object[]{"6"});
        this.xmodelo.addRow(new Object[]{"7"});
        this.xmodelo.addRow(new Object[]{"8"});
        this.xmodelo.addRow(new Object[]{"9"});
        this.xmodelo.addRow(new Object[]{"10"});
        this.xmodelo.addRow(new Object[]{"11"});
        this.xmodelo.addRow(new Object[]{"12"});
        this.xmodelo.addRow(new Object[]{"13"});
        this.xmodelo.addRow(new Object[]{"14"});
        this.xmodelo.addRow(new Object[]{"15"});
    }
    ...
    private void grabarOtros() {
        ...
        this.xsql = "INSERT INTO h_so_optometria_otros  (id_optometria,`Oftalmoscopia OD`  ,`Oftalmoscopia OI`  ,Hallazgos  ,`Queratometro OD`  ,`Queratometro OI` ,\n`Test Estereopsis` ,`Campo Visual OD` ,`Campo Visual OI`)\nVALUES(" + this.xoptometria + "," + this.xoftalmoscopiaOD + "," + this.xoftalmoscopiaOI + ",'" + this.JTHallazgos.getText() + "'," + this.JTQueratometroOD.getText() + "," + this.JTQueratometroOI.getText() + ",'" + this.JCBEsteropsis.getSelectedItem().toString() + "'," + this.xcampovisialOD + "," + this.xcampovisialOI + ")";
        System.out.println(this.xsql);
        this.xct.ejecutarSQL(this.xsql);
        this.xct.cerrarConexionBd();
    ...
    private void grabarOtrosObservacion() {
        for (int i = 0; i < this.JTDetalle.getRowCount(); i++) {
            if (this.xmodelo.getValueAt(i, 1) != null && this.xmodelo.getValueAt(i, 1).toString().equals("true")) {
                String str = "INSERT INTO h_so_optometria_vision_cromatica  (id_optometria,nivel_vision,observacion)\nVALUES(" + this.xoptometria + "," + Long.valueOf(this.xmodelo.getValueAt(i, 0).toString()) + ",'" + this.xmodelo.getValueAt(i, 2) + "')";
                this.xsql = str;
                this.xsql = str;
                System.out.println(this.xsql);
                System.out.println("Guardo en observacion");
    ...
    private void actualzarotros() {
        ...
        this.xsql = "UPDATE h_so_optometria_otros SET `Oftalmoscopia OD`=" + this.xoftalmoscopiaOD + ", `Oftalmoscopia OI`=" + this.xoftalmoscopiaOI + ", Hallazgos='" + this.JTHallazgos.getText() + "', `Queratometro OD`=" + this.JTQueratometroOD.getText() + " , `Queratometro OI`=" + this.JTQueratometroOI.getText() + ",`Test Estereopsis`='" + this.JCBEsteropsis.getSelectedItem().toString() + "' \n                 , `Campo Visual OD`=" + this.xcampovisialOD + " , `Campo Visual OI`=" + this.xcampovisialOI + " WHERE (id_optometria=" + this.xoptometria + ")";
        System.out.println(this.xsql1);
        this.xct.ejecutarSQL(this.xsql);
    }

    private void actualzarotrosObservacion() {
        for (int i = 0; i < this.JTDetalle.getRowCount(); i++) {
            if (this.xmodelo.getValueAt(i, 1) != null && this.xmodelo.getValueAt(i, 1).toString().equals("true")) {
                this.xsql = "UPDATE h_so_optometria_vision_cromatica SET  observacion='" + this.xmodelo.getValueAt(i, 2) + "'  WHERE (id_optometria=" + this.xoptometria + ")";
                System.out.println(this.xsql1);
                System.out.println("si actualizo en observacion");
                this.xct.ejecutarSQL(this.xsql);
            }
        }
    }
    ...
    private void buscarSintomas() {
        try {
            ...
            Logger.getLogger(JP_Optometria.class.getName()).log(Level.SEVERE, (String) null, (Throwable) ex);
        }
    }
    ...
    private void buscarotros() {
        try {
            ...
            if (xrs.next()) {
                ...
                if (xrs.getString("Test Estereopsis") != null) {
                    this.JCBEsteropsis.setSelectedItem(xrs.getString("Test Estereopsis").toString());
                }
            }
            xrs.close();
            this.xct.cerrarConexionBd();
    ...
    private void buscarOtrosobservacion() {
        try {
            this.xsql = "SELECT nivel_vision,observacion FROM h_so_optometria_vision_cromatica WHERE id_optometria=" + this.xoptometria + "";
            System.out.println("Datos " + this.xsql);
            ResultSet xrs = this.xct.traerRs(this.xsql);
            if (xrs.next()) {
                xrs.beforeFirst();
                int n = 0;
                while (xrs.next()) {
                    this.xmodelo.addRow(this.xdatos2);
                    this.xmodelo.setValueAt(Long.valueOf(xrs.getLong(1)), n, 0);
                    this.xmodelo.setValueAt(true, n, 1);
