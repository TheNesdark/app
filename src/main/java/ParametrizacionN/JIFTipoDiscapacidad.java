...
/* JADX INFO: loaded from: GenomaP.jar:ParametrizacionN/JIFTipoDiscapacidad.class */
public class JIFTipoDiscapacidad extends JInternalFrame {
    private GTipoDiscapacidad gTipoDiscapacidad;
    private final IGTipoDiscapacidadService iGTipoDiscapacidadService;
    private List<GTipoDiscapacidad> listarGTipoDiscapacidad;
    ...
    public JIFTipoDiscapacidad() {
        initComponents();
        this.gTipoDiscapacidad = new GTipoDiscapacidad();
        this.iGTipoDiscapacidadService = (IGTipoDiscapacidadService) Principal.contexto.getBean(IGTipoDiscapacidadService.class);
        this.listarGTipoDiscapacidad = new ArrayList();
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("TIPO DISCAPACIDAD");
        setFrameIcon(new ImageIcon(getClass().getResource("/Imagenes/genomap.png")));
        setName("jiftipodiscapacidad");
        try {
            setSelected(true);
        ...
        this.JTFCodigo.addKeyListener(new KeyAdapter() { // from class: ParametrizacionN.JIFTipoDiscapacidad.1
            public void keyTyped(KeyEvent evt) {
                JIFTipoDiscapacidad.this.JTFCodigoKeyTyped(evt);
            }
        });
        this.JCHEstado.setFont(new Font("Arial", 1, 12));
        this.JCHEstado.setSelected(true);
        this.JCHEstado.setText("Estado");
        this.JCHEstado.addActionListener(new ActionListener() { // from class: ParametrizacionN.JIFTipoDiscapacidad.2
            public void actionPerformed(ActionEvent evt) {
                JIFTipoDiscapacidad.this.JCHEstadoActionPerformed(evt);
            }
        });
        ...
        this.JTable.addMouseListener(new MouseAdapter() { // from class: ParametrizacionN.JIFTipoDiscapacidad.3
            public void mouseClicked(MouseEvent evt) {
                JIFTipoDiscapacidad.this.JTableMouseClicked(evt);
            }
        });
    ...
    private void crearModeloDatos() {
        this.modelo = new DefaultTableModel(new Object[0], new String[]{"CODIGO", "DISCAPACIDAD", "ESTADO"}) { // from class: ParametrizacionN.JIFTipoDiscapacidad.4
    ...
    private void cargarDatosTabla() {
        crearModeloDatos();
        this.listarGTipoDiscapacidad = this.iGTipoDiscapacidadService.listarGTipoDiscapacidad();
        this.listarGTipoDiscapacidad.forEach(e -> {
            this.modelo.addRow(this.datos);
            this.modelo.setValueAt(e.getCodigo(), this.JTable.getRowCount() - 1, 0);
            this.modelo.setValueAt(e.getNombre(), this.JTable.getRowCount() - 1, 1);
    ...
    public void grabar() {
        if (!this.JTFCodigo.getText().isEmpty() || !this.JTFNombre.getText().isEmpty()) {
            this.gTipoDiscapacidad.setCodigo(this.JTFCodigo.getText());
            this.gTipoDiscapacidad.setNombre(this.JTFNombre.getText());
            this.gTipoDiscapacidad.setEstado(Boolean.valueOf(this.JCHEstado.isSelected()));
            String id = Principal.usuarioSistemaDTO.getIdUsuarioSistema().toString();
            this.gTipoDiscapacidad.setIdUsuario(Integer.valueOf(id));
            this.iGTipoDiscapacidadService.grabar(this.gTipoDiscapacidad);
    ...
    private void selecionarFila() {
        if (this.JTable.getSelectedRow() != -1) {
            this.gTipoDiscapacidad = this.listarGTipoDiscapacidad.get(this.JTable.getSelectedRow());
            Principal.txtNo.setText(this.gTipoDiscapacidad.getId().toString());
            ...
            this.JCHEstado.setSelected(this.listarGTipoDiscapacidad.get(this.JTable.getSelectedRow()).getEstado().booleanValue());
        }
    }
}
