...
import com.genoma.plus.controller.parametrizacion.JDEmpresaMisionBienestar;
...
/* JADX INFO: loaded from: GenomaP.jar:ParametrizacionN/JIFFEmpresaBienestarSalud.class */
public class JIFFEmpresaBienestarSalud extends JInternalFrame {
    ...
    private DefaultTableModel xmodeloCargosBS1;
    private Object[] xdato;
    private Object[] xdatoCargos;
    public int xidpersona;
    public Persona xjppersona;
    private int xtipo;
    private JDEmpresaMisionBienestar dEmpresaMision;
    ...
    private JScrollPane JSPDCargosEmpresaBS1;
    ...
    private JTable JTBCargosEmpresaBS1;
    ...
    private JFormattedTextField JTFFNombreCargoBS1;
    ...
    private String uuidEmpresaConvenioEditar = "";

    public JIFFEmpresaBienestarSalud(String xname, int xtipo, String xtitulo) {
        this.xtipo = 0;
        initComponents();
        setName(xname);
        ...
        mNuevo();
        cargarAseguradoras();
        mCrearModeloCargosBS1();
    }

    /* JADX WARN: Type inference failed for: r3v326, types: [java.lang.Object[], java.lang.Object[][]] */
    /* JADX WARN: Type inference failed for: r3v446, types: [java.lang.Object[], java.lang.Object[][]] */
    /* JADX WARN: Type inference failed for: r3v456, types: [java.lang.Object[], java.lang.Object[][]] */
    ...
    private void initComponents() {
        ...
        this.JSPDCargosEmpresaBS1 = new JScrollPane();
        this.JTBCargosEmpresaBS1 = new JTable();
        this.JTFFNombreCargoBS1 = new JFormattedTextField();
        ...
        setMaximumSize(null);
        setMinimumSize(null);
        setName("jifconfempresabienestar");
        setNormalBounds(null);
        addInternalFrameListener(new InternalFrameListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.1
            ...
            public void internalFrameClosing(InternalFrameEvent evt) {
                JIFFEmpresaBienestarSalud.this.formInternalFrameClosing(evt);
            }
        ...
        this.JTPDatosB.addChangeListener(new ChangeListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.2
            public void stateChanged(ChangeEvent evt) {
                JIFFEmpresaBienestarSalud.this.JTPDatosBStateChanged(evt);
            }
        });
        ...
        this.JBTImpuesto.addActionListener(new ActionListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.3
            public void actionPerformed(ActionEvent evt) {
                JIFFEmpresaBienestarSalud.this.JBTImpuestoActionPerformed(evt);
            }
        });
        ...
        this.JBTCuentas.addActionListener(new ActionListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.4
            public void actionPerformed(ActionEvent evt) {
                JIFFEmpresaBienestarSalud.this.JBTCuentasActionPerformed(evt);
            }
        });
        ...
        this.JBTTipoEmpresa.addActionListener(new ActionListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.5
            public void actionPerformed(ActionEvent evt) {
                JIFFEmpresaBienestarSalud.this.JBTTipoEmpresaActionPerformed(evt);
            }
        });
        ...
        this.JBTCPagarPuc.addActionListener(new ActionListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.6
            public void actionPerformed(ActionEvent evt) {
                JIFFEmpresaBienestarSalud.this.JBTCPagarPucActionPerformed(evt);
            }
        });
        ...
        this.JBTContrato.addActionListener(new ActionListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.7
            public void actionPerformed(ActionEvent evt) {
                JIFFEmpresaBienestarSalud.this.JBTContratoActionPerformed(evt);
            }
        });
        ...
        this.JBTUnidadFunc.addActionListener(new ActionListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.8
            public void actionPerformed(ActionEvent evt) {
                JIFFEmpresaBienestarSalud.this.JBTUnidadFuncActionPerformed(evt);
            }
        });
        ...
        this.JBTActividadEconomica.addActionListener(new ActionListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.9
            public void actionPerformed(ActionEvent evt) {
                JIFFEmpresaBienestarSalud.this.JBTActividadEconomicaActionPerformed(evt);
            }
        });
        ...
        this.JBAuditor.addActionListener(new ActionListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.10
            public void actionPerformed(ActionEvent evt) {
                JIFFEmpresaBienestarSalud.this.JBAuditorActionPerformed(evt);
            }
        });
        ...
        this.JBTCargueTipoDoc.addActionListener(new ActionListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.11
            public void actionPerformed(ActionEvent evt) {
                JIFFEmpresaBienestarSalud.this.JBTCargueTipoDocActionPerformed(evt);
            }
        });
        ...
        this.JCBTipoIdent.addItemListener(new ItemListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.12
            public void itemStateChanged(ItemEvent evt) {
                JIFFEmpresaBienestarSalud.this.JCBTipoIdentItemStateChanged(evt);
            }
        });
        ...
        this.JTFFNDocumento.addFocusListener(new FocusAdapter() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.13
            public void focusLost(FocusEvent evt) {
                JIFFEmpresaBienestarSalud.this.JTFFNDocumentoFocusLost(evt);
            }
        });
        this.JTFFNDocumento.addKeyListener(new KeyAdapter() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.14
            public void keyPressed(KeyEvent evt) {
                JIFFEmpresaBienestarSalud.this.JTFFNDocumentoKeyPressed(evt);
            }
        });
        ...
        this.JCHEstado.addActionListener(new ActionListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.15
            public void actionPerformed(ActionEvent evt) {
                JIFFEmpresaBienestarSalud.this.JCHEstadoActionPerformed(evt);
            }
        });
        ...
        this.JTFContacto.addActionListener(new ActionListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.16
            public void actionPerformed(ActionEvent evt) {
                JIFFEmpresaBienestarSalud.this.JTFContactoActionPerformed(evt);
            }
        });
        ...
        this.JRBPersonaN.addActionListener(new ActionListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.17
            public void actionPerformed(ActionEvent evt) {
                JIFFEmpresaBienestarSalud.this.JRBPersonaNActionPerformed(evt);
            }
        });
        ...
        this.JRBPersonaJ.addActionListener(new ActionListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.18
            public void actionPerformed(ActionEvent evt) {
                JIFFEmpresaBienestarSalud.this.JRBPersonaJActionPerformed(evt);
            }
        });
        ...
        this.JCHConvenioMed1.addActionListener(new ActionListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.19
            public void actionPerformed(ActionEvent evt) {
                JIFFEmpresaBienestarSalud.this.JCHConvenioMed1ActionPerformed(evt);
            }
        });
        ...
        this.JSPDigitoV1.addFocusListener(new FocusAdapter() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.20
            public void focusLost(FocusEvent evt) {
                JIFFEmpresaBienestarSalud.this.JSPDigitoV1FocusLost(evt);
            }
        });
        ...
        this.JRBEmpresa.addActionListener(new ActionListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.21
            public void actionPerformed(ActionEvent evt) {
                JIFFEmpresaBienestarSalud.this.JRBEmpresaActionPerformed(evt);
            }
        });
        ...
        this.JRBEPS.addActionListener(new ActionListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.22
            public void actionPerformed(ActionEvent evt) {
                JIFFEmpresaBienestarSalud.this.JRBEPSActionPerformed(evt);
            }
        });
        ...
        this.JRBEPS1.addActionListener(new ActionListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.23
            public void actionPerformed(ActionEvent evt) {
                JIFFEmpresaBienestarSalud.this.JRBEPS1ActionPerformed(evt);
            }
        });
        ...
        this.JCHTransportadora.addActionListener(new ActionListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.24
            public void actionPerformed(ActionEvent evt) {
                JIFFEmpresaBienestarSalud.this.JCHTransportadoraActionPerformed(evt);
            }
        });
        ...
        this.JCHConvenioMed.addActionListener(new ActionListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.25
            public void actionPerformed(ActionEvent evt) {
                JIFFEmpresaBienestarSalud.this.JCHConvenioMedActionPerformed(evt);
            }
        });
        ...
        this.JCHMInventario.addActionListener(new ActionListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.26
            public void actionPerformed(ActionEvent evt) {
                JIFFEmpresaBienestarSalud.this.JCHMInventarioActionPerformed(evt);
            }
        });
        ...
        this.JCHFacInterna.addActionListener(new ActionListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.27
            public void actionPerformed(ActionEvent evt) {
                JIFFEmpresaBienestarSalud.this.JCHFacInternaActionPerformed(evt);
            }
        });
        ...
        this.JCHActivadoC.addActionListener(new ActionListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.28
            public void actionPerformed(ActionEvent evt) {
                JIFFEmpresaBienestarSalud.this.JCHActivadoCActionPerformed(evt);
            }
        });
        ...
        this.JCHMCartera.addActionListener(new ActionListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.29
            public void actionPerformed(ActionEvent evt) {
                JIFFEmpresaBienestarSalud.this.JCHMCarteraActionPerformed(evt);
            }
        });
        this.JCHPoliza.setFont(new Font("Arial", 1, 12));
        this.JCHPoliza.setForeground(Color.blue);
        this.JCHPoliza.setText("Póliza?");
        this.JCHPoliza.addActionListener(new ActionListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.30
            public void actionPerformed(ActionEvent evt) {
                JIFFEmpresaBienestarSalud.this.JCHPolizaActionPerformed(evt);
            }
        });
        ...
        this.JTFFechaPoliza.addActionListener(new ActionListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.31
            public void actionPerformed(ActionEvent evt) {
                JIFFEmpresaBienestarSalud.this.JTFFechaPolizaActionPerformed(evt);
            }
        });
        ...
        this.JDCFechaPoliza.addPropertyChangeListener(new PropertyChangeListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.32
            @Override // java.beans.PropertyChangeListener
            public void propertyChange(PropertyChangeEvent evt) {
                JIFFEmpresaBienestarSalud.this.JDCFechaPolizaPropertyChange(evt);
            }
        });
        ...
        this.JCHARetencion.addActionListener(new ActionListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.33
            public void actionPerformed(ActionEvent evt) {
                JIFFEmpresaBienestarSalud.this.JCHARetencionActionPerformed(evt);
            }
        });
        ...
        this.JCHEsNomina.addActionListener(new ActionListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.34
            public void actionPerformed(ActionEvent evt) {
                JIFFEmpresaBienestarSalud.this.JCHEsNominaActionPerformed(evt);
            }
        });
        ...
        this.JCHManejoResiduos.addActionListener(new ActionListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.35
            public void actionPerformed(ActionEvent evt) {
                JIFFEmpresaBienestarSalud.this.JCHManejoResiduosActionPerformed(evt);
            }
        });
        ...
        this.JCHFiltroProcxEmp.addActionListener(new ActionListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.36
            public void actionPerformed(ActionEvent evt) {
                JIFFEmpresaBienestarSalud.this.JCHFiltroProcxEmpActionPerformed(evt);
            }
        });
        ...
        this.JRBCapitadoGl.addActionListener(new ActionListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.37
            public void actionPerformed(ActionEvent evt) {
                JIFFEmpresaBienestarSalud.this.JRBCapitadoGlActionPerformed(evt);
            }
        });
        this.JBGModoFac.add(this.JRBEvento);
        this.JRBEvento.setFont(new Font("Arial", 1, 12));
        this.JRBEvento.setText("Evento");
        this.JRBEvento.addActionListener(new ActionListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.38
            public void actionPerformed(ActionEvent evt) {
                JIFFEmpresaBienestarSalud.this.JRBEventoActionPerformed(evt);
            }
        });
        ...
        this.JTBEmpresaxC.setRowHeight(25);
        ...
        this.JTBEmpresaxC.addMouseListener(new MouseAdapter() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.40
            public void mouseClicked(MouseEvent evt) {
                JIFFEmpresaBienestarSalud.this.JTBEmpresaxCMouseClicked(evt);
            }
        });
        ...
        this.JCHEstadoEC.addActionListener(new ActionListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.41
            public void actionPerformed(ActionEvent evt) {
                JIFFEmpresaBienestarSalud.this.JCHEstadoECActionPerformed(evt);
            }
        });
        ...
        this.JBGrabar.setToolTipText("Grabar");
        this.JBGrabar.addActionListener(new ActionListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.42
            public void actionPerformed(ActionEvent evt) {
                JIFFEmpresaBienestarSalud.this.JBGrabarActionPerformed(evt);
            }
        });
        this.JBGrabar1.setFont(new Font("Arial", 1, 12));
        this.JBGrabar1.setIcon(new ImageIcon(getClass().getResource("/Imagenes/Nuevo.png")));
        this.JBGrabar1.setText("Nuevo");
        this.JBGrabar1.setToolTipText("Grabar");
        this.JBGrabar1.addActionListener(new ActionListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.43
            public void actionPerformed(ActionEvent evt) {
                JIFFEmpresaBienestarSalud.this.JBGrabar1ActionPerformed(evt);
            }
        });
        ...
        this.JTFFCodRips.addKeyListener(new KeyAdapter() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.44
            public void keyTyped(KeyEvent evt) {
                JIFFEmpresaBienestarSalud.this.JTFFCodRipsKeyTyped(evt);
            }
        });
        ...
        this.JCHEsEps.addActionListener(new ActionListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.45
            public void actionPerformed(ActionEvent evt) {
                JIFFEmpresaBienestarSalud.this.JCHEsEpsActionPerformed(evt);
            }
        });
        ...
        this.JRBMetFact_0.addActionListener(new ActionListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.46
            public void actionPerformed(ActionEvent evt) {
                JIFFEmpresaBienestarSalud.this.JRBMetFact_0ActionPerformed(evt);
            }
        });
        ...
        this.JRBMetFact_1.addActionListener(new ActionListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.47
            public void actionPerformed(ActionEvent evt) {
                JIFFEmpresaBienestarSalud.this.JRBMetFact_1ActionPerformed(evt);
            }
        });
        ...
        this.JRBMetFact_2.addActionListener(new ActionListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.48
            public void actionPerformed(ActionEvent evt) {
                JIFFEmpresaBienestarSalud.this.JRBMetFact_2ActionPerformed(evt);
            }
        });
        GroupLayout JPIMetodoFactLayout = new GroupLayout(this.JPIMetodoFact);
        this.JPIMetodoFact.setLayout(JPIMetodoFactLayout);
        JPIMetodoFactLayout.setHorizontalGroup(JPIMetodoFactLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPIMetodoFactLayout.createSequentialGroup().addGap(14, 14, 14).addGroup(JPIMetodoFactLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.JRBMetFact_2).addComponent(this.JRBMetFact_1).addComponent(this.JRBMetFact_0)).addContainerGap(17, 32767)));
        JPIMetodoFactLayout.setVerticalGroup(JPIMetodoFactLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPIMetodoFactLayout.createSequentialGroup().addComponent(this.JRBMetFact_0).addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED).addComponent(this.JRBMetFact_1).addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED).addComponent(this.JRBMetFact_2)));
        ...
        this.JCBTcodigo.addItemListener(new ItemListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.49
            public void itemStateChanged(ItemEvent evt) {
                JIFFEmpresaBienestarSalud.this.JCBTcodigoItemStateChanged(evt);
            }
        });
        ...
        this.JCBCodigoM.addItemListener(new ItemListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.50
            public void itemStateChanged(ItemEvent evt) {
                JIFFEmpresaBienestarSalud.this.JCBCodigoMItemStateChanged(evt);
            }
        });
        this.JCBCodigoM.addActionListener(new ActionListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.51
            public void actionPerformed(ActionEvent evt) {
                JIFFEmpresaBienestarSalud.this.JCBCodigoMActionPerformed(evt);
            }
        });
        ...
        this.JRB_RNoAplica.addActionListener(new ActionListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.52
            public void actionPerformed(ActionEvent evt) {
                JIFFEmpresaBienestarSalud.this.JRB_RNoAplicaActionPerformed(evt);
            }
        });
        this.JBGMetRedondeo.add(this.JRB_RDecima);
        this.JRB_RDecima.setFont(new Font("Arial", 1, 12));
        this.JRB_RDecima.setText("Decima");
        this.JRB_RDecima.addActionListener(new ActionListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.53
            public void actionPerformed(ActionEvent evt) {
                JIFFEmpresaBienestarSalud.this.JRB_RDecimaActionPerformed(evt);
            }
        });
        ...
        this.JRB_RCentecima.addActionListener(new ActionListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.54
            public void actionPerformed(ActionEvent evt) {
                JIFFEmpresaBienestarSalud.this.JRB_RCentecimaActionPerformed(evt);
            }
        });
        ...
        this.JRB_RSinDecimal.addActionListener(new ActionListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.55
            public void actionPerformed(ActionEvent evt) {
                JIFFEmpresaBienestarSalud.this.JRB_RSinDecimalActionPerformed(evt);
            }
        });
        GroupLayout JPIMRedondeoLayout = new GroupLayout(this.JPIMRedondeo);
        this.JPIMRedondeo.setLayout(JPIMRedondeoLayout);
        JPIMRedondeoLayout.setHorizontalGroup(JPIMRedondeoLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPIMRedondeoLayout.createSequentialGroup().addContainerGap().addGroup(JPIMRedondeoLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.JRB_RNoAplica).addComponent(this.JRB_RSinDecimal)).addGap(18, 18, 18).addGroup(JPIMRedondeoLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.JRB_RCentecima).addComponent(this.JRB_RDecima)).addContainerGap(-1, 32767)));
        ...
        this.JCHGeneraMovimentoC.addActionListener(new ActionListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.56
            public void actionPerformed(ActionEvent evt) {
                JIFFEmpresaBienestarSalud.this.JCHGeneraMovimentoCActionPerformed(evt);
            }
        });
        ...
        this.JCHAgendaInventario.addActionListener(new ActionListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.57
            public void actionPerformed(ActionEvent evt) {
                JIFFEmpresaBienestarSalud.this.JCHAgendaInventarioActionPerformed(evt);
            }
        });
        this.JCHFiltro4505.setFont(new Font("Arial", 1, 12));
        this.JCHFiltro4505.setForeground(Color.blue);
        this.JCHFiltro4505.setText("Aplica 4505?");
        this.JCHFiltro4505.setToolTipText("Aplica 4505?");
        this.JCHFiltro4505.addActionListener(new ActionListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.58
            public void actionPerformed(ActionEvent evt) {
                JIFFEmpresaBienestarSalud.this.JCHFiltro4505ActionPerformed(evt);
            }
        });
        ...
        this.JCHFiltroCodAutorizacion.addActionListener(new ActionListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.59
            public void actionPerformed(ActionEvent evt) {
                JIFFEmpresaBienestarSalud.this.JCHFiltroCodAutorizacionActionPerformed(evt);
            }
        });
        ...
        this.JCHFiltroAsignarCita.setToolTipText("Si el convenio necesita código autorización");
        this.JCHFiltroAsignarCita.addActionListener(new ActionListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.60
            public void actionPerformed(ActionEvent evt) {
                JIFFEmpresaBienestarSalud.this.JCHFiltroAsignarCitaActionPerformed(evt);
            }
        });
        ...
        this.JCHAplicaCodigoMaterial.setToolTipText("Si el convenio necesita código autorización");
        this.JCHAplicaCodigoMaterial.addActionListener(new ActionListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.61
            public void actionPerformed(ActionEvent evt) {
                JIFFEmpresaBienestarSalud.this.JCHAplicaCodigoMaterialActionPerformed(evt);
            }
        });
        ...
        this.JTBAseguradora.setRowHeight(25);
        ...
        this.JTBAseguradora.addMouseListener(new MouseAdapter() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.62
            public void mouseClicked(MouseEvent evt) {
                JIFFEmpresaBienestarSalud.this.JTBAseguradoraMouseClicked(evt);
            }
        });
        ...
        this.JCHDescuentoP.setToolTipText("Si el convenio necesita código autorización");
        this.JCHBloquear.setFont(new Font("Arial", 1, 12));
        this.JCHBloquear.setForeground(Color.blue);
        this.JCHBloquear.setText("Bloquear?");
        this.JCHBloquear.setToolTipText("Si el convenio necesita código autorización");
        this.JSPDCargosEmpresaBS1.setBorder(BorderFactory.createTitledBorder((Border) null, "CARGOS  POR EMPRESA BS1", 0, 0, new Font("Arial", 1, 12), Color.red));
        this.JSPDCargosEmpresaBS1.setFont(new Font("Arial", 1, 12));
        this.JTBCargosEmpresaBS1.setFont(new Font("Arial", 1, 12));
        this.JTBCargosEmpresaBS1.setModel(new DefaultTableModel((Object[][]) new Object[0], new String[0]));
        this.JTBCargosEmpresaBS1.setRowHeight(25);
        this.JTBCargosEmpresaBS1.setSelectionBackground(new Color(255, 255, 255));
        this.JTBCargosEmpresaBS1.setSelectionForeground(new Color(255, 0, 0));
        this.JTBCargosEmpresaBS1.setSelectionMode(0);
        this.JTBCargosEmpresaBS1.addMouseListener(new MouseAdapter() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.63
            public void mouseClicked(MouseEvent evt) {
                JIFFEmpresaBienestarSalud.this.JTBCargosEmpresaBS1MouseClicked(evt);
            }
        });
        this.JSPDCargosEmpresaBS1.setViewportView(this.JTBCargosEmpresaBS1);
        this.JTFFNombreCargoBS1.setBorder(BorderFactory.createTitledBorder((Border) null, "Nombre del cargo", 0, 0, new Font("Arial", 1, 12), Color.blue));
        this.JTFFNombreCargoBS1.setFont(new Font("Arial", 1, 12));
        ...
        this.JBAgregarCargoTablaBS1.addActionListener(new ActionListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.64
            public void actionPerformed(ActionEvent evt) {
                JIFFEmpresaBienestarSalud.this.JBAgregarCargoTablaBS1ActionPerformed(evt);
            }
        });
        ...
        JPIEmpresaCont1Layout.setHorizontalGroup(JPIEmpresaCont1Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPIEmpresaCont1Layout.createSequentialGroup().addGroup(JPIEmpresaCont1Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPIEmpresaCont1Layout.createSequentialGroup().addGap(12, 12, 12).addComponent(this.JTFFCodRips, -2, 136, -2).addGap(10, 10, 10).addComponent(this.JCBRegimen, -2, 248, -2).addGap(6, 6, 6).addComponent(this.JCBPlan, -2, 193, -2).addGap(6, 6, 6).addComponent(this.JCBTipoEmpresa, -2, 320, -2).addGap(6, 6, 6).addGroup(JPIEmpresaCont1Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPIEmpresaCont1Layout.createSequentialGroup().addGap(2, 2, 2).addComponent(this.JCHEstadoEC)).addComponent(this.JCHEsEps, -2, 79, -2))).addGroup(GroupLayout.Alignment.TRAILING, JPIEmpresaCont1Layout.createSequentialGroup().addContainerGap().addGroup(JPIEmpresaCont1Layout.createParallelGroup(GroupLayout.Alignment.TRAILING).addGroup(JPIEmpresaCont1Layout.createSequentialGroup().addGroup(JPIEmpresaCont1Layout.createParallelGroup(GroupLayout.Alignment.TRAILING).addComponent(this.JSPDEmpresaxC, GroupLayout.Alignment.LEADING).addGroup(JPIEmpresaCont1Layout.createSequentialGroup().addGroup(JPIEmpresaCont1Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.JCB_TipoContratacion, -2, 320, -2).addGroup(JPIEmpresaCont1Layout.createSequentialGroup().addComponent(this.JTFFNombreCargoBS1, -2, 238, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED, -1, 32767).addComponent(this.JBAgregarCargoTablaBS1))).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(JPIEmpresaCont1Layout.createParallelGroup(GroupLayout.Alignment.LEADING, false).addGroup(JPIEmpresaCont1Layout.createSequentialGroup().addComponent(this.JCB_TipoAseguramiento, -2, 310, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JCB_TipoCoberturaPlan, -2, 310, -2)).addComponent(this.JSPDCargosEmpresaBS1)))).addGap(12, 12, 12)).addGroup(GroupLayout.Alignment.LEADING, JPIEmpresaCont1Layout.createSequentialGroup().addGap(4, 4, 4).addGroup(JPIEmpresaCont1Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPIEmpresaCont1Layout.createSequentialGroup().addComponent(this.JTFFNConvenio, -2, 500, -2).addGap(14, 14, 14).addComponent(this.JCBManual, 0, -1, 32767)).addGroup(JPIEmpresaCont1Layout.createSequentialGroup().addComponent(this.JSPCCita, -2, 101, -2).addGap(9, 9, 9).addComponent(this.JSPNDiasP, -2, 101, -2).addGap(9, 9, 9).addComponent(this.JSPNPrioridad, -2, 61, -2).addGap(9, 9, 9).addComponent(this.JCBTcodigo, -2, 210, -2).addGap(10, 10, 10).addComponent(this.JCBCodigoM, 0, -1, 32767)).addGroup(JPIEmpresaCont1Layout.createSequentialGroup().addComponent(this.JCB_GIps, -2, 311, -2).addGap(18, 18, 18).addGroup(JPIEmpresaCont1Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.JCHAgendaInventario).addComponent(this.JCHFiltroProcxEmp)).addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED).addGroup(JPIEmpresaCont1Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPIEmpresaCont1Layout.createSequentialGroup().addComponent(this.JCHFiltro4505).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JCHFiltroCodAutorizacion).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JCHFiltroAsignarCita).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JCHDescuentoP, -2, 97, -2)).addGroup(JPIEmpresaCont1Layout.createSequentialGroup().addComponent(this.JCHGeneraMovimentoC).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JCHAplicaCodigoMaterial, -2, 160, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JCHBloquear, -2, 97, -2))).addGap(18, 18, 18)))).addComponent(this.JSPDAseguradora)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(JPIEmpresaCont1Layout.createParallelGroup(GroupLayout.Alignment.LEADING, false).addComponent(this.JPIMRedondeo, GroupLayout.Alignment.TRAILING, -1, -1, 32767).addComponent(this.JPIMetodoFact, GroupLayout.Alignment.TRAILING, -1, -1, 32767).addComponent(this.JPIModoFact, GroupLayout.Alignment.TRAILING, -1, -1, 32767).addComponent(this.JBGrabar1, -1, -1, 32767).addComponent(this.JBGrabar, -1, -1, 32767)))).addContainerGap()));
        JPIEmpresaCont1Layout.setVerticalGroup(JPIEmpresaCont1Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPIEmpresaCont1Layout.createSequentialGroup().addGap(11, 11, 11).addGroup(JPIEmpresaCont1Layout.createParallelGroup(GroupLayout.Alignment.LEADING, false).addComponent(this.JTFFCodRips).addComponent(this.JCBRegimen, -1, 50, 32767).addGroup(JPIEmpresaCont1Layout.createSequentialGroup().addComponent(this.JCHEstadoEC).addGap(0, 0, 0).addComponent(this.JCHEsEps)).addComponent(this.JCBPlan).addComponent(this.JCBTipoEmpresa)).addGroup(JPIEmpresaCont1Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPIEmpresaCont1Layout.createSequentialGroup().addGap(7, 7, 7).addComponent(this.JPIModoFact, -2, -1, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JPIMetodoFact, -2, -1, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JPIMRedondeo, -2, -1, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JBGrabar1).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JBGrabar, -2, 34, -2)).addGroup(JPIEmpresaCont1Layout.createSequentialGroup().addGroup(JPIEmpresaCont1Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPIEmpresaCont1Layout.createSequentialGroup().addGap(7, 7, 7).addComponent(this.JTFFNConvenio, -2, -1, -2)).addGroup(GroupLayout.Alignment.TRAILING, JPIEmpresaCont1Layout.createSequentialGroup().addGap(6, 6, 6).addComponent(this.JCBManual, -2, 36, -2))).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(JPIEmpresaCont1Layout.createParallelGroup(GroupLayout.Alignment.TRAILING, false).addComponent(this.JCBTcodigo, GroupLayout.Alignment.LEADING).addComponent(this.JSPNPrioridad, GroupLayout.Alignment.LEADING).addComponent(this.JCBCodigoM).addComponent(this.JSPCCita, GroupLayout.Alignment.LEADING).addComponent(this.JSPNDiasP, GroupLayout.Alignment.LEADING)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(JPIEmpresaCont1Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPIEmpresaCont1Layout.createSequentialGroup().addGroup(JPIEmpresaCont1Layout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(this.JCHFiltroProcxEmp).addComponent(this.JCHGeneraMovimentoC).addComponent(this.JCHAplicaCodigoMaterial).addComponent(this.JCHBloquear)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(JPIEmpresaCont1Layout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(this.JCHFiltro4505).addComponent(this.JCHFiltroCodAutorizacion).addComponent(this.JCHFiltroAsignarCita).addComponent(this.JCHDescuentoP).addComponent(this.JCHAgendaInventario))).addComponent(this.JCB_GIps, -2, 38, -2)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(JPIEmpresaCont1Layout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(this.JCB_TipoContratacion, -2, -1, -2).addComponent(this.JCB_TipoAseguramiento, -2, -1, -2).addComponent(this.JCB_TipoCoberturaPlan, -2, -1, -2)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(JPIEmpresaCont1Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.JSPDCargosEmpresaBS1, -2, 87, -2).addComponent(this.JTFFNombreCargoBS1, -2, -1, -2).addComponent(this.JBAgregarCargoTablaBS1, -2, 34, -2)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JSPDEmpresaxC, -2, 139, -2))).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED, -1, 32767).addComponent(this.JSPDAseguradora, -2, 0, -2).addContainerGap()));
        ...
        this.JBTEmpresaContrato.addActionListener(new ActionListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.65
            public void actionPerformed(ActionEvent evt) {
                JIFFEmpresaBienestarSalud.this.JBTEmpresaContratoActionPerformed(evt);
            }
        });
        ...
        this.JBTEmpresaServicios.addActionListener(new ActionListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.66
            public void actionPerformed(ActionEvent evt) {
                JIFFEmpresaBienestarSalud.this.JBTEmpresaServiciosActionPerformed(evt);
            }
        });
        ...
        this.JBTEmpresaProcedimiento.addActionListener(new ActionListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.67
            public void actionPerformed(ActionEvent evt) {
                JIFFEmpresaBienestarSalud.this.JBTEmpresaProcedimientoActionPerformed(evt);
            }
        });
        ...
        this.JBTEmpresaGFactura.addActionListener(new ActionListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.68
            public void actionPerformed(ActionEvent evt) {
                JIFFEmpresaBienestarSalud.this.JBTEmpresaGFacturaActionPerformed(evt);
            }
        });
        ...
        this.JBTEmpresaEstrato.addActionListener(new ActionListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.69
            public void actionPerformed(ActionEvent evt) {
                JIFFEmpresaBienestarSalud.this.JBTEmpresaEstratoActionPerformed(evt);
            }
        });
        ...
        this.JBTEmpresaAfiliados.addActionListener(new ActionListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.70
            public void actionPerformed(ActionEvent evt) {
                JIFFEmpresaBienestarSalud.this.JBTEmpresaAfiliadosActionPerformed(evt);
            }
        });
        ...
        this.JBTSoportes.addActionListener(new ActionListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.71
            public void actionPerformed(ActionEvent evt) {
                JIFFEmpresaBienestarSalud.this.JBTSoportesActionPerformed(evt);
            }
        });
        ...
        this.JBTExportar_tarifas.addActionListener(new ActionListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.72
            public void actionPerformed(ActionEvent evt) {
                JIFFEmpresaBienestarSalud.this.JBTExportar_tarifasActionPerformed(evt);
            }
        });
        this.JBTEmpresa.setFont(new Font("Arial", 1, 12));
        this.JBTEmpresa.setText("Empresa en Misión");
        this.JBTEmpresa.setEnabled(false);
        this.JBTEmpresa.addActionListener(new ActionListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.73
            public void actionPerformed(ActionEvent evt) {
                JIFFEmpresaBienestarSalud.this.JBTEmpresaActionPerformed(evt);
            }
        });
        this.JBTEmpresa1.setFont(new Font("Arial", 1, 12));
        this.JBTEmpresa1.setText("Convenio Homologado BS1");
        this.JBTEmpresa1.addActionListener(new ActionListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.74
            public void actionPerformed(ActionEvent evt) {
                JIFFEmpresaBienestarSalud.this.JBTEmpresa1ActionPerformed(evt);
            }
        });
        GroupLayout jPanel3Layout = new GroupLayout(this.jPanel3);
        this.jPanel3.setLayout(jPanel3Layout);
        jPanel3Layout.setHorizontalGroup(jPanel3Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(jPanel3Layout.createSequentialGroup().addContainerGap().addComponent(this.JBTEmpresaAfiliados, -2, 152, -2).addGap(18, 18, 18).addComponent(this.JBTSoportes, -2, 152, -2).addGap(18, 18, 18).addComponent(this.JBTExportar_tarifas, -2, 152, -2).addGap(18, 18, 18).addComponent(this.JBTEmpresa, -2, 155, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JBTEmpresa1).addContainerGap(367, 32767)));
        jPanel3Layout.setVerticalGroup(jPanel3Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(jPanel3Layout.createSequentialGroup().addContainerGap().addGroup(jPanel3Layout.createParallelGroup(GroupLayout.Alignment.TRAILING, false).addGroup(jPanel3Layout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(this.JBTEmpresaAfiliados, -2, 40, -2).addComponent(this.JBTSoportes, -2, 40, -2).addComponent(this.JBTExportar_tarifas, -2, 40, -2)).addComponent(this.JBTEmpresa, GroupLayout.Alignment.LEADING, -1, -1, 32767).addComponent(this.JBTEmpresa1, GroupLayout.Alignment.LEADING, -1, -1, 32767)).addContainerGap(-1, 32767)));
        ...
        JPIDatosEpsLayout.setHorizontalGroup(JPIDatosEpsLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPIDatosEpsLayout.createSequentialGroup().addGap(10, 10, 10).addComponent(this.JPIEmpresaCont1, -2, 0, 32767)).addGroup(JPIDatosEpsLayout.createSequentialGroup().addContainerGap().addComponent(this.jTabbedPane1)));
        JPIDatosEpsLayout.setVerticalGroup(JPIDatosEpsLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPIDatosEpsLayout.createSequentialGroup().addContainerGap().addComponent(this.JPIEmpresaCont1, -2, 489, 32767).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.jTabbedPane1, -2, 85, -2).addContainerGap()));
        ...
        JPI_ConvenioLayout.setVerticalGroup(JPI_ConvenioLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.JPIDatosEps, -1, -1, 32767));
        ...
        this.JTFNombreBusqueda.addKeyListener(new KeyAdapter() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.75
            public void keyTyped(KeyEvent evt) {
                JIFFEmpresaBienestarSalud.this.JTFNombreBusquedaKeyTyped(evt);
            }
        });
        ...
        this.JCHComienza.addActionListener(new ActionListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.76
            public void actionPerformed(ActionEvent evt) {
                JIFFEmpresaBienestarSalud.this.JCHComienzaActionPerformed(evt);
            }
        });
        this.JBGFiltro.add(this.JCHContiene);
        this.JCHContiene.setFont(new Font("Arial", 1, 12));
        this.JCHContiene.setText("Contiene");
        this.JCHContiene.addActionListener(new ActionListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.77
            public void actionPerformed(ActionEvent evt) {
                JIFFEmpresaBienestarSalud.this.JCHContieneActionPerformed(evt);
            }
        });
        ...
        this.JCHContiene1.addActionListener(new ActionListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.78
            public void actionPerformed(ActionEvent evt) {
                JIFFEmpresaBienestarSalud.this.JCHContiene1ActionPerformed(evt);
            }
        });
        ...
        this.JTBHistorico.addMouseListener(new MouseAdapter() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.79
            public void mouseClicked(MouseEvent evt) {
                JIFFEmpresaBienestarSalud.this.JTBHistoricoMouseClicked(evt);
            }
        });
        ...
        this.JTFRuta.addMouseListener(new MouseAdapter() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.80
            public void mouseClicked(MouseEvent evt) {
                JIFFEmpresaBienestarSalud.this.JTFRutaMouseClicked(evt);
            }
        });
        ...
        this.JBTExportar.addActionListener(new ActionListener() { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.81
            public void actionPerformed(ActionEvent evt) {
                JIFFEmpresaBienestarSalud.this.JBTExportarActionPerformed(evt);
            }
        });
        ...
        JPI_HistoricoLayout.setVerticalGroup(JPI_HistoricoLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPI_HistoricoLayout.createSequentialGroup().addContainerGap().addComponent(this.JPIDatosBusqueda, -2, -1, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JSPHistorico, -1, 422, 32767).addGap(18, 18, 18).addGroup(JPI_HistoricoLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.JTFRuta, -2, 50, -2).addComponent(this.JBTExportar, -2, 50, -2)).addContainerGap()));
        this.JTPDatosB.addTab("HISTÓRICO", this.JPI_Historico);
        GroupLayout layout = new GroupLayout(getContentPane());
        getContentPane().setLayout(layout);
        layout.setHorizontalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(layout.createSequentialGroup().addContainerGap().addComponent(this.JTPDatosB, -2, 1248, -2).addContainerGap(-1, 32767)));
        layout.setVerticalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(layout.createSequentialGroup().addContainerGap().addComponent(this.JTPDatosB).addContainerGap()));
        pack();
    }
    ...
    public void JCHEsEpsActionPerformed(ActionEvent evt) {
        ...
        System.out.println(this.xeseps);
    }
    ...
    public void JTBEmpresaxCMouseClicked(MouseEvent evt) {
        if (this.JTBEmpresaxC.getSelectedRow() != -1 && evt.getClickCount() == 2) {
            this.xIdEmpresaC = Integer.valueOf(this.xmodelo1.getValueAt(this.JTBEmpresaxC.getSelectedRow(), 0).toString()).intValue();
            ...
            if (this.xRedondeo == 0) {
                this.JRB_RNoAplica.setSelected(true);
            } else if (this.xRedondeo == -1) {
                this.JRB_RDecima.setSelected(true);
            } else if (this.xRedondeo == -2) {
            ...
            if ("Codigo Tarifa Procedimiento".equals(this.xmodelo1.getValueAt(this.JTBEmpresaxC.getSelectedRow(), 15).toString())) {
                this.xcodigop = 0;
            } else if ("Codigo Real (Soat)".equals(this.xmodelo1.getValueAt(this.JTBEmpresaxC.getSelectedRow(), 15).toString())) {
                this.xcodigop = 1;
            } else {
                this.xcodigop = 2;
            }
            this.JCBCodigoM.setSelectedItem(this.xmodelo1.getValueAt(this.JTBEmpresaxC.getSelectedRow(), 16).toString());
            if ("Codigo Tarifa Suministro".equals(this.xmodelo1.getValueAt(this.JTBEmpresaxC.getSelectedRow(), 16).toString())) {
                this.xcodigom = 0;
            } else if ("Codigo ATC".equals(this.xmodelo1.getValueAt(this.JTBEmpresaxC.getSelectedRow(), 16).toString())) {
                this.xcodigom = 1;
            } else {
                this.xcodigom = 2;
            }
            ...
            this.uuidEmpresaConvenioEditar = recuperarUuidBS1Empresa(this.xmodelo1.getValueAt(this.JTBEmpresaxC.getSelectedRow(), 0).toString());
            String QueryRecuperarCargos = "SELECT Car_ID, Car_Nombre\nFROM Empresa_Cargo\nWHERE zEmpr_ID ='" + this.uuidEmpresaConvenioEditar + "';";
            mCargarDatosCargosBS1(QueryRecuperarCargos);
            return;
        }
        this.JBTEmpresaEstrato.setEnabled(false);
        this.JBTEmpresaGFactura.setEnabled(false);
    ...
    public void JBTExportar_tarifasActionPerformed(ActionEvent evt) {
        ...
        if (xv == 0) {
            File xfile = xfilec.getSelectedFile();
            this.ruta = xfile.getAbsolutePath() + "\\";
        }
        mExportar3();
    }
    ...
    public void JCBTipoIdentItemStateChanged(ItemEvent evt) {
        if (this.JCBTipoIdent.getSelectedIndex() != -1) {
            if (this.JCBTipoIdent.getSelectedItem().toString().equals("CC")) {
            ...
            if (this.JCBTipoIdent.getSelectedItem().toString().equals("CE")) {
                this.JTFApellido1.setEditable(true);
                this.JTFApellido2.setEditable(true);
                this.JTFNombre1.setEditable(true);
                this.JTFNombre2.setEditable(true);
            ...
            if (this.JCBTipoIdent.getSelectedItem().toString().equals("NA")) {
                this.JTFApellido1.setEditable(true);
                this.JTFApellido2.setEditable(true);
                this.JTFNombre1.setEditable(true);
                this.JTFNombre2.setEditable(true);
            ...
            if (this.JCBTipoIdent.getSelectedItem().toString().equals("PA")) {
                this.JTFApellido1.setEditable(true);
                this.JTFApellido2.setEditable(true);
                this.JTFNombre1.setEditable(true);
                this.JTFNombre2.setEditable(true);
            ...
            if (this.JCBTipoIdent.getSelectedItem().toString().equals("RC")) {
                this.JTFApellido1.setEditable(true);
                this.JTFApellido2.setEditable(true);
                this.JTFNombre1.setEditable(true);
                this.JTFNombre2.setEditable(true);
            ...
            if (this.JCBTipoIdent.getSelectedItem().toString().equals("TI")) {
                this.JTFApellido1.setEditable(true);
                this.JTFApellido2.setEditable(true);
                this.JTFNombre1.setEditable(true);
                this.JTFNombre2.setEditable(true);
    ...
    public void JBTCargueTipoDocActionPerformed(ActionEvent evt) {
        try {
            ...
            System.out.println("id usuario sistema: " + Principal.usuarioSistemaDTO.getIdUsuarioSistema() + " Id empresa: " + Principal.txtNo.getText());
    ...
    public void JBTEmpresaActionPerformed(ActionEvent evt) {
        String uuidEmpresaBS1 = recuperarUuidBS1Empresa(this.JTBEmpresaxC.getValueAt(this.JTBEmpresaxC.getSelectedRow(), 0).toString());
        this.dEmpresaMision = new JDEmpresaMisionBienestar(null, true, this, Integer.valueOf(this.xmodelo1.getValueAt(this.JTBEmpresaxC.getSelectedRow(), 0).toString()), this, uuidEmpresaBS1);
        this.dEmpresaMision.setLocationRelativeTo(this);
        this.dEmpresaMision.setVisible(true);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void JTBCargosEmpresaBS1MouseClicked(MouseEvent evt) {
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void JBAgregarCargoTablaBS1ActionPerformed(ActionEvent evt) {
        if (!this.uuidEmpresaConvenioEditar.equals("")) {
            UUID uuid = UUID.randomUUID();
            ConsultasSqlServer Cs = new ConsultasSqlServer();
            String Query = "INSERT INTO dbBS1DevelopmentX1.dbo.Empresa_Cargo\n(Car_ID, Car_Nombre, zEmpr_ID)\nVALUES('" + uuid + "', '" + this.JTFFNombreCargoBS1.getText() + "', '" + this.uuidEmpresaConvenioEditar + "'); ";
        ...
        if (!this.JTFFNombreCargoBS1.getText().equals("")) {
            mAgregarCargoDatatableBS1();
        }
    }
    ...
    public void JBTEmpresa1ActionPerformed(ActionEvent evt) {
        if (!Principal.txtNo.getText().isEmpty()) {
            if (!this.JTBEmpresaxC.getValueAt(this.JTBEmpresaxC.getSelectedRow(), 0).toString().equals("")) {
                JDConvenioEmpresa jDConvenioEmpresa = new JDConvenioEmpresa(null, true, this.JTBEmpresaxC.getValueAt(this.JTBEmpresaxC.getSelectedRow(), 0).toString(), this.JTBEmpresaxC.getValueAt(this.JTBEmpresaxC.getSelectedRow(), 1).toString());
                jDConvenioEmpresa.setLocationRelativeTo(null);
                jDConvenioEmpresa.setVisible(true);
                return;
            }
            JOptionPane.showInternalMessageDialog(this, "Debe seleccionar un convenio", "Verificar", 1);
            return;
        }
        JOptionPane.showInternalMessageDialog(this, "Debe seleccionar un tercero", "Verificar", 1);
    }

    private void mAgregarCargoDatatableBS1() {
        UUID uuid = UUID.randomUUID();
        this.xmodeloCargosBS1.addRow(new Object[]{String.valueOf(uuid), this.JTFFNombreCargoBS1.getText()});
        this.JTFFNombreCargoBS1.setText("");
    }

    /* JADX WARN: Type inference failed for: r4v1, types: [java.lang.Object[], java.lang.Object[][]] */
    private void mCrearModeloCargosBS1() {
        this.xmodeloCargosBS1 = new DefaultTableModel(new Object[0], new String[]{"idCargo", "Car_Nombre"}) { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.82
        ...
        JTable jTable = this.JTBCargosEmpresaBS1;
        JTable jTable2 = this.JTBCargosEmpresaBS1;
        jTable.setAutoResizeMode(0);
        this.JTBCargosEmpresaBS1.doLayout();
        this.JTBCargosEmpresaBS1.setModel(this.xmodeloCargosBS1);
        this.JTBCargosEmpresaBS1.getColumnModel().getColumn(0).setPreferredWidth(160);
        this.JTBCargosEmpresaBS1.getColumnModel().getColumn(1).setPreferredWidth(220);
    }

    private String recuperarUuidBS1Empresa(String idConvenioGenoma) {
        ResultSet rs;
        Throwable th;
        ConsultasMySQL Cs = new ConsultasMySQL();
        String uuidEmpresaBS1 = "";
        String Query = "SELECT idConvenioBS1 ,nombreConvenioGenoma FROM g_homologacion_convenio\nWHERE idConvenioGenoma ='" + idConvenioGenoma + "'";
        try {
            rs = Cs.traerRs(Query);
            th = null;
        ...
        try {
            try {
                if (rs.next()) {
                    uuidEmpresaBS1 = rs.getString("idConvenioBS1");
                }
                if (rs != null) {
                    if (0 != 0) {
                        try {
    ...
    private void mSeleccionarDatosTabla() {
        ...
        if (Integer.valueOf(this.xmodelo.getValueAt(this.JTBHistorico.getSelectedRow(), 12).toString()).intValue() == 0) {
            this.JRBEmpresa.setSelected(true);
            this.xeps = 0;
        } else if (Integer.valueOf(this.xmodelo.getValueAt(this.JTBHistorico.getSelectedRow(), 12).toString()).intValue() == 1) {
        ...
        System.out.println(this.xmodelo.getValueAt(this.JTBHistorico.getSelectedRow(), 26).toString());
    ...
    private void mExportar() {
        ...
        if (n == 0) {
            try {
                ...
                Logger.getLogger(JIFFEmpresaBienestarSalud.class.getName()).log(Level.SEVERE, (String) null, e);
            } catch (IOException ex) {
                Logger.getLogger(JIFFEmpresaBienestarSalud.class.getName()).log(Level.SEVERE, (String) null, (Throwable) ex);
            }
        }
    }
    ...
    private void mExportar3() {
        ...
        try {
            ...
            this.xmt.mExportar_Datos_Formato_Consulta(sql, this.ruta + "Tarifas_procedimiento.xls", "TARIFA DE PROCEDIMIENTO");
            ...
            this.xmt.mExportar_Datos_Formato_Consulta(sql2, this.ruta + "Tarifas_Suministro.xls", "TARIFA DE SUMINISTRO MANUAL: " + this.JCBManual.getSelectedItem());
    ...
    private void mExportar2() {
        ...
        if (n == 0) {
            try {
                WritableWorkbook workbook = Workbook.createWorkbook(new File(this.ruta + "Tarifas.xls"));
                WritableSheet sheet = workbook.createSheet("Procedimientos", 0);
                sheet.addCell(new Label(0, 0, "Tipo Procedimiento"));
                sheet.addCell(new Label(1, 0, "Cod CUPS"));
                sheet.addCell(new Label(2, 0, "Procedimiento"));
                sheet.addCell(new Label(3, 0, "Valor"));
                String sql = "SELECT `f_tipoprocedimiento`.`Nbre` AS TipoProc,`f_tarifaprocedimiento`.`CodCUPS`,  `g_procedimiento`.`Nbre` AS Procedimiento, `f_tarifaprocedimiento`.`VrMinimo`FROM `f_tarifaprocedimiento` INNER JOIN  `g_procedimiento` ON (`f_tarifaprocedimiento`.`Id_Procedimiento` = `g_procedimiento`.`Id`)INNER JOIN  `f_tipoprocedimiento` ON (`g_procedimiento`.`Id_tipoprocedimiento` = `f_tipoprocedimiento`.`Id`)WHERE(`f_tarifaprocedimiento`.`Id_Manual`='" + this.xidmanual[this.JCBManual.getSelectedIndex()] + "') ORDER BY `f_tipoprocedimiento`.`Nbre` ASC, `g_procedimiento`.`Nbre` ASC";
                this.xmt.mExportar_Datos_Formato_Consulta(sql, this.ruta + "Tarifas_procedimiento.xls", "TARIFA DE PROCEDIMIENTO");
                ...
                if (xrs.next()) {
                    ...
                    int b = 0;
                    while (xrs.next()) {
                        sheet.addCell(new Label(0, b + 1, xrs.getString(1)));
                        sheet.addCell(new Label(1, b + 1, xrs.getString(2)));
                        sheet.addCell(new Label(2, b + 1, xrs.getString(3)));
                        sheet.addCell(new Number(3, b + 1, xrs.getDouble(4)));
                        b++;
                    }
                }
                xrs.close();
                this.xct.cerrarConexionBd();
                WritableSheet sheet2 = workbook.createSheet("Tarifas", 1);
                sheet2.addCell(new Label(0, 0, "Codigo Interno"));
                sheet2.addCell(new Label(1, 0, "Principio Activo"));
                sheet2.addCell(new Label(2, 0, "Nombre"));
                sheet2.addCell(new Label(3, 0, "Codigo Cum"));
                sheet2.addCell(new Label(4, 0, "Registro Invima"));
                sheet2.addCell(new Label(5, 0, "Fecha Vencimiento Invima"));
                sheet2.addCell(new Label(6, 0, "Concentracion"));
                sheet2.addCell(new Label(7, 0, "Forma Farmaceutica"));
                sheet2.addCell(new Label(8, 0, "Presentacion Comercial"));
                sheet2.addCell(new Label(9, 0, "Tipo Producto"));
                sheet2.addCell(new Label(10, 0, "Valor"));
                String sql2 = "SELECT\n    `i_suministro`.`Id`\n    , `i_principioactivo`.`Nbre` AS `NPActivo`\n    , `i_suministro`.`Nbre` AS `NSuministro`\n    , `i_suministro`.`CodigoCUM`\n    , `i_suministro`.`RegistroInvima`\n    , `i_suministro`.`FechaVInvima`\n    , `i_concentracion`.`Nbre` AS `NConcentracion`\n    , `i_presentacionfarmaceutica`.`Nbre` AS `FFarmaceutica`\n    , `i_presentacioncomercial`.`Nbre` AS `PComercial`\n    , `i_tipoproducto`.`Nbre` AS `NTipoProducto`\n    , `f_tarifasuministro`.`Valor`\nFROM\n     `i_suministro`\n    INNER JOIN  `i_principioactivo` \n        ON (`i_suministro`.`IdPrincipioActivo` = `i_principioactivo`.`Id`)\n    INNER JOIN  `i_presentacioncomercial` \n        ON (`i_suministro`.`IdPresentacionComercial` = `i_presentacioncomercial`.`Id`)\n    INNER JOIN  `i_presentacionfarmaceutica` \n        ON (`i_suministro`.`IdPresentacionFarmaceutica` = `i_presentacionfarmaceutica`.`Id`)\n    INNER JOIN  `i_laboratorio` \n        ON (`i_suministro`.`IdLaboratorio` = `i_laboratorio`.`Id`)\n    INNER JOIN  `i_concentracion` \n        ON (`i_suministro`.`IdConcentracion` = `i_concentracion`.`Id`)\n    INNER JOIN  `i_tipoproducto` \n        ON (`i_suministro`.`IdTipoProducto` = `i_tipoproducto`.`Id`)\n    INNER JOIN  `f_tarifasuministro` \n        ON (`f_tarifasuministro`.`Id_suministro` = `i_suministro`.`Id`)\nWHERE (`f_tarifasuministro`.`Id_manual` ='" + this.xidmanual[this.JCBManual.getSelectedIndex()] + "')\nORDER BY `NSuministro` ASC";
                ...
                if (xrs2.next()) {
                    ...
                    int b2 = 0;
                    while (xrs2.next()) {
                        sheet2.addCell(new Label(0, b2 + 1, xrs2.getString(1)));
                        sheet2.addCell(new Label(1, b2 + 1, xrs2.getString(2)));
                        sheet2.addCell(new Label(2, b2 + 1, xrs2.getString(3)));
                        sheet2.addCell(new Label(3, b2 + 1, xrs2.getString(4)));
                        sheet2.addCell(new Label(4, b2 + 1, xrs2.getString(5)));
                        sheet2.addCell(new Label(5, b2 + 1, xrs2.getString(6)));
                        sheet2.addCell(new Label(6, b2 + 1, xrs2.getString(7)));
                        sheet2.addCell(new Label(7, b2 + 1, xrs2.getString(8)));
                        sheet2.addCell(new Label(8, b2 + 1, xrs2.getString(9)));
                        sheet2.addCell(new Label(9, b2 + 1, xrs2.getString(10)));
                        sheet2.addCell(new Number(10, b2 + 1, xrs2.getDouble(11)));
                        b2++;
                    }
                }
                xrs2.close();
                ...
                Logger.getLogger(JIFFEmpresaBienestarSalud.class.getName()).log(Level.SEVERE, (String) null, (Throwable) ex2);
            }
        }
    }
    ...
    public void mNuevo() {
        ...
        this.uuidEmpresaConvenioEditar = "";
        this.JTFFNombreCargoBS1.setText("");
        mCrearModeloCargosBS1();
    ...
    public void mGrabar() {
        System.out.println("ENTRO A GRABAR TERCERO PARA BIENESTAR SALUD");
            ...
            if (mValidarDatosP()) {
                ...
                if (x == 0) {
                    ...
                    if (existe == 0) {
                        ...
                        JOptionPane.showInternalMessageDialog(this, "ESTE NÚMERO DE IDENTIFICACIÓN YA SE ENCUENTRA REGISTRADO EN UN TERCERO.", "VERIFICAR- " + StringUtils.trim(this.JTFFNDocumento.getText()), 1, new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/Imagenes/Information.png"))));
                    }
                }
            }
        } else {
    ...
    private void cargarAseguradoras() {
        System.out.println("entra al metodo a cargar aseguradoras");
        mCrearModeloAseguradora();
        this.aAseguradoraProjection = this.aAseguradoraService.ListarAseguradoras();
        System.out.println("entra al metodo" + this.aAseguradoraProjection.size());
    ...
    private void mCrearModeloAseguradora() {
        this.xmodeloAseguradora = new DefaultTableModel(new Object[0], new String[]{"id", "Nombre", "Codigo", "Fecha"}) { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.83
    ...
    private void mCrearTablaEmpresaxConvenio() {
        this.xmodelo1 = new DefaultTableModel((Object[][]) null, new String[]{"Id", "Nombre", "Manual", "Modo", "Metodo Facturación", "FiltroEmpresa", "Cupo Cita", "Estado", "NDiasP", "NPrioridad", "Régimen", "CodRips", "DIps", "Metodo Fact", "Redondeo", "CodigoP", "CodigoM", "GMovimientoC", "AgendaInventario", "4505", "Código Autorización", "Para Asignar Citas", "Tipo Contratación", "Tipo Aseguramiento", "Tipo Plan de Cobertura", "Aplica4505", "Codigo Material?", "Descuento", "Bloquear"}) { // from class: ParametrizacionN.JIFFEmpresaBienestarSalud.84
            Class[] types = {Integer.class, String.class, String.class, Integer.class, String.class, Boolean.class, Integer.class, Boolean.class, Integer.class, Integer.class, String.class, String.class, String.class, Integer.class, Integer.class, String.class, String.class, Boolean.class, Boolean.class, Boolean.class, Boolean.class, Boolean.class, String.class, String.class, String.class, Boolean.class, Boolean.class, Boolean.class, Boolean.class};
        ...
        JTable jTable = this.JTBEmpresaxC;
        JTable jTable2 = this.JTBEmpresaxC;
        jTable.setAutoResizeMode(0);
    ...
    private void mCargarDatosCargosBS1(String sql) {
        mCrearModeloCargosBS1();
        ConsultasSqlServer Cs = new ConsultasSqlServer();
        List<Object[]> e = new ArrayList<>();
        ResultSet rs2 = Cs.traerRs(sql);
        try {
            if (rs2.next()) {
                rs2.beforeFirst();
                while (rs2.next()) {
                    Object[] fila = {rs2.getString("Car_ID"), rs2.getString("Car_Nombre")};
                    e.add(fila);
                    this.xmodeloCargosBS1.addRow(new Object[]{rs2.getString("Car_ID"), rs2.getString("Car_Nombre")});
                }
            }
            rs2.close();
            this.xct.cerrarConexionBd();
        ...
        try {
            if (rs.next()) {
                ...
                while (rs.next()) {
                    ...
                    this.xmodelo.setValueAt(Boolean.valueOf(rs.getBoolean(34)), x, 33);
    ...
    private void mCargarDatosEps() {
        ...
        System.out.println(" Datos Eps : " + sql);
        ResultSet rs = this.xct.traerRs(sql);
        try {
            if (rs.next()) {
    ...
    private void mGrabarAseguradora() {
        ...
        System.out.println(this.JCBTipoEmpresa.getSelectedItem().toString());
        ...
        if (tipoEmpresa.equals("SOAT") && !existe.booleanValue()) {
            System.out.println("Entro a la condicional grabar aseguradora");
        ...
        System.out.println("Error no es SOAT o ya existe");
    }

    private void mRealizarHomologacionEmpresa(String idConvenioBS1, String nombreConvenioBS1, String idConvenioGenoma, String nombreConvenioGenoma) {
        ConsultasMySQL cs = new ConsultasMySQL();
        String QueryHomologacion = "INSERT INTO g_homologacion_convenio\n(idConvenioBS1, nombreConvenioBS1, idConvenioGenoma, nombreConvenioGenoma, estado, fechaRegistro, usuarioSistema)\nVALUES('" + idConvenioBS1 + "', '" + nombreConvenioBS1 + "', '" + idConvenioGenoma + "', '" + nombreConvenioGenoma + "', 1, '" + this.xmt.formatoAMDH24.format(this.xmt.getFechaActual()) + "', '" + Principal.usuarioSistemaDTO.getLogin() + "');";
        cs.ejecutarSQL(QueryHomologacion);
        cs.cerrarConexionBd();
        System.out.println("HOMOLOGÓ EL CONVENIO.........");
    }

    private String mGuardarDireccionEmpBS1(String nombreMunicipio) {
        UUID uuidContacto = UUID.randomUUID();
        UUID uuidGeneralUbicacion = UUID.randomUUID();
        ConsultasSqlServer Cs = new ConsultasSqlServer();
        String idMunicipioBS1 = "680";
        String Query = "select Mun_ID from General_Municipio gm\nWHERE gm.Mun_Nombre ='" + nombreMunicipio + "'";
        try {
            ...
            try {
                try {
                    if (rs.next()) {
                        try {
                            idMunicipioBS1 = String.valueOf(rs.getInt("Mun_ID"));
                        } catch (Exception e) {
                        }
                    }
                    if (rs != null) {
        ...
        String QuerySaveContacto = "INSERT INTO General_Contacto\n(Con_ID, Con_CorreoElectronico)\nVALUES('" + String.valueOf(uuidContacto) + "', '" + this.JTFContacto.getText() + "');";
        Cs.ejecutarSQL(QuerySaveContacto);
        Cs.cerrarConexionBd();
        String QuerySaveGUbicacion = "INSERT INTO General_Ubicacion\n(Ubc_ID, Ubc_Direccion, Ubc_Barrio, zMun_ID, zZon_ID, zCon_ID)\nVALUES('" + String.valueOf(uuidGeneralUbicacion) + "', '" + this.JTFDireccion.getText() + "', '', '" + idMunicipioBS1 + "', NULL, '" + uuidContacto + "');";
        Cs.ejecutarSQL(QuerySaveGUbicacion);
        Cs.cerrarConexionBd();
        return String.valueOf(uuidGeneralUbicacion);
    }

    private void mGuardarCargosEmpresaBS1(String uuidEmpresa) {
        ConsultasSqlServer Cs = new ConsultasSqlServer();
        if (this.uuidEmpresaConvenioEditar.equals("")) {
            for (int i = 0; i < this.JTBCargosEmpresaBS1.getRowCount(); i++) {
                System.out.println("Registro número: " + i);
                System.out.println("ID: " + this.JTBCargosEmpresaBS1.getValueAt(i, 0));
                System.out.println("NOMBRE CARGO: " + this.JTBCargosEmpresaBS1.getValueAt(i, 1));
                String Query = "INSERT INTO Empresa_Cargo\n(Car_ID, Car_Nombre, zEmpr_ID)\nVALUES('" + this.JTBCargosEmpresaBS1.getValueAt(i, 0).toString() + "', '" + this.JTBCargosEmpresaBS1.getValueAt(i, 1).toString() + "', '" + uuidEmpresa + "');";
                Cs.ejecutarSQL(Query);
            }
        }
    }

    private void mGrabarEmpresaConvenioBS1(String idGeneradoConvenioGenoma, String idNitEmpresa) {
        ConsultasSqlServer Cs = new ConsultasSqlServer();
        String QueryValidarExistencia = "select count(Empr_NIT) as empresa from Empresa\nwhere Empr_NIT ='" + idNitEmpresa + "'";
        Cs.cerrarConexionBd();
        int empresaExistenten = Integer.valueOf(Cs.traerDato(QueryValidarExistencia)).intValue();
        if (empresaExistenten == 0) {
            int tipoDePagoEmpresa = 0;
            int diasDePago = ((Integer) this.JSPNDiasP.getValue()).intValue();
            if (diasDePago > 0) {
                tipoDePagoEmpresa = 2;
            } else if (diasDePago == 0) {
                tipoDePagoEmpresa = 1;
            }
            UUID uuid = UUID.randomUUID();
            String ubicacionID = mGuardarDireccionEmpBS1(String.valueOf(this.JCBMunicipio.getSelectedItem()));
            String QueryInsertar = "INSERT INTO Empresa\n(Empr_ID, Empr_NIT, Empr_Sucursal, Empr_RazonSocial, Empr_RazonComercial, Empr_Sigla, Empr_CorreoElectronico, \nzEmp_ID_DirAct, zEmp_ID_SecAct, zEmp_ID_RepLeg, zUbc_ID, Empr_Digito, zFPag_ID, Empr_Password, Empr_UltIngreso, \nEmpr_Bloqueada, Empr_CorreoElectronico2, AccesoWeb, zPer_ID_Creador, FechaR)\nVALUES('" + String.valueOf(uuid) + "','" + this.JTFFNDocumento.getText() + "','1','" + this.JTFFNConvenio.getText() + "', '" + this.JTFFNConvenio.getText() + "','', '" + this.JTFEmail.getText() + "', NULL, NULL, NULL, '" + ubicacionID + "','" + this.JSPDigitoV1.getText() + "', '" + tipoDePagoEmpresa + "', '1234567', NULL, 0, NULL, 0, NULL, NULL);";
            Cs.ejecutarSQL(QueryInsertar);
            Cs.cerrarConexionBd();
            mRealizarHomologacionEmpresa(String.valueOf(uuid), this.JTFFNConvenio.getText(), idGeneradoConvenioGenoma, this.JTFFNConvenio.getText());
            mGuardarCargosEmpresaBS1(String.valueOf(uuid));
            System.out.println("TERMINÓ PROCESO EN GUARDADO DE CONVENIO Y HOMOLOGACIÓN BS1");
            return;
        }
        JOptionPane.showInternalMessageDialog(this, "Ya existe " + idNitEmpresa + " en bs1, se omitió la creacíon.\nRealicé la homologacion manualmente", "Notificación", 1);
    }

    private int validarEmpresaConvenioExistente(String idEmpCont, String nombreNuevoConvenio) {
        String Query = "select COUNT(Nbre) as registros from `f_empresacontxconvenio` \nwhere `Id_EmpresaCont` ='" + idEmpCont + "' and `Nbre`='" + nombreNuevoConvenio + "'";
        int registros = Integer.valueOf(this.xct.traerDato(Query)).intValue();
        this.xct.cerrarConexionBd();
        return registros;
    }

    private void mGrabarDatosEps() {
        int registroExistente = validarEmpresaConvenioExistente(Principal.txtNo.getText(), this.JTFFNConvenio.getText());
        ...
        JOptionPane.showInternalMessageDialog(this, "Ya existe un convenio con este nombre relacionado a este tercero", "VERIFICAR", 1, new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/Imagenes/Information.png"))));
    }
    ...
    /* JADX INFO: loaded from: GenomaP.jar:ParametrizacionN/JIFFEmpresaBienestarSalud$MiRender.class */
