...
/* JADX INFO: loaded from: GenomaP.jar:ParametrizacionN/JIFEntornoAtencion.class */
public class JIFEntornoAtencion extends JInternalFrame {
    private GEntornoAtencion gEntornoAtencion;
    private final IGEntornoAtencionService atencionService;
    private List<GEntornoAtencion> listarGEntornoAtencion;
    ...
    public JIFEntornoAtencion() {
        initComponents();
        this.gEntornoAtencion = new GEntornoAtencion();
        this.atencionService = (IGEntornoAtencionService) Principal.contexto.getBean(IGEntornoAtencionService.class);
        this.listarGEntornoAtencion = new ArrayList();
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("ENTORNO DE ATENCION");
        setFrameIcon(new ImageIcon(getClass().getResource("/Imagenes/genomap.png")));
        setName("jifentornoatencion");
        try {
            setSelected(true);
        ...
        this.JTFCodigo.addKeyListener(new KeyAdapter() { // from class: ParametrizacionN.JIFEntornoAtencion.1
            public void keyTyped(KeyEvent evt) {
                JIFEntornoAtencion.this.JTFCodigoKeyTyped(evt);
            }
        });
        this.JCHEstado.setFont(new Font("Arial", 1, 12));
        this.JCHEstado.setSelected(true);
        this.JCHEstado.setText("Estado");
        this.JCHEstado.addActionListener(new ActionListener() { // from class: ParametrizacionN.JIFEntornoAtencion.2
            public void actionPerformed(ActionEvent evt) {
                JIFEntornoAtencion.this.JCHEstadoActionPerformed(evt);
            }
        });
        ...
        this.JTable.addMouseListener(new MouseAdapter() { // from class: ParametrizacionN.JIFEntornoAtencion.3
            public void mouseClicked(MouseEvent evt) {
                JIFEntornoAtencion.this.JTableMouseClicked(evt);
            }
        });
    ...
    private void crearModeloDatos() {
        this.modelo = new DefaultTableModel(new Object[0], new String[]{"CODIGO", "NOMBRE", "ESTADO"}) { // from class: ParametrizacionN.JIFEntornoAtencion.4
    ...
    private void cargarDatosTabla() {
        crearModeloDatos();
        this.listarGEntornoAtencion = this.atencionService.listarGEntornoAtencion();
        this.listarGEntornoAtencion.forEach(e -> {
    ...
    public void grabar() {
        if (!this.JTFCodigo.getText().isEmpty() || !this.JTFNombre.getText().isEmpty()) {
            this.gEntornoAtencion.setCodigo(this.JTFCodigo.getText());
            this.gEntornoAtencion.setNombre(this.JTFNombre.getText());
            this.gEntornoAtencion.setEstado(Boolean.valueOf(this.JCHEstado.isSelected()));
            this.gEntornoAtencion.setIdUsuario(Principal.usuarioSistemaDTO.getIdUsuarioSistema().toString());
            this.atencionService.grabar(this.gEntornoAtencion);
    ...
    private void selecionarFila() {
        if (this.JTable.getSelectedRow() != -1) {
            this.gEntornoAtencion = this.listarGEntornoAtencion.get(this.JTable.getSelectedRow());
            Principal.txtNo.setText(this.gEntornoAtencion.getId().toString());
            ...
            this.JCHEstado.setSelected(this.listarGEntornoAtencion.get(this.JTable.getSelectedRow()).getEstado().booleanValue());
        }
    }
}
