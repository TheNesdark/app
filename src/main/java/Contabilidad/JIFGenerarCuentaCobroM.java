...
/* JADX INFO: loaded from: GenomaP.jar:Contabilidad/JIFGenerarCuentaCobroM.class */
public class JIFGenerarCuentaCobroM extends JInternalFrame {
    ...
    public JIFGenerarCuentaCobroM(String xnombre) {
        initComponents();
        springStart();
    ...
    private void initComponents() {
        ...
        this.JCBTercero.addItemListener(new ItemListener() { // from class: Contabilidad.JIFGenerarCuentaCobroM.1
            public void itemStateChanged(ItemEvent evt) {
                JIFGenerarCuentaCobroM.this.JCBTerceroItemStateChanged(evt);
            }
        });
        ...
        JPIDatosPLayout.setHorizontalGroup(JPIDatosPLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPIDatosPLayout.createSequentialGroup().addContainerGap().addComponent(this.JDFFechaC, -2, 121, -2).addGap(18, 18, 18).addComponent(this.JCBTercero, -2, 541, -2).addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED).addComponent(this.JSPObservacion, -2, 257, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JSPNDiasP, -2, 101, -2).addContainerGap(-1, 32767)));
        JPIDatosPLayout.setVerticalGroup(JPIDatosPLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(GroupLayout.Alignment.TRAILING, JPIDatosPLayout.createSequentialGroup().addContainerGap().addGroup(JPIDatosPLayout.createParallelGroup(GroupLayout.Alignment.TRAILING).addGroup(JPIDatosPLayout.createSequentialGroup().addGap(0, 0, 32767).addComponent(this.JSPNDiasP, -2, 50, -2)).addComponent(this.JCBTercero, GroupLayout.Alignment.LEADING).addComponent(this.JDFFechaC, GroupLayout.Alignment.LEADING, -1, -1, 32767).addComponent(this.JSPObservacion)).addContainerGap()));
        ...
        this.JTFFValor.addFocusListener(new FocusAdapter() { // from class: Contabilidad.JIFGenerarCuentaCobroM.2
            public void focusLost(FocusEvent evt) {
                JIFGenerarCuentaCobroM.this.JTFFValorFocusLost(evt);
            }
        });
        this.JTFFValor.addKeyListener(new KeyAdapter() { // from class: Contabilidad.JIFGenerarCuentaCobroM.3
            public void keyPressed(KeyEvent evt) {
                JIFGenerarCuentaCobroM.this.JTFFValorKeyPressed(evt);
            }
        });
        ...
        this.JCBConcepto.addItemListener(new ItemListener() { // from class: Contabilidad.JIFGenerarCuentaCobroM.4
            public void itemStateChanged(ItemEvent evt) {
                JIFGenerarCuentaCobroM.this.JCBConceptoItemStateChanged(evt);
            }
        });
        this.JCBConcepto.addMouseListener(new MouseAdapter() { // from class: Contabilidad.JIFGenerarCuentaCobroM.5
            public void mouseClicked(MouseEvent evt) {
                JIFGenerarCuentaCobroM.this.JCBConceptoMouseClicked(evt);
            }
        });
        this.JCBConcepto.addActionListener(new ActionListener() { // from class: Contabilidad.JIFGenerarCuentaCobroM.6
            public void actionPerformed(ActionEvent evt) {
                JIFGenerarCuentaCobroM.this.JCBConceptoActionPerformed(evt);
            }
        });
        ...
        this.JBTAdicionar.addFocusListener(new FocusAdapter() { // from class: Contabilidad.JIFGenerarCuentaCobroM.7
            public void focusGained(FocusEvent evt) {
                JIFGenerarCuentaCobroM.this.JBTAdicionarFocusGained(evt);
            }
        });
        this.JBTAdicionar.addActionListener(new ActionListener() { // from class: Contabilidad.JIFGenerarCuentaCobroM.8
            public void actionPerformed(ActionEvent evt) {
                JIFGenerarCuentaCobroM.this.JBTAdicionarActionPerformed(evt);
            }
        });
        this.JCHDetalle.setFont(new Font("Arial", 1, 12));
        this.JCHDetalle.setForeground(Color.blue);
        this.JCHDetalle.setText("Es Detalle?");
        this.JCHDetalle.addActionListener(new ActionListener() { // from class: Contabilidad.JIFGenerarCuentaCobroM.9
            public void actionPerformed(ActionEvent evt) {
                JIFGenerarCuentaCobroM.this.JCHDetalleActionPerformed(evt);
            }
        });
        ...
        this.JTFFValorTotal.addFocusListener(new FocusAdapter() { // from class: Contabilidad.JIFGenerarCuentaCobroM.10
            public void focusGained(FocusEvent evt) {
                JIFGenerarCuentaCobroM.this.JTFFValorTotalFocusGained(evt);
            }
        });
        ...
        this.JTFFCantidad.addFocusListener(new FocusAdapter() { // from class: Contabilidad.JIFGenerarCuentaCobroM.11
            public void focusLost(FocusEvent evt) {
                JIFGenerarCuentaCobroM.this.JTFFCantidadFocusLost(evt);
            }
        });
        this.JTFFCantidad.addInputMethodListener(new InputMethodListener() { // from class: Contabilidad.JIFGenerarCuentaCobroM.12
            public void inputMethodTextChanged(InputMethodEvent evt) {
                JIFGenerarCuentaCobroM.this.JTFFCantidadInputMethodTextChanged(evt);
            }

            public void caretPositionChanged(InputMethodEvent evt) {
            }
        });
        this.JTFFCantidad.addKeyListener(new KeyAdapter() { // from class: Contabilidad.JIFGenerarCuentaCobroM.13
            public void keyPressed(KeyEvent evt) {
                JIFGenerarCuentaCobroM.this.JTFFCantidadKeyPressed(evt);
            }

            public void keyReleased(KeyEvent evt) {
                JIFGenerarCuentaCobroM.this.JTFFCantidadKeyReleased(evt);
            }
        });
        ...
        this.jtffPorcentajeImpuesto.addFocusListener(new FocusAdapter() { // from class: Contabilidad.JIFGenerarCuentaCobroM.14
            public void focusLost(FocusEvent evt) {
                JIFGenerarCuentaCobroM.this.jtffPorcentajeImpuestoFocusLost(evt);
            }
        });
        this.jtffPorcentajeImpuesto.addKeyListener(new KeyAdapter() { // from class: Contabilidad.JIFGenerarCuentaCobroM.15
            public void keyPressed(KeyEvent evt) {
                JIFGenerarCuentaCobroM.this.jtffPorcentajeImpuestoKeyPressed(evt);
            }
        });
        ...
        this.JTFFDescuento.addFocusListener(new FocusAdapter() { // from class: Contabilidad.JIFGenerarCuentaCobroM.16
            public void focusLost(FocusEvent evt) {
                JIFGenerarCuentaCobroM.this.JTFFDescuentoFocusLost(evt);
            }
        });
        this.JTFFDescuento.addInputMethodListener(new InputMethodListener() { // from class: Contabilidad.JIFGenerarCuentaCobroM.17
            public void inputMethodTextChanged(InputMethodEvent evt) {
                JIFGenerarCuentaCobroM.this.JTFFDescuentoInputMethodTextChanged(evt);
            }

            public void caretPositionChanged(InputMethodEvent evt) {
            }
        });
        this.JTFFDescuento.addKeyListener(new KeyAdapter() { // from class: Contabilidad.JIFGenerarCuentaCobroM.18
            public void keyPressed(KeyEvent evt) {
                JIFGenerarCuentaCobroM.this.JTFFDescuentoKeyPressed(evt);
            }

            public void keyReleased(KeyEvent evt) {
                JIFGenerarCuentaCobroM.this.JTFFDescuentoKeyReleased(evt);
            }
        });
        GroupLayout JPIConsultaLayout = new GroupLayout(this.JPIConsulta);
        this.JPIConsulta.setLayout(JPIConsultaLayout);
        JPIConsultaLayout.setHorizontalGroup(JPIConsultaLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPIConsultaLayout.createSequentialGroup().addContainerGap().addComponent(this.JCBConcepto, -2, 333, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED, -1, 32767).addComponent(this.jtffPorcentajeImpuesto, -2, 69, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JTFFCantidad, -2, 83, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JTFFValor, -2, 105, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JTFFDescuento, -2, 76, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JTFFValorTotal, -2, 111, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JCHDetalle, -2, 97, -2).addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED).addComponent(this.JBTAdicionar, -2, 124, -2).addContainerGap()));
        JPIConsultaLayout.setVerticalGroup(JPIConsultaLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPIConsultaLayout.createSequentialGroup().addGroup(JPIConsultaLayout.createParallelGroup(GroupLayout.Alignment.TRAILING).addGroup(GroupLayout.Alignment.LEADING, JPIConsultaLayout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(this.JBTAdicionar, -2, 52, -2).addComponent(this.JCHDetalle)).addGroup(JPIConsultaLayout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(this.JCBConcepto, -2, 52, -2).addComponent(this.JTFFValor, -2, 52, -2).addComponent(this.JTFFCantidad, -2, 52, -2).addComponent(this.JTFFValorTotal, -2, 52, -2).addComponent(this.jtffPorcentajeImpuesto, -2, 52, -2).addComponent(this.JTFFDescuento, -2, 52, -2))).addContainerGap(-1, 32767)));
        ...
        this.JTResultado.addKeyListener(new KeyAdapter() { // from class: Contabilidad.JIFGenerarCuentaCobroM.19
            public void keyPressed(KeyEvent evt) {
                JIFGenerarCuentaCobroM.this.JTResultadoKeyPressed(evt);
            }
        });
        ...
        this.JCBSubGrupo.addItemListener(new ItemListener() { // from class: Contabilidad.JIFGenerarCuentaCobroM.20
            public void itemStateChanged(ItemEvent evt) {
                JIFGenerarCuentaCobroM.this.JCBSubGrupoItemStateChanged(evt);
            }
        });
        ...
        this.JCHMovxConcepto.addActionListener(new ActionListener() { // from class: Contabilidad.JIFGenerarCuentaCobroM.21
            public void actionPerformed(ActionEvent evt) {
                JIFGenerarCuentaCobroM.this.JCHMovxConceptoActionPerformed(evt);
            }
        });
        ...
        this.JBT_EnvioDian.addActionListener(new ActionListener() { // from class: Contabilidad.JIFGenerarCuentaCobroM.22
            public void actionPerformed(ActionEvent evt) {
                JIFGenerarCuentaCobroM.this.JBT_EnvioDianActionPerformed(evt);
            }
        });
        ...
        this.JTFRuta.addMouseListener(new MouseAdapter() { // from class: Contabilidad.JIFGenerarCuentaCobroM.23
            public void mouseClicked(MouseEvent evt) {
                JIFGenerarCuentaCobroM.this.JTFRutaMouseClicked(evt);
            }
        });
        this.JTFRuta.addActionListener(new ActionListener() { // from class: Contabilidad.JIFGenerarCuentaCobroM.24
            public void actionPerformed(ActionEvent evt) {
                JIFGenerarCuentaCobroM.this.JTFRutaActionPerformed(evt);
            }
        });
        ...
        this.JBTActualizarAbdjunto.addFocusListener(new FocusAdapter() { // from class: Contabilidad.JIFGenerarCuentaCobroM.25
            public void focusGained(FocusEvent evt) {
                JIFGenerarCuentaCobroM.this.JBTActualizarAbdjuntoFocusGained(evt);
            }
        });
        this.JBTActualizarAbdjunto.addActionListener(new ActionListener() { // from class: Contabilidad.JIFGenerarCuentaCobroM.26
            public void actionPerformed(ActionEvent evt) {
                JIFGenerarCuentaCobroM.this.JBTActualizarAbdjuntoActionPerformed(evt);
            }
        });
        GroupLayout JPIUtilidadesLayout = new GroupLayout(this.JPIUtilidades);
        this.JPIUtilidades.setLayout(JPIUtilidadesLayout);
        JPIUtilidadesLayout.setHorizontalGroup(JPIUtilidadesLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPIUtilidadesLayout.createSequentialGroup().addGroup(JPIUtilidadesLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPIUtilidadesLayout.createSequentialGroup().addGap(17, 17, 17).addComponent(this.JLB_MensajeDian, -2, 618, -2).addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED).addComponent(this.JLB_EstadoDian, -1, 416, 32767)).addGroup(JPIUtilidadesLayout.createSequentialGroup().addContainerGap(-1, 32767).addComponent(this.JTFRuta, -2, 524, -2).addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED).addComponent(this.JBTActualizarAbdjunto, -2, 184, -2).addGap(162, 162, 162).addComponent(this.JBT_EnvioDian, -2, 166, -2))).addContainerGap()));
        JPIUtilidadesLayout.setVerticalGroup(JPIUtilidadesLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPIUtilidadesLayout.createSequentialGroup().addGap(15, 15, 15).addGroup(JPIUtilidadesLayout.createParallelGroup(GroupLayout.Alignment.TRAILING).addGroup(JPIUtilidadesLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.JBT_EnvioDian, -2, 50, -2).addComponent(this.JTFRuta, -2, 50, -2)).addComponent(this.JBTActualizarAbdjunto, -2, 52, -2)).addGap(18, 18, 18).addGroup(JPIUtilidadesLayout.createParallelGroup(GroupLayout.Alignment.TRAILING).addComponent(this.JLB_MensajeDian, -2, 35, -2).addComponent(this.JLB_EstadoDian, -2, 35, -2)).addContainerGap(49, 32767)));
        this.JTP_DatosFac.addTab("ENVÍO DIAN", this.JPIUtilidades);
        GroupLayout jPanel1Layout = new GroupLayout(this.jPanel1);
        this.jPanel1.setLayout(jPanel1Layout);
        jPanel1Layout.setHorizontalGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(jPanel1Layout.createSequentialGroup().addContainerGap().addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.JPIConsulta, -1, -1, 32767).addComponent(this.JSPResultado).addComponent(this.JTP_DatosFac)).addContainerGap()));
        jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(jPanel1Layout.createSequentialGroup().addComponent(this.JPIConsulta, -2, -1, -2).addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED).addComponent(this.JSPResultado, -2, 189, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JTP_DatosFac)));
        ...
        this.JTResultado1.addPropertyChangeListener(new PropertyChangeListener() { // from class: Contabilidad.JIFGenerarCuentaCobroM.27
            @Override // java.beans.PropertyChangeListener
            public void propertyChange(PropertyChangeEvent evt) {
                JIFGenerarCuentaCobroM.this.JTResultado1PropertyChange(evt);
            }
        });
        ...
        JPI_DFacturaLayout.setVerticalGroup(JPI_DFacturaLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPI_DFacturaLayout.createSequentialGroup().addContainerGap().addComponent(this.JSPResultado1, -1, 479, 32767).addContainerGap()));
        ...
        layout.setVerticalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(layout.createSequentialGroup().addContainerGap().addComponent(this.JPIDatosP, -2, -1, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JTP_Detalle, -1, -1, -2).addContainerGap(-1, 32767)));
        pack();
    }
    ...
    public void JCBConceptoItemStateChanged(ItemEvent evt) {
        if (this.xlleno && this.JCBConcepto.getSelectedIndex() != -1) {
            ...
            this.jtffPorcentajeImpuesto.setValue(Double.valueOf(Double.parseDouble(porImpuesto)));
    ...
    public void JBTAdicionarActionPerformed(ActionEvent evt) {
        ...
        if (this.JCBConcepto.getSelectedIndex() != -1) {
            if (!this.JTFFValor.getText().isEmpty()) {
                if (!this.xmt.mVerificarDatosDoblesTabla(this.JTResultado, 0, this.xidconcepto[this.JCBConcepto.getSelectedIndex()][0])) {
                    this.xmodelo.addRow(this.xdato);
                    this.xmodelo.setValueAt(this.xidconcepto[this.JCBConcepto.getSelectedIndex()][0], this.xnfila, 0);
                    this.xmodelo.setValueAt(this.JCBConcepto.getSelectedItem(), this.xnfila, 1);
                ...
                JOptionPane.showInternalMessageDialog(this, "Conceto ya se encuentra en la tabla", "Verificación", 1, new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/Imagenes/Information.png"))));
                return;
            }
    ...
    public void JBT_EnvioDianActionPerformed(ActionEvent evt) {
        if (!this.JTFFNFacturaEvento.getText().isEmpty()) {
            ...
            this.xIFacturaElectronicaDAO.mGenerarFacturaElectronica(this.xnfacturaevento, 0, Boolean.valueOf(formaEnvio), this.adjunto);
            this.adjunto = new ArrayList();
        }
    }
        ...
        if (evt.getClickCount() == 2) {
            ...
            if (r == 0) {
                ...
                try {
                    ...
                    Logger.getLogger(JIFGenerarCuentaCobroM.class.getName()).log(Level.SEVERE, (String) null, (Throwable) ex);
                }
                this.adjunto.add(a);
            }
        }
    ...
    public void mGrabar() {
        ...
        cd.setDescripcion(this.JTAObservacion.getText() + " Factura Venta N° " + this.JTFFNFacturaEvento.getText());
                    ...
                    if (Principal.xclase.mValidarFechasDoc(this.JDFFechaC.getDate())) {
                        ...
                        if (x == 0) {
                            ...
                            if (!this.JCH_AplicaMP.isSelected() && this.JCH_AplicaMC.isSelected()) {
                                ...
                                if (!this.xidsubgrupo[this.JCBSubGrupo.getSelectedIndex()][5].equals("")) {
                                    if (this.JTResultado.getRowCount() > 0) {
                                        if (!this.xmt.mVerificarDatosLLeno(this.JTResultado, 6) && !this.xmt.mVerificarDatosLLeno(this.JTResultado, 7)) {
                                            if (this.JCBTipoC.getSelectedIndex() != -1) {
                                                if (this.JCBMedioDePago.getSelectedIndex() != -1) {
    ...
    private void mGrabarCuentaCorbro() {
        ...
        for (int y = 0; y < this.JTResultado.getRowCount(); y++) {
            String sql2 = "insert into cc_detalle_cuentacobrom (Id_cuentacobro, Id_ConceptoCC, TipoConcepto, Valor, cantidad,porcentajeImpuesto,valorImpuesto,valorTotalImpuesto, descuento)Values ('" + Principal.txtNo.getText() + "','" + this.xmodelo.getValueAt(y, 0) + "','" + this.xmodelo.getValueAt(y, 8) + "','" + this.xmodelo.getValueAt(y, 2) + "','" + this.xmodelo.getValueAt(y, 3) + "','" + this.xmodelo.getValueAt(y, 5) + "','" + this.xmodelo.getValueAt(y, 11) + "','" + this.xmodelo.getValueAt(y, 6) + "','" + this.descuentoTotal + "')";
            this.xct.ejecutarSQL(sql2);
            this.xct.cerrarConexionBd();
        }
        for (int y2 = 0; y2 < this.JTResultado1.getRowCount(); y2++) {
            if (Boolean.valueOf(this.xmodelo1.getValueAt(y2, 7).toString()).booleanValue()) {
                String sql3 = "update cc_documentoc set Id_CuentaCobro='" + Principal.txtNo.getText() + "' where Id='" + this.xmodelo1.getValueAt(y2, 5) + "'";
    ...
    private void mGrabarDetalleDoc_PorConcepto(String xnfactura) {
        ...
        for (int x = 0; x < this.JTResultado.getRowCount(); x++) {
            this.xsql = "insert into cc_detalle_documentoc (Id_Documentoc, Id_Puc, TipoCPuc, Id_Tercero, NFactura, VDebito, VCredito, Concepto) Values ('" + Principal.txtNo.getText() + "','" + this.xmodelo.getValueAt(x, 10).toString() + "','1','" + this.xidempresa[this.JCBTercero.getSelectedIndex()] + "','" + xnfactura + "','0','" + this.xmodelo.getValueAt(x, 7) + "','" + this.JTAObservacion.getText() + "  Factura de Venta N° : " + this.JTFFNFacturaEvento.getText() + "'  )";
            xct1.ejecutarSQL(this.xsql);
            xct1.cerrarConexionBd();
        }
        this.xsql = "insert into cc_detalle_documentoc (Id_Documentoc, Id_Puc, TipoCPuc, Id_Tercero, NFactura, VDebito, VCredito, Concepto) Values ('" + Principal.txtNo.getText() + "','" + this.medioDePago.get(this.JCBMedioDePago.getSelectedIndex()).getCodigo() + "','0','" + this.xidempresa[this.JCBTercero.getSelectedIndex()] + "','" + xnfactura + "','" + this.JTFFTotalizarR.getValue() + "','0','" + this.JTAObservacion.getText() + "  Factura de Venta N° : " + this.JTFFNFacturaEvento.getText() + "'  )";
        xct1.ejecutarSQL(this.xsql);
        xct1.cerrarConexionBd();
    }
    ...
    private void mGrabarDetalle_Normal(String xnfactura) {
        ConsultasMySQL xct1 = new ConsultasMySQL();
        this.xsql = "insert into cc_detalle_documentoc (Id_Documentoc, Id_Puc, TipoCPuc, Id_Tercero, NFactura, VDebito, VCredito, Concepto) Values ('" + Principal.txtNo.getText() + "','" + this.xidsubgrupo[this.JCBSubGrupo.getSelectedIndex()][4] + "','0','" + this.xidempresa[this.JCBTercero.getSelectedIndex()] + "','" + xnfactura + "','" + this.JTFFTotalizarR.getValue() + "','0','" + this.JTAObservacion.getText() + "  Factura de Venta N° : " + this.JTFFNFacturaEvento.getText() + "'  )";
        xct1.ejecutarSQL(this.xsql);
        xct1.cerrarConexionBd();
        this.xsql = "insert into cc_detalle_documentoc (Id_Documentoc, Id_Puc, TipoCPuc, Id_Tercero, NFactura, VDebito, VCredito, Concepto) Values ('" + Principal.txtNo.getText() + "','" + this.xidsubgrupo[this.JCBSubGrupo.getSelectedIndex()][5] + "','1','" + this.xidempresa[this.JCBTercero.getSelectedIndex()] + "','" + xnfactura + "','0','" + this.JTFFTotalizarR.getValue() + "','" + this.JTAObservacion.getText() + "  Factura de Venta N° : " + this.JTFFNFacturaEvento.getText() + "'  )";
        xct1.ejecutarSQL(this.xsql);
        xct1.cerrarConexionBd();
    }
    ...
    public void mNuevo() {
        ...
        this.xsql = "SELECT  `cc_terceros`.`Id` , `cc_terceros`.`RazonSocialCompleta`  FROM `f_empresacontxconvenio` INNER JOIN `cc_terceros`  ON (`f_empresacontxconvenio`.`Id_EmpresaCont` = `cc_terceros`.`Id`) INNER JOIN `f_subgrupo_empresa`  ON (`f_subgrupo_empresa`.`Id_Empresa` = `f_empresacontxconvenio`.`Id`) where cc_terceros.Estado=1 GROUP BY `cc_terceros`.`Id` ORDER BY `cc_terceros`.`RazonSocialCompleta` ASC ";
        ...
        if (Principal.informacionIps.getManejaPresupuesto().intValue() == 1) {
            ...
            if (Principal.informacionIps.getNombreIps().equals("891982129")) {
    ...
    private void mCrearTabla() {
        this.xmodelo = new DefaultTableModel((Object[][]) null, new String[]{"Id", "Concepto", "Valor", "Cantidad", "Subtotal", "%Imp", "Valor Imp", "Total", "Tipo", "Debito", "Credito", "Valor Unit Impuesto", "Descuento"}) { // from class: Contabilidad.JIFGenerarCuentaCobroM.28
    ...
    private void mCrearTabla_Proveedores() {
        this.xmodelo1 = new DefaultTableModel((Object[][]) null, new String[]{"Id", "Empresa", "N° Comprobante", "N° Radicación", "Fecha Radicación", "N° DocumentoC", "Valor", "Reembolsar?", "Concepto"}) { // from class: Contabilidad.JIFGenerarCuentaCobroM.29
    ...
    private void mGenerarFacturaEvento() {
        ...
        if (Principal.informacionIps.getNombreIps().equals("CLINICA OFTALMOLOGICA DAJUD SAS") || Principal.informacionIps.getNombreIps().equals("COD-OPTICA UT") || Principal.informacionIps.getNombreIps().equals("JAIME CESAR DAJUD FERNANDEZ") || Principal.informacionIps.getNombreIps().equals("CLINICA LAURELES PSIQUIATRAS ASOCIADOS I.P.S. S.A.S.") || Principal.informacionIps.getNombreIps().equals("UNION TEMPORAL CLINICA LAURELES")) {
            sql = "insert into f_factura_evento(Fecha_FacturaEvento, Prefijo, No_FacturaEvento_M, Id_Liquidacion, idResolucionDian, idMedioPago, EstaArmada, No_CuentaCobro, ConceptoCobro, Sede, diasPago, Fecha, UsuarioS)  values('" + this.xmt.formatoAMD.format(this.xmt.getFechaActual()) + "','" + this.resolucionDian.getPrefijo() + "','" + this.resolucionDian.getConsecutivoFE() + "','" + xidliquidacion + "','" + this.resolucionDian.getId() + "','" + this.medioDePago.get(this.JCBMedioDePago.getSelectedIndex()).getId() + "','2','" + xcuentacobro + "','" + this.JTAObservacion.getText() + "','" + Principal.sedeUsuarioSeleccionadaDTO.getNombre() + "','" + this.JSPNDiasP.getValue() + "','" + this.xmt.formatoAMDH24.format(this.xmt.getFechaActual()) + "','" + Principal.usuarioSistemaDTO.getLogin() + "')";
        } else {
            String path = this.JTFRuta.getText();
            String escapedFilepath = path.replace("\\", "\\\\");
            System.out.println("Path: " + path + " Replace = " + escapedFilepath);
            sql = "insert into f_factura_evento(Fecha_FacturaEvento,  Prefijo, No_FacturaEvento_M, Id_Liquidacion, idResolucionDian, idMedioPago, EstaArmada, No_CuentaCobro, ConceptoCobro, Sede, archivoAbjunto,diasPago, Fecha, UsuarioS)  values('" + this.xmt.formatoAMD.format(this.xmt.getFechaActual()) + "','" + this.resolucionDian.getPrefijo() + "','" + this.resolucionDian.getConsecutivoFE() + "','" + xidliquidacion + "','" + this.resolucionDian.getId() + "','" + this.medioDePago.get(this.JCBMedioDePago.getSelectedIndex()).getId() + "','2','" + xcuentacobro + "','" + this.JTAObservacion.getText() + "','" + Principal.sedeUsuarioSeleccionadaDTO.getNombre() + "','" + escapedFilepath + "','" + this.JSPNDiasP.getValue() + "','" + this.xmt.formatoAMDH24.format(this.xmt.getFechaActual()) + "','" + Principal.usuarioSistemaDTO.getLogin() + "')";
        }
