...
/* JADX INFO: loaded from: GenomaP.jar:Contabilidad/JIFGeneracionDisfon.class */
public class JIFGeneracionDisfon extends JInternalFrame {
    ...
    private void initComponents() {
        ...
        this.JBTGenerar.addActionListener(new ActionListener() { // from class: Contabilidad.JIFGeneracionDisfon.1
            public void actionPerformed(ActionEvent evt) {
                JIFGeneracionDisfon.this.JBTGenerarActionPerformed(evt);
            }
        });
        this.JTFRuta.setFont(new Font("Arial", 1, 12));
        this.JTFRuta.setBorder(BorderFactory.createTitledBorder((Border) null, "Ruta", 0, 0, new Font("Arial", 1, 12), Color.blue));
        this.JTFRuta.addMouseListener(new MouseAdapter() { // from class: Contabilidad.JIFGeneracionDisfon.2
            public void mouseClicked(MouseEvent evt) {
                JIFGeneracionDisfon.this.JTFRutaMouseClicked(evt);
            }
        });
        ...
        this.JRBTNo.addActionListener(new ActionListener() { // from class: Contabilidad.JIFGeneracionDisfon.3
            public void actionPerformed(ActionEvent evt) {
                JIFGeneracionDisfon.this.JRBTNoActionPerformed(evt);
            }
        });
        ...
        try {
            try {
                try {
                    ...
                    Logger.getLogger(JIFGeneracionDisfon.class.getName()).log(Level.SEVERE, (String) null, (Throwable) ex2);
                    try {
                        bw.close();
