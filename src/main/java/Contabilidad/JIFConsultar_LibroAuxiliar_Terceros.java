...
/* JADX INFO: loaded from: GenomaP.jar:Contabilidad/JIFConsultar_LibroAuxiliar_Terceros.class */
public class JIFConsultar_LibroAuxiliar_Terceros extends JInternalFrame {
    private String[][] xid;
    ...
    public String xIncluirCierre = "in(0,1)";
    public String xAplicaNiif = "in(0)";

    public JIFConsultar_LibroAuxiliar_Terceros(String xTitulo) {
        initComponents();
    ...
    private void initComponents() {
        ...
        setIconifiable(true);
        setMaximizable(true);
        setTitle("CONSULTAR LIBRO AUXILIAR POR TERCERO");
        setFrameIcon(new ImageIcon(getClass().getResource("/Imagenes/genomap.png")));
        setName("xjif_libro_auxiliar_terceros");
        this.JTFRuta.setFont(new Font("Arial", 1, 12));
        this.JTFRuta.setText("C:\\Genoma\\plantilla");
        this.JTFRuta.setBorder(BorderFactory.createTitledBorder((Border) null, "Ubicación de archivo a exportar", 0, 0, new Font("Arial", 1, 12), Color.blue));
        this.JTFRuta.addMouseListener(new MouseAdapter() { // from class: Contabilidad.JIFConsultar_LibroAuxiliar_Terceros.1
            public void mouseClicked(MouseEvent evt) {
                JIFConsultar_LibroAuxiliar_Terceros.this.JTFRutaMouseClicked(evt);
            }
        });
        ...
        this.JBTExportar.addActionListener(new ActionListener() { // from class: Contabilidad.JIFConsultar_LibroAuxiliar_Terceros.2
            public void actionPerformed(ActionEvent evt) {
                JIFConsultar_LibroAuxiliar_Terceros.this.JBTExportarActionPerformed(evt);
            }
        });
        ...
        this.JBBuscaTercero.addActionListener(new ActionListener() { // from class: Contabilidad.JIFConsultar_LibroAuxiliar_Terceros.3
            public void actionPerformed(ActionEvent evt) {
                JIFConsultar_LibroAuxiliar_Terceros.this.JBBuscaTerceroActionPerformed(evt);
            }
        });
        GroupLayout JPIDatosPLayout = new GroupLayout(this.JPIDatosP);
        this.JPIDatosP.setLayout(JPIDatosPLayout);
        JPIDatosPLayout.setHorizontalGroup(JPIDatosPLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(GroupLayout.Alignment.TRAILING, JPIDatosPLayout.createSequentialGroup().addContainerGap().addComponent(this.JDCFechaInicio, -2, 125, -2).addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED).addComponent(this.JDCFechaFin, -2, 125, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JLTercero, -2, 494, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED, 9, 32767).addComponent(this.JBBuscaTercero, -2, 58, -2).addContainerGap()));
        JPIDatosPLayout.setVerticalGroup(JPIDatosPLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPIDatosPLayout.createSequentialGroup().addGroup(JPIDatosPLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPIDatosPLayout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(this.JDCFechaInicio, -2, 50, -2).addComponent(this.JDCFechaFin, -2, 50, -2)).addComponent(this.JLTercero, -2, 50, -2).addComponent(this.JBBuscaTercero, -2, 50, -2)).addGap(10, 10, 10)));
        this.JCHVisualizarNiif.setFont(new Font("Arial", 1, 13));
        this.JCHVisualizarNiif.setText("Visualizacion NIIF");
        this.JCHVisualizarNiif.addActionListener(new ActionListener() { // from class: Contabilidad.JIFConsultar_LibroAuxiliar_Terceros.4
            public void actionPerformed(ActionEvent evt) {
                JIFConsultar_LibroAuxiliar_Terceros.this.JCHVisualizarNiifActionPerformed(evt);
            }
        });
        this.JCH_IncluirMovCierre.setFont(new Font("Arial", 1, 13));
        this.JCH_IncluirMovCierre.setText("Incluir Movimiento Cierre?");
        this.JCH_IncluirMovCierre.addActionListener(new ActionListener() { // from class: Contabilidad.JIFConsultar_LibroAuxiliar_Terceros.5
            public void actionPerformed(ActionEvent evt) {
                JIFConsultar_LibroAuxiliar_Terceros.this.JCH_IncluirMovCierreActionPerformed(evt);
            }
        });
        GroupLayout layout = new GroupLayout(getContentPane());
        getContentPane().setLayout(layout);
        layout.setHorizontalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(layout.createSequentialGroup().addContainerGap().addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.JTPDetalle).addGroup(layout.createSequentialGroup().addComponent(this.JTFRuta, -2, 398, -2).addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED).addComponent(this.JBTExportar, -2, 128, -2).addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED).addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(layout.createSequentialGroup().addComponent(this.JCHVisualizarNiif).addGap(0, 0, 32767)).addComponent(this.JCH_IncluirMovCierre, -1, -1, 32767))).addGroup(GroupLayout.Alignment.TRAILING, layout.createSequentialGroup().addGap(0, 0, 32767).addComponent(this.JPIDatosP, -2, -1, -2))).addContainerGap()));
        layout.setVerticalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(layout.createSequentialGroup().addContainerGap().addComponent(this.JPIDatosP, -2, -1, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JTPDetalle, -1, 429, 32767).addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED).addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING, false).addComponent(this.JTFRuta, -2, 50, -2).addComponent(this.JBTExportar, -2, 50, -2).addGroup(layout.createSequentialGroup().addComponent(this.JCHVisualizarNiif).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED, -1, 32767).addComponent(this.JCH_IncluirMovCierre))).addContainerGap()));
        pack();
    }
    ...
    public void mBuscar() {
        if (!"0".equals(this.xidTercero)) {
            this.xWorkerSQL = null;
            this.xWorkerSQL = new WorkerSQL("Cargando la Informacion...", this);
            this.xWorkerSQL.execute();
            return;
        }
        JOptionPane.showInternalMessageDialog(this, "Debe cargar un Tercero", "VERIFICAR", 1, new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/Imagenes/Information.png"))));
    }
    ...
    */
    public void mBuscarM() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: Contabilidad.JIFConsultar_LibroAuxiliar_Terceros.mBuscarM():void");
    }
    ...
    */
    public void mBuscar_Niif() {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: Contabilidad.JIFConsultar_LibroAuxiliar_Terceros.mBuscar_Niif():void");
    }

    private void mCrearModeloDatos2() {
        this.xmodelo2 = new DefaultTableModel() { // from class: Contabilidad.JIFConsultar_LibroAuxiliar_Terceros.6
    ...
    public void mImprimir() {
        ...
        if (this.JCHVisualizarNiif.isSelected()) {
            this.xmt.GenerarPDF(this.xmt.getRutaRep() + "CC_Libro_Auxiliar_AgrupadoTercero_Niif", parametros);
        } else {
            this.xmt.GenerarPDF(this.xmt.getRutaRep() + "CC_Libro_Auxiliar_AgrupadoTercero", parametros);
        }
    }

    /* JADX WARN: Type inference failed for: r4v1, types: [java.lang.Object[], java.lang.Object[][]] */
    private void mCrearModeloDatos() {
        this.xmodelo = new DefaultTableModel(new Object[0], new String[]{"Id", "Auxiliar", "SaldoAnterior", "Debito", "Credito", "SaldoActual"}) { // from class: Contabilidad.JIFConsultar_LibroAuxiliar_Terceros.7
    ...
    private void mCrearTablaTmp() {
        try {
            ...
            this.xct.cerrarConexionBd();
            this.xsql = "ALTER TABLE `cc_tmp_lauxiliar` ENGINE=INNODB AUTO_INCREMENT=1 COMMENT='' ROW_FORMAT=DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci ";
            this.xct.ejecutarSQL(this.xsql);
            this.xct.cerrarConexionBd();
