...
/* JADX INFO: loaded from: GenomaP.jar:Contabilidad/JIFConsultar_BalanceP_Fecha.class */
public class JIFConsultar_BalanceP_Fecha extends JInternalFrame {
    private String[][] xid;
    ...
    public JIFConsultar_BalanceP_Fecha(String xTitulo) {
        initComponents();
    ...
    private void initComponents() {
        ...
        this.JCH_CSaldo.addActionListener(new ActionListener() { // from class: Contabilidad.JIFConsultar_BalanceP_Fecha.1
            public void actionPerformed(ActionEvent evt) {
                JIFConsultar_BalanceP_Fecha.this.JCH_CSaldoActionPerformed(evt);
            }
        });
        this.JCHCTercero.setFont(new Font("Arial", 1, 13));
        this.JCHCTercero.setSelected(true);
        this.JCHCTercero.setText("Con Tercero?");
        this.JCHCTercero.addActionListener(new ActionListener() { // from class: Contabilidad.JIFConsultar_BalanceP_Fecha.2
            public void actionPerformed(ActionEvent evt) {
                JIFConsultar_BalanceP_Fecha.this.JCHCTerceroActionPerformed(evt);
            }
        });
        ...
        this.JCHAplicaNiif.addActionListener(new ActionListener() { // from class: Contabilidad.JIFConsultar_BalanceP_Fecha.3
            public void actionPerformed(ActionEvent evt) {
                JIFConsultar_BalanceP_Fecha.this.JCHAplicaNiifActionPerformed(evt);
            }
        });
        ...
        this.JCH_IncluirMovCierre.addActionListener(new ActionListener() { // from class: Contabilidad.JIFConsultar_BalanceP_Fecha.4
            public void actionPerformed(ActionEvent evt) {
                JIFConsultar_BalanceP_Fecha.this.JCH_IncluirMovCierreActionPerformed(evt);
            }
        });
        this.JTFCuentaInicio.setBorder(BorderFactory.createTitledBorder((Border) null, "Cuenta Inicio", 0, 0, new Font("Arial", 1, 12), new Color(51, 51, 255)));
        this.JTFCuentaFin.setBorder(BorderFactory.createTitledBorder((Border) null, "Cuenta Fin", 0, 0, new Font("Arial", 1, 12), new Color(0, 51, 255)));
        this.JSPNivel.setFont(new Font("Arial", 1, 12));
        this.JSPNivel.setModel(new SpinnerNumberModel(20, 1, 20, 1));
        ...
        jPanel1Layout.setHorizontalGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup().addGap(18, 18, 18).addComponent(this.JDCFechaInicio, -2, 125, -2).addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED).addComponent(this.JDCFechaFin, -2, 125, -2).addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED).addComponent(this.JTFCuentaInicio, -1, 118, 32767).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JTFCuentaFin, -1, 117, 32767).addGap(18, 18, 18).addComponent(this.JSPNivel, -2, 75, -2).addGap(30, 30, 30).addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(jPanel1Layout.createSequentialGroup().addComponent(this.JCH_IncluirMovCierre, -2, 213, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JCHAplicaNiif, -2, 115, -2)).addGroup(jPanel1Layout.createSequentialGroup().addComponent(this.JCHCTercero).addGap(18, 18, 18).addComponent(this.JCH_CSaldo))).addContainerGap(-1, 32767)));
        jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(jPanel1Layout.createSequentialGroup().addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(this.JCHCTercero).addComponent(this.JCH_CSaldo)).addGap(0, 0, 0).addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(this.JCHAplicaNiif).addComponent(this.JCH_IncluirMovCierre)).addGap(0, 0, 32767)).addGroup(jPanel1Layout.createSequentialGroup().addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(jPanel1Layout.createSequentialGroup().addContainerGap().addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING, false).addComponent(this.JTFCuentaInicio, -1, 50, 32767).addComponent(this.JTFCuentaFin))).addGroup(jPanel1Layout.createSequentialGroup().addContainerGap().addComponent(this.JSPNivel, -2, 50, -2)).addGroup(jPanel1Layout.createSequentialGroup().addGap(9, 9, 9).addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.TRAILING, false).addComponent(this.JDCFechaInicio, -1, 53, 32767).addComponent(this.JDCFechaFin, -1, -1, 32767)))).addContainerGap()));
        ...
        this.JTFRuta.addMouseListener(new MouseAdapter() { // from class: Contabilidad.JIFConsultar_BalanceP_Fecha.5
            public void mouseClicked(MouseEvent evt) {
                JIFConsultar_BalanceP_Fecha.this.JTFRutaMouseClicked(evt);
            }
        });
        ...
        this.JBTExportar.addActionListener(new ActionListener() { // from class: Contabilidad.JIFConsultar_BalanceP_Fecha.6
            public void actionPerformed(ActionEvent evt) {
                JIFConsultar_BalanceP_Fecha.this.JBTExportarActionPerformed(evt);
            }
        });
        ...
        this.JBG_Filtro.add(this.JRB_Tipo1);
        this.JRB_Tipo1.setFont(new Font("Arial", 1, 12));
        this.JRB_Tipo1.setSelected(true);
        this.JRB_Tipo1.setText("Colgaap");
        this.JRB_Tipo1.addActionListener(new ActionListener() { // from class: Contabilidad.JIFConsultar_BalanceP_Fecha.7
            public void actionPerformed(ActionEvent evt) {
                JIFConsultar_BalanceP_Fecha.this.JRB_Tipo1ActionPerformed(evt);
            }
        });
        this.JBG_Filtro.add(this.JRB_Tipo2);
        this.JRB_Tipo2.setFont(new Font("Arial", 1, 12));
        this.JRB_Tipo2.setText("Niif");
        this.JRB_Tipo2.addActionListener(new ActionListener() { // from class: Contabilidad.JIFConsultar_BalanceP_Fecha.8
            public void actionPerformed(ActionEvent evt) {
                JIFConsultar_BalanceP_Fecha.this.JRB_Tipo2ActionPerformed(evt);
            }
        });
        ...
        layout.setVerticalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(layout.createSequentialGroup().addComponent(this.jPanel1, -2, -1, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED, -1, 32767).addComponent(this.jScrollPane1, -2, 408, -2).addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED).addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.JTFRuta, -2, 50, -2).addComponent(this.JBTExportar, -2, 50, -2).addComponent(this.JPI_Vsualizar, -1, -1, 32767)).addContainerGap()));
        pack();
    }
    ...
    */
    public void mBuscar_Niif() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: Contabilidad.JIFConsultar_BalanceP_Fecha.mBuscar_Niif():void");
    }
    ...
    */
    public void mBuscarM() {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: Contabilidad.JIFConsultar_BalanceP_Fecha.mBuscarM():void");
    }
    ...
    public void mNuevo() {
        ...
        if (getTitle().equals("LIBRO MAYOR")) {
            this.JCHCTercero.setSelected(false);
            this.JCH_CSaldo.setSelected(false);
    ...
    private void mCrearModeloDatos2() {
        this.xmodelo2 = new DefaultTableModel(new Object[0], new String[]{"IdPuc", "Nombre PUC", "S/Anterior", "V/Debito", "V/Credito", "S/Actual", "CodigoC"}) { // from class: Contabilidad.JIFConsultar_BalanceP_Fecha.9
        ...
        try {
            ...
            if (this.JCH_CSaldo.isSelected()) {
                if (this.JRB_Tipo1.isSelected()) {
                    if (this.JTFCuentaInicio.getText().isEmpty() && this.JTFCuentaFin.getText().isEmpty()) {
                        xsql2 = "SELECT " + this.xcc_puc + ".Id, " + this.xcc_puc + ".Nbre, " + this.xcc_puc + ".SaldoAnterior, " + this.xcc_puc + ".VDebito, " + this.xcc_puc + ".VCredito, " + this.xcc_puc + ".SaldoActual, " + this.xcc_puc + ".id_nivel,  " + this.xcc_puc + ".Id_Tercero,  " + this.xcc_puc + ".CodigoC \nFROM  " + this.xcc_puc + " ,`d_ips`\nWHERE( (" + this.xcc_puc + ".SaldoAnterior<>0 || " + this.xcc_puc + ".VDebito<>0 || " + this.xcc_puc + ".VCredito<>0 || " + this.xcc_puc + ".SaldoActual<>0 ) ) \nAND LENGTH(" + this.xcc_puc + ".Id) <= '" + this.JSPNivel.getValue().toString() + "' \nORDER BY " + this.xcc_puc + ".Id ASC";
                    } else {
                        xsql2 = "SELECT " + this.xcc_puc + ".Id, " + this.xcc_puc + ".Nbre, " + this.xcc_puc + ".SaldoAnterior, " + this.xcc_puc + ".VDebito, " + this.xcc_puc + ".VCredito, " + this.xcc_puc + ".SaldoActual, " + this.xcc_puc + ".id_nivel,  " + this.xcc_puc + ".Id_Tercero,  " + this.xcc_puc + ".CodigoC \nFROM  " + this.xcc_puc + " ,`d_ips`\nWHERE( (" + this.xcc_puc + ".SaldoAnterior<>0 || " + this.xcc_puc + ".VDebito<>0 || " + this.xcc_puc + ".VCredito<>0 || " + this.xcc_puc + ".SaldoActual<>0 ) and SUBSTRING( " + this.xcc_puc + ".Id,1," + this.JTFCuentaInicio.getText().length() + ") >= " + this.JTFCuentaInicio.getText() + " AND SUBSTRING( " + this.xcc_puc + ".Id,1," + this.JTFCuentaFin.getText().length() + ") <= " + this.JTFCuentaFin.getText() + " ) \nAND LENGTH(" + this.xcc_puc + ".Id) <= '" + this.JSPNivel.getValue().toString() + "' \nORDER BY " + this.xcc_puc + ".Id ASC";
                    }
                } else if (this.JTFCuentaInicio.getText().isEmpty() && this.JTFCuentaFin.getText().isEmpty()) {
                    xsql2 = "SELECT cc_puc_niif.Id, cc_puc_niif.Nbre,cc_puc_niif.SaldoAnterior,cc_puc_niif.VDebito, cc_puc_niif.VCredito, cc_puc_niif.SaldoActual,cc_puc_niif.id_nivel, cc_puc_niif.Id_Tercero, cc_puc_niif.CodigoC \nFROM cc_puc_niif ,`d_ips`\nWHERE( (cc_puc_niif.SaldoAnterior<>0 || cc_puc_niif.VDebito<>0 || cc_puc_niif.VCredito<>0 ||cc_puc_niif.SaldoActual<>0)   ) \nAND LENGTH(cc_puc_niif.Id) <= '" + this.JSPNivel.getValue().toString() + "' \nORDER BY cc_puc_niif.Id ASC";
                } else {
                    xsql2 = "SELECT cc_puc_niif.Id, cc_puc_niif.Nbre,cc_puc_niif.SaldoAnterior,cc_puc_niif.VDebito, cc_puc_niif.VCredito, cc_puc_niif.SaldoActual,cc_puc_niif.id_nivel, cc_puc_niif.Id_Tercero, cc_puc_niif.CodigoC \nFROM cc_puc_niif ,`d_ips`\nWHERE( (cc_puc_niif.SaldoAnterior<>0 || cc_puc_niif.VDebito<>0 || cc_puc_niif.VCredito<>0 ||cc_puc_niif.SaldoActual<>0) and  SUBSTRING( cc_puc_niif.Id,1," + this.JTFCuentaInicio.getText().length() + ") >= " + this.JTFCuentaInicio.getText() + " AND SUBSTRING( cc_puc_niif.Id,1," + this.JTFCuentaFin.getText().length() + ") <= " + this.JTFCuentaFin.getText() + " ) \nAND LENGTH(cc_puc_niif.Id) <= '" + this.JSPNivel.getValue().toString() + "' \nORDER BY cc_puc_niif.Id ASC";
                }
            } else if (this.JRB_Tipo1.isSelected()) {
                if (this.JTFCuentaInicio.getText().isEmpty() && this.JTFCuentaFin.getText().isEmpty()) {
                    xsql2 = "SELECT " + this.xcc_puc + ".Id, " + this.xcc_puc + ".Nbre, " + this.xcc_puc + ".SaldoAnterior, " + this.xcc_puc + ".VDebito, " + this.xcc_puc + ".VCredito, " + this.xcc_puc + ".SaldoActual, " + this.xcc_puc + ".id_nivel,  " + this.xcc_puc + ".Id_Tercero,  " + this.xcc_puc + ".CodigoC \nFROM  " + this.xcc_puc + " ,`d_ips`  \nWHERE LENGTH(" + this.xcc_puc + ".Id) <= '" + this.JSPNivel.getValue().toString() + "' \nORDER BY " + this.xcc_puc + ".Id ASC";
                } else {
                    xsql2 = "SELECT " + this.xcc_puc + ".Id, " + this.xcc_puc + ".Nbre, " + this.xcc_puc + ".SaldoAnterior, " + this.xcc_puc + ".VDebito, " + this.xcc_puc + ".VCredito, " + this.xcc_puc + ".SaldoActual, " + this.xcc_puc + ".id_nivel,  " + this.xcc_puc + ".Id_Tercero,  " + this.xcc_puc + ".CodigoC \nFROM  " + this.xcc_puc + " ,`d_ips` where(SUBSTRING( " + this.xcc_puc + ".Id,1," + this.JTFCuentaInicio.getText().length() + ") >= " + this.JTFCuentaInicio.getText() + " AND SUBSTRING( " + this.xcc_puc + ".Id,1," + this.JTFCuentaFin.getText().length() + ") <= " + this.JTFCuentaFin.getText() + " ) \nAND LENGTH(" + this.xcc_puc + ".Id) <= '" + this.JSPNivel.getValue().toString() + "' \nORDER BY " + this.xcc_puc + ".Id ASC";
                }
            } else if (this.JTFCuentaInicio.getText().isEmpty() && this.JTFCuentaFin.getText().isEmpty()) {
                xsql2 = "SELECT  cc_puc_niif.Id,  cc_puc_niif.Nbre,  cc_puc_niif.SaldoAnterior, cc_puc_niif.VDebito, cc_puc_niif.VCredito,  cc_puc_niif.SaldoActual, cc_puc_niif.id_nivel,  cc_puc_niif.Id_Tercero,  cc_puc_niif.CodigoC \nFROM   cc_puc_niif ,`d_ips` WHERE LENGTH(cc_puc_niif.Id) <= '" + this.JSPNivel.getValue().toString() + "' \nORDER BY cc_puc_niif.Id ASC";
            } else {
                xsql2 = "SELECT  cc_puc_niif.Id,  cc_puc_niif.Nbre,  cc_puc_niif.SaldoAnterior, cc_puc_niif.VDebito, cc_puc_niif.VCredito,  cc_puc_niif.SaldoActual, cc_puc_niif.id_nivel,  cc_puc_niif.Id_Tercero,  cc_puc_niif.CodigoC \nFROM   cc_puc_niif ,`d_ips` where(SUBSTRING( cc_puc_niif.Id,1," + this.JTFCuentaInicio.getText().length() + ") >= " + this.JTFCuentaInicio.getText() + " AND SUBSTRING( cc_puc_niif.Id,1," + this.JTFCuentaFin.getText().length() + ") <= " + this.JTFCuentaFin.getText() + " ) \nAND LENGTH(cc_puc_niif.Id) <= '" + this.JSPNivel.getValue().toString() + "' \nORDER BY cc_puc_niif.Id ASC";
            }
                    ...
                    if (xrs1.getInt(8) == 1 && this.JCHCTercero.isSelected()) {
                        ...
                        if (xrs2.next()) {
                            ...
                            while (xrs2.next()) {
                                ...
                                this.xmodelo2.setValueAt(xrs2.getString("No_identificacion"), i, 6);
                                i++;
                            }
                        }
                        xrs2.close();
            ...
            Logger.getLogger(JIFConsultar_BalanceP_Fecha.class.getName()).log(Level.SEVERE, (String) null, (Throwable) ex);
        }
    }
    ...
    public void mImprimir() {
        ...
        parametros[3][1] = this.JTFCuentaInicio.getText().length() + "";
        ...
        parametros[6][1] = this.JTFCuentaInicio.getText();
