...
/* JADX INFO: loaded from: GenomaP.jar:Contabilidad/JIFSolicitudReembolsoCM.class */
public class JIFSolicitudReembolsoCM extends JInternalFrame {
    ...
    public JIFSolicitudReembolsoCM(String xnombre) {
        initComponents();
        setName(xnombre);
    ...
    private void initComponents() {
        ...
        this.JSPObservacion.setBorder(BorderFactory.createTitledBorder((Border) null, "Observaci�n", 0, 0, new Font("Arial", 1, 12), Color.blue));
        this.JTAObservacion.setFont(new Font("Arial", 1, 12));
        this.JSPObservacion.setViewportView(this.JTAObservacion);
        GroupLayout JPIDatosLayout = new GroupLayout(this.JPIDatos);
        this.JPIDatos.setLayout(JPIDatosLayout);
        JPIDatosLayout.setHorizontalGroup(JPIDatosLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPIDatosLayout.createSequentialGroup().addContainerGap().addComponent(this.JDFFechaI, -2, 121, -2).addGap(18, 18, 18).addComponent(this.JSPObservacion, -1, 811, 32767).addContainerGap()));
        ...
        this.JTResultado.addMouseListener(new MouseAdapter() { // from class: Contabilidad.JIFSolicitudReembolsoCM.1
            public void mouseClicked(MouseEvent evt) {
                JIFSolicitudReembolsoCM.this.JTResultadoMouseClicked(evt);
            }
        });
        this.JTResultado.addPropertyChangeListener(new PropertyChangeListener() { // from class: Contabilidad.JIFSolicitudReembolsoCM.2
            @Override // java.beans.PropertyChangeListener
            public void propertyChange(PropertyChangeEvent evt) {
                JIFSolicitudReembolsoCM.this.JTResultadoPropertyChange(evt);
            }
        });
        ...
        this.JTFRuta.setBorder(BorderFactory.createTitledBorder((Border) null, "Ubicaci�n de archivo", 0, 0, new Font("Arial", 1, 12), Color.blue));
        this.JTFRuta.addMouseListener(new MouseAdapter() { // from class: Contabilidad.JIFSolicitudReembolsoCM.3
            public void mouseClicked(MouseEvent evt) {
                JIFSolicitudReembolsoCM.this.JTFRutaMouseClicked(evt);
            }
        });
        this.JBTExportar.setFont(new Font("Arial", 1, 12));
        this.JBTExportar.setIcon(new ImageIcon(getClass().getResource("/Imagenes/Excel_Icono24x24.png")));
        this.JBTExportar.setText("Exportar");
        this.JBTExportar.addActionListener(new ActionListener() { // from class: Contabilidad.JIFSolicitudReembolsoCM.4
            public void actionPerformed(ActionEvent evt) {
                JIFSolicitudReembolsoCM.this.JBTExportarActionPerformed(evt);
            }
        });
        ...
        jPanel2Layout.setHorizontalGroup(jPanel2Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.JSPDetalle1, GroupLayout.Alignment.TRAILING, -1, 1013, 32767).addGroup(jPanel2Layout.createSequentialGroup().addGap(14, 14, 14).addComponent(this.JTPDatos).addContainerGap()));
        jPanel2Layout.setVerticalGroup(jPanel2Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(jPanel2Layout.createSequentialGroup().addContainerGap().addComponent(this.JSPDetalle1, -1, 331, 32767).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JTPDatos, -2, 122, -2).addGap(16, 16, 16)));
        ...
        this.JPIDContables.setAutoscrolls(true);
        this.JCBPeriodoC.setFont(new Font("Arial", 1, 12));
        this.JCBPeriodoC.setBorder(BorderFactory.createTitledBorder((Border) null, "Per�odo", 0, 0, new Font("Arial", 1, 12), Color.blue));
        ...
        this.JCBCuentaContable.addActionListener(new ActionListener() { // from class: Contabilidad.JIFSolicitudReembolsoCM.5
            public void actionPerformed(ActionEvent evt) {
                JIFSolicitudReembolsoCM.this.JCBCuentaContableActionPerformed(evt);
            }
        });
        ...
        this.JCBTipoC.addActionListener(new ActionListener() { // from class: Contabilidad.JIFSolicitudReembolsoCM.6
            public void actionPerformed(ActionEvent evt) {
                JIFSolicitudReembolsoCM.this.JCBTipoCActionPerformed(evt);
            }
        });
        ...
        this.JBBuscaTercero.addActionListener(new ActionListener() { // from class: Contabilidad.JIFSolicitudReembolsoCM.7
            public void actionPerformed(ActionEvent evt) {
                JIFSolicitudReembolsoCM.this.JBBuscaTerceroActionPerformed(evt);
            }
        });
        ...
        JPIDContablesLayout.setHorizontalGroup(JPIDContablesLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPIDContablesLayout.createSequentialGroup().addGap(20, 20, 20).addGroup(JPIDContablesLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPIDContablesLayout.createSequentialGroup().addComponent(this.JDFFechaC, -2, 112, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JCBPeriodoC, -2, 238, -2)).addComponent(this.JCBCuentaContable, -2, 356, -2)).addGap(18, 18, 18).addGroup(JPIDContablesLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.JTFFTercero, -2, 364, -2).addComponent(this.JCBTipoC, -2, 358, -2)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(JPIDContablesLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.JTFFNDoc, -2, 140, -2).addComponent(this.JBBuscaTercero, -2, 58, -2)).addContainerGap(72, 32767)));
        JPIDContablesLayout.setVerticalGroup(JPIDContablesLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPIDContablesLayout.createSequentialGroup().addContainerGap().addGroup(JPIDContablesLayout.createParallelGroup(GroupLayout.Alignment.TRAILING).addComponent(this.JTFFTercero, -2, -1, -2).addGroup(JPIDContablesLayout.createSequentialGroup().addGroup(JPIDContablesLayout.createParallelGroup(GroupLayout.Alignment.TRAILING, false).addComponent(this.JDFFechaC, GroupLayout.Alignment.LEADING, -1, -1, 32767).addGroup(GroupLayout.Alignment.LEADING, JPIDContablesLayout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(this.JCBPeriodoC, -2, 50, -2).addComponent(this.JCBTipoC, -2, 50, -2).addComponent(this.JTFFNDoc, -2, -1, -2))).addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED).addGroup(JPIDContablesLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.JCBCuentaContable, -2, 50, -2).addComponent(this.JBBuscaTercero, GroupLayout.Alignment.TRAILING, -2, 50, -2)))).addContainerGap(52, 32767)));
        ...
        this.JCBPeriodo_Ppt.setBorder(BorderFactory.createTitledBorder((Border) null, "Per�odo", 0, 0, new Font("Arial", 1, 12), Color.blue));
        this.JCBTipoDoc_Ppt.setFont(new Font("Arial", 1, 12));
        this.JCBTipoDoc_Ppt.setBorder(BorderFactory.createTitledBorder((Border) null, "Tipo Documento (Disponibilidad)", 0, 0, new Font("Arial", 1, 12), Color.blue));
        this.JCBTipoDoc_Compromiso.setFont(new Font("Arial", 1, 12));
        this.JCBTipoDoc_Compromiso.setBorder(BorderFactory.createTitledBorder((Border) null, "Tipo Documento (Compromiso)", 0, 0, new Font("Arial", 1, 12), Color.blue));
        ...
        JPIDContables1Layout.setHorizontalGroup(JPIDContables1Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(GroupLayout.Alignment.TRAILING, JPIDContables1Layout.createSequentialGroup().addContainerGap(36, 32767).addGroup(JPIDContables1Layout.createParallelGroup(GroupLayout.Alignment.TRAILING).addComponent(this.JCBTipoDocumentoObligacion, -2, 238, -2).addComponent(this.JCBPeriodo_Ppt, -2, 238, -2)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JCBTipoDoc_Ppt, -2, 238, -2).addGap(18, 18, 18).addComponent(this.JCBTipoDoc_Compromiso, -2, 238, -2).addGap(170, 170, 170)));
        JPIDContables1Layout.setVerticalGroup(JPIDContables1Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(GroupLayout.Alignment.TRAILING, JPIDContables1Layout.createSequentialGroup().addGap(9, 9, 9).addGroup(JPIDContables1Layout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(this.JCBTipoDoc_Ppt, -2, 50, -2).addComponent(this.JCBTipoDoc_Compromiso, -2, 50, -2).addComponent(this.JCBPeriodo_Ppt, -2, 50, -2)).addGap(20, 20, 20).addComponent(this.JCBTipoDocumentoObligacion, -2, 50, -2)));
        GroupLayout jPanel3Layout = new GroupLayout(this.jPanel3);
        this.jPanel3.setLayout(jPanel3Layout);
        jPanel3Layout.setHorizontalGroup(jPanel3Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(jPanel3Layout.createSequentialGroup().addContainerGap().addGroup(jPanel3Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.JPIDContables1, -1, -1, -2).addComponent(this.JPIDContables, -2, -1, -2)).addContainerGap(19, 32767)));
        jPanel3Layout.setVerticalGroup(jPanel3Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(jPanel3Layout.createSequentialGroup().addContainerGap().addComponent(this.JPIDContables, -2, -1, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JPIDContables1, -1, -1, -2).addGap(126, 126, 126)));
        this.jTabbedPane1.addTab("DATOS DE MOVIMIENTOS", this.jPanel3);
        GroupLayout layout = new GroupLayout(getContentPane());
        getContentPane().setLayout(layout);
        layout.setHorizontalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(layout.createSequentialGroup().addContainerGap().addComponent(this.JPIDatos, -2, -1, -2).addContainerGap(-1, 32767)).addGroup(layout.createSequentialGroup().addComponent(this.jTabbedPane1, -2, 1034, -2).addGap(0, 0, 32767)));
        layout.setVerticalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(layout.createSequentialGroup().addContainerGap().addComponent(this.JPIDatos, -2, -1, -2).addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED).addComponent(this.jTabbedPane1, -1, -1, -2)));
    ...
    private void mCrearTabla() {
        this.xmodelo = new DefaultTableModel((Object[][]) null, new String[]{"Id", "Fecha", "Tercero", "Valor", "Reembolsar?", "N° Entrada", "Rubro", "Puc", "idTercero"}) { // from class: Contabilidad.JIFSolicitudReembolsoCM.8
            Class[] types = {Long.class, String.class, String.class, Double.class, Boolean.class, Long.class, String.class, String.class, String.class};
            boolean[] canEdit = {false, false, false, false, true, false, false, false, false};
    ...
    public void mNuevo() {
        ...
        this.JTFFReembolso.setValue(new Integer(0));
        this.JTFFSaldo.setValue(new Integer(0));
        mCargarDatos();
        llenarCombos();
        if (Principal.informacionIps.getManejaPresupuesto().intValue() == 0) {
            this.JCBPeriodo_Ppt.setEnabled(false);
            this.JCBPeriodo_Ppt.setSelectedIndex(-1);
            this.JCBTipoDoc_Ppt.setEnabled(false);
            this.JCBTipoDoc_Ppt.setSelectedIndex(-1);
            this.JCBTipoDoc_Compromiso.setEnabled(false);
            this.JCBTipoDoc_Compromiso.setSelectedIndex(-1);
            this.JCBTipoDocumentoObligacion.setEnabled(false);
            this.JCBTipoDocumentoObligacion.setSelectedIndex(-1);
        }
    }
                ...
                if (!Principal.informacionIps.getNombreIps().equals("BIENESTAR ACTIVA IPS")) {
                    if (this.idTercero != null && !this.idTercero.isEmpty() && !this.JTFFTercero.getText().isEmpty()) {
                                    ...
                                    if (this.JCBPeriodoC.getSelectedIndex() != -1) {
                                        if (this.JCBPeriodo_Ppt.getSelectedIndex() != -1) {
                                            if (this.JCBTipoDoc_Compromiso.getSelectedIndex() != -1) {
                                                ...
                                                JOptionPane.showInternalMessageDialog(this, "Debe seleccionar un tipo documento de disponibilidad", "VERIFICAR", 1, new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/Imagenes/Information.png"))));
                                                return;
                                            }
                                            JOptionPane.showInternalMessageDialog(this, "Debe seleccionar un tipo documento compromiso", "VERIFICAR", 1, new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/Imagenes/Information.png"))));
                                            return;
                                        }
                        ...
                        if (Principal.informacionIps.getManejaContabilidad().intValue() == 0 && Principal.informacionIps.getManejaPresupuesto().intValue() == 1) {
                            JOptionPane.showInternalMessageDialog(this, "Opcion Invalida para solo manejo presupuestal", "VERIFICAR", 1, new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/Imagenes/Information.png"))));
                            return;
                        }
                        return;
                    }
    ...
    private void grabarDetalle() {
        ...
        if (n == 0) {
            ...
            String encabezadoPresupuestalDispobilidad = null;
            ...
            if (Principal.informacionIps.getManejaContabilidad().intValue() == 1 && Principal.informacionIps.getManejaPresupuesto().intValue() == 1) {
                if (!Principal.informacionIps.getNombreIps().equals("BIENESTAR ACTIVA IPS")) {
                    ...
                    insertarSolicitudDeDisponibilidadEncabezado(this.encabezadoContable);
                    insertarRadicacion(this.encabezadoContable);
                    encabezadoPresupuestalDispobilidad = insertarEncabezadoPresupuestal(this.xidtipodoc_ppt[this.JCBTipoDoc_Ppt.getSelectedIndex()], 1, this.xSolicitudP, this.encabezadoContable);
                    encabezadoPresupuestalCompromiso = insertarEncabezadoPresupuestal(this.xidtipodoc_Compromiso[this.JCBTipoDoc_Compromiso.getSelectedIndex()], 2, encabezadoPresupuestalDispobilidad, this.encabezadoContable);
                ...
                for (int x = 0; x < this.JTResultado.getRowCount(); x++) {
                    ...
                    if (!Principal.informacionIps.getNombreIps().equals("BIENESTAR ACTIVA IPS")) {
                        ...
                        insertarDetalleSolicitudDeDisponibilidad(this.xSolicitudP, x);
                        guardarMovimientoPresupuestal(x, encabezadoPresupuestalDispobilidad);
                        guardarMovimientoPresupuestal(x, encabezadoPresupuestalCompromiso);
                        guardarMovimientoPresupuestal(x, encabezadoPresupuestalObligacion);
                    }
                }
                if (!Principal.informacionIps.getNombreIps().equals("BIENESTAR ACTIVA IPS")) {
                    insertartCredito(this.encabezadoContable);
                    actualizarIdDocumentoPresupuestal(encabezadoPresupuestalDispobilidad, 1, encabezadoPresupuestalDispobilidad);
                    actualizarIdDocumentoPresupuestal(encabezadoPresupuestalCompromiso, 2, encabezadoPresupuestalDispobilidad);
                    ...
                    actualizarDocumentoContable(this.xIdRadicacion);
                }
                mImprimir();
                return;
            }
            if (Principal.informacionIps.getManejaContabilidad().intValue() == 1 && Principal.informacionIps.getManejaPresupuesto().intValue() == 0) {
                ...
                for (int x2 = 0; x2 < this.JTResultado.getRowCount(); x2++) {
                    if (Boolean.valueOf(this.xmodelo.getValueAt(x2, 4).toString()).booleanValue()) {
                        String sql3 = "update cc_recibocm  set Id_SolicitudR='" + Principal.txtNo.getText() + "' where Id='" + this.xmodelo.getValueAt(x2, 0).toString() + "'";
                        this.xconsultas.ejecutarSQL(sql3);
                        this.xconsultas.cerrarConexionBd();
                    }
                    if (!Principal.informacionIps.getNombreIps().equals("BIENESTAR ACTIVA IPS")) {
                        guardarMovimientoContable(x2, this.encabezadoContable);
                    }
                }
                if (!Principal.informacionIps.getNombreIps().equals("BIENESTAR ACTIVA IPS")) {
                    insertartCredito(this.encabezadoContable);
    ...
    public void mBuscarDatos(String xid) {
        ...
        try {
            ...
            Logger.getLogger(JIFSolicitudReembolsoCM.class.getName()).log(Level.SEVERE, (String) null, (Throwable) ex);
        }
    }
    ...
    private void llenarCombos() {
        ...
        this.sql = "SELECT  `pp_tipo_documentos`.`Id` , `pp_tipo_documentos`.`Nbre`  FROM `pp_tipo_documentos` INNER JOIN `pp_clase_documento`  ON (`pp_tipo_documentos`.`Id_ClaseDoc` = `pp_clase_documento`.`Id`) WHERE pp_clase_documento.`Id`=9 ";
        this.xidtipodoc_ppt = this.xconsultas.llenarCombo(this.sql, this.xidtipodoc_ppt, this.JCBTipoDoc_Ppt);
        ...
        this.sql = "SELECT  `pp_tipo_documentos`.`Id` , `pp_tipo_documentos`.`Nbre`  FROM `pp_tipo_documentos` INNER JOIN `pp_clase_documento`  ON (`pp_tipo_documentos`.`Id_ClaseDoc` = `pp_clase_documento`.`Id`) WHERE pp_clase_documento.`Id`=4 ";
        this.xidtipodoc_Compromiso = this.xconsultas.llenarCombo(this.sql, this.xidtipodoc_ppt, this.JCBTipoDoc_Compromiso);
        if (this.xidtipodoc_Compromiso.length > 1) {
            this.JCBTipoDoc_Compromiso.setSelectedIndex(-1);
        }
    ...
    private void guardarMovimientoContable(int x, String idEncabezado) {
        this.sql = "INSERT INTO `cc_detalle_documentoc`  (`Id_Documentoc`,`Id_Puc`,`TipoCPuc`,`Id_Tercero`,`Id_Radicacion`,`NFactura`,`VDebito`,\n`VCredito`,`PRetencion`,`Base`,`Concepto`,`Id_Certificado`,`Id_ConceptoN`,`estado`) VALUES (" + idEncabezado + "," + this.xmodelo.getValueAt(x, 7).toString() + ",0," + this.xmodelo.getValueAt(x, 8) + ",0,0," + this.xmodelo.getValueAt(x, 3) + ",0,0,0,'CIERRE DE CAJA  MENOR N° " + Principal.txtNo.getText() + "',0,0,1); ";
        this.xconsultas.ejecutarSQL(this.sql);
    }

    private void guardarMovimientoPresupuestal(int x, String idEncabezado) {
        this.sql = "INSERT INTO `pp_detalle_movimiento` (`idEncabezado`,`Id_Movimiento`,`Id_Rubro`,`Id_Tercero`,`Valor`,`Observacion`) VALUES ( " + Principal.informacionGeneralPrincipalDTO.getIdMaestroRubro() + "," + idEncabezado + ",'" + this.xmodelo.getValueAt(x, 6).toString() + "'," + this.idTercero + "," + this.xmodelo.getValueAt(x, 3) + ",' CIERRE DE CAJA  MENOR N° " + Principal.txtNo.getText() + "')";
        this.xconsultas.ejecutarSQL(this.sql);
    }

    private String insertarEncabezadoContable() {
        this.sql = "insert into cc_documentoc (FechaD, Id_TipoComprobante, Id_PeriodoC, Descripcion,  Fecha, UsuarioS, idCierreCaja, EstadoA) Values ('" + this.xmetodos.formatoAMD.format(this.JDFFechaC.getDate()) + "','" + this.xidtipodoc[this.JCBTipoC.getSelectedIndex()] + "','" + this.xidperiodo[this.JCBPeriodoC.getSelectedIndex()] + "','CIERRE DE CAJA  MENOR N° " + Principal.txtNo.getText() + "','" + this.xmetodos.formatoAMDH24.format(this.xmetodos.getFechaActual()) + "','" + Principal.usuarioSistemaDTO.getLogin() + "','" + Principal.txtNo.getText() + "', 1 )";
    ...
    private void insertarRadicacion(String idDocumentoC) {
        this.sql = "INSERT INTO `cc_radicacion` (`Fecha`,`Id_Proveedor`,`Id_PeriodoC`,`SubTotal`,`ConceptoC`,`Pagada`,`Id_UnidadF`,`Id_Cuenta`,`Id_SubGrupoCC`,`Id_CuentaAuxPuc`,`Id_CuentaAuxPPagar`,`Id_Concepto`,`UsuarioS`, Id_Comprobante )\nVALUES ('" + this.xmetodos.formatoAMD.format(this.JDFFechaC.getDate()) + "'," + this.idTercero + "," + this.xidperiodo[this.JCBPeriodoC.getSelectedIndex()] + ", " + this.JTFFReembolso.getValue() + ",'CIERRE DE CAJA  MENOR N° " + Principal.txtNo.getText() + "',0,21,5111,18,51111402," + this.xidauxiliarxpagar[this.JCBCuentaContable.getSelectedIndex()] + ",1,'" + Principal.usuarioSistemaDTO.getLogin() + "', '" + idDocumentoC + "' )";
        this.xIdRadicacion = this.xconsultas.ejecutarSQLId(this.sql);
        String sqlFirma = "  INSERT INTO `cc_detalle_firma_documentoc` (`Id_OrdenDc`,`Id_UsuarioF`,`Autorizo`,`FechaA`,`Observacion`) VALUES (" + idDocumentoC + ",1,1,'" + this.xmetodos.formatoAMDH24.format(this.xmetodos.getFechaActual()) + "','Cierre de caja')";
        this.xconsultas.ejecutarSQL(sqlFirma);
    }

    private void insertarSolicitudDeDisponibilidadEncabezado(String idDocumentoC) {
        mConcecutivoS();
        this.sql = "INSERT INTO `pp_solicitud_pto`  (`IdUsuarioCargon`,`FechaR`,`Descripcion`,`Valor`,`idunidadfuncional`,`nconsecutivo`,`idPeriodo`,`Estado`,`UsuarioS`, idDocumentoContable)\n     VALUES (" + Principal.usuarioSistemaDTO.getIdPersonaCargo() + ",'" + this.xmetodos.formatoAMD.format(this.JDFFechaC.getDate()) + "','CIERRE DE CAJA  MENOR N° " + Principal.txtNo.getText() + "'," + this.JTFFReembolso.getValue() + ",21," + this.xConsecutivoS + "," + this.xidperiodo_ppt[this.JCBPeriodo_Ppt.getSelectedIndex()] + ",1,'" + Principal.usuarioSistemaDTO.getLogin() + "', '" + idDocumentoC + "' )";
        this.xSolicitudP = this.xconsultas.ejecutarSQLId(this.sql);
    }

    private void insertarDetalleSolicitudDeDisponibilidad(String encabezado, int x) {
        this.sql = "INSERT INTO  `pp_solicitud_pto_detalle` (`idmovimiento`,`idrubro`,`valor`,`estado`) VALUES (" + encabezado + ",'" + this.xmodelo.getValueAt(x, 6) + "'," + this.xmodelo.getValueAt(x, 3) + ",1)";
        this.xconsultas.ejecutarSQL(this.sql);
    }
    ...
    private void actualizarDocumentoContable(String xIdRadicacion) {
        String str = "UPDATE `cc_documentoc` SET `cc_documentoc`.`Id_Radicacion` = " + xIdRadicacion + "   WHERE `cc_documentoc`.`Id` =" + this.encabezadoContable + " ;";
    }

    /* JADX INFO: loaded from: GenomaP.jar:Contabilidad/JIFSolicitudReembolsoCM$MiRender.class */
