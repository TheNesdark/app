...
import com.genoma.plus.dao.impl.sig.InformeMorbilidadIraDAOImpl;
...
/* JADX INFO: loaded from: GenomaP.jar:com/genoma/plus/controller/sig/JIFInformeMorbilidadIra.class */
public class JIFInformeMorbilidadIra extends JInternalFrame {
    private DefaultTableModel xmodeloH;
    private DefaultTableModel xmodeloM;
    private DefaultTableModel xmodeloMo;
    private InformeMorbilidadIraDAO xInformeMorbilidadIraDAO;
    ...
    public JIFInformeMorbilidadIra() {
        initComponents();
        springStart();
        mNuevo();
    }
    ...
    private void springStart() {
        this.xInformeMorbilidadIraDAO = (InformeMorbilidadIraDAOImpl) new ClassPathXmlApplicationContext(new String[]{"/recursos/applicationContext.xml"}).getBean("informeMorbilidadIraDAO");
    }
    ...
    public void mImprimir() {
        if (this.JTHospitalizacion.getRowCount() != 0 && this.JTMuerte.getRowCount() != 0 && this.JTMorbilidad.getRowCount() != 0) {
            try {
                ...
                this.xSivigila.mGenerarSivigila("MORBILIDAD POR IRA F995 (IRA COLECTIVA)");
                reader = new PdfReader(this.directorio + this.xmt.getBarra() + "MORBILIDAD POR IRA F995 (IRA COLECTIVA).pdf");
                stamper = new PdfStamper(reader, new FileOutputStream(this.xmt.getSO() + this.xmt.getBarra() + "Reportes" + this.xmt.getBarra() + "Morbilidad por IRA F995.pdf"));
                ...
                over.endText();
                stamper.close();
                this.xmt.mostrarPdf(this.xmt.getSO() + this.xmt.getBarra() + "Reportes" + this.xmt.getBarra() + "Morbilidad por IRA F995.pdf");
                this.xmt.mEliminarArchivo(new File(this.directorio + this.xmt.getBarra() + "MORBILIDAD POR IRA F995 (IRA COLECTIVA).pdf"));
                return;
            } catch (DocumentException e) {
                Logger.getLogger(JIFInformeMorbilidadIra.class.getName()).log(Level.SEVERE, (String) null, e);
                return;
            } catch (IOException ex) {
                Logger.getLogger(JIFInformeMorbilidadIra.class.getName()).log(Level.SEVERE, (String) null, (Throwable) ex);
                return;
            }
        }
    ...
    private void mModeloHospitalizacion() {
        this.xmodeloH = new DefaultTableModel(new Object[0], new String[]{"Servicio", "<1", "1", "2 a 4", "5 a 19", "20 a 39", "40 a 59", ">=60"}) { // from class: com.genoma.plus.controller.sig.JIFInformeMorbilidadIra.1
    ...
    private void mModeloMuerte() {
        this.xmodeloM = new DefaultTableModel(new Object[0], new String[]{"Servicio", "<1", "1", "2 a 4", "5 a 19", "20 a 39", "40 a 59", ">=60"}) { // from class: com.genoma.plus.controller.sig.JIFInformeMorbilidadIra.2
            Class[] types = {String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class};
            boolean[] canEdit = {false, false, false, false};
    ...
    private void mModeloMorbilidad() {
        this.xmodeloMo = new DefaultTableModel(new Object[0], new String[]{"Servicio", "<1", "1", "2 a 4", "5 a 19", "20 a 39", "40 a 59", ">=60"}) { // from class: com.genoma.plus.controller.sig.JIFInformeMorbilidadIra.3
            Class[] types = {String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class};
            boolean[] canEdit = {false, false, false, false};
    ...
    public void mBuscaDatos() {
        ...
        mModeloMuerte();
        mModeloMorbilidad();
        List<Object[]> listH1 = this.xInformeMorbilidadIraDAO.ListHospitalizacion1(this.xmt.formatoAMD1.format(this.JDFFechaI.getDate()), this.xmt.formatoAMD1.format(this.JDFFechaF.getDate()));
        List<Object[]> listH2 = this.xInformeMorbilidadIraDAO.ListHospitalizacion2(this.xmt.formatoAMD1.format(this.JDFFechaI.getDate()), this.xmt.formatoAMD1.format(this.JDFFechaF.getDate()));
        List<Object[]> listM1 = this.xInformeMorbilidadIraDAO.ListMuertes1(this.xmt.formatoAMD1.format(this.JDFFechaI.getDate()), this.xmt.formatoAMD1.format(this.JDFFechaF.getDate()));
        List<Object[]> listM2 = this.xInformeMorbilidadIraDAO.ListMuertes2(this.xmt.formatoAMD1.format(this.JDFFechaI.getDate()), this.xmt.formatoAMD1.format(this.JDFFechaF.getDate()));
        List<Object[]> listMo1 = this.xInformeMorbilidadIraDAO.ListMorbilidad1(this.xmt.formatoAMD1.format(this.JDFFechaI.getDate()), this.xmt.formatoAMD1.format(this.JDFFechaF.getDate()));
        List<Object[]> listMo2 = this.xInformeMorbilidadIraDAO.ListMOrbilidad2(this.xmt.formatoAMD1.format(this.JDFFechaI.getDate()), this.xmt.formatoAMD1.format(this.JDFFechaF.getDate()));
        this.xmodeloH.addRow(this.xDato);
        this.xmodeloH.setValueAt("Total hospitalizaciones por IRAG (J00-J22)", 0, 0);
        ...
        this.xmodeloM.setValueAt("Total muertes por IRAG (J00-J22)", 0, 0);
        ...
        this.xmodeloMo.setValueAt("Total IRA consulta externa y urgencias (J00-J22)", 0, 0);
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("INFORME DE MORBILIDAD DE IRA");
        setFrameIcon(new ImageIcon(getClass().getResource("/Imagenes/genomap.png")));
        setName("xjifinformemorbilidadira");
        ...
        this.JYAno.addPropertyChangeListener(new PropertyChangeListener() { // from class: com.genoma.plus.controller.sig.JIFInformeMorbilidadIra.4
            @Override // java.beans.PropertyChangeListener
            public void propertyChange(PropertyChangeEvent evt) {
                JIFInformeMorbilidadIra.this.JYAnoPropertyChange(evt);
            }
        });
        ...
        this.JTFRuta.addMouseListener(new MouseAdapter() { // from class: com.genoma.plus.controller.sig.JIFInformeMorbilidadIra.5
            public void mouseClicked(MouseEvent evt) {
                JIFInformeMorbilidadIra.this.JTFRutaMouseClicked(evt);
            }
        });
        ...
        this.JBTExportar.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.sig.JIFInformeMorbilidadIra.6
            public void actionPerformed(ActionEvent evt) {
                JIFInformeMorbilidadIra.this.JBTExportarActionPerformed(evt);
            }
        });
    ...
    public void JBTExportarActionPerformed(ActionEvent evt) {
        if (!this.JTFRuta.getText().isEmpty()) {
            ...
            if (n == 0) {
                ...
                String[] xtitulo = {"HOSPITALIZACION", "MUERTES", "MORBILIDAD POR IRA"};
