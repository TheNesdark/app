...
/* JADX INFO: loaded from: GenomaP.jar:com/genoma/plus/controller/salud_ocupacional/JIFFTestRuffier.class */
public class JIFFTestRuffier extends JInternalFrame {
    ...
    public void mImprimir() {
        ...
        this.xmt.GenerarPDF(this.xmt.getRutaRep() + "SO_TestRuffier", mparametros);
    }

    /* JADX WARN: Type inference failed for: r4v1, types: [java.lang.Object[], java.lang.Object[][]] */
    private void mCrearTabla() {
        this.xmodelo = new DefaultTableModel(new Object[0], new String[]{"Fecha", "Identificacion", "No. Documento", "Usuario", "Sexo", "Edad", "Unidad de Negocio", "Tipo de Empresa", "Empresa", "Resultado", "Valoracion"}) { // from class: com.genoma.plus.controller.salud_ocupacional.JIFFTestRuffier.1
    ...
    private void mBuscaDatos() {
        List<AutoReporteDTO> list = this.InformeSaludOcupacionalDAO.listRuffier(this.xmt.formatoAMD1.format(this.JDFechaI.getDate()), this.xmt.formatoAMD1.format(this.JDFechaF.getDate()));
        mCrearTabla();
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("INFORME TEST DE RUFFIER");
        setToolTipText("");
        setFrameIcon(new ImageIcon(getClass().getResource("/Imagenes/genomap.png")));
        setName("xjiftestruffier");
        ...
        this.JDFechaI.addFocusListener(new FocusAdapter() { // from class: com.genoma.plus.controller.salud_ocupacional.JIFFTestRuffier.2
            public void focusLost(FocusEvent evt) {
                JIFFTestRuffier.this.JDFechaIFocusLost(evt);
            }
        });
        this.JDFechaI.addPropertyChangeListener(new PropertyChangeListener() { // from class: com.genoma.plus.controller.salud_ocupacional.JIFFTestRuffier.3
            @Override // java.beans.PropertyChangeListener
            public void propertyChange(PropertyChangeEvent evt) {
                JIFFTestRuffier.this.JDFechaIPropertyChange(evt);
            }
        });
        this.JDFechaF.setBorder(BorderFactory.createTitledBorder((Border) null, "Fecha Final", 0, 0, new Font("Arial", 1, 12), Color.blue));
        this.JDFechaF.setDateFormatString("dd/MM/yyyy");
        this.JDFechaF.setFont(new Font("Arial", 1, 12));
        this.JDFechaF.addPropertyChangeListener(new PropertyChangeListener() { // from class: com.genoma.plus.controller.salud_ocupacional.JIFFTestRuffier.4
            @Override // java.beans.PropertyChangeListener
            public void propertyChange(PropertyChangeEvent evt) {
                JIFFTestRuffier.this.JDFechaFPropertyChange(evt);
            }
        });
        ...
        this.JBTGenerar.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.salud_ocupacional.JIFFTestRuffier.5
            public void actionPerformed(ActionEvent evt) {
                JIFFTestRuffier.this.JBTGenerarActionPerformed(evt);
            }
        });
        ...
        this.JTFRuta.addMouseListener(new MouseAdapter() { // from class: com.genoma.plus.controller.salud_ocupacional.JIFFTestRuffier.6
            public void mouseClicked(MouseEvent evt) {
                JIFFTestRuffier.this.JTFRutaMouseClicked(evt);
            }
        });
