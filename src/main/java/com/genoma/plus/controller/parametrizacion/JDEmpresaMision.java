...
/* JADX INFO: loaded from: GenomaP.jar:com/genoma/plus/controller/parametrizacion/JDEmpresaMision.class */
public class JDEmpresaMision extends JDialog {
    ...
    public JDEmpresaMision(Frame parent, boolean modal, Object xllamador, Integer idConvenioe, JInternalFrame formularioLlamador) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        this.JTFDocumento.addKeyListener(new KeyAdapter() { // from class: com.genoma.plus.controller.parametrizacion.JDEmpresaMision.1
            public void keyTyped(KeyEvent evt) {
                JDEmpresaMision.this.JTFDocumentoKeyTyped(evt);
            }
        });
        this.JTFNombre.setBorder(BorderFactory.createTitledBorder((Border) null, "Nombre", 0, 0, new Font("Arial", 1, 12), Color.blue));
        this.JTFNombre.setFont(new Font("Arial", 1, 12));
        this.JTFNombre.addKeyListener(new KeyAdapter() { // from class: com.genoma.plus.controller.parametrizacion.JDEmpresaMision.2
            public void keyTyped(KeyEvent evt) {
                JDEmpresaMision.this.JTFNombreKeyTyped(evt);
            }
        });
        ...
        this.JBGrabar9.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.parametrizacion.JDEmpresaMision.3
            public void actionPerformed(ActionEvent evt) {
                JDEmpresaMision.this.JBGrabar9ActionPerformed(evt);
            }
        });
        ...
        this.JBGrabar10.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.parametrizacion.JDEmpresaMision.4
            public void actionPerformed(ActionEvent evt) {
                JDEmpresaMision.this.JBGrabar10ActionPerformed(evt);
            }
        });
        ...
        this.JBGrabar11.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.parametrizacion.JDEmpresaMision.5
            public void actionPerformed(ActionEvent evt) {
                JDEmpresaMision.this.JBGrabar11ActionPerformed(evt);
            }
        });
    ...
    private void mCrearModeloDatos() {
        this.xmodelo = new DefaultTableModel(new Object[0], new String[]{"IdEmpresa Convenio", "Nombre", "Fecha", "IdUsuarioRH", "Documento"}) { // from class: com.genoma.plus.controller.parametrizacion.JDEmpresaMision.6
    ...
    private void mCargarDatosTabla() {
        try {
            ...
            Logger.getLogger(JDEmpresaMision.class.getName()).log(Level.SEVERE, (String) null, (Throwable) ex);
        }
    }
}
