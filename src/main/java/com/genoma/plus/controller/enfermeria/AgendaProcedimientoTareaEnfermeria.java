...
/* JADX INFO: loaded from: GenomaP.jar:com/genoma/plus/controller/enfermeria/AgendaProcedimientoTareaEnfermeria.class */
public class AgendaProcedimientoTareaEnfermeria {
    ...
    public void FinalizaTarea() {
        try {
            ...
            Logger.getLogger(AgendaProcedimientoTareaEnfermeria.class.getName()).log(Level.SEVERE, (String) null, e);
        }
    }
    ...
    public void iniciarTarea() {
        ...
        crearProgramacion();
        JobDetail job = new JobDetail("TareaBuscarPacienteAgendaEnfermeria", (String) null, AgendaProcedimientoTarea_ImplementacionEnfermeria.class);
