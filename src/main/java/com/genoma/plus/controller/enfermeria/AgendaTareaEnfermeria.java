...
/* JADX INFO: loaded from: GenomaP.jar:com/genoma/plus/controller/enfermeria/AgendaTareaEnfermeria.class */
public class AgendaTareaEnfermeria {
    ...
    public void FinalizaTarea() {
        try {
            ...
            Logger.getLogger(AgendaTareaEnfermeria.class.getName()).log(Level.SEVERE, (String) null, e);
        }
    }
    ...
    public void iniciarTarea() {
        ...
        crearProgramacion();
        JobDetail job = new JobDetail("TareaBuscarPacienteAgendaEnfermeria", (String) null, AgendaTarea_ImplementacionEnfermeria.class);
