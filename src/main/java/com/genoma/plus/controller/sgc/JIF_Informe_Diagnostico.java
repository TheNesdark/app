...
import com.genoma.plus.jpa.projection.InformeDiagnostico;
import com.genoma.plus.jpa.service.InformeDiagnosticoService;
...
/* JADX INFO: loaded from: GenomaP.jar:com/genoma/plus/controller/sgc/JIF_Informe_Diagnostico.class */
public class JIF_Informe_Diagnostico extends JInternalFrame {
    ...
    private final InformeDiagnosticoService xInformeDiagnosticoService = (InformeDiagnosticoService) Principal.contexto.getBean(InformeDiagnosticoService.class);

    public JIF_Informe_Diagnostico() {
        initComponents();
        mNuevo();
    }
    ...
    private void mCrearModeloInformeDiagnostico() {
        this.xModelo = new DefaultTableModel((Object[][]) null, new String[]{"Usuario", "Sexo", "FechaNac", "Edad", "Telefono", "Direccion", "FechaIngreso", "HoraIngreso", "Cie10", "Patologia", "Clasedecita", "Convenio"}) { // from class: com.genoma.plus.controller.sgc.JIF_Informe_Diagnostico.1
    ...
    private void mCargarDatosTablaInformeDiagnostico() {
        ...
        List<InformeDiagnostico> list = this.xInformeDiagnosticoService.buscarInformeDiagnostico(this.xmt.formatoAMD.format(this.JDFechaI.getDate()), this.xmt.formatoAMD.format(this.JDFechaF.getDate()));
        for (int x = 0; x < list.size(); x++) {
            this.xModelo.addRow(this.xDato);
            this.xModelo.setValueAt(list.get(x).getUsuario(), x, 0);
            this.xModelo.setValueAt(list.get(x).getId_Sexo(), x, 1);
            this.xModelo.setValueAt(list.get(x).getFechaNac(), x, 2);
            this.xModelo.setValueAt(list.get(x).getEdad(), x, 3);
            this.xModelo.setValueAt(list.get(x).getTelefono(), x, 4);
            this.xModelo.setValueAt(list.get(x).getDireccion(), x, 5);
            this.xModelo.setValueAt(list.get(x).getFechaIngreso(), x, 6);
            this.xModelo.setValueAt(list.get(x).getHoraIngreso(), x, 7);
            this.xModelo.setValueAt(list.get(x).getCie10(), x, 8);
            this.xModelo.setValueAt(list.get(x).getPatologia(), x, 9);
            this.xModelo.setValueAt(list.get(x).getClasedecita(), x, 10);
            this.xModelo.setValueAt(list.get(x).getConvenio(), x, 11);
        }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Informe Diagnostico");
        setFrameIcon(new ImageIcon(getClass().getResource("/Imagenes/genomap.png")));
        setName("jif_InformeDiagnostico");
        ...
        this.JDFechaI.addPropertyChangeListener(new PropertyChangeListener() { // from class: com.genoma.plus.controller.sgc.JIF_Informe_Diagnostico.2
            @Override // java.beans.PropertyChangeListener
            public void propertyChange(PropertyChangeEvent evt) {
                JIF_Informe_Diagnostico.this.JDFechaIPropertyChange(evt);
            }
        });
        this.JDFechaF.setBorder(BorderFactory.createTitledBorder((Border) null, "Fecha Final", 0, 0, new Font("Arial", 1, 12), Color.blue));
        this.JDFechaF.setDateFormatString("dd/MM/yyyy");
        this.JDFechaF.setFont(new Font("Arial", 1, 12));
        this.JDFechaF.addPropertyChangeListener(new PropertyChangeListener() { // from class: com.genoma.plus.controller.sgc.JIF_Informe_Diagnostico.3
            @Override // java.beans.PropertyChangeListener
            public void propertyChange(PropertyChangeEvent evt) {
                JIF_Informe_Diagnostico.this.JDFechaFPropertyChange(evt);
            }
        });
        ...
        this.JTFRuta.addMouseListener(new MouseAdapter() { // from class: com.genoma.plus.controller.sgc.JIF_Informe_Diagnostico.4
            public void mouseClicked(MouseEvent evt) {
                JIF_Informe_Diagnostico.this.JTFRutaMouseClicked(evt);
            }
        });
        this.JTFRuta.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.sgc.JIF_Informe_Diagnostico.5
            public void actionPerformed(ActionEvent evt) {
                JIF_Informe_Diagnostico.this.JTFRutaActionPerformed(evt);
            }
        });
        ...
        this.JBTExportar.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.sgc.JIF_Informe_Diagnostico.6
            public void actionPerformed(ActionEvent evt) {
                JIF_Informe_Diagnostico.this.JBTExportarActionPerformed(evt);
            }
        });
