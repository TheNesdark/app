...
import com.genoma.plus.jpa.projection.IReporteProduccionRes2193DTO;
import com.genoma.plus.jpa.service.IReporteProduccionRes2193DAO;
...
/* JADX INFO: loaded from: GenomaP.jar:com/genoma/plus/controller/sgc/JIF_RProduccionRes2193.class */
public class JIF_RProduccionRes2193 extends JInternalFrame {
    ...
    private final IReporteProduccionRes2193DAO xIReporteProduccionRes2193DAO = (IReporteProduccionRes2193DAO) Principal.contexto.getBean(IReporteProduccionRes2193DAO.class);

    public JIF_RProduccionRes2193() {
        initComponents();
        mNuevo();
    }
    ...
    private void mCrearModeloTotalConsulta() {
        this.xModelo = new DefaultTableModel((Object[][]) null, new String[]{"Concepto", "Contributivo", "Subsidiado", "NoAsegurado", "Particular", "Otros"}) { // from class: com.genoma.plus.controller.sgc.JIF_RProduccionRes2193.1
    ...
    private void mCargarDatosTablaTotalConsulta() {
        ...
        List<IReporteProduccionRes2193DTO> list = this.xIReporteProduccionRes2193DAO.ReporteProduccionRes2193(this.xmt.formatoAMD.format(this.JDFechaI.getDate()), this.xmt.formatoAMD.format(this.JDFechaF.getDate()));
        for (int x = 0; x < list.size(); x++) {
            this.xModelo.addRow(this.xDato);
            this.xModelo.setValueAt(list.get(x).getConcepto(), x, 0);
            this.xModelo.setValueAt(list.get(x).getContributivo(), x, 1);
            this.xModelo.setValueAt(list.get(x).getSubsidiado(), x, 2);
            this.xModelo.setValueAt(list.get(x).getNoAsegurado(), x, 3);
            this.xModelo.setValueAt(list.get(x).getParticular(), x, 4);
            this.xModelo.setValueAt(list.get(x).getOtros(), x, 5);
        }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Reporte de Produccion Resolucion 2193");
        setToolTipText("");
        setFrameIcon(new ImageIcon(getClass().getResource("/Imagenes/genomap.png")));
        setName("jif_ReporteProduccion2193");
        ...
        this.JDFechaI.addPropertyChangeListener(new PropertyChangeListener() { // from class: com.genoma.plus.controller.sgc.JIF_RProduccionRes2193.2
            @Override // java.beans.PropertyChangeListener
            public void propertyChange(PropertyChangeEvent evt) {
                JIF_RProduccionRes2193.this.JDFechaIPropertyChange(evt);
            }
        });
        this.JDFechaF.setBorder(BorderFactory.createTitledBorder((Border) null, "Fecha Final", 0, 0, new Font("Arial", 1, 12), Color.blue));
        this.JDFechaF.setDateFormatString("dd/MM/yyyy");
        this.JDFechaF.setFont(new Font("Arial", 1, 12));
        this.JDFechaF.addPropertyChangeListener(new PropertyChangeListener() { // from class: com.genoma.plus.controller.sgc.JIF_RProduccionRes2193.3
            @Override // java.beans.PropertyChangeListener
            public void propertyChange(PropertyChangeEvent evt) {
                JIF_RProduccionRes2193.this.JDFechaFPropertyChange(evt);
            }
        });
        ...
        this.JTFRuta.addMouseListener(new MouseAdapter() { // from class: com.genoma.plus.controller.sgc.JIF_RProduccionRes2193.4
            public void mouseClicked(MouseEvent evt) {
                JIF_RProduccionRes2193.this.JTFRutaMouseClicked(evt);
            }
        });
        this.JTFRuta.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.sgc.JIF_RProduccionRes2193.5
            public void actionPerformed(ActionEvent evt) {
                JIF_RProduccionRes2193.this.JTFRutaActionPerformed(evt);
            }
        });
        ...
        this.JBTExportar.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.sgc.JIF_RProduccionRes2193.6
            public void actionPerformed(ActionEvent evt) {
                JIF_RProduccionRes2193.this.JBTExportarActionPerformed(evt);
            }
        });
