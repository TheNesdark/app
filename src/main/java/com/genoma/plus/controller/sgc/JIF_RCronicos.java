...
import com.genoma.plus.jpa.projection.IReporteCronicosDTO;
import com.genoma.plus.jpa.service.IReporteCronicosDAO;
...
/* JADX INFO: loaded from: GenomaP.jar:com/genoma/plus/controller/sgc/JIF_RCronicos.class */
public class JIF_RCronicos extends JInternalFrame {
    ...
    private final IReporteCronicosDAO xIReporteCronicosDAO = (IReporteCronicosDAO) Principal.contexto.getBean(IReporteCronicosDAO.class);

    public JIF_RCronicos() {
        initComponents();
        mNuevo();
    }
    ...
    private void mCrearModeloTotalConsulta() {
        this.xModelo = new DefaultTableModel((Object[][]) null, new String[]{"TIdentificacion", "Documento", "Apellido1", "Apellido2", "Nombre1", "Nombre2", "Sexo", "Edad", "Teléfono", "Dirección", "FechaAtencion", "HTA", "AnosHta", "Diabetes", "AnosDiabetes", "DiabetesyHta", "Talla", "Peso", "HTASistolica", "HTADiastolica", "PAbdominal", "TFG", "Estadio", "VlrCreatinina", "FCreatinina", "VlrAlbumina", "FAlbumina", "RAlbuminaCreatinina", "FRAlbuminaCreatinina", "VlrGlucosa", "FGlucosa", "VlrHBA1C", "FHBA1C", "VlrColesterol", "FColesterol", "VlrTrigliceridos", "FTrigliceridos", "VlrHdl", "FHdl", "VlrLdl", "FLdl", "Convenio - Empresa"}) { // from class: com.genoma.plus.controller.sgc.JIF_RCronicos.1
            Class[] types = {String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class};
        ...
        this.JTDetalle.getColumnModel().getColumn(41).setPreferredWidth(300);
    }

    private void mCargarDatosTablaTotalConsulta() {
        mCrearModeloTotalConsulta();
        List<IReporteCronicosDTO> list = this.xIReporteCronicosDAO.ReporteCronicos(this.xmt.formatoAMD.format(this.JDFechaI.getDate()), this.xmt.formatoAMD.format(this.JDFechaF.getDate()));
        for (int x = 0; x < list.size(); x++) {
            this.xModelo.addRow(this.xDato);
            this.xModelo.setValueAt(list.get(x).getTipoIdentificacion(), x, 0);
            ...
            this.xModelo.setValueAt(list.get(x).getIdSexo(), x, 6);
            this.xModelo.setValueAt(list.get(x).getEdad(), x, 7);
            this.xModelo.setValueAt(list.get(x).getTelefono(), x, 8);
            this.xModelo.setValueAt(list.get(x).getDireccion(), x, 9);
            this.xModelo.setValueAt(list.get(x).getFechaAtencion(), x, 10);
            this.xModelo.setValueAt(list.get(x).getHta(), x, 11);
            this.xModelo.setValueAt(list.get(x).getaDiagnosticoHTA(), x, 12);
            this.xModelo.setValueAt(list.get(x).getDiabetes(), x, 13);
            this.xModelo.setValueAt(list.get(x).getaDiagnosticoDiabetes(), x, 14);
            this.xModelo.setValueAt(list.get(x).getesDiabetesyHTA(), x, 15);
            this.xModelo.setValueAt(list.get(x).getTalla(), x, 16);
            this.xModelo.setValueAt(list.get(x).getPeso(), x, 17);
            this.xModelo.setValueAt(list.get(x).getTArtSentadosS(), x, 18);
            this.xModelo.setValueAt(list.get(x).getTArtSentadosD(), x, 19);
            this.xModelo.setValueAt(list.get(x).getcAbdominal(), x, 20);
            this.xModelo.setValueAt(list.get(x).getTfg(), x, 21);
            this.xModelo.setValueAt(list.get(x).getEstadio(), x, 22);
            this.xModelo.setValueAt(list.get(x).getVlrCreatinina(), x, 23);
            this.xModelo.setValueAt(list.get(x).getFResultadoCreatinina(), x, 24);
            this.xModelo.setValueAt(list.get(x).getVlrAlbuminuria(), x, 25);
            this.xModelo.setValueAt(list.get(x).getFResultadoAlbuminuria(), x, 26);
            this.xModelo.setValueAt(list.get(x).getRelAlbCrea(), x, 27);
            this.xModelo.setValueAt(list.get(x).getFechaRelAlbCrea(), x, 28);
            this.xModelo.setValueAt(list.get(x).getVlrGlucosa(), x, 29);
            this.xModelo.setValueAt(list.get(x).getFResultadoGlucosa(), x, 30);
            this.xModelo.setValueAt(list.get(x).getVlrHBA1C(), x, 31);
            this.xModelo.setValueAt(list.get(x).getFResultadoHBA1C(), x, 32);
            this.xModelo.setValueAt(list.get(x).getVlrColesterol(), x, 33);
            this.xModelo.setValueAt(list.get(x).getFResultadoColesterol(), x, 34);
            this.xModelo.setValueAt(list.get(x).getVlrTrigliceridos(), x, 35);
            this.xModelo.setValueAt(list.get(x).getFResultadoTrigliceridos(), x, 36);
            this.xModelo.setValueAt(list.get(x).getVlrHdl(), x, 37);
            this.xModelo.setValueAt(list.get(x).getFResultadoHdl(), x, 38);
            this.xModelo.setValueAt(list.get(x).getVlrLdl(), x, 39);
            this.xModelo.setValueAt(list.get(x).getFresultadoLdl(), x, 40);
            this.xModelo.setValueAt(list.get(x).getConvenio(), x, 41);
        }
        this.JLBLCont.setText(list.size() + "");
    }

    public void mBuscar() {
        mCargarDatosTablaTotalConsulta();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Informe de Cronicos");
        setToolTipText("");
        setFrameIcon(new ImageIcon(getClass().getResource("/Imagenes/genomap.png")));
        setName("jif_ReporteCronicos");
        ...
        this.JDFechaI.addPropertyChangeListener(new PropertyChangeListener() { // from class: com.genoma.plus.controller.sgc.JIF_RCronicos.2
            @Override // java.beans.PropertyChangeListener
            public void propertyChange(PropertyChangeEvent evt) {
                JIF_RCronicos.this.JDFechaIPropertyChange(evt);
            }
        });
        this.JDFechaF.setBorder(BorderFactory.createTitledBorder((Border) null, "Fecha Final", 0, 0, new Font("Arial", 1, 12), Color.blue));
        this.JDFechaF.setDateFormatString("dd/MM/yyyy");
        this.JDFechaF.setFont(new Font("Arial", 1, 12));
        this.JDFechaF.addPropertyChangeListener(new PropertyChangeListener() { // from class: com.genoma.plus.controller.sgc.JIF_RCronicos.3
            @Override // java.beans.PropertyChangeListener
            public void propertyChange(PropertyChangeEvent evt) {
                JIF_RCronicos.this.JDFechaFPropertyChange(evt);
            }
        });
        ...
        this.JTFRuta.addMouseListener(new MouseAdapter() { // from class: com.genoma.plus.controller.sgc.JIF_RCronicos.4
            public void mouseClicked(MouseEvent evt) {
                JIF_RCronicos.this.JTFRutaMouseClicked(evt);
            }
        });
        this.JTFRuta.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.sgc.JIF_RCronicos.5
            public void actionPerformed(ActionEvent evt) {
                JIF_RCronicos.this.JTFRutaActionPerformed(evt);
            }
        });
        ...
        this.JBTExportar.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.sgc.JIF_RCronicos.6
            public void actionPerformed(ActionEvent evt) {
                JIF_RCronicos.this.JBTExportarActionPerformed(evt);
            }
        });
        ...
        this.jPanel3.setBorder(BorderFactory.createTitledBorder((Border) null, "Total de registros", 0, 0, new Font("Dialog", 0, 12), Color.blue));
        ...
        getAccessibleContext().setAccessibleName("Informe de Cronicos");
        pack();
    }
