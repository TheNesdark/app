...
import com.genoma.plus.jpa.projection.IReporteConsultaDiariasDTO;
import com.genoma.plus.jpa.service.IReporteConsultaDiariasDAO;
...
/* JADX INFO: loaded from: GenomaP.jar:com/genoma/plus/controller/sgc/JIF_RConsultasMedicasDiarias.class */
public class JIF_RConsultasMedicasDiarias extends JInternalFrame {
    ...
    private final IReporteConsultaDiariasDAO xIReporteConsultaDiariasDAO = (IReporteConsultaDiariasDAO) Principal.contexto.getBean(IReporteConsultaDiariasDAO.class);

    public JIF_RConsultasMedicasDiarias() {
        initComponents();
        mNuevo();
    }
    ...
    private void mCrearModeloTotalConsulta() {
        this.xModelo = new DefaultTableModel((Object[][]) null, new String[]{"Municipio", "TipoId", "NoDocumento", "nombre_1", "Nombre_2", "Apelli_1", "Apelli_2", "Sexo", "Edad", "Telefono", "Movil", "Direccion", "C_Diagnostico", "N_Diagnostico", "TipoAtencion", "FechaAtencion", "EPS"}) { // from class: com.genoma.plus.controller.sgc.JIF_RConsultasMedicasDiarias.1
            Class[] types = {String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, Long.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class};
    ...
    private void mCargarDatosTablaTotalConsulta() {
        ...
        List<IReporteConsultaDiariasDTO> list = this.xIReporteConsultaDiariasDAO.consultarDiario(this.xmt.formatoAMD.format(this.JDFechaI.getDate()), this.xmt.formatoAMD.format(this.JDFechaF.getDate()));
        for (int x = 0; x < list.size(); x++) {
            this.xModelo.addRow(this.xDato);
            this.xModelo.setValueAt(list.get(x).getMunicipio(), x, 0);
            this.xModelo.setValueAt(list.get(x).getId_TipoIdentificacion(), x, 1);
            this.xModelo.setValueAt(list.get(x).getNoDocumento(), x, 2);
            this.xModelo.setValueAt(list.get(x).getNombre1(), x, 3);
            this.xModelo.setValueAt(list.get(x).getNombre2(), x, 4);
            this.xModelo.setValueAt(list.get(x).getApellido1(), x, 5);
            this.xModelo.setValueAt(list.get(x).getApellido2(), x, 6);
            this.xModelo.setValueAt(list.get(x).getId_Sexo(), x, 7);
            this.xModelo.setValueAt(list.get(x).getEdad(), x, 8);
            this.xModelo.setValueAt(list.get(x).getTelefono(), x, 9);
            this.xModelo.setValueAt(list.get(x).getMovil(), x, 10);
            this.xModelo.setValueAt(list.get(x).getDireccion(), x, 11);
            this.xModelo.setValueAt(list.get(x).getCodigo_Dxp(), x, 12);
            this.xModelo.setValueAt(list.get(x).getDiagnostico(), x, 13);
            this.xModelo.setValueAt(list.get(x).getClasecita(), x, 14);
            this.xModelo.setValueAt(list.get(x).getFecha_Atencion(), x, 15);
            this.xModelo.setValueAt(list.get(x).getEmpresa(), x, 16);
        }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Reporte de Consultas Diarias");
        setFrameIcon(new ImageIcon(getClass().getResource("/Imagenes/genomap.png")));
        setName("jif_ReporteConsultasDiarias");
        ...
        this.JDFechaI.addPropertyChangeListener(new PropertyChangeListener() { // from class: com.genoma.plus.controller.sgc.JIF_RConsultasMedicasDiarias.2
            @Override // java.beans.PropertyChangeListener
            public void propertyChange(PropertyChangeEvent evt) {
                JIF_RConsultasMedicasDiarias.this.JDFechaIPropertyChange(evt);
            }
        });
        this.JDFechaF.setBorder(BorderFactory.createTitledBorder((Border) null, "Fecha Final", 0, 0, new Font("Arial", 1, 12), Color.blue));
        this.JDFechaF.setDateFormatString("dd/MM/yyyy");
        this.JDFechaF.setFont(new Font("Arial", 1, 12));
        this.JDFechaF.addPropertyChangeListener(new PropertyChangeListener() { // from class: com.genoma.plus.controller.sgc.JIF_RConsultasMedicasDiarias.3
            @Override // java.beans.PropertyChangeListener
            public void propertyChange(PropertyChangeEvent evt) {
                JIF_RConsultasMedicasDiarias.this.JDFechaFPropertyChange(evt);
            }
        });
        ...
        this.JTFRuta.addMouseListener(new MouseAdapter() { // from class: com.genoma.plus.controller.sgc.JIF_RConsultasMedicasDiarias.4
            public void mouseClicked(MouseEvent evt) {
                JIF_RConsultasMedicasDiarias.this.JTFRutaMouseClicked(evt);
            }
        });
        this.JTFRuta.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.sgc.JIF_RConsultasMedicasDiarias.5
            public void actionPerformed(ActionEvent evt) {
                JIF_RConsultasMedicasDiarias.this.JTFRutaActionPerformed(evt);
            }
        });
        ...
        this.JBTExportar.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.sgc.JIF_RConsultasMedicasDiarias.6
            public void actionPerformed(ActionEvent evt) {
                JIF_RConsultasMedicasDiarias.this.JBTExportarActionPerformed(evt);
            }
        });
