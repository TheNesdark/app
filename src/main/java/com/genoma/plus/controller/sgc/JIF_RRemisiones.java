...
import com.genoma.plus.jpa.projection.IReporteRemisionesDTO;
import com.genoma.plus.jpa.service.IReporteRemisionesDAO;
...
/* JADX INFO: loaded from: GenomaP.jar:com/genoma/plus/controller/sgc/JIF_RRemisiones.class */
public class JIF_RRemisiones extends JInternalFrame {
    ...
    private final IReporteRemisionesDAO xIReporteRemisionesDAO = (IReporteRemisionesDAO) Principal.contexto.getBean(IReporteRemisionesDAO.class);

    public JIF_RRemisiones() {
        initComponents();
        mNuevo();
    }
    ...
    private void mCrearModeloTotalConsulta() {
        this.xModelo = new DefaultTableModel((Object[][]) null, new String[]{"TIdentificacion", "Documento", "Nombres", "Apellidos", "Sexo", "Edad", "Dirección", "Teléfono", "Movil", "Empresa-convenio", "FechaRemision", "Tipo_Atención", "CodDx", "Diagnostico", "Detalle", "Especialida_Remision", "Institucion Recibe", "Aplica Ambulacia", "Auxiliar Enfermeria", "Conductor Ambulacia", "Placa Ambulancia", "Profesional Remite", "Especialidad Remite"}) { // from class: com.genoma.plus.controller.sgc.JIF_RRemisiones.1
            Class[] types = {String.class, String.class, String.class, String.class, String.class, Long.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class, String.class};
    ...
    private void mCargarDatosTablaTotalConsulta() {
        ...
        List<IReporteRemisionesDTO> list = this.xIReporteRemisionesDAO.ReporteRemisiones(this.xmt.formatoAMD.format(this.JDFechaI.getDate()), this.xmt.formatoAMD.format(this.JDFechaF.getDate()));
        for (int x = 0; x < list.size(); x++) {
            this.xModelo.addRow(this.xDato);
            this.xModelo.setValueAt(list.get(x).getTipoIdentificacion(), x, 0);
            this.xModelo.setValueAt(list.get(x).getDocumneto(), x, 1);
            this.xModelo.setValueAt(list.get(x).getNombres(), x, 2);
            this.xModelo.setValueAt(list.get(x).getApellidos(), x, 3);
            this.xModelo.setValueAt(list.get(x).getSexo(), x, 4);
            this.xModelo.setValueAt(list.get(x).getEdad(), x, 5);
            this.xModelo.setValueAt(list.get(x).getDireccion(), x, 6);
            this.xModelo.setValueAt(list.get(x).getTelefono(), x, 7);
            this.xModelo.setValueAt(list.get(x).getMovil(), x, 8);
            this.xModelo.setValueAt(list.get(x).getConvenio(), x, 9);
            this.xModelo.setValueAt(list.get(x).getFechaRem(), x, 10);
            this.xModelo.setValueAt(list.get(x).getServicio(), x, 11);
            this.xModelo.setValueAt(list.get(x).getCodDx(), x, 12);
            this.xModelo.setValueAt(list.get(x).getDiagnostico(), x, 13);
            this.xModelo.setValueAt(list.get(x).getDetalle(), x, 14);
            this.xModelo.setValueAt(list.get(x).getEspecialidadRem(), x, 15);
            this.xModelo.setValueAt(list.get(x).getInstitucionRecibe(), x, 16);
            this.xModelo.setValueAt(list.get(x).getAplicaAmbulacia(), x, 17);
            this.xModelo.setValueAt(list.get(x).getAuxiliarEnfermeria(), x, 18);
            this.xModelo.setValueAt(list.get(x).getConductorAmbulacia(), x, 19);
            this.xModelo.setValueAt(list.get(x).getPlacaAmbulancia(), x, 20);
            this.xModelo.setValueAt(list.get(x).getProfesionalRemite(), x, 21);
            this.xModelo.setValueAt(list.get(x).getEspecialidadRemite(), x, 22);
        }
    ...
    private void initComponents() {
        ...
        this.JDFechaI.addPropertyChangeListener(new PropertyChangeListener() { // from class: com.genoma.plus.controller.sgc.JIF_RRemisiones.2
            @Override // java.beans.PropertyChangeListener
            public void propertyChange(PropertyChangeEvent evt) {
                JIF_RRemisiones.this.JDFechaIPropertyChange(evt);
            }
        });
        this.JDFechaF.setBorder(BorderFactory.createTitledBorder((Border) null, "Fecha Final", 0, 0, new Font("Arial", 1, 12), Color.blue));
        this.JDFechaF.setDateFormatString("dd/MM/yyyy");
        this.JDFechaF.setFont(new Font("Arial", 1, 12));
        this.JDFechaF.addPropertyChangeListener(new PropertyChangeListener() { // from class: com.genoma.plus.controller.sgc.JIF_RRemisiones.3
            @Override // java.beans.PropertyChangeListener
            public void propertyChange(PropertyChangeEvent evt) {
                JIF_RRemisiones.this.JDFechaFPropertyChange(evt);
            }
        });
        ...
        this.JTFRuta.addMouseListener(new MouseAdapter() { // from class: com.genoma.plus.controller.sgc.JIF_RRemisiones.4
            public void mouseClicked(MouseEvent evt) {
                JIF_RRemisiones.this.JTFRutaMouseClicked(evt);
            }
        });
        this.JTFRuta.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.sgc.JIF_RRemisiones.5
            public void actionPerformed(ActionEvent evt) {
                JIF_RRemisiones.this.JTFRutaActionPerformed(evt);
            }
        });
        ...
        this.JBTExportar.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.sgc.JIF_RRemisiones.6
            public void actionPerformed(ActionEvent evt) {
                JIF_RRemisiones.this.JBTExportarActionPerformed(evt);
            }
        });
