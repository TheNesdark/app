...
import com.genoma.plus.dao.impl.inventario.ConsolidadoEntradasDAOImpl;
...
/* JADX INFO: loaded from: GenomaP.jar:com/genoma/plus/controller/inventario/JIFConsolidadoEntradas.class */
public class JIFConsolidadoEntradas extends JInternalFrame {
    private ConsolidadoEntradasDAO xConsolidadoEntradasDAO;
    ...
    private void springStart() {
        this.xConsolidadoEntradasDAO = (ConsolidadoEntradasDAOImpl) new ClassPathXmlApplicationContext(new String[]{"/recursos/applicationContext.xml"}).getBean("consolidadoEntradasDAO");
    }
    ...
    private void mCreaModeloPaciente() {
        this.xModelo1 = new DefaultTableModel(new Object[0], new String[]{"Id", "Fecha Entrada", "No. Factura", "Tercero", "Tipo Movimiento", "Bodega", "Estado", "IdDocumentoContable", "Observacion", "IdSuministro", "Producto", "Presentacion Comercial", "Principio Activo", "Tipo Producto", "Categoria", "Cantidad", "V/Unitario", "IVA", "V/Fletes", "V/Descuento", "Lote", "Fecha Vencimiento", "Fecha Registro", "Usuario Registro"}) { // from class: com.genoma.plus.controller.inventario.JIFConsolidadoEntradas.1
            Class[] types = {Long.class, String.class, String.class, String.class, String.class, String.class, String.class, Long.class, String.class, Long.class, String.class, String.class, String.class, String.class, String.class, Integer.class, Double.class, Double.class, Double.class, Double.class, String.class, String.class, String.class, String.class};
    ...
    private void mCargarDatosPaciente() {
        List<ConsolidadoEntradasDTO> list = this.xConsolidadoEntradasDAO.listaConsolidadoEntradas(this.xmt.formatoAMDG.format(this.JDFechaI.getDate()), this.xmt.formatoAMDG.format(this.JDFechaF.getDate()), this.xtipo);
        mCreaModeloPaciente();
        for (int x = 0; x < list.size(); x++) {
            this.xModelo1.addRow(this.xdatos);
            this.xModelo1.setValueAt(list.get(x).getId(), x, 0);
            this.xModelo1.setValueAt(list.get(x).getFechaEntrada(), x, 1);
            this.xModelo1.setValueAt(list.get(x).getNoFactura(), x, 2);
            this.xModelo1.setValueAt(list.get(x).getTercero(), x, 3);
            this.xModelo1.setValueAt(list.get(x).getNTipoMovimiento(), x, 4);
            this.xModelo1.setValueAt(list.get(x).getNBodega(), x, 5);
            ...
            this.xModelo1.setValueAt(list.get(x).getIdSuministros(), x, 9);
            this.xModelo1.setValueAt(list.get(x).getNProducto(), x, 10);
            this.xModelo1.setValueAt(list.get(x).getNPresentacionComercial(), x, 11);
            this.xModelo1.setValueAt(list.get(x).getNPActivo(), x, 12);
            this.xModelo1.setValueAt(list.get(x).getNTipoProducto(), x, 13);
            this.xModelo1.setValueAt(list.get(x).getNCategoria(), x, 14);
            this.xModelo1.setValueAt(Integer.valueOf(list.get(x).getCantidad()), x, 15);
            this.xModelo1.setValueAt(list.get(x).getVUnitario(), x, 16);
            this.xModelo1.setValueAt(list.get(x).getIva(), x, 17);
            this.xModelo1.setValueAt(list.get(x).getVFletesO(), x, 18);
            this.xModelo1.setValueAt(list.get(x).getVDescuento(), x, 19);
            this.xModelo1.setValueAt(list.get(x).getLote(), x, 20);
            this.xModelo1.setValueAt(list.get(x).getFechaVencimiento(), x, 21);
            this.xModelo1.setValueAt(list.get(x).getFechaRegistro(), x, 22);
            this.xModelo1.setValueAt(list.get(x).getUsuarioRegistro(), x, 23);
        }
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("CONSOLIDADO DE ENTRADAS");
        setFrameIcon(new ImageIcon(getClass().getResource("/Imagenes/genomap.png")));
        setName("xjifconsolidadoentradas");
        ...
        this.JDFechaF.addPropertyChangeListener(new PropertyChangeListener() { // from class: com.genoma.plus.controller.inventario.JIFConsolidadoEntradas.2
            @Override // java.beans.PropertyChangeListener
            public void propertyChange(PropertyChangeEvent evt) {
                JIFConsolidadoEntradas.this.JDFechaFPropertyChange(evt);
            }
        });
        ...
        this.JDFechaI.addPropertyChangeListener(new PropertyChangeListener() { // from class: com.genoma.plus.controller.inventario.JIFConsolidadoEntradas.3
            @Override // java.beans.PropertyChangeListener
            public void propertyChange(PropertyChangeEvent evt) {
                JIFConsolidadoEntradas.this.JDFechaIPropertyChange(evt);
            }
        });
        ...
        this.JRBTodos.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.inventario.JIFConsolidadoEntradas.4
            public void actionPerformed(ActionEvent evt) {
                JIFConsolidadoEntradas.this.JRBTodosActionPerformed(evt);
            }
        });
        this.JGBFiltro.add(this.JRBActivos);
        this.JRBActivos.setFont(new Font("Arial", 1, 12));
        this.JRBActivos.setText("Activos");
        this.JRBActivos.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.inventario.JIFConsolidadoEntradas.5
            public void actionPerformed(ActionEvent evt) {
                JIFConsolidadoEntradas.this.JRBActivosActionPerformed(evt);
            }
        });
        this.JGBFiltro.add(this.JRBAnulados);
        this.JRBAnulados.setFont(new Font("Arial", 1, 12));
        this.JRBAnulados.setText("Anulados");
        this.JRBAnulados.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.inventario.JIFConsolidadoEntradas.6
            public void actionPerformed(ActionEvent evt) {
                JIFConsolidadoEntradas.this.JRBAnuladosActionPerformed(evt);
            }
        });
        ...
        this.JTFRuta.addMouseListener(new MouseAdapter() { // from class: com.genoma.plus.controller.inventario.JIFConsolidadoEntradas.7
            public void mouseClicked(MouseEvent evt) {
                JIFConsolidadoEntradas.this.JTFRutaMouseClicked(evt);
            }
        });
        this.JBTExportar.setFont(new Font("Arial", 1, 12));
        this.JBTExportar.setIcon(new ImageIcon(getClass().getResource("/Imagenes/Excel_Icono24x24.png")));
        this.JBTExportar.setText("Exportar");
        this.JBTExportar.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.inventario.JIFConsolidadoEntradas.8
            public void actionPerformed(ActionEvent evt) {
                JIFConsolidadoEntradas.this.JBTExportarActionPerformed(evt);
            }
        });
        ...
        layout.setVerticalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(GroupLayout.Alignment.TRAILING, layout.createSequentialGroup().addContainerGap().addComponent(this.JPInformacion, -2, -1, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JSTDetalle, -2, 361, -2).addGap(10, 10, 10).addGroup(layout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(this.JBTExportar, -2, 50, -2).addComponent(this.JTFRuta, -2, 50, -2)).addGap(10, 10, 10)));
        pack();
    }
