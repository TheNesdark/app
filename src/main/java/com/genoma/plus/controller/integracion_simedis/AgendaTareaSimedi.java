...
/* JADX INFO: loaded from: GenomaP.jar:com/genoma/plus/controller/integracion_simedis/AgendaTareaSimedi.class */
public class AgendaTareaSimedi {
    ...
    public void FinalizaTarea() {
        try {
            ...
            Logger.getLogger(AgendaTareaSimedi.class.getName()).log(Level.SEVERE, (String) null, e);
        }
    }
    ...
    public void iniciarTarea() {
        ...
        crearProgramacion();
        JobDetail job = new JobDetail("TareaBuscarPacienteAgendaEnfermeria", (String) null, AgendaTarea_ImplementacionSimedis.class);
