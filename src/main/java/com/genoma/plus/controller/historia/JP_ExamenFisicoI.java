...
/* JADX INFO: loaded from: GenomaP.jar:com/genoma/plus/controller/historia/JP_ExamenFisicoI.class */
public class JP_ExamenFisicoI extends JPanel {
    ...
    public JP_ExamenFisicoI(clasesHistoriaCE xclase, String xNHoja) {
        initComponents();
        ...
        if (this.JTFNRegistro.getText().isEmpty() || this.JTFNRegistro.getText() == null || this.JTFNRegistro.getText().equals("0")) {
            this.nExamenFisico = false;
        } else {
    ...
    private void initComponents() {
        ...
        this.JTP_EFEstadoGeneral.addKeyListener(new KeyAdapter() { // from class: com.genoma.plus.controller.historia.JP_ExamenFisicoI.1
            public void keyPressed(KeyEvent evt) {
                JP_ExamenFisicoI.this.JTP_EFEstadoGeneralKeyPressed(evt);
            }
        });
        ...
        this.JTFFPSentadoS.addFocusListener(new FocusAdapter() { // from class: com.genoma.plus.controller.historia.JP_ExamenFisicoI.2
            public void focusLost(FocusEvent evt) {
                JP_ExamenFisicoI.this.JTFFPSentadoSFocusLost(evt);
            }
        });
        this.JTFFPSentadoS.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JP_ExamenFisicoI.3
            public void actionPerformed(ActionEvent evt) {
                JP_ExamenFisicoI.this.JTFFPSentadoSActionPerformed(evt);
            }
        });
        ...
        this.JTFFPSentadoD.addFocusListener(new FocusAdapter() { // from class: com.genoma.plus.controller.historia.JP_ExamenFisicoI.4
            public void focusLost(FocusEvent evt) {
                JP_ExamenFisicoI.this.JTFFPSentadoDFocusLost(evt);
            }
        });
        this.JTFFPSentadoD.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JP_ExamenFisicoI.5
            public void actionPerformed(ActionEvent evt) {
                JP_ExamenFisicoI.this.JTFFPSentadoDActionPerformed(evt);
            }
        });
        ...
        this.JTFFSFc.addFocusListener(new FocusAdapter() { // from class: com.genoma.plus.controller.historia.JP_ExamenFisicoI.6
            public void focusGained(FocusEvent evt) {
                JP_ExamenFisicoI.this.JTFFSFcFocusGained(evt);
            }

            public void focusLost(FocusEvent evt) {
                JP_ExamenFisicoI.this.JTFFSFcFocusLost(evt);
            }
        });
        this.JTFFSFc.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JP_ExamenFisicoI.7
            public void actionPerformed(ActionEvent evt) {
                JP_ExamenFisicoI.this.JTFFSFcActionPerformed(evt);
            }
        });
        this.JTFFSFc.addKeyListener(new KeyAdapter() { // from class: com.genoma.plus.controller.historia.JP_ExamenFisicoI.8
            public void keyPressed(KeyEvent evt) {
                JP_ExamenFisicoI.this.JTFFSFcKeyPressed(evt);
            }

            public void keyTyped(KeyEvent evt) {
                JP_ExamenFisicoI.this.JTFFSFcKeyTyped(evt);
            }
        });
        ...
        this.JTFFSFr.addFocusListener(new FocusAdapter() { // from class: com.genoma.plus.controller.historia.JP_ExamenFisicoI.9
            public void focusGained(FocusEvent evt) {
                JP_ExamenFisicoI.this.JTFFSFrFocusGained(evt);
            }
        });
        this.JTFFSFr.addKeyListener(new KeyAdapter() { // from class: com.genoma.plus.controller.historia.JP_ExamenFisicoI.10
            public void keyTyped(KeyEvent evt) {
                JP_ExamenFisicoI.this.JTFFSFrKeyTyped(evt);
            }
        });
        ...
        this.JTFFTemperatura.addFocusListener(new FocusAdapter() { // from class: com.genoma.plus.controller.historia.JP_ExamenFisicoI.11
            public void focusGained(FocusEvent evt) {
                JP_ExamenFisicoI.this.JTFFTemperaturaFocusGained(evt);
            }
        });
        this.JTFFTemperatura.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JP_ExamenFisicoI.12
            public void actionPerformed(ActionEvent evt) {
                JP_ExamenFisicoI.this.JTFFTemperaturaActionPerformed(evt);
            }
        });
        this.JTFFTemperatura.addKeyListener(new KeyAdapter() { // from class: com.genoma.plus.controller.historia.JP_ExamenFisicoI.13
            public void keyTyped(KeyEvent evt) {
                JP_ExamenFisicoI.this.JTFFTemperaturaKeyTyped(evt);
            }
        });
        ...
        this.JTFFPs2.addFocusListener(new FocusAdapter() { // from class: com.genoma.plus.controller.historia.JP_ExamenFisicoI.14
            public void focusGained(FocusEvent evt) {
                JP_ExamenFisicoI.this.JTFFPs2FocusGained(evt);
            }
        });
        this.JTFFPs2.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JP_ExamenFisicoI.15
            public void actionPerformed(ActionEvent evt) {
                JP_ExamenFisicoI.this.JTFFPs2ActionPerformed(evt);
            }
        });
        this.JTFFPs2.addKeyListener(new KeyAdapter() { // from class: com.genoma.plus.controller.historia.JP_ExamenFisicoI.16
            public void keyTyped(KeyEvent evt) {
                JP_ExamenFisicoI.this.JTFFPs2KeyTyped(evt);
            }
        });
        ...
        this.JTFFSTalla.addFocusListener(new FocusAdapter() { // from class: com.genoma.plus.controller.historia.JP_ExamenFisicoI.17
            public void focusGained(FocusEvent evt) {
                JP_ExamenFisicoI.this.JTFFSTallaFocusGained(evt);
            }
        });
        this.JTFFSTalla.addKeyListener(new KeyAdapter() { // from class: com.genoma.plus.controller.historia.JP_ExamenFisicoI.18
            public void keyTyped(KeyEvent evt) {
                JP_ExamenFisicoI.this.JTFFSTallaKeyTyped(evt);
            }
        });
        ...
        this.JTFPAbdominal.addFocusListener(new FocusAdapter() { // from class: com.genoma.plus.controller.historia.JP_ExamenFisicoI.19
            public void focusGained(FocusEvent evt) {
                JP_ExamenFisicoI.this.JTFPAbdominalFocusGained(evt);
            }
        });
        this.JTFPAbdominal.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JP_ExamenFisicoI.20
            public void actionPerformed(ActionEvent evt) {
                JP_ExamenFisicoI.this.JTFPAbdominalActionPerformed(evt);
            }
        });
        this.JTFPAbdominal.addKeyListener(new KeyAdapter() { // from class: com.genoma.plus.controller.historia.JP_ExamenFisicoI.21
            public void keyTyped(KeyEvent evt) {
                JP_ExamenFisicoI.this.JTFPAbdominalKeyTyped(evt);
            }
        });
        ...
        this.JTFFSPAM.addFocusListener(new FocusAdapter() { // from class: com.genoma.plus.controller.historia.JP_ExamenFisicoI.22
            public void focusGained(FocusEvent evt) {
                JP_ExamenFisicoI.this.JTFFSPAMFocusGained(evt);
            }
        });
        ...
        this.JTFFSPeso2.addFocusListener(new FocusAdapter() { // from class: com.genoma.plus.controller.historia.JP_ExamenFisicoI.23
            public void focusLost(FocusEvent evt) {
                JP_ExamenFisicoI.this.JTFFSPeso2FocusLost(evt);
            }
        });
        this.JTFFSPeso2.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JP_ExamenFisicoI.24
            public void actionPerformed(ActionEvent evt) {
                JP_ExamenFisicoI.this.JTFFSPeso2ActionPerformed(evt);
            }
        });
        ...
        this.JCH_EstadoInicial.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JP_ExamenFisicoI.25
            public void actionPerformed(ActionEvent evt) {
                JP_ExamenFisicoI.this.JCH_EstadoInicialActionPerformed(evt);
            }
        });
        ...
        this.JCH_ValorporDefecto.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JP_ExamenFisicoI.26
            public void actionPerformed(ActionEvent evt) {
                JP_ExamenFisicoI.this.JCH_ValorporDefectoActionPerformed(evt);
            }
        });
        ...
        this.JBTGuardar.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JP_ExamenFisicoI.27
            public void actionPerformed(ActionEvent evt) {
                JP_ExamenFisicoI.this.JBTGuardarActionPerformed(evt);
            }
        });
        ...
        this.JCH_SinValidacionSignos.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JP_ExamenFisicoI.28
            public void actionPerformed(ActionEvent evt) {
                JP_ExamenFisicoI.this.JCH_SinValidacionSignosActionPerformed(evt);
            }
        });
    ...
    private void mValidarPresion(int valor, int xt) {
        if (xt == 0) {
            if (valor > 0 && valor < 100) {
                JOptionPane.showMessageDialog(this, "Presión Sistólica Baja", "VERIFICAR", 2, new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/Imagenes/Warning.png"))));
                return;
            } else {
                if (valor > 0 && valor > 140) {
                    JOptionPane.showMessageDialog(this, "Presión Sistólica Alta", "VERIFICAR", 2, new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/Imagenes/Warning.png"))));
                    return;
                }
                return;
            }
        ...
        if (valor > 0 && valor < 60) {
            JOptionPane.showMessageDialog(this, "Presión Diastólica Baja", "VERIFICAR", 2, new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/Imagenes/Warning.png"))));
        } else if (valor > 0 && valor > 90) {
            JOptionPane.showMessageDialog(this, "Presión Diastólica Alta", "VERIFICAR", 2, new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/Imagenes/Warning.png"))));
        }
    }

    /* JADX WARN: Type inference failed for: r4v1, types: [java.lang.Object[], java.lang.Object[][]] */
    private void mModelo() {
        this.xmodelo = new DefaultTableModel(new Object[0], new String[]{"Id", "Sistema", "Descripcion", "IdDetalle", "VDefecto"}) { // from class: com.genoma.plus.controller.historia.JP_ExamenFisicoI.29
    ...
    private void mCargarDatosTabla() {
        ...
        if (!listExamen.isEmpty()) {
            ...
            this.JTFFSIMC.setText(truncateDecimal(String.valueOf(listExamen.get(0).getImc())));
            this.JTFFSPAM.setText(String.valueOf(listExamen.get(0).getTAMedia()).toString());
            if (listExamen.get(0).getImc().doubleValue() < 18.5d) {
                this.JLBCImc.setText("Delgadez");
            } else if (listExamen.get(0).getImc().doubleValue() >= 18.5d && listExamen.get(0).getImc().doubleValue() < 25.0d) {
                this.JLBCImc.setText("Normal");
            } else if (listExamen.get(0).getImc().doubleValue() >= 25.0d && listExamen.get(0).getImc().doubleValue() < 30.0d) {
                this.JLBCImc.setText("Sobrepeso");
            } else if (listExamen.get(0).getImc().doubleValue() >= 30.0d) {
                this.JLBCImc.setText("Obesidad");
                if (listExamen.get(0).getImc().doubleValue() >= 30.0d && listExamen.get(0).getImc().doubleValue() <= 34.9d) {
                    this.JLBCObecidad.setText("Obesidad grado I");
                } else if (listExamen.get(0).getImc().doubleValue() >= 35.0d && listExamen.get(0).getImc().doubleValue() <= 39.9d) {
                    this.JLBCObecidad.setText("Obesidad grado II");
                } else if (listExamen.get(0).getImc().doubleValue() >= 40.0d) {
        ...
        System.out.println("tipo historia -> " + String.valueOf(clasesHistoriaCE.informacionAgendaMedicaDTO.getIdTipohc()));
    ...
    public void mGrabarM() {
        ...
        e.setImc(Double.valueOf(this.imc));
            ...
            if (!this.JTFFSFr.getText().isEmpty() && Double.parseDouble(this.JTFFSFr.getText().toString()) > 0.0d) {
                if (!this.JTFFTemperatura.getText().isEmpty() && Double.parseDouble(this.JTFFTemperatura.getText().toString()) >= 0.0d) {
                    if (Principal.informacionIps.getNombreIps().equals("E.S.E CAMU BUENAVISTA")) {
                        if (Integer.parseInt(this.JTFFPs2.getText().toString()) > 0) {
                            if (Integer.parseInt(this.JTFFSTalla.getText().toString()) > 0) {
                                if (Integer.parseInt(this.JTFFSPeso2.getText().toString()) > 0) {
                                            ...
                                            if (!this.xmetodo.mVerificarDatosLLeno(this.JTB_Hallazgo, 1)) {
                                                if (clasesHistoriaCE.informacionAgendaMedicaDTO.getIdTipoAtencion().intValue() == 1) {
                                                    if (!this.JTFPAbdominal.getText().isEmpty() && Double.parseDouble(this.JTFPAbdominal.getText()) > 0.0d) {
                                                        ...
                                                        JOptionPane.showMessageDialog(this, "Llene el perimetro Abdominal", "VERIFICAR", 1, new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/Imagenes/Information.png"))));
                                                ...
                                                JOptionPane.showMessageDialog(this, "Los hallagazgo no deben estar en blanco", "VERIFICAR", 1, new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/Imagenes/Information.png"))));
                                            }
                                        } else {
                                            JOptionPane.showMessageDialog(this, "El estado general no debe estar en blanco", "VERIFICAR", 1, new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/Imagenes/Information.png"))));
                                            this.JTP_EFEstadoGeneral.requestFocus();
                                        }
                                    }
                                } else {
                                    JOptionPane.showMessageDialog(this, "Verifique el peso", "VERIFICAR", 1, new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/Imagenes/Information.png"))));
                                    this.JTFFSPeso2.requestFocus();
                                }
                            } else {
                                JOptionPane.showMessageDialog(this, "Verifique la talla", "VERIFICAR", 1, new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/Imagenes/Information.png"))));
                                this.JTFFSTalla.requestFocus();
                            }
                        } else {
                            JOptionPane.showMessageDialog(this, "Verifique la saturación de oxígeno", "VERIFICAR", 1, new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/Imagenes/Information.png"))));
                            this.JTFFPs2.requestFocus();
                        }
                    } else if (validarPresion().booleanValue()) {
                        if (!this.JTP_EFEstadoGeneral.getText().isEmpty()) {
                            if (!this.xmetodo.mVerificarDatosLLeno(this.JTB_Hallazgo, 1)) {
    ...
    public String truncateDecimal(String value) {
        BigDecimal decimalValue = new BigDecimal(value);
        return decimalValue.setScale(2, RoundingMode.DOWN).toString();
    }
}
