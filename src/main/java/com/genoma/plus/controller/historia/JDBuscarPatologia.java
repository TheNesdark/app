...
/* JADX INFO: loaded from: GenomaP.jar:com/genoma/plus/controller/historia/JDBuscarPatologia.class */
public class JDBuscarPatologia extends JDialog {
    ...
    public JDBuscarPatologia(Frame parent, JPanel JPI_Datos) {
        super(parent, true);
    ...
    public JDBuscarPatologia(Object jppatologias, String nombre, JTextField codigo, JTextField nombrep, Object jifhistoria, String idcofides) {
        this.modelo = new DefaultTableModel();
        this.metodos = new Metodos();
        this.consultas = new ConsultasMySQL();
        this.nfila = 0;
    ...
    public JDBuscarPatologia(Object jppatologias, String nombre, JTextField codigo, JTextField nombrep, Object jifhistoria, int nidcofides) {
        this.modelo = new DefaultTableModel();
        this.metodos = new Metodos();
        this.consultas = new ConsultasMySQL();
        this.nfila = 0;
    ...
    public JDBuscarPatologia(Object jppatologias, String xnombrellamador) {
        this.modelo = new DefaultTableModel();
        this.metodos = new Metodos();
        this.consultas = new ConsultasMySQL();
        this.nfila = 0;
    ...
    public JDBuscarPatologia(JTextField codigo, JTextField nombrep, String xnombrellamador, int xValidacion) {
        this.modelo = new DefaultTableModel();
        this.metodos = new Metodos();
        this.consultas = new ConsultasMySQL();
        this.nfila = 0;
    ...
    public JDBuscarPatologia(JTextField codigo, String xnombrellamador) {
        this.modelo = new DefaultTableModel();
        this.metodos = new Metodos();
        this.consultas = new ConsultasMySQL();
        this.nfila = 0;
    ...
    public JDBuscarPatologia(JPSo_Osteomuscular xclase, String xnombrellamador) {
        this.modelo = new DefaultTableModel();
        this.metodos = new Metodos();
        this.consultas = new ConsultasMySQL();
        this.nfila = 0;
    ...
    public JDBuscarPatologia(JPOdontograma xJPOdontograma, String xnombrellamador) {
        this.modelo = new DefaultTableModel();
        this.metodos = new Metodos();
        this.consultas = new ConsultasMySQL();
        this.nfila = 0;
    ...
    private void initComponents() {
        ...
        this.JFTFNombrePatologia.addKeyListener(new KeyAdapter() { // from class: com.genoma.plus.controller.historia.JDBuscarPatologia.1
            public void keyPressed(KeyEvent evt) {
                JDBuscarPatologia.this.JFTFNombrePatologiaKeyPressed(evt);
            }

            public void keyReleased(KeyEvent evt) {
                JDBuscarPatologia.this.JFTFNombrePatologiaKeyReleased(evt);
            }
        });
        ...
        this.JCHEmpieza.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JDBuscarPatologia.2
            public void actionPerformed(ActionEvent evt) {
                JDBuscarPatologia.this.JCHEmpiezaActionPerformed(evt);
            }
        });
        this.JCHContiene.setFont(new Font("Arial", 1, 12));
        this.JCHContiene.setForeground(Color.blue);
        this.JCHContiene.setText("Contiene");
        this.JCHContiene.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JDBuscarPatologia.3
            public void actionPerformed(ActionEvent evt) {
                JDBuscarPatologia.this.JCHContieneActionPerformed(evt);
            }
        });
        ...
        this.JCHFiltroPrograma.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JDBuscarPatologia.4
            public void actionPerformed(ActionEvent evt) {
                JDBuscarPatologia.this.JCHFiltroProgramaActionPerformed(evt);
            }
        });
        GroupLayout JPIDatosBuscarLayout = new GroupLayout(this.JPIDatosBuscar);
        this.JPIDatosBuscar.setLayout(JPIDatosBuscarLayout);
        JPIDatosBuscarLayout.setHorizontalGroup(JPIDatosBuscarLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPIDatosBuscarLayout.createSequentialGroup().addContainerGap().addComponent(this.JFTFNombrePatologia, -2, 483, -2).addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED).addGroup(JPIDatosBuscarLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.JCHFiltroPrograma).addComponent(this.JPIFBusqueda, -2, -1, -2)).addContainerGap(15, 32767)));
        ...
        this.JTResultado.addMouseListener(new MouseAdapter() { // from class: com.genoma.plus.controller.historia.JDBuscarPatologia.5
            public void mouseClicked(MouseEvent evt) {
                JDBuscarPatologia.this.JTResultadoMouseClicked(evt);
            }
        });
    ...
    public void JTResultadoMouseClicked(MouseEvent evt) {
        if (this.xnombre.equals("jpingreso")) {
            dispose();
            return;
        }
        if (this.xnombre.equals("antecedentesFamiliares") || this.xnombre.equals("patologiasasociadas") || this.xnombre.equals("antecedentesocupacionales") || this.xnombre.equals("cirugia")) {
            mLlenarTextFiel();
            return;
        }
        if (this.xnombre.equals("conclusion") || this.xnombre.equals("incapacidad") || this.xnombre.equals("ReporteP") || this.xnombre.equals("Odontolgia") || this.xnombre.equals("seguimientopac") || this.xnombre.equals("transfusiones") || this.xnombre.equals("transporte_asis") || this.xnombre.equals("xjpdiagnostico")) {
            mLlenarTextFiel();
            return;
        }
        if (this.xnombre.equals("digitaciondx")) {
        ...
        if (this.xnombre.equals("facturacion") || this.xnombre.equals("EgresoPyP") || this.xnombre.equals("LiqServicios")) {
            mLlenarTextFiel1();
            return;
        }
        if (this.xnombre.equals("diagnostico_activos")) {
        ...
        if (this.xnombre.equals("dxodontograma")) {
            ...
            dispose();
        } else if (this.xnombre.equals("historia_fisioterapia")) {
            mLlenarTextFiel();
        } else if (this.xnombre.equals("recien_nacidos")) {
            mLlenarTextFiel();
        } else if (this.xnombre.equals("Cirugias")) {
            mLlenarTextFiel2();
        }
    }
    ...
    private void mCrearTabla() {
        this.modelo = new DefaultTableModel(new Object[0], new String[]{"Código", "Nombre"}) { // from class: com.genoma.plus.controller.historia.JDBuscarPatologia.6
