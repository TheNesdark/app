...
/* JADX INFO: loaded from: GenomaP.jar:com/genoma/plus/controller/historia/JPSo_Audiometria_nueva_graficaxy.class */
public class JPSo_Audiometria_nueva_graficaxy extends JPanel {
    ...
    private JRadioButton RdDer1;
    private JRadioButton RdDer2;
    private JRadioButton RdDer3;
    private JRadioButton RdIzq1;
    private JRadioButton RdIzq2;
    private JRadioButton RdIzq3;
    ...
    private ButtonGroup groupimgDer;
    private ButtonGroup groupimgIzq;
    ...
    private JLabel jLbImg1Derecha;
    private JLabel jLbImg1Izquierda;
    ...
    private int contador_de_objetos2 = 0;
    private DefaultListModel listModel = new DefaultListModel();
    private DefaultListModel listMode2 = new DefaultListModel();

    public JPSo_Audiometria_nueva_graficaxy() {
        initComponents();
        ...
        this.ms = new MiImagen(this.contenedorDerecha, this.listModel);
        this.ms2 = new MiImagen(this.contenedorIzquierda, this.listMode2);
        BuscarPointsDeAudiometria();
        mNuevo();
        this.JCBLobulo.setVisible(false);
    }

    private void BuscarPointsDeAudiometria() {
        if (Integer.parseInt(this.JPODer250.getValue().toString()) > 0 || Integer.parseInt(this.JPODer500.getValue().toString()) > 0 || Integer.parseInt(this.JPODer1000.getValue().toString()) > 0 || Integer.parseInt(this.JPODer2000.getValue().toString()) > 0 || Integer.parseInt(this.JPODer3000.getValue().toString()) > 0 || Integer.parseInt(this.JPODer4000.getValue().toString()) > 0 || Integer.parseInt(this.JPODer6000.getValue().toString()) > 0 || Integer.parseInt(this.JPODer8000.getValue().toString()) > 0) {
            Point250Der();
            Point500Der();
            Point1000Der();
            Point2000Der();
        ...
        if (Integer.parseInt(this.JPOIzq250.getValue().toString()) > 0 || Integer.parseInt(this.JPOIzq500.getValue().toString()) > 0 || Integer.parseInt(this.JPOIzq1000.getValue().toString()) > 0 || Integer.parseInt(this.JPOIzq2000.getValue().toString()) > 0 || Integer.parseInt(this.JPOIzq3000.getValue().toString()) > 0 || Integer.parseInt(this.JPOIzq4000.getValue().toString()) > 0 || Integer.parseInt(this.JPODer6000.getValue().toString()) > 0 || Integer.parseInt(this.JPODer8000.getValue().toString()) > 0) {
            Point250Izq();
            Point500Izq();
            Point1000Izq();
            Point2000Izq();
    ...
    private void Point250Der() {
        String imagenPoint = SelecImgPointDerecha();
        int cx = 0;
        int cy = 0;
        try {
            String Sqlx = "SELECT scia.x,scia.y\nFROM so_cordenadas_img_audiometria scia \nwhere scia.intensidad = '" + this.JPODer250.getValue() + "' AND scia.frecuencia = '250'";
            System.out.println(Sqlx);
            ResultSet xrs = this.xconsultasbd.traerRs(Sqlx);
            if (xrs.next()) {
                cx = Integer.parseInt(xrs.getString("x").toString());
                cy = Integer.parseInt(xrs.getString("y").toString());
            }
            xrs.close();
            this.xconsultasbd.cerrarConexionBd();
            this.ms.imagen = imagenPoint;
            this.ms.Nuevo_Objeto(cy - 7, cx - 7);
            this.jLbImg1Derecha.getParent().setComponentZOrder(this.jLbImg1Derecha, this.contador_de_objetos + 1);
    ...
    private void Point500Der() {
        String imagenPoint = SelecImgPointDerecha();
        int cx = 0;
        int cy = 0;
        try {
            String Sqlx = "SELECT scia.x,scia.y\nFROM so_cordenadas_img_audiometria scia \nwhere scia.intensidad = '" + this.JPODer500.getValue() + "' AND scia.frecuencia = '500'";
            System.out.println(Sqlx);
            ResultSet xrs = this.xconsultasbd.traerRs(Sqlx);
            if (xrs.next()) {
                cx = Integer.parseInt(xrs.getString("x").toString());
    ...
    private void Point1000Der() {
        String imagenPoint = SelecImgPointDerecha();
        int cx = 0;
        int cy = 0;
        try {
            String Sqlx = "SELECT scia.x,scia.y\nFROM so_cordenadas_img_audiometria scia \nwhere scia.intensidad = '" + this.JPODer1000.getValue() + "' AND scia.frecuencia = '1000'";
            System.out.println(Sqlx);
            ResultSet xrs = this.xconsultasbd.traerRs(Sqlx);
            if (xrs.next()) {
                cx = Integer.parseInt(xrs.getString("x").toString());
    ...
    private void Point2000Der() {
        String imagenPoint = SelecImgPointDerecha();
        int cx = 0;
        int cy = 0;
        try {
            String Sqlx = "SELECT scia.x,scia.y\nFROM so_cordenadas_img_audiometria scia \nwhere scia.intensidad = '" + this.JPODer2000.getValue() + "' AND scia.frecuencia = '2000'";
            System.out.println(Sqlx);
            ResultSet xrs = this.xconsultasbd.traerRs(Sqlx);
            if (xrs.next()) {
                cx = Integer.parseInt(xrs.getString("x").toString());
    ...
    private void Point3000Der() {
        String imagenPoint = SelecImgPointDerecha();
        int cx = 0;
        int cy = 0;
        try {
            String Sqlx = "SELECT scia.x,scia.y\nFROM so_cordenadas_img_audiometria scia \nwhere scia.intensidad = '" + this.JPODer3000.getValue() + "' AND scia.frecuencia = '3000'";
            System.out.println(Sqlx);
            ResultSet xrs = this.xconsultasbd.traerRs(Sqlx);
            if (xrs.next()) {
                cx = Integer.parseInt(xrs.getString("x").toString());
    ...
    private void Point4000Der() {
        String imagenPoint = SelecImgPointDerecha();
        int cx = 0;
        int cy = 0;
        try {
            String Sqlx = "SELECT scia.x,scia.y\nFROM so_cordenadas_img_audiometria scia \nwhere scia.intensidad = '" + this.JPODer4000.getValue() + "' AND scia.frecuencia = '4000'";
            System.out.println(Sqlx);
            ResultSet xrs = this.xconsultasbd.traerRs(Sqlx);
            if (xrs.next()) {
                cx = Integer.parseInt(xrs.getString("x").toString());
    ...
    private void Point6000Der() {
        String imagenPoint = SelecImgPointDerecha();
        int cx = 0;
        int cy = 0;
        try {
            String Sqlx = "SELECT scia.x,scia.y\nFROM so_cordenadas_img_audiometria scia \nwhere scia.intensidad = '" + this.JPODer6000.getValue() + "' AND scia.frecuencia = '6000'";
            System.out.println(Sqlx);
            ResultSet xrs = this.xconsultasbd.traerRs(Sqlx);
            if (xrs.next()) {
                cx = Integer.parseInt(xrs.getString("x").toString());
    ...
    private void Point8000Der() {
        String imagenPoint = SelecImgPointDerecha();
        int cx = 0;
        int cy = 0;
        try {
            String Sqlx = "SELECT scia.x,scia.y\nFROM so_cordenadas_img_audiometria scia \nwhere scia.intensidad = '" + this.JPODer8000.getValue() + "' AND scia.frecuencia = '8000'";
            System.out.println(Sqlx);
            ResultSet xrs = this.xconsultasbd.traerRs(Sqlx);
            if (xrs.next()) {
                cx = Integer.parseInt(xrs.getString("x").toString());
    ...
    private void Point250Izq() {
        String imagenPoint = SelecImgPointIzquierda();
        int cx = 0;
        int cy = 0;
        try {
            String Sqlx = "SELECT scia.x,scia.y\nFROM so_cordenadas_img_audiometria scia \nwhere scia.intensidad = '" + this.JPOIzq250.getValue() + "' AND scia.frecuencia = '250'";
            System.out.println(Sqlx);
            ResultSet xrs = this.xconsultasbd.traerRs(Sqlx);
            if (xrs.next()) {
                cx = Integer.parseInt(xrs.getString("x").toString());
            ...
            xrs.close();
            this.xconsultasbd.cerrarConexionBd();
            this.ms2.imagen = imagenPoint;
            this.ms2.Nuevo_Objeto(cy - 7, cx - 7);
            this.jLbImg1Izquierda.getParent().setComponentZOrder(this.jLbImg1Izquierda, this.contador_de_objetos2 + 1);
            this.contador_de_objetos2++;
        } catch (Exception ex) {
            this.xconsultasbd.cerrarConexionBd();
            System.out.println("Error " + ex);
        }
    ...
    private void Point500Izq() {
        String imagenPoint = SelecImgPointIzquierda();
        int cx = 0;
        int cy = 0;
        try {
            String Sqlx = "SELECT scia.x,scia.y\nFROM so_cordenadas_img_audiometria scia \nwhere scia.intensidad = '" + this.JPOIzq500.getValue() + "' AND scia.frecuencia = '500'";
            System.out.println(Sqlx);
            ResultSet xrs = this.xconsultasbd.traerRs(Sqlx);
            if (xrs.next()) {
                cx = Integer.parseInt(xrs.getString("x").toString());
    ...
    private void Point1000Izq() {
        String imagenPoint = SelecImgPointIzquierda();
        int cx = 0;
        int cy = 0;
        try {
            String Sqlx = "SELECT scia.x,scia.y\nFROM so_cordenadas_img_audiometria scia \nwhere scia.intensidad = '" + this.JPOIzq1000.getValue() + "' AND scia.frecuencia = '1000'";
            System.out.println(Sqlx);
            ResultSet xrs = this.xconsultasbd.traerRs(Sqlx);
            if (xrs.next()) {
                cx = Integer.parseInt(xrs.getString("x").toString());
    ...
    private void Point2000Izq() {
        String imagenPoint = SelecImgPointIzquierda();
        int cx = 0;
        int cy = 0;
        try {
            String Sqlx = "SELECT scia.x,scia.y\nFROM so_cordenadas_img_audiometria scia \nwhere scia.intensidad = '" + this.JPOIzq2000.getValue() + "' AND scia.frecuencia = '2000'";
            System.out.println(Sqlx);
            ResultSet xrs = this.xconsultasbd.traerRs(Sqlx);
            if (xrs.next()) {
                cx = Integer.parseInt(xrs.getString("x").toString());
    ...
    private void Point3000Izq() {
        String imagenPoint = SelecImgPointIzquierda();
        int cx = 0;
        int cy = 0;
        try {
            String Sqlx = "SELECT scia.x,scia.y\nFROM so_cordenadas_img_audiometria scia \nwhere scia.intensidad = '" + this.JPOIzq3000.getValue() + "' AND scia.frecuencia = '3000'";
            System.out.println(Sqlx);
            ResultSet xrs = this.xconsultasbd.traerRs(Sqlx);
            if (xrs.next()) {
                cx = Integer.parseInt(xrs.getString("x").toString());
    ...
    private void Point4000Izq() {
        String imagenPoint = SelecImgPointIzquierda();
        int cx = 0;
        int cy = 0;
        try {
            String Sqlx = "SELECT scia.x,scia.y\nFROM so_cordenadas_img_audiometria scia \nwhere scia.intensidad = '" + this.JPOIzq4000.getValue() + "' AND scia.frecuencia = '4000'";
            System.out.println(Sqlx);
            ResultSet xrs = this.xconsultasbd.traerRs(Sqlx);
            if (xrs.next()) {
                cx = Integer.parseInt(xrs.getString("x").toString());
    ...
    private void Point6000Izq() {
        String imagenPoint = SelecImgPointIzquierda();
        int cx = 0;
        int cy = 0;
        try {
            String Sqlx = "SELECT scia.x,scia.y\nFROM so_cordenadas_img_audiometria scia \nwhere scia.intensidad = '" + this.JPOIzq6000.getValue() + "' AND scia.frecuencia = '6000'";
            System.out.println(Sqlx);
            ResultSet xrs = this.xconsultasbd.traerRs(Sqlx);
            if (xrs.next()) {
                cx = Integer.parseInt(xrs.getString("x").toString());
    ...
    private void Point8000Izq() {
        String imagenPoint = SelecImgPointIzquierda();
        int cx = 0;
        int cy = 0;
        try {
            String Sqlx = "SELECT scia.x,scia.y\nFROM so_cordenadas_img_audiometria scia \nwhere scia.intensidad = '" + this.JPOIzq8000.getValue() + "' AND scia.frecuencia = '8000'";
            System.out.println(Sqlx);
            ResultSet xrs = this.xconsultasbd.traerRs(Sqlx);
            if (xrs.next()) {
                cx = Integer.parseInt(xrs.getString("x").toString());
    ...
    public void mImprimir2() {
        ...
        System.out.println(sizeXrs);
        this.xconsultasbd.cerrarConexionBd();
        if (sizeXrs > 0) {
            ResubirSoporte = false;
        } else {
            ResubirSoporte = true;
            System.out.println("No hay soporte asociado a esta audiometria");
        }
        String[][] mparametros = new String[4][2];
        ...
        if (Principal.informacionIps.getNombreIps().equals("IPS SU SALUD INTEGRAL S.A.S")) {
            ...
            if (Principal.informacionIps.getNombreIps().equals("BIEN ESTAR SALUD BS S.A.S.")) {
                mparametros[0][0] = "idatencion1";
                mparametros[0][1] = idAtencion;
                this.xmetodo.GenerarPDFAudimetriaBienestar(this.xmetodo.getRutaRep() + "SO2_HistoriaClinica_Audiometria1_Bienestar", mparametros, String.valueOf(clasesHistoriaCE.informacionAgendaMedicaDTO.getIdIngreso()), ResubirSoporte);
                return;
            }
            this.xmetodo.GenerarPDF(this.xmetodo.getRutaRep() + "SO2_HistoriaClinica_Audiometria1", mparametros);
        }
    ...
    /* JADX WARN: Type inference failed for: r3v631, types: [java.lang.Object[], java.lang.Object[][]] */
    private void initComponents() {
        ...
        this.groupimgIzq = new ButtonGroup();
        this.groupimgDer = new ButtonGroup();
        ...
        this.RdDer1 = new JRadioButton();
        this.jLabel61 = new JLabel();
        this.jLabel62 = new JLabel();
        this.RdDer2 = new JRadioButton();
        this.RdDer3 = new JRadioButton();
        this.jLabel63 = new JLabel();
        this.jPanel14 = new JPanel();
        this.jLabel58 = new JLabel();
        this.jLabel59 = new JLabel();
        this.jLabel60 = new JLabel();
        this.RdIzq1 = new JRadioButton();
        this.RdIzq2 = new JRadioButton();
        this.RdIzq3 = new JRadioButton();
        this.contenedorDerecha = new JPanel();
        this.jLbImg1Derecha = new JLabel();
        this.contenedorIzquierda = new JPanel();
        this.jLbImg1Izquierda = new JLabel();
        ...
        setBorder(BorderFactory.createTitledBorder((Border) null, "EXAMEN DE AUDIOMETRÍA", 2, 0, new Font("Arial", 1, 14), new Color(0, 204, 204)));
        setAutoscrolls(true);
        setName("jifaudiometria_so_nuevo_grafica_xy");
        ...
        this.JPODer500.addChangeListener(new ChangeListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.1
            public void stateChanged(ChangeEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JPODer500StateChanged(evt);
            }
        });
        this.JPODer1000.setModel(new SpinnerNumberModel(0, (Comparable) null, 100, 5));
        this.JPODer1000.addChangeListener(new ChangeListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.2
            public void stateChanged(ChangeEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JPODer1000StateChanged(evt);
            }
        });
        this.JPODer2000.setModel(new SpinnerNumberModel(0, (Comparable) null, 100, 5));
        this.JPODer2000.addChangeListener(new ChangeListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.3
            public void stateChanged(ChangeEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JPODer2000StateChanged(evt);
            }
        });
        this.JPODer3000.setModel(new SpinnerNumberModel(0, (Comparable) null, 100, 5));
        this.JPODer3000.addChangeListener(new ChangeListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.4
            public void stateChanged(ChangeEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JPODer3000StateChanged(evt);
            }
        });
        this.JPODer4000.setModel(new SpinnerNumberModel(0, (Comparable) null, 100, 5));
        this.JPODer4000.addChangeListener(new ChangeListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.5
            public void stateChanged(ChangeEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JPODer4000StateChanged(evt);
            }
        });
        this.JPODer6000.setModel(new SpinnerNumberModel(0, (Comparable) null, 100, 5));
        this.JPODer6000.addChangeListener(new ChangeListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.6
            public void stateChanged(ChangeEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JPODer6000StateChanged(evt);
            }
        });
        this.JPODer8000.setModel(new SpinnerNumberModel(0, (Comparable) null, 100, 5));
        this.JPODer8000.addChangeListener(new ChangeListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.7
            public void stateChanged(ChangeEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JPODer8000StateChanged(evt);
            }
        });
        this.JPOIzq500.setModel(new SpinnerNumberModel(0, (Comparable) null, 100, 5));
        this.JPOIzq500.addChangeListener(new ChangeListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.8
            public void stateChanged(ChangeEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JPOIzq500StateChanged(evt);
            }
        });
        this.JPOIzq1000.setModel(new SpinnerNumberModel(0, (Comparable) null, 100, 5));
        this.JPOIzq1000.addChangeListener(new ChangeListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.9
            public void stateChanged(ChangeEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JPOIzq1000StateChanged(evt);
            }
        });
        this.JPOIzq2000.setModel(new SpinnerNumberModel(0, (Comparable) null, 100, 5));
        this.JPOIzq2000.addChangeListener(new ChangeListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.10
            public void stateChanged(ChangeEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JPOIzq2000StateChanged(evt);
            }
        });
        this.JPOIzq3000.setModel(new SpinnerNumberModel(0, (Comparable) null, 100, 5));
        this.JPOIzq3000.addChangeListener(new ChangeListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.11
            public void stateChanged(ChangeEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JPOIzq3000StateChanged(evt);
            }
        });
        this.JPOIzq4000.setModel(new SpinnerNumberModel(0, (Comparable) null, 100, 5));
        this.JPOIzq4000.addChangeListener(new ChangeListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.12
            public void stateChanged(ChangeEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JPOIzq4000StateChanged(evt);
            }
        });
        this.JPOIzq6000.setModel(new SpinnerNumberModel(0, (Comparable) null, 100, 5));
        this.JPOIzq6000.addChangeListener(new ChangeListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.13
            public void stateChanged(ChangeEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JPOIzq6000StateChanged(evt);
            }
        });
        this.JPOIzq8000.setModel(new SpinnerNumberModel(0, (Comparable) null, 100, 5));
        this.JPOIzq8000.addChangeListener(new ChangeListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.14
            public void stateChanged(ChangeEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JPOIzq8000StateChanged(evt);
            }
        });
        ...
        this.JBGrabarRes.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.15
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JBGrabarResActionPerformed(evt);
            }
        });
        ...
        this.JRBNo.setFont(new Font("Arial", 1, 10));
        this.JRBNo.setSelected(true);
        this.JRBNo.setText("No");
        this.JRBNo.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.16
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JRBNoActionPerformed(evt);
            }
        });
        this.JBElementos.add(this.JRBInsercion);
        this.JRBInsercion.setFont(new Font("Arial", 1, 10));
        this.JRBInsercion.setText("Inserción");
        this.JRBInsercion.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.17
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JRBInsercionActionPerformed(evt);
            }
        });
        this.JBElementos.add(this.JRBCopa);
        this.JRBCopa.setFont(new Font("Arial", 1, 10));
        this.JRBCopa.setText("Copa");
        this.JRBCopa.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.18
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JRBCopaActionPerformed(evt);
            }
        });
        this.JBElementos.add(this.JRBOtro);
        this.JRBOtro.setFont(new Font("Arial", 1, 10));
        this.JRBOtro.setText("Otro");
        this.JRBOtro.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.19
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JRBOtroActionPerformed(evt);
            }
        });
        ...
        this.JRBSi_Autoscopia.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.20
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JRBSi_AutoscopiaActionPerformed(evt);
            }
        });
        ...
        this.JRBNo_Autoscopia.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.21
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JRBNo_AutoscopiaActionPerformed(evt);
            }
        });
        this.jLabel13.setFont(new Font("Arial", 1, 10));
        this.jLabel13.setText("Retest?");
        this.JBRetest.add(this.JRBSi_Retest);
        this.JRBSi_Retest.setFont(new Font("Arial", 1, 10));
        this.JRBSi_Retest.setText("Si");
        this.JRBSi_Retest.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.22
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JRBSi_RetestActionPerformed(evt);
            }
        });
        this.JBRetest.add(this.JRBNo_Retest);
        this.JRBNo_Retest.setFont(new Font("Arial", 1, 10));
        this.JRBNo_Retest.setSelected(true);
        this.JRBNo_Retest.setText("No");
        this.JRBNo_Retest.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.23
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JRBNo_RetestActionPerformed(evt);
            }
        });
        ...
        this.JCHBPromedio.setFont(new Font("Arial", 1, 10));
        this.JCHBPromedio.setText("Promedio (5,1,2,3)?");
        this.JCHBPromedio.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.24
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JCHBPromedioActionPerformed(evt);
            }
        });
        this.JCHBLineaB.setFont(new Font("Arial", 1, 10));
        this.JCHBLineaB.setText("Línea base?");
        this.JCHBLineaB.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.25
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JCHBLineaBActionPerformed(evt);
            }
        });
        this.JPODer250.setModel(new SpinnerNumberModel(0, (Comparable) null, 100, 5));
        this.JPODer250.addChangeListener(new ChangeListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.26
            public void stateChanged(ChangeEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JPODer250StateChanged(evt);
            }
        });
        this.JPOIzq250.setModel(new SpinnerNumberModel(0, (Comparable) null, 100, 5));
        this.JPOIzq250.addChangeListener(new ChangeListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.27
            public void stateChanged(ChangeEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JPOIzq250StateChanged(evt);
            }
        });
        ...
        JPDatosAudioLayout.setHorizontalGroup(JPDatosAudioLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPDatosAudioLayout.createSequentialGroup().addContainerGap().addGroup(JPDatosAudioLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPDatosAudioLayout.createSequentialGroup().addGap(437, 437, 437).addComponent(this.jLabel57, -2, 193, -2)).addGroup(JPDatosAudioLayout.createSequentialGroup().addComponent(this.jLabel12, -2, 254, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JRBSi_Autoscopia).addGap(12, 12, 12).addComponent(this.JRBNo_Autoscopia)).addGroup(JPDatosAudioLayout.createSequentialGroup().addComponent(this.jLabel13, -2, 54, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JRBSi_Retest).addGap(10, 10, 10).addComponent(this.JRBNo_Retest).addGap(18, 18, 18).addComponent(this.JCHBLineaB).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JCHBPromedio)).addGroup(JPDatosAudioLayout.createSequentialGroup().addComponent(this.jLabel11).addGap(10, 10, 10).addComponent(this.JRBNo).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JRBOtro).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JRBInsercion).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JRBCopa)).addGroup(JPDatosAudioLayout.createSequentialGroup().addGroup(JPDatosAudioLayout.createParallelGroup(GroupLayout.Alignment.TRAILING).addComponent(this.jLabel2).addComponent(this.jLabel1)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(JPDatosAudioLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.JPODer250, -2, 55, -2).addComponent(this.jLabel28).addComponent(this.JPOIzq250, -2, 55, -2)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(JPDatosAudioLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.JPODer500, -2, 55, -2).addComponent(this.jLabel3).addComponent(this.JPOIzq500, -2, 55, -2)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(JPDatosAudioLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.jLabel4, -2, 43, -2).addComponent(this.JPODer1000, -2, 55, -2).addComponent(this.JPOIzq1000, -2, 55, -2)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(JPDatosAudioLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.JPOIzq2000, -2, 55, -2).addComponent(this.JPODer2000, -2, 55, -2).addComponent(this.jLabel5, -2, 43, -2)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(JPDatosAudioLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.JPOIzq3000, -2, 55, -2).addComponent(this.JPODer3000, -2, 55, -2).addComponent(this.jLabel6, -2, 43, -2)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(JPDatosAudioLayout.createParallelGroup(GroupLayout.Alignment.TRAILING).addComponent(this.JPOIzq4000, -2, 55, -2).addGroup(JPDatosAudioLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.jLabel7, -2, 43, -2).addComponent(this.JPODer4000, -2, 55, -2))).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(JPDatosAudioLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.jLabel8, -2, 43, -2).addComponent(this.JPODer6000, -2, 55, -2).addComponent(this.JPOIzq6000, -2, 55, -2)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(JPDatosAudioLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.jLabel9, -2, 43, -2).addComponent(this.JPODer8000, -2, 55, -2).addComponent(this.JPOIzq8000, -2, 55, -2)).addGroup(JPDatosAudioLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.jLabel10, GroupLayout.Alignment.TRAILING, -2, 71, -2).addGroup(JPDatosAudioLayout.createSequentialGroup().addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(JPDatosAudioLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.JFTFPromedioOIzq, -2, 56, -2).addComponent(this.JFTFPromedioODer, -2, 56, -2)))))).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(JPDatosAudioLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.JBGrabarRes, -2, 180, -2).addComponent(this.jScrollPane2, -2, 180, -2)).addContainerGap(-1, 32767)));
        JPDatosAudioLayout.setVerticalGroup(JPDatosAudioLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPDatosAudioLayout.createSequentialGroup().addGroup(JPDatosAudioLayout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(this.jLabel13).addComponent(this.JRBSi_Retest).addComponent(this.JRBNo_Retest).addComponent(this.JCHBLineaB).addComponent(this.JCHBPromedio)).addGroup(JPDatosAudioLayout.createParallelGroup(GroupLayout.Alignment.LEADING, false).addGroup(JPDatosAudioLayout.createSequentialGroup().addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(JPDatosAudioLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.jLabel11, GroupLayout.Alignment.TRAILING).addGroup(GroupLayout.Alignment.TRAILING, JPDatosAudioLayout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(this.JRBNo).addComponent(this.JRBOtro).addComponent(this.JRBInsercion).addComponent(this.JRBCopa))).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(JPDatosAudioLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(JPDatosAudioLayout.createSequentialGroup().addGroup(JPDatosAudioLayout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(this.jLabel4).addComponent(this.jLabel5)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JPODer2000, -2, 25, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JPOIzq2000, -2, 25, -2)).addGroup(JPDatosAudioLayout.createParallelGroup(GroupLayout.Alignment.LEADING, false).addGroup(JPDatosAudioLayout.createSequentialGroup().addGap(20, 20, 20).addGroup(JPDatosAudioLayout.createParallelGroup(GroupLayout.Alignment.TRAILING).addGroup(GroupLayout.Alignment.LEADING, JPDatosAudioLayout.createSequentialGroup().addComponent(this.JPODer4000, -2, 25, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JPOIzq4000, -2, 25, -2)).addGroup(GroupLayout.Alignment.LEADING, JPDatosAudioLayout.createSequentialGroup().addGroup(JPDatosAudioLayout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(this.JPODer8000, -2, 25, -2).addComponent(this.JFTFPromedioODer, -2, 25, -2)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JFTFPromedioOIzq, -2, 25, -2)).addGroup(GroupLayout.Alignment.LEADING, JPDatosAudioLayout.createSequentialGroup().addComponent(this.JPODer6000, -2, 25, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(JPDatosAudioLayout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(this.JPOIzq6000, -2, 25, -2).addComponent(this.JPOIzq8000, -2, 25, -2))))).addGroup(JPDatosAudioLayout.createSequentialGroup().addGap(21, 21, 21).addComponent(this.JPODer1000, -2, 25, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JPOIzq1000, -2, 25, -2)).addGroup(JPDatosAudioLayout.createSequentialGroup().addComponent(this.jLabel3).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JPODer500, -2, 25, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JPOIzq500, -2, 25, -2)).addGroup(JPDatosAudioLayout.createSequentialGroup().addComponent(this.jLabel28).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(JPDatosAudioLayout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(this.JPODer250, -2, 25, -2).addComponent(this.jLabel1)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(JPDatosAudioLayout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(this.JPOIzq250, -2, 25, -2).addComponent(this.jLabel2))).addGroup(GroupLayout.Alignment.TRAILING, JPDatosAudioLayout.createSequentialGroup().addGroup(JPDatosAudioLayout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(this.jLabel6).addComponent(this.jLabel7).addComponent(this.jLabel8).addComponent(this.jLabel9).addComponent(this.jLabel10)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JPODer3000, -2, 25, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JPOIzq3000, -2, 25, -2).addGap(1, 1, 1))))).addGroup(JPDatosAudioLayout.createSequentialGroup().addGap(2, 2, 2).addComponent(this.JBGrabarRes, -2, 43, -2).addGap(18, 18, 18).addComponent(this.jScrollPane2))).addGap(9, 9, 9).addGroup(JPDatosAudioLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.jLabel57).addGroup(JPDatosAudioLayout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(this.jLabel12).addComponent(this.JRBSi_Autoscopia).addComponent(this.JRBNo_Autoscopia)))));
        this.jPanel7.setBorder(BorderFactory.createTitledBorder((Border) null, "Exposición a Ruido No Industrial", 0, 0, new Font("Arial", 1, 10), new Color(0, 51, 255)));
        this.JCHBTiroCaza.setFont(new Font("Arial", 1, 10));
        this.JCHBTiroCaza.setText("Tiro o Caza");
        this.JCHBTiroCaza.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.28
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JCHBTiroCazaActionPerformed(evt);
            }
        });
        this.JCHBRudioAmbiental.setFont(new Font("Arial", 1, 10));
        this.JCHBRudioAmbiental.setText("Ruido Ambiental");
        this.JCHBRudioAmbiental.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.29
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JCHBRudioAmbientalActionPerformed(evt);
            }
        });
        this.JCHBUsoAudifonos.setFont(new Font("Arial", 1, 10));
        this.JCHBUsoAudifonos.setText("Uso de Audifonos");
        this.JCHBUsoAudifonos.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.30
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JCHBUsoAudifonosActionPerformed(evt);
            }
        });
        this.JCHBTejo.setFont(new Font("Arial", 1, 10));
        this.JCHBTejo.setText("Tejo");
        this.JCHBTejo.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.31
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JCHBTejoActionPerformed(evt);
            }
        });
        this.JCHBDiscotecas.setFont(new Font("Arial", 1, 10));
        this.JCHBDiscotecas.setText("Discotecas");
        this.JCHBDiscotecas.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.32
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JCHBDiscotecasActionPerformed(evt);
            }
        });
        this.JCHBServicioMilitar.setFont(new Font("Arial", 1, 10));
        this.JCHBServicioMilitar.setText("Servicio Militar");
        this.JCHBServicioMilitar.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.33
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JCHBServicioMilitarActionPerformed(evt);
            }
        });
        this.JCHBUsoDeMoto.setFont(new Font("Arial", 1, 10));
        this.JCHBUsoDeMoto.setText("Uso de Moto");
        this.JCHBUsoDeMoto.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.34
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JCHBUsoDeMotoActionPerformed(evt);
            }
        });
        ...
        this.jPanel13.setBorder(new LineBorder(new Color(204, 204, 204), 1, true));
        this.groupimgDer.add(this.RdDer1);
        this.RdDer1.setSelected(true);
        this.RdDer1.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.35
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.RdDer1ActionPerformed(evt);
            }
        });
        this.jLabel61.setIcon(new ImageIcon(getClass().getResource("/Imagenes/circleRed.png")));
        this.jLabel62.setIcon(new ImageIcon(getClass().getResource("/Imagenes/cuadrad.png")));
        this.groupimgDer.add(this.RdDer2);
        this.RdDer2.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.36
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.RdDer2ActionPerformed(evt);
            }
        });
        this.groupimgDer.add(this.RdDer3);
        this.RdDer3.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.37
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.RdDer3ActionPerformed(evt);
            }
        });
        this.jLabel63.setIcon(new ImageIcon(getClass().getResource("/Imagenes/rectang.png")));
        GroupLayout jPanel13Layout = new GroupLayout(this.jPanel13);
        this.jPanel13.setLayout(jPanel13Layout);
        jPanel13Layout.setHorizontalGroup(jPanel13Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(GroupLayout.Alignment.TRAILING, jPanel13Layout.createSequentialGroup().addContainerGap().addGroup(jPanel13Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(GroupLayout.Alignment.TRAILING, jPanel13Layout.createSequentialGroup().addComponent(this.RdDer1).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED, -1, 32767).addComponent(this.jLabel61)).addGroup(GroupLayout.Alignment.TRAILING, jPanel13Layout.createSequentialGroup().addComponent(this.RdDer3).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED, -1, 32767).addComponent(this.jLabel63)).addGroup(GroupLayout.Alignment.TRAILING, jPanel13Layout.createSequentialGroup().addComponent(this.RdDer2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED, -1, 32767).addComponent(this.jLabel62)))));
        jPanel13Layout.setVerticalGroup(jPanel13Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(jPanel13Layout.createSequentialGroup().addContainerGap().addGroup(jPanel13Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.jLabel61).addComponent(this.RdDer1)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(jPanel13Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(jPanel13Layout.createSequentialGroup().addGap(3, 3, 3).addComponent(this.jLabel62)).addComponent(this.RdDer2)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(jPanel13Layout.createParallelGroup(GroupLayout.Alignment.TRAILING).addComponent(this.jLabel63).addComponent(this.RdDer3)).addContainerGap(-1, 32767)));
        this.jPanel14.setBorder(new LineBorder(new Color(204, 204, 204), 1, true));
        this.jLabel58.setIcon(new ImageIcon(getClass().getResource("/Imagenes/equiz az.png")));
        this.jLabel59.setIcon(new ImageIcon(getClass().getResource("/Imagenes/rectang_az.png")));
        this.jLabel60.setIcon(new ImageIcon(getClass().getResource("/Imagenes/cuadrad_az.png")));
        this.groupimgIzq.add(this.RdIzq1);
        this.RdIzq1.setSelected(true);
        this.RdIzq1.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.38
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.RdIzq1ActionPerformed(evt);
            }
        });
        this.groupimgIzq.add(this.RdIzq2);
        this.RdIzq2.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.39
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.RdIzq2ActionPerformed(evt);
            }
        });
        this.groupimgIzq.add(this.RdIzq3);
        this.RdIzq3.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.40
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.RdIzq3ActionPerformed(evt);
            }
        });
        GroupLayout jPanel14Layout = new GroupLayout(this.jPanel14);
        this.jPanel14.setLayout(jPanel14Layout);
        jPanel14Layout.setHorizontalGroup(jPanel14Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(GroupLayout.Alignment.TRAILING, jPanel14Layout.createSequentialGroup().addContainerGap().addGroup(jPanel14Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(GroupLayout.Alignment.TRAILING, jPanel14Layout.createSequentialGroup().addComponent(this.RdIzq1).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED, -1, 32767).addComponent(this.jLabel58)).addGroup(GroupLayout.Alignment.TRAILING, jPanel14Layout.createSequentialGroup().addComponent(this.RdIzq3).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED, -1, 32767).addComponent(this.jLabel59)).addGroup(GroupLayout.Alignment.TRAILING, jPanel14Layout.createSequentialGroup().addComponent(this.RdIzq2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED, -1, 32767).addComponent(this.jLabel60)))));
        jPanel14Layout.setVerticalGroup(jPanel14Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(jPanel14Layout.createSequentialGroup().addContainerGap().addGroup(jPanel14Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.jLabel58).addComponent(this.RdIzq1)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(jPanel14Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(jPanel14Layout.createSequentialGroup().addGap(3, 3, 3).addComponent(this.jLabel60)).addComponent(this.RdIzq2)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED, -1, 32767).addGroup(jPanel14Layout.createParallelGroup(GroupLayout.Alignment.TRAILING).addComponent(this.jLabel59).addComponent(this.RdIzq3)).addGap(16, 16, 16)));
        this.contenedorDerecha.setBackground(Color.white);
        this.contenedorDerecha.setBorder(BorderFactory.createLineBorder(new Color(204, 204, 204), 0));
        this.jLbImg1Derecha.setIcon(new ImageIcon(getClass().getResource("/Imagenes/GraficaAudiometriaXy.png")));
        this.jLbImg1Derecha.setAlignmentY(0.0f);
        GroupLayout contenedorDerechaLayout = new GroupLayout(this.contenedorDerecha);
        this.contenedorDerecha.setLayout(contenedorDerechaLayout);
        contenedorDerechaLayout.setHorizontalGroup(contenedorDerechaLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(contenedorDerechaLayout.createSequentialGroup().addComponent(this.jLbImg1Derecha).addGap(0, 12, 32767)));
        contenedorDerechaLayout.setVerticalGroup(contenedorDerechaLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(GroupLayout.Alignment.TRAILING, contenedorDerechaLayout.createSequentialGroup().addComponent(this.jLbImg1Derecha).addGap(0, 0, 32767)));
        this.contenedorIzquierda.setBackground(Color.white);
        this.contenedorIzquierda.setBorder(BorderFactory.createLineBorder(Color.white, 0));
        this.contenedorIzquierda.setForeground(Color.white);
        this.contenedorIzquierda.setPreferredSize(new Dimension(433, 314));
        this.jLbImg1Izquierda.setBackground(Color.white);
        this.jLbImg1Izquierda.setIcon(new ImageIcon(getClass().getResource("/Imagenes/GraficaAudiometriaXy.png")));
        this.jLbImg1Izquierda.setAlignmentY(0.0f);
        GroupLayout contenedorIzquierdaLayout = new GroupLayout(this.contenedorIzquierda);
        this.contenedorIzquierda.setLayout(contenedorIzquierdaLayout);
        contenedorIzquierdaLayout.setHorizontalGroup(contenedorIzquierdaLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(GroupLayout.Alignment.TRAILING, contenedorIzquierdaLayout.createSequentialGroup().addGap(0, 2, 32767).addComponent(this.jLbImg1Izquierda, -2, 421, -2)));
        contenedorIzquierdaLayout.setVerticalGroup(contenedorIzquierdaLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.jLbImg1Izquierda));
        GroupLayout jPanel8Layout = new GroupLayout(this.jPanel8);
        this.jPanel8.setLayout(jPanel8Layout);
        jPanel8Layout.setHorizontalGroup(jPanel8Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(jPanel8Layout.createSequentialGroup().addComponent(this.jPanel13, -2, -1, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.contenedorDerecha, -2, -1, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.contenedorIzquierda, -2, 423, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.jPanel14, -2, -1, -2).addContainerGap(36, 32767)));
        jPanel8Layout.setVerticalGroup(jPanel8Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(jPanel8Layout.createSequentialGroup().addContainerGap().addGroup(jPanel8Layout.createParallelGroup(GroupLayout.Alignment.TRAILING, false).addComponent(this.jPanel14, GroupLayout.Alignment.LEADING, -2, 84, -2).addComponent(this.jPanel13, GroupLayout.Alignment.LEADING, -2, -1, -2).addComponent(this.contenedorDerecha, GroupLayout.Alignment.LEADING, -1, -1, 32767).addComponent(this.contenedorIzquierda, GroupLayout.Alignment.LEADING, -1, 310, 32767)).addContainerGap(-1, 32767)));
        ...
        this.JCSarampionSI.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.41
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JCSarampionSIActionPerformed(evt);
            }
        });
        this.GroupSarampion.add(this.JCSarampionNO);
        this.JCSarampionNO.setSelected(true);
        this.JCSarampionNO.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.42
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JCSarampionNOActionPerformed(evt);
            }
        });
        this.groupPaperas.add(this.JCPaperasNO);
        this.JCPaperasNO.setSelected(true);
        this.JCPaperasNO.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.43
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JCPaperasNOActionPerformed(evt);
            }
        });
        this.groupPaperas.add(this.JCPaperasSI);
        this.JCPaperasSI.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.44
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JCPaperasSIActionPerformed(evt);
            }
        });
        this.groupSifilis.add(this.JCSifilisSI);
        this.JCSifilisSI.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.45
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JCSifilisSIActionPerformed(evt);
            }
        });
        this.groupSifilis.add(this.JCSifilisNO);
        this.JCSifilisNO.setSelected(true);
        this.JCSifilisNO.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.46
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JCSifilisNOActionPerformed(evt);
            }
        });
        this.groupTBC.add(this.JCTBCNO);
        this.JCTBCNO.setSelected(true);
        this.JCTBCNO.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.47
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JCTBCNOActionPerformed(evt);
            }
        });
        this.groupTBC.add(this.JCTBCSI);
        this.JCTBCSI.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.48
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JCTBCSIActionPerformed(evt);
            }
        });
        this.groupPolio.add(this.JCPolioSI);
        this.JCPolioSI.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.49
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JCPolioSIActionPerformed(evt);
            }
        });
        this.groupPolio.add(this.JCPolioNO);
        this.JCPolioNO.setSelected(true);
        this.JCPolioNO.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.50
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JCPolioNOActionPerformed(evt);
            }
        });
        ...
        this.JCTraumaDeCraneoSI.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.51
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JCTraumaDeCraneoSIActionPerformed(evt);
            }
        });
        this.groupTraumaCreaneo.add(this.JCTraumaDeCraneoNO);
        this.JCTraumaDeCraneoNO.setSelected(true);
        this.JCTraumaDeCraneoNO.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.52
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JCTraumaDeCraneoNOActionPerformed(evt);
            }
        });
        this.groupHipertencion.add(this.JCHipertencionArterialNO);
        this.JCHipertencionArterialNO.setSelected(true);
        this.JCHipertencionArterialNO.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.53
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JCHipertencionArterialNOActionPerformed(evt);
            }
        });
        this.groupHipertencion.add(this.JCHipertencionArterialSI);
        this.JCHipertencionArterialSI.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.54
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JCHipertencionArterialSIActionPerformed(evt);
            }
        });
        this.groupDiabetes.add(this.JCDiabetesSI);
        this.JCDiabetesSI.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.55
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JCDiabetesSIActionPerformed(evt);
            }
        });
        this.groupDiabetes.add(this.JCDiabetesNO);
        this.JCDiabetesNO.setSelected(true);
        this.JCDiabetesNO.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.56
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JCDiabetesNOActionPerformed(evt);
            }
        });
        this.groupDrogasToxicas.add(this.JCDrogastoxicasNO);
        this.JCDrogastoxicasNO.setSelected(true);
        this.JCDrogastoxicasNO.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.57
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JCDrogastoxicasNOActionPerformed(evt);
            }
        });
        this.groupDrogasToxicas.add(this.JCDrogastoxicasSI);
        this.JCDrogastoxicasSI.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.58
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JCDrogastoxicasSIActionPerformed(evt);
            }
        });
        this.groupMareo.add(this.JCMareoSI);
        this.JCMareoSI.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.59
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JCMareoSIActionPerformed(evt);
            }
        });
        this.groupMareo.add(this.JCMareoNO);
        this.JCMareoNO.setSelected(true);
        this.JCMareoNO.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.60
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JCMareoNOActionPerformed(evt);
            }
        });
        ...
        this.JCAmigdalitisSI.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.61
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JCAmigdalitisSIActionPerformed(evt);
            }
        });
        this.groupAmigdalitis.add(this.JCAmigdalitisNO);
        this.JCAmigdalitisNO.setSelected(true);
        this.JCAmigdalitisNO.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.62
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JCAmigdalitisNOActionPerformed(evt);
            }
        });
        this.groupOtitis.add(this.JCOtitisNO);
        this.JCOtitisNO.setSelected(true);
        this.JCOtitisNO.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.63
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JCOtitisNOActionPerformed(evt);
            }
        });
        this.groupOtitis.add(this.JCOtitisSI);
        this.JCOtitisSI.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.64
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JCOtitisSIActionPerformed(evt);
            }
        });
        this.groupOtalgia.add(this.JCOtalgiaSI);
        this.JCOtalgiaSI.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.65
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JCOtalgiaSIActionPerformed(evt);
            }
        });
        this.groupOtalgia.add(this.JCOtalgiaNO);
        this.JCOtalgiaNO.setSelected(true);
        this.JCOtalgiaNO.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.66
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JCOtalgiaNOActionPerformed(evt);
            }
        });
        this.groupAlergias.add(this.JCAlergiasNO);
        this.JCAlergiasNO.setSelected(true);
        this.JCAlergiasNO.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.67
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JCAlergiasNOActionPerformed(evt);
            }
        });
        this.groupAlergias.add(this.JCAlergiasSI);
        this.JCAlergiasSI.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.68
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JCAlergiasSIActionPerformed(evt);
            }
        });
        this.groupOtorrea.add(this.JCOtorreaSI);
        this.JCOtorreaSI.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.69
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JCOtorreaSIActionPerformed(evt);
            }
        });
        this.groupOtorrea.add(this.JCOtorreaNO);
        this.JCOtorreaNO.setSelected(true);
        this.JCOtorreaNO.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.70
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JCOtorreaNOActionPerformed(evt);
            }
        });
        ...
        this.JCAcufenosNO.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.71
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JCAcufenosNOActionPerformed(evt);
            }
        });
        this.groupAcufenos.add(this.JCAcufenosSI);
        this.JCAcufenosSI.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.72
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JCAcufenosSIActionPerformed(evt);
            }
        });
        this.groupVertigo.add(this.JCVertigoSI);
        this.JCVertigoSI.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.73
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JCVertigoSIActionPerformed(evt);
            }
        });
        this.groupHipoacusia.add(this.JCHipoacusiaSI);
        this.JCHipoacusiaSI.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.74
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JCHipoacusiaSIActionPerformed(evt);
            }
        });
        this.groupVertigo.add(this.JCVertigoNO);
        this.JCVertigoNO.setSelected(true);
        this.JCVertigoNO.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.75
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JCVertigoNOActionPerformed(evt);
            }
        });
        this.groupHipoacusia.add(this.JCHipoacusiaNO);
        this.JCHipoacusiaNO.setSelected(true);
        this.JCHipoacusiaNO.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.76
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JCHipoacusiaNOActionPerformed(evt);
            }
        });
        this.groupSorderaFamiliar.add(this.JCSordelaFamiliarSI);
        this.JCSordelaFamiliarSI.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.77
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JCSordelaFamiliarSIActionPerformed(evt);
            }
        });
        this.groupSorderaFamiliar.add(this.JCSordelaFamiliarNO);
        this.JCSordelaFamiliarNO.setSelected(true);
        this.JCSordelaFamiliarNO.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.78
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JCSordelaFamiliarNOActionPerformed(evt);
            }
        });
        this.groupCirugiasdeOido.add(this.JCCirugiasOidoNO);
        this.JCCirugiasOidoNO.setSelected(true);
        this.JCCirugiasOidoNO.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.79
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JCCirugiasOidoNOActionPerformed(evt);
            }
        });
        this.groupCirugiasdeOido.add(this.JCCirugiasOidoSI);
        this.JCCirugiasOidoSI.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.80
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JCCirugiasOidoSIActionPerformed(evt);
            }
        });
        ...
        this.jTLarsenOi.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.81
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.jTLarsenOiActionPerformed(evt);
            }
        });
        this.jTGatiso.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.82
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.jTGatisoActionPerformed(evt);
            }
        });
        ...
        jPanel11Layout.setHorizontalGroup(jPanel11Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(jPanel11Layout.createSequentialGroup().addContainerGap().addGroup(jPanel11Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.jScrollPane8).addGroup(jPanel11Layout.createSequentialGroup().addComponent(this.jPanel12, -2, -1, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.jScrollPane7, -1, 571, 32767))).addContainerGap()));
        jPanel11Layout.setVerticalGroup(jPanel11Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(jPanel11Layout.createSequentialGroup().addContainerGap().addGroup(jPanel11Layout.createParallelGroup(GroupLayout.Alignment.LEADING, false).addComponent(this.jPanel12, -2, 148, -2).addComponent(this.jScrollPane7)).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.jScrollPane8, -1, 147, 32767).addContainerGap()));
        ...
        jPanel1Layout.setHorizontalGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(jPanel1Layout.createSequentialGroup().addComponent(this.jPanel7, -1, -1, 32767).addGap(160, 160, 160)).addGroup(jPanel1Layout.createSequentialGroup().addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.TRAILING, false).addComponent(this.JPDatosAudio, -1, -1, 32767).addComponent(this.JTP_DatosG)).addContainerGap(99, 32767)));
        jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup().addContainerGap().addComponent(this.jPanel7, -2, -1, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JPDatosAudio, -2, -1, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JTP_DatosG, -2, 369, -2).addGap(269, 269, 269)));
        ...
        this.JSPIzquierdo250.addChangeListener(new ChangeListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.83
            public void stateChanged(ChangeEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JSPIzquierdo250StateChanged(evt);
            }
        });
        this.JSPDerecho500.setModel(new SpinnerNumberModel(0, (Comparable) null, 100, 5));
        this.JSPDerecho500.addChangeListener(new ChangeListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.84
            public void stateChanged(ChangeEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JSPDerecho500StateChanged(evt);
            }
        });
        this.JSPIzquierdo500.setModel(new SpinnerNumberModel(0, (Comparable) null, 100, 5));
        this.JSPIzquierdo500.addChangeListener(new ChangeListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.85
            public void stateChanged(ChangeEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JSPIzquierdo500StateChanged(evt);
            }
        });
        this.JSPDerecho1000.setModel(new SpinnerNumberModel(0, (Comparable) null, 100, 5));
        this.JSPDerecho1000.addChangeListener(new ChangeListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.86
            public void stateChanged(ChangeEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JSPDerecho1000StateChanged(evt);
            }
        });
        this.JSPIzquierdo1000.setModel(new SpinnerNumberModel(0, (Comparable) null, 100, 5));
        this.JSPIzquierdo1000.addChangeListener(new ChangeListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.87
            public void stateChanged(ChangeEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JSPIzquierdo1000StateChanged(evt);
            }
        });
        this.JSPDerecho2000.setModel(new SpinnerNumberModel(0, (Comparable) null, 100, 5));
        this.JSPDerecho2000.addChangeListener(new ChangeListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.88
            public void stateChanged(ChangeEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JSPDerecho2000StateChanged(evt);
            }
        });
        this.JSPIzquierdo2000.setModel(new SpinnerNumberModel(0, (Comparable) null, 100, 5));
        this.JSPIzquierdo2000.addChangeListener(new ChangeListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.89
            public void stateChanged(ChangeEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JSPIzquierdo2000StateChanged(evt);
            }
        });
        this.JSPDerecho3000.setModel(new SpinnerNumberModel(0, (Comparable) null, 100, 5));
        this.JSPDerecho3000.addChangeListener(new ChangeListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.90
            public void stateChanged(ChangeEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JSPDerecho3000StateChanged(evt);
            }
        });
        this.JSPIzquierdo3000.setModel(new SpinnerNumberModel(0, (Comparable) null, 100, 5));
        this.JSPIzquierdo3000.addChangeListener(new ChangeListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.91
            public void stateChanged(ChangeEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JSPIzquierdo3000StateChanged(evt);
            }
        });
        this.JSPDerecho4000.setModel(new SpinnerNumberModel(0, (Comparable) null, 100, 5));
        this.JSPDerecho4000.addChangeListener(new ChangeListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.92
            public void stateChanged(ChangeEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JSPDerecho4000StateChanged(evt);
            }
        });
        this.JSPIzquierdo4000.setModel(new SpinnerNumberModel(0, (Comparable) null, 100, 5));
        this.JSPIzquierdo4000.addChangeListener(new ChangeListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.93
            public void stateChanged(ChangeEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JSPIzquierdo4000StateChanged(evt);
            }
        });
        this.JSPDerecho250.setModel(new SpinnerNumberModel(0, (Comparable) null, 100, 5));
        this.JSPDerecho250.addChangeListener(new ChangeListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.94
            public void stateChanged(ChangeEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JSPDerecho250StateChanged(evt);
            }
        });
        ...
        this.JBGrabarViaOsea.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.95
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JBGrabarViaOseaActionPerformed(evt);
            }
        });
        ...
        this.JBGrabarTestWeber.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.96
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JBGrabarTestWeberActionPerformed(evt);
            }
        });
        ...
        this.JBGrabarOtoscopia.addActionListener(new ActionListener() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.97
            public void actionPerformed(ActionEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JBGrabarOtoscopiaActionPerformed(evt);
            }
        });
        ...
        jPanel3Layout.setVerticalGroup(jPanel3Layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(jPanel3Layout.createSequentialGroup().addContainerGap().addComponent(this.jPanel5, -2, -1, -2).addContainerGap(660, 32767)));
        ...
        this.JTDetalleHistorico.addMouseListener(new MouseAdapter() { // from class: com.genoma.plus.controller.historia.JPSo_Audiometria_nueva_graficaxy.98
            public void mouseClicked(MouseEvent evt) {
                JPSo_Audiometria_nueva_graficaxy.this.JTDetalleHistoricoMouseClicked(evt);
            }
        });
        ...
        layout.setVerticalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(layout.createSequentialGroup().addComponent(this.jTabbedPane1, -2, -1, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.JPInformacion, -2, 1, -2).addContainerGap(-1, 32767)));
    ...
    public void JBGrabarResActionPerformed(ActionEvent evt) {
        if (this.aDiagnostico.JTDetalle.getRowCount() > 0) {
            mGuardar();
        } else {
            JOptionPane.showMessageDialog((Component) null, "Seleccione un resultado un diagnostico", "Error", 0);
        }
        mCargarDatosTablaHistorico();
    }
    ...
    private String SelecImgPointDerecha() {
        String imagenPoint = "";
        if (this.RdDer1.isSelected()) {
            imagenPoint = "circleRed.png";
        } else if (this.RdDer2.isSelected()) {
            imagenPoint = "cuadrad.png";
        } else if (this.RdDer3.isSelected()) {
            imagenPoint = "rectang.png";
        }
        return imagenPoint;
    }

    private String SelecImgPointIzquierda() {
        String imagenPoint = "";
        if (this.RdIzq1.isSelected()) {
            imagenPoint = "equiz az.png";
        } else if (this.RdIzq2.isSelected()) {
            imagenPoint = "cuadrad_az.png";
        } else if (this.RdIzq3.isSelected()) {
            imagenPoint = "rectang_az.png";
        }
        return imagenPoint;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void RdIzq1ActionPerformed(ActionEvent evt) {
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void RdIzq2ActionPerformed(ActionEvent evt) {
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void RdIzq3ActionPerformed(ActionEvent evt) {
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void RdDer1ActionPerformed(ActionEvent evt) {
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void RdDer2ActionPerformed(ActionEvent evt) {
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void RdDer3ActionPerformed(ActionEvent evt) {
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void JPOIzq8000StateChanged(ChangeEvent evt) {
        String imagenPoint = SelecImgPointIzquierda();
        int cx = 0;
        int cy = 0;
        try {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void JPODer8000StateChanged(ChangeEvent evt) {
        String imagenPoint = SelecImgPointDerecha();
        int cx = 0;
        int cy = 0;
        try {
    ...
    private void GenerarGraficoDerecho() {
        this.directorio = new File(this.xmetodo.mRutaSoporte("JPSo_Optometria"));
        System.out.println(this.directorio);
        JPSo_Optometria.makeScreenshot(String.valueOf(this.directorio), "GraficaXyDerecha", this.contenedorDerecha);
        System.out.println(this.directorio);
        JPSo_Optometria.makeScreenshot(String.valueOf(this.directorio), "GraficaXyIzquierda", this.contenedorIzquierda);
    }
    ...
    private void mCargarDatosTablaHistorico() {
        try {
            ...
            Logger.getLogger(JPSo_Audiometria_nueva_graficaxy.class.getName()).log(Level.SEVERE, (String) null, (Throwable) ex);
        }
    }
        ...
        if (n == 0) {
            if (!this.xmetodo.esIPSMineros()) {
                ...
                if (this.JTDetalleHistorico.getRowCount() > 0) {
                    ...
                    mGenerarGrafico();
                    try {
                        archivo1 = Metodos.encodeFileToBase64Binary(this.xmetodo.getRutaRep("") + "GraficaXyDerecha.png");
                        archivo2 = Metodos.encodeFileToBase64Binary(this.xmetodo.getRutaRep("") + "GraficaXyIzquierda.png");
                        redibujar(archivo1, "GraficaXyDerecha.png", this.jLbImg1Derecha);
                        redibujar(archivo2, "GraficaXyIzquierda.png", this.jLbImg1Izquierda);
                    } catch (Exception e) {
                        System.out.println("Ocurrio un error al recuperar los graficos ======" + e);
                    }
                }
                String sql2 = "UPDATE\n\th_so_audiometria\nSET\n\tId_Atencion = '" + clasesHistoriaCE.informacionAgendaMedicaDTO.getIdAtencion() + "', Fecha_R = '" + this.xmetodo.formatoAMD.format(this.xmetodo.getFechaActual()) + "', ImgOI = '" + archivo2 + "', ImgOD = '" + archivo1 + "' \nWHERE \t\n\th_so_audiometria.`Id_Atencion`='" + clasesHistoriaCE.informacionAgendaMedicaDTO.getIdAtencion() + "'";
                ...
                if (this.JTDetalleHistorico.getRowCount() > 0) {
                    ...
                    try {
                        ...
                        System.out.println("Ocurrio un error al recuperar los graficos ======" + e2);
                    }
                }
                String sql4 = "UPDATE\n\th_so_audiometria\nSET\n\tId_Atencion = '" + clasesHistoriaCE.informacionAgendaMedicaDTO.getIdAtencion() + "', Fecha_R = '" + this.xmetodo.formatoAMD.format(this.xmetodo.getFechaActual()) + "', ImgOI = '" + archivo2 + "', ImgOD = '" + archivo1 + "' \nWHERE \t\n\th_so_audiometria.`Id_Atencion`='" + clasesHistoriaCE.informacionAgendaMedicaDTO.getIdAtencion() + "'";
    ...
    private void mBuscarAdiometriaAtencion() {
        try {
            ...
            if (xrs.next()) {
                ...
                this.ImgDerecha = xrs.getString("ImgOI");
                this.ImgIzquierda = xrs.getString("ImgOD");
    ...
    public void mGenerarGrafico() {
        try {
            this.directorio = new File(this.xmetodo.getRutaRep(""));
            System.out.println(this.directorio);
            JPSo_Optometria.makeScreenshot(String.valueOf(this.directorio), "GraficaXyDerecha", this.contenedorDerecha);
            System.out.println(this.directorio);
            JPSo_Optometria.makeScreenshot(String.valueOf(this.directorio), "GraficaXyIzquierda", this.contenedorIzquierda);
        } catch (Exception ex) {
            System.out.println("Ocrrio un error al generar las images =====" + ex);
        }
    }
