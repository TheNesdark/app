...
/* JADX INFO: loaded from: GenomaP.jar:com/genoma/plus/controller/historia/dto/Anexo6Dto.class */
public class Anexo6Dto {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Anexo6Dto)) {
            return false;
        }
        Anexo6Dto other = (Anexo6Dto) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof Anexo6Dto;
    }
    ...
    /* JADX INFO: loaded from: GenomaP.jar:com/genoma/plus/controller/historia/dto/Anexo6Dto$Anexo6DtoBuilder.class */
    @Generated
    public static class Anexo6DtoBuilder {
        ...
        @Generated
        public Anexo6DtoBuilder causaAtencion(String causaAtencion) {
            this.causaAtencion = causaAtencion;
            return this;
        }

        @Generated
        public Anexo6DtoBuilder codigoPrestadorRemite(String codigoPrestadorRemite) {
            this.codigoPrestadorRemite = codigoPrestadorRemite;
            return this;
        }

        @Generated
        public Anexo6DtoBuilder diagnostico(String diagnostico) {
            this.diagnostico = diagnostico;
            return this;
        }

        @Generated
        public Anexo6DtoBuilder diagnosticoRelacionado1(String diagnosticoRelacionado1) {
            this.diagnosticoRelacionado1 = diagnosticoRelacionado1;
            return this;
        }

        @Generated
        public Anexo6DtoBuilder diagnosticoRelacionado2(String diagnosticoRelacionado2) {
            this.diagnosticoRelacionado2 = diagnosticoRelacionado2;
            return this;
        }

        @Generated
        public Anexo6DtoBuilder diagnosticoRelacionado3(String diagnosticoRelacionado3) {
            this.diagnosticoRelacionado3 = diagnosticoRelacionado3;
            return this;
        }

        @Generated
        public Anexo6DtoBuilder condicionDestino(String condicionDestino) {
            this.condicionDestino = condicionDestino;
            return this;
        }

        @Generated
        public Anexo6DtoBuilder prioridadAtencion(String prioridadAtencion) {
            this.prioridadAtencion = prioridadAtencion;
            return this;
        }

        @Generated
        public Anexo6DtoBuilder tipoAtencionSolicitada(String tipoAtencionSolicitada) {
            this.tipoAtencionSolicitada = tipoAtencionSolicitada;
            return this;
        }

        @Generated
        public Anexo6DtoBuilder grupoServicios(String grupoServicios) {
            this.grupoServicios = grupoServicios;
            return this;
        }

        @Generated
        public Anexo6DtoBuilder modalidadAtencion(String modalidadAtencion) {
            this.modalidadAtencion = modalidadAtencion;
            return this;
        }

        @Generated
        public Anexo6DtoBuilder codigoServicio(String codigoServicio) {
            this.codigoServicio = codigoServicio;
            return this;
        }

        @Generated
        public Anexo6DtoBuilder cupsDetalle(List<ListaCupsDetalleDto> cupsDetalle) {
            this.cupsDetalle = cupsDetalle;
            return this;
        }

        @Generated
        public Anexo6Dto build() {
            return new Anexo6Dto(this.causaAtencion, this.codigoPrestadorRemite, this.diagnostico, this.diagnosticoRelacionado1, this.diagnosticoRelacionado2, this.diagnosticoRelacionado3, this.condicionDestino, this.prioridadAtencion, this.tipoAtencionSolicitada, this.grupoServicios, this.modalidadAtencion, this.codigoServicio, this.cupsDetalle);
        }

        @Generated
        public String toString() {
            return "Anexo6Dto.Anexo6DtoBuilder(causaAtencion=" + this.causaAtencion + ", codigoPrestadorRemite=" + this.codigoPrestadorRemite + ", diagnostico=" + this.diagnostico + ", diagnosticoRelacionado1=" + this.diagnosticoRelacionado1 + ", diagnosticoRelacionado2=" + this.diagnosticoRelacionado2 + ", diagnosticoRelacionado3=" + this.diagnosticoRelacionado3 + ", condicionDestino=" + this.condicionDestino + ", prioridadAtencion=" + this.prioridadAtencion + ", tipoAtencionSolicitada=" + this.tipoAtencionSolicitada + ", grupoServicios=" + this.grupoServicios + ", modalidadAtencion=" + this.modalidadAtencion + ", codigoServicio=" + this.codigoServicio + ", cupsDetalle=" + this.cupsDetalle + ")";
        }
    }
    ...
    @Generated
    public static Anexo6DtoBuilder builder() {
        return new Anexo6DtoBuilder();
    }
