...
/* JADX INFO: loaded from: GenomaP.jar:com/genoma/plus/dao/laboratorio/LaboratorioDAO.class */
public interface LaboratorioDAO {
    List<AgendaDetalleDTO> listAgenda(String str, Integer num, Integer num2, String str2, String str3, String str4);

    List<AgendaDetalleDTO> listAgendaIdProcedimiento(String str, Integer num, Integer num2, String str2, String str3);

    List<AgendaDetalleDTO> listAgendaDocNombre(String str, String str2, String str3, String str4);

    List<AgendaDetalleDTO> listAgendaNumeroRecepcion(String str, String str2);
    ...
    List<GenericoDTO> listResultadoInterfaz(Long l, String str, String str2, String str3);
    ...
    List<RecepcionDetalleDTO> listRecepcionDetalle(String str, Integer num, Integer num2, Integer num3);

    List<RecepcionDetalleDTO> listRecepcionDetalleArea(String str, String str2, Integer num, Integer num2, Integer num3);

    List<RecepcionDetalleDTO> listRecepcionDetalleIdProcedimiento(String str, String str2, Integer num, Integer num2, Integer num3);
    ...
    void updateDatelleResultadoEnviado(int i, long j);

    void cargarArchivosDeResultadosExternos(Long l, Long l2, String str);
    ...
    List<Object[]> validacionAdministrativaResultados(String str);

    List<Object[]> listaNombrePdfColcan(String str);
}
