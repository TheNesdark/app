...
/* JADX INFO: loaded from: GenomaP.jar:RecursosHumanos/JIDPrestamos_Buscador.class */
public class JIDPrestamos_Buscador extends JDialog {
    ...
    public JIDPrestamos_Buscador(Frame parent, boolean modal, JIFPrestamos jIFPrestamos) {
        super(parent, modal);
    ...
    public JIDPrestamos_Buscador(Frame parent, boolean modal, JIFNovedadesNomina jIFNovedadesNomina) {
        super(parent, modal);
        this.personaService = (IEmpleadoNominaService) Principal.contexto.getBean(IEmpleadoNominaService.class);
        this.empleadosNomina = new EmpleadosNomina();
        this.empleadoNominaList = new ArrayList();
    ...
    private void crearModeloTabla() {
        this.model = new DefaultTableModel() { // from class: RecursosHumanos.JIDPrestamos_Buscador.1
    ...
    private void initComponents() {
        ...
        this.JTFNombre.addKeyListener(new KeyAdapter() { // from class: RecursosHumanos.JIDPrestamos_Buscador.2
            public void keyPressed(KeyEvent evt) {
                JIDPrestamos_Buscador.this.JTFNombreKeyPressed(evt);
            }
        });
        ...
        this.JTDetalle.addMouseListener(new MouseAdapter() { // from class: RecursosHumanos.JIDPrestamos_Buscador.3
            public void mouseClicked(MouseEvent evt) {
                JIDPrestamos_Buscador.this.JTDetalleMouseClicked(evt);
            }
        });
    ...
    public void JTDetalleMouseClicked(MouseEvent evt) {
        ...
        if (selectedRowIndex != -1) {
            this.jIFPrestamos.fillTextFieldWithPersona(this.empleadoNominaList.get(selectedRowIndex));
            dispose();
        }
    }
}
